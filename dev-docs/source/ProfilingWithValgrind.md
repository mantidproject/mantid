...
[callgrind](http://valgrind.org/docs/manual/cl-manual.html) plugin to
the [valgrind](http://valgrind.org/) tool set to profile your code.
...
set of
[macros](http://valgrind.org/docs/manual/cl-manual.html#cl-manual.clientrequests)
...
To profile only the call to `bar1()` then you would do the following to
the code:
...
[here](http://valgrind.org/docs/manual/cl-manual.html#opt.instr-atstart)
more details.
...
<figure>
<img src="images/KCachegrind_MantidPlot.png"
alt="images/KCachegrind_MantidPlot.png" />
<figcaption>Example of KCachegrind display a profile of MantidPlot
starting up and closing down</figcaption>
</figure>
...
- Self - Exclusive count spent in the selected function. Units are those
  selected by the to-right drop-down
