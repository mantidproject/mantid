...
The `ExtractSubtrees` component converts a set of row cell contents and
a set of row locations into a structured set of subtrees. This is better
described by the illustration below.

<img src="../../images/extract_subtree.svg" class="align-center"
width="800" alt="image" />
...
This algorithm is used by `../API/JobTreeView` in the `selectedSubtrees`
method which is required to implement non-trivial copy and paste.
