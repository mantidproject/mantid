...
.. note:: This document was not written by the author of MaskWorkspace.  These notes may border on speculation.
...
But currently, it is usually expected to have a 1:1 mapping of Detector ID to Spectrum, though this is not guaranteed.
Some Detector ID's, such as those associated with monitors, are not associated with the workspace, but may be part of the Instrument
