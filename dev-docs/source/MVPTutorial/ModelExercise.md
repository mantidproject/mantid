...
presenter to only show the line colours allowed in the model. To achieve
this you will need to add:

1.  A function to the model containing a list of allowed line colours
    and returning them when called.
