...
A GUI should help a user to easily manipulate the behaviour of the code
(by changing variables etc.). For example consider creating a plot of a
sine wave. In this exercise you will create a view which contains the
options for manipulating the plot.
