...
1. Install Apple's Command Line tools (required by Homebrew)
...
1. Add the necessary 'taps'. The last 4 are to use qt4.
...
1. Disable homebrew update and install ``mantid-developer`` formula (this may take a while depending on your network speed)
...
1. Pin libraries that depend on Python 2 and libmxml and NeXus is not compatible with v3:
