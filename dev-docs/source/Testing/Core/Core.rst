...
This was last updated for Release 5.1. Check if the organiser has considered if the Core testers can test on 4 different platforms: eg. 1: Windows, 2: Mac, 3: Linux, 4: IDAaaS. 
...
.. csv-table:: Smaller tasks
    ...
    Sliceviewer,:r:`Y`,:b:`Y`,,:o:`Y`, `Instructions <https://www.mantidproject.org/MantidPlot:_SliceViewer>`_
