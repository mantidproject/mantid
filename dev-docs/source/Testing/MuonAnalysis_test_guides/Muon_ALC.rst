...
This interface loads a series of runs and automatically calculates the asymmetry.
...
- In the loading bar enter ``81075-100``
...
- Right-click in the ``Funtion`` box to add a ``LinearBackground`` fitting function
...
- Right-click in the ``Peaks`` box to add a ``Gaussian`` fitting function, set the parameters to give a decent guess (use plot guess to check)
...
- In the loading bar enter ``81070-81075``
- Select ``field_danfysik`` for the sample log
...
- In the loading bar enter ``134028-35``
