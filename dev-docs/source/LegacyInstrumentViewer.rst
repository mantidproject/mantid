...
.. note::
   ...
   This page describes the legacy OpenGL-based Instrument Viewer in ``qt/widgets/instrumentview``.
   For the current Python Instrument View, see :ref:`InstrumentViewer`.
