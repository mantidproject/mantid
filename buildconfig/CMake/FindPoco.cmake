# * try to find Poco libraries and include files POCO_INCLUDE_DIR where to find Standard.hxx, etc. POCO_LIBRARIES
#   libraries to link against POCO_FOUND If false, do not try to use POCO
...
# Set a version string by examining either the Poco/Version.h header or the Poco/Foundation.h header if Version.h does
# not exist
if(POCO_INCLUDE_DIR)
  ...
  # regex quantifiers like {8} don't seem to work so we'll stick with + even though it's not strictly true
...
# Also set a shared library version number. This is different to the main version number and can form part of the
# package name on some Linux systems
...
# handle the QUIETLY and REQUIRED arguments and set POCO_FOUND to TRUE if all listed variables are TRUE
