# * enable_unity_build based upon http://cheind.wordpress.com/2009/12/10/reducing-compilation-time-unity-builds/
#   example. Expanded to allow the user to specify the maximum number of cpp files in each unity build file. Script then
#   handles generation of n unity build files.
...
function(enable_unity_build UB_SUFFIX SOURCE_VARIABLE_NAME SOURCE_UNITY_IGNORE UNIT_SIZE)
  ...
  set(${SOURCE_VARIABLE_NAME}
      ${${SOURCE_VARIABLE_NAME}} ${unit_build_files}
      PARENT_SCOPE
  )
