function(coverage_setup _COVERAGE_SRCS _coverage_UPLOAD)
	...
	set (GCOV_EXECUTABLE gcov CACHE STRING "Gcov executable to use, e.g. gcov-8 or llvm-cov-11")
	...
	add_custom_target(coverage_cpp
		COMMAND gcovr
			...
			# Compilers will include a branch to unwind the stack
			# after throwing an exception. Typically when going through
			# a vptr, exclude this so branch coverage doesn't become useless
			--exclude-throw-branches
			--xml "${COV_CPP_XML_DIR}/Cobertura.xml"
			# The file format will take x.html and turn it into
			# x.Framework.Kernel.y.cpp.html so set x to mantid
	...
	add_custom_target(coverage
		DEPENDS coverage_cpp
		# TODO coverage_python
	)
