# * Find muParser Find the muParser library
#
# This module defines the following variables: MUPARSER_FOUND        - True if MUPARSER_INCLUDE_DIR & MUPARSER_LIBRARY
# are found MUPARSER_LIBRARIES    - Set when MUPARSER_LIBRARY is found MUPARSER_INCLUDE_DIRS - Set when
# MUPARSER_INCLUDE_DIR is found
#
# MUPARSER_INCLUDE_DIR  - where to find muParser.h etc. MUPARSER_LIBRARY      - the muParser library
#
...
# handle the QUIETLY and REQUIRED arguments and set MUPARSER_FOUND to TRUE if all listed variables are TRUE
...
if(NOT TARGET MuParser::MuParser)
  ...
  set_target_properties(
    MuParser::MuParser PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${MUPARSER_INCLUDE_DIR} IMPORTED_LOCATION
                                                                                        ${MUPARSER_LIBRARY}
  )
  if(EXISTS "${MUPARSER_LIBRARY_DEBUG}")
    set_target_properties(MuParser::MuParser PROPERTIES IMPORTED_LOCATION_DEBUG ${MUPARSER_LIBRARY_DEBUG})
  endif()
endif()
