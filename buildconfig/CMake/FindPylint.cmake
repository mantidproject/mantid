# * Find Pylint Find the Pylint executable and extract the version number
#
# OUTPUT Variables
#
# PYLINT_FOUND True if the pylint package was found PYLINT_EXECUTABLE The pylint executable location PYLINT_VERSION A
# string denoting the version of pylint that has been found PYLINT_RUNNER_SCRIPT Location of python script that will
# actually run pylint PYLINT_CFG_FILE Location of configuration file
#
...
if(PYLINT_EXECUTABLE)
  execute_process(
    COMMAND ${PYLINT_EXECUTABLE} --version
    OUTPUT_VARIABLE PYLINT_VERSION_RAW
    ERROR_QUIET
  )
