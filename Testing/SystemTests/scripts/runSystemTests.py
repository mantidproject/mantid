        ...
        for ip in range(options.ncores):
            processes.append(
                Process(target=systemtesting.testThreadsLoop,
                        args=(mtdconf, options, tests_dict, tests_lock, tests_left, results_array, status_dict,
                              total_number_of_tests, maximum_name_length, tests_done, ip, lock, required_files_dict,
                              locked_files_dict)))
