...
class AbinsCASTEPIsotopes(stresstesting.MantidStressTest, HelperTestingClass):
    """
    In this benchmark it is tested is calculations for systems with isotope substitution works properly. Input data is
    generated by CASTEP. This system test should be fast so no need for excludeInPullRequests flag.
    """
    tolerance = None
    ref_result = None
