...
class WeigthedLSGaussPeaksEVSdataTest2(stresstesting.MantidStressTest):
    def runTest(self):
        ...
        expected_params = [0.11790928270268099, 0.0003733355959906781, 4.750983503334755e-06, 0.002725666504029804,
                           -4.494580010809418, 0.12986299166539694, 0.00016646632365980064, 2.616230019006275e-05]
