...
class SANSMergedDetectorsTest(stresstesting.MantidStressTest):
    ...
    def runTest(self):
        ...
        # Setup detector positions
        i.SetDetectorOffsets(bank = 'REAR', x = -16.0, y = 58.0, z = 0.0,
                             rot = 0.0, radius = 0.0, side = 0.0)
        i.SetDetectorOffsets(bank = 'FRONT', x = 44.0, y = -20.0, z = 47.0,
                             rot = 0.0, radius = 1.0, side = 1.0)
        i.Gravity(False)
