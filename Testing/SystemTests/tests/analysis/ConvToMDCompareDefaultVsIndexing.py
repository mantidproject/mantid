    ...
    def runTest(self):
        for func in self.test_functions:
            for pw in self.test_pix_width:
                ...
                CreateSampleWorkspace(WorkspaceType='Event', OutputWorkspace=data_name, Function=func, XMin='10000',
                                      XMax='100000', NumEvents='1000', BankPixelWidth=pw, Random=False)

                ConvertToMD(OutputWorkspace=self.indexed_name(params), SplitInto='2', SplitThreshold='10',
                            ConverterType='Indexed', InputWorkspace=data_name, QDimensions='Q3D',
                            dEAnalysisMode='Elastic', Q3DFrames='Q_lab')

                ConvertToMD(OutputWorkspace=self.default_name(params), SplitInto='2', SplitThreshold='10',
                            ConverterType='Default', InputWorkspace=data_name, QDimensions='Q3D',
                            dEAnalysisMode='Elastic', Q3DFrames='Q_lab')
