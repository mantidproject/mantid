...
class ImagingIMATTomoTests(unittest.TestCase):
    ...
    def test_imports(self):
        print("Nothing to see here, but setup should have been ran first")
        try:
            import sys
            print("\n".join(sys.path))
        ...
        try:
            ...
            print(ee)
            pass  # cos we throw at import scipy.ndimage

        # for whatever reason on second import we fail to import io
        import IMAT.tomorec
    ...
    #     import IMAT.tomorec.configs as cfgs
    #
    #     # cannot import recon command.py
