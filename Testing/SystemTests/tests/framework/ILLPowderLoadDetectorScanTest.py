...
class ILLPowderLoadDetectorScanTest(systemtesting.MantidSystemTest):
    ...
    def d20_detector_scan_test(self):
        ...
        self.assertEqual(ws.y(0)[0], 523944)
        self.assertDelta(ws.e(0)[0], 723.8397, 0.0001)
        self.assertEqual(ws.y(570)[0], 523819)
        self.assertDelta(ws.e(570)[0], 723.7534, 0.0001)
        self.assertEqual(ws.y(571)[0], 0)
        self.assertEqual(ws.e(571)[0], 0)
        self.assertEqual(ws.y(37114)[0], 0)
        self.assertEqual(ws.e(37114)[0], 0)
        self.assertEqual(ws.y(37115)[0], 6111)
        self.assertDelta(ws.e(37115)[0], 78.1728, 0.0001)
        self.assertEqual(ws.y(1754682)[0], 4087)
        self.assertDelta(ws.e(1754682)[0], 63.9296, 0.0001)
