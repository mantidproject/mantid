...
from mantid.simpleapi import (config, CropWorkspace, DeleteWorkspace, DirectILLApplySelfShielding, DirectILLCollectData,
                              DirectILLDiagnostics, DirectILLIntegrateVanadium, DirectILLReduction,
                              DirectILLSelfShielding, DirectILLTubeBackground, SetSample, Subtract, Load)
...
class IN4(systemtesting.MantidSystemTest):
    def runTest(self):
        ...
        DirectILLApplySelfShielding(InputWorkspace='sample',
...
class IN5(systemtesting.MantidSystemTest):
    def runTest(self):
        ...
        DirectILLCollectData(Run='ILL/IN5/096003.nxs', OutputWorkspace='sample', OutputEppWorkspace='epps')
