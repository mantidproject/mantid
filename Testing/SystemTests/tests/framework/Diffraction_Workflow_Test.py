...
class Diffraction_Workflow_Test(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        AnvredCorrection(InputWorkspace=ws,
                         OutputWorkspace=ws,
        ...
        # Convert to Q space
        ConvertToDiffractionMDWorkspace(InputWorkspace=ws,
                                        OutputWorkspace=ws + '_MD2',
                                        LorentzCorrection='0',
        ...
        CentroidPeaksMD(InputWorkspace=ws + '_MD2',
                        CoordinatesToUse='Q (lab frame)',
                        PeakRadius='0.12',
                        PeaksWorkspace=ws + '_peaksLattice',
                        OutputWorkspace=ws + '_peaksLattice')
        # Find the UB matrix using the peaks and known lattice parameters
        FindUBUsingLatticeParameters(PeaksWorkspace=ws + '_peaksLattice',
                                     a='10.3522',
                                     b='6.0768',
                                     c='4.7276',
                                     alpha='90',
        ...
        IntegratePeaksMD(InputWorkspace=ws + '_MD2',
                         PeakRadius='0.12',
        ...
        BinMD(InputWorkspace=ws + '_HKL',
              AlignedDim0="[H,0,0], -20, 20, 800",
              AlignedDim1="[0,K,0], -5, 5, 50",
        ...
        self.assertDelta(w.signalAt(10), 140.824, 1,
                         "Peak 1")  #self.assertDelta( w.signalAt(10), 1110.86, 10, "Peak 1")
