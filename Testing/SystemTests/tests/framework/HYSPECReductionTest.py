...
class HYSPECReductionTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        FilterByLogValue(InputWorkspace='sum',
                         OutputWorkspace='sum1',
                         LogName='s1',
                         MinimumValue='0',
                         MaximumValue='24.5',
                         LogBoundary='Left')
        DeleteWorkspace('sum')
        GenerateEventsFilter(InputWorkspace='sum1',
                             ...
                             LogValueInterval='3')
        FilterEvents(InputWorkspace='sum1',
        ...
        DgsReduction(SampleInputWorkspace='splitc',
