...
class LoadSingleRunSingleSpectrumTest(systemtesting.MantidSystemTest):
    ...
    def validate(self):
        ...
        self.assertEqual(
            self._tof_input.spectra, '143', "Passed '143' as spectra to VesuvioTOFFitInput but found different value "
...
class LoadMultipleRunMultipleSpectrumTest(systemtesting.MantidSystemTest):
    ...
    def validate(self):
        ...
        self.assertTrue(
            ...
            "found type '" + str(type(self._tof_input.sample_data)) + "' instead.")
        self.assertEqual(
            self._tof_input.spectra, '135-198', "Passed 'forward' as spectra to VesuvioTOFFitInput, expected '135-198' "
...
class LoadBackScatteringSpectrumTest(systemtesting.MantidSystemTest):
    ...
    def validate(self):
        self.assertTrue(
            self._tof_input.using_back_scattering_spectra, "Back-scattering spectra passed to VesuvioTOFFitInput but "
        ...
        self.assertTrue(
            ...
            "found type '" + str(type(self._tof_input.sample_data)) + "' instead.")
        self.assertEqual(
            self._tof_input.spectra, '3-134', "Passed 'backward' as spectra to VesuvioTOFFitInput, expected '3-134' "
            "but found different value for spectra field: '" + self._tof_input.spectra + "'.")
