...
class CrystalFieldPythonInterface(MantidSystemTest):
    ...
    def runTest(self):
        ...
        cf = CrystalField("Ce", "C2v", B20=0.37737, B22=3.9770, B40=-0.031787, B42=-0.11611, B44=-0.12544, Temperature=44.0, FWHM=1.1)
        cf.background = Background(peak=Function("Gaussian", Height=10, Sigma=1), background=Function("LinearBackground", A0=1.0, A1=0.01))
        ...
        cf.background = Background(peak=Function("Gaussian", Height=10, Sigma=0.3), background=Function("FlatBackground", A0=1.0))
        ...
        params = {"B20": 0.377, "B22": 3.9, "B40": -0.03, "B42": -0.116, "B44": -0.125, "Temperature": [44.0, 50.0], "FWHM": [1.1, 0.9]}
        ...
        cfms = CrystalFieldMultiSite(
            Ions="Ce", Symmetries="C2v", Temperatures=[20], FWHMs=[1.0], Background=Gaussian(PeakCentre=1) + LinearBackground()
        )
        cfms = CrystalFieldMultiSite(
            Ions=["Ce", "Pr"],
            Symmetries=["C2v", "C2v"],
        ...
        cfms = CrystalFieldMultiSite(Ions="Ce", Symmetries="C2", Temperatures=[25], FWHMs=[1.0], PeakShape="Gaussian", BmolX=1.0, B40=-0.02)
        ...
        cf = CrystalField(
            "Ce", "C2v", B20=0, B22=0, B40=0, B42=0, B44=0, Temperature=44.0, FWHM=1.0, ResolutionModel=([0, 100], [1, 1]), FWHMVariation=0
        )
        ...
        cf = CrystalField(
            "Ce", "C2v", B20=0.37737, B22=3.9770, B40=-0.031787, B42=-0.11611, B44=-0.12544, PhysicalProperty=PhysicalProperties("Cv")
        )
