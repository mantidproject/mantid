...
ref_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(DIRS[0]))), "SystemTests", "tests", "framework",
                       "reference")
...
class CreateCalibrationWholeTest(systemtesting.MantidSystemTest):
    ...
    def validate(self):
        ...
        if systemtesting.using_gsl_v1():
            return ("engg_calibration_bank_1", "engggui_calibration_bank_1_gsl1.nxs", "engg_calibration_bank_2",
                    "engggui_calibration_bank_2_gsl1.nxs", "engg_calibration_banks_parameters",
                    "engggui_calibration_banks_parameters_gsl1.nxs", "Engg difc Zero Peaks Bank 1",
                    "engggui_difc_zero_peaks_bank_1.nxs", "Engg difc Zero Peaks Bank 2",
                    "engggui_difc_zero_peaks_bank_2.nxs")
        else:
            return ("engg_calibration_bank_1", "engggui_calibration_bank_1.nxs", "engg_calibration_bank_2",
                    "engggui_calibration_bank_2.nxs", "engg_calibration_banks_parameters",
                    "engggui_calibration_banks_parameters.nxs", "Engg difc Zero Peaks Bank 1",
                    "engggui_difc_zero_peaks_bank_1.nxs", "Engg difc Zero Peaks Bank 2",
                    "engggui_difc_zero_peaks_bank_2.nxs")
...
class CreateCalibrationCroppedTest(systemtesting.MantidSystemTest):
    ...
    def validate(self):
        ...
        self.disableChecking.append('SpectraMap')
        if systemtesting.using_gsl_v1():
            return ("cropped", "engggui_calibration_bank_cropped_gsl1.nxs", "engg_calibration_banks_parameters",
                    "engggui_calibration_cropped_parameters_gsl1.nxs", "Engg difc Zero Peaks Bank cropped",
                    "engggui_difc_zero_peaks_bank_cropped_gsl1.nxs")
        else:
            return ("cropped", "engggui_calibration_bank_cropped.nxs", "engg_calibration_banks_parameters",
                    "engggui_calibration_bank_cropped_parameters.nxs", "Engg difc Zero Peaks Bank cropped",
...
class CreateCalibrationBankTest(systemtesting.MantidSystemTest):
    ...
    def validate(self):
        ...
        if systemtesting.using_gsl_v1():
            ...
            return ("engg_calibration_bank_2", "engggui_calibration_bank_2.nxs", "engg_calibration_banks_parameters",
                    "engggui_calibration_bank_south_parameters.nxs", "Engg difc Zero Peaks Bank 2",
                    "engggui_difc_zero_peaks_bank_2.nxs")
...
class FocusBothBanks(systemtesting.MantidSystemTest):
    ...
    def validate(self):
        return ("engg_focus_output_bank_1", "enggui_focusing_output_ws_bank_1.nxs", "engg_focus_output_bank_2",
