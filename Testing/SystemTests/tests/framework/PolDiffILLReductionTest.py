...
class PolDiffILLReductionTest(systemtesting.MantidSystemTest):
    ...
    def d7_reduction_test_vanadium_individual(self):
        PolDiffILLReduction(Run='396993,396994',
                            ProcessAs='Vanadium',
    ...
    def d7_reduction_test_sample_individual(self):
        PolDiffILLReduction(Run='397004,397005',
                            ProcessAs='Sample',
        ...
        D7AbsoluteCrossSections(InputWorkspace='sample_individual',
                                ...
                                OutputUnits='Q',
                                SampleAndEnvironmentProperties=self._sampleProperties)
        self._check_output(mtd['sample_individual_not_normalised'],
                           263,
                           1,
                           6,
                           'q',
    ...
    def d7_reduction_test_sample_full_reduction(self):
        ...
        PolDiffILLReduction(Run='396993,396994',
                            ...
                            SampleAndEnvironmentProperties=self._sampleProperties,
                            OutputTreatment='Sum')
        PolDiffILLReduction(Run='396986,396987',
                            ProcessAs='Transmission',
        ...
        D7AbsoluteCrossSections(InputWorkspace='sample_full',
        ...
        self._check_output(mtd['sample_full_normalised'],
                           263,
                           1,
                           6,
                           'q',
