...
class SNAPReduxSimple(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        kwargs = {"RunNumbers": "45874", "GroupDetectorsBy": "Banks", "Binning": [0.5, -0.004, 7], "MaxChunkSize": 0.01}

        # create grouping for two output spectra
        CreateGroupingWorkspace(InstrumentFilename="SNAP_Definition.xml", GroupDetectorsBy="Group", OutputWorkspace="SNAP_grouping")
        _assert_reduction_configuration(kwargs)
        SNAPReduce(**kwargs)
