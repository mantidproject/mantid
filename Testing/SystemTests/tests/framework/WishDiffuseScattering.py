...
class WishDiffuseScattering(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        SmoothNeighbours(InputWorkspace='C',
                         OutputWorkspace='Csn',
                         RadiusUnits='NumberOfPixels',
                         Radius='3',
                         NumberOfNeighbours='25',
                         PreserveEvents='0')
        ...
        SmoothNeighbours(InputWorkspace='B',
                         OutputWorkspace='Bsn',
                         RadiusUnits='NumberOfPixels',
                         Radius='3',
                         NumberOfNeighbours='25',
        ...
        SmoothNeighbours(InputWorkspace='A',
                         OutputWorkspace='Asn',
                         RadiusUnits='NumberOfPixels',
                         Radius='3',
                         NumberOfNeighbours='25',
        ...
        ReplaceSpecialValues(InputWorkspace='C_div_A_sn_smooth',
        ...
        ReplaceSpecialValues(InputWorkspace='B_div_A_sn_smooth',
        ...
        ConvertToDiffractionMDWorkspace(InputWorkspace='CminusB_smooth',
                                        OutputWorkspace='CminusB_smooth_MD_HKL',
                                        OutputDimensions='HKL',
                                        Version=2)

        BinMD(InputWorkspace='CminusB_smooth_MD_HKL',
