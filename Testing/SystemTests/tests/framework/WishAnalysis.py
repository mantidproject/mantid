...
class WishAnalysis(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        # load Data
        LoadRaw(Filename="WISH00016748.raw",
        ...
        NormaliseToMonitor(InputWorkspace="w16748-1",
                           OutputWorkspace="w16748-1",
        ...
        AlignDetectors(InputWorkspace="w16748-1",
                       OutputWorkspace="w16748-1",
                       CalibrationFile="wish_grouping_noends2_no_offsets_nov2009.cal")
        #focus data
        DiffractionFocussing(InputWorkspace="w16748-1",
                             OutputWorkspace="w16748-1foc",
