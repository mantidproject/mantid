    ...
    def runTest(self):
        for func in self.test_functions:
            for pw in self.test_pix_width:
                ...
                ConvertToMD(OutputWorkspace=self.indexed_name(params),
                            SplitInto='2',
                            SplitThreshold='10',
                ...
                ConvertToMD(OutputWorkspace=self.default_name(params),
                            SplitInto='2',
                            SplitThreshold='10',
