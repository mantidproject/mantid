...
class PG3AbsorptionCorrection(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        Subtract(
            LHSWorkspace="PG3_46577", RHSWorkspace="PP_46577", OutputWorkspace="diff"
        )
...
class PG3StripPeaks(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        LoadEventNexus(
            Filename="PG3_4866_event.nxs", OutputWorkspace="PG3_4866", Precount=True
        )
        FilterBadPulses(InputWorkspace="PG3_4866", OutputWorkspace="PG3_4866")
        RemovePromptPulse(
            InputWorkspace="PG3_4866", OutputWorkspace="PG3_4866", Width=50
        )
        CompressEvents(
            InputWorkspace="PG3_4866", OutputWorkspace="PG3_4866", Tolerance=0.01
        )
        ...
        LoadCalFile(
            InputWorkspace="PG3_4866", CalFilename=self.cal_file, WorkspaceName="PG3"
        )
        ...
        ConvertUnits(
            InputWorkspace="PG3_4866", OutputWorkspace="PG3_4866", Target="TOF"
        )
        UnwrapSNS(InputWorkspace="PG3_4866", OutputWorkspace="PG3_4866", LRef=62)
        RemoveLowResTOF(
            InputWorkspace="PG3_4866", OutputWorkspace="PG3_4866", ReferenceDIFC=1500
        )
        ConvertUnits(
            InputWorkspace="PG3_4866", OutputWorkspace="PG3_4866", Target="dSpacing"
        )
        Rebin(
            InputWorkspace="PG3_4866",
            OutputWorkspace="PG3_4866",
...
class SeriesAndConjoinFilesTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        ConjoinFiles(
            RunNumbers=[9829, 9830],
            OutputWorkspace="ConjoinFilesTest",
            Directory=savedir,
        )
        # convert units makes sure the geometry was picked up
        ConvertUnits(
            InputWorkspace="ConjoinFilesTest",
            OutputWorkspace="ConjoinFilesTest",
            Target="dSpacing",
        )
...
class InfoFromLogs(systemtesting.MantidSystemTest):
    def skipTests(self):
        return _skip_test()
    ...
    def runTest(self):
        ...
        la_b6 = wksp.sample()
        assert la_b6.getMaterial().relativeMolecularMass() == 2.713
        assert la_b6.getHeight() == 55.0
