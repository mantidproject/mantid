...
from sans.command_interface.ISISCommandInterface import (SANS2DTUBES, SANS2D, Set1D, Detector, MaskFile, Gravity,
...
class SANS2DBatchTest_V2(systemtesting.MantidSystemTest):
    def runTest(self):
        ...
        os.remove(
            os.path.join(config['defaultsave.directory'], '5512p7_SANS2DBatch_p7rear_1D_2.0_14.0Phi-45.0_45.0.xml'))
