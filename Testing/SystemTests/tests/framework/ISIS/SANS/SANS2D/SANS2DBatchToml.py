...
from sans.command_interface.ISISCommandInterface import (SANS2D, Set1D, Detector, MaskFile, Gravity, BatchReduce,
...
class SANS2DBatchTest_TOML(systemtesting.MantidSystemTest):
    def runTest(self):
        ...
        xml_path = os.path.join(config['defaultsave.directory'],
