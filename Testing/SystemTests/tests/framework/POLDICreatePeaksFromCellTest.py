...
class POLDICreatePeaksFromCellTestAl2O3(ReflectionCheckingTest):
    ...
    def runTest(self):
        peaks_Al2O3 = PoldiCreatePeaksFromCell(
            SpaceGroup="R -3 c", Atoms="Al 0 0 0.35216 1.0 0.009; O 0.30668 0 1/4 1.0 0.0125", a=4.7605, c=12.9956, LatticeSpacingMin=0.885
        )
...
class POLDICreatePeaksFromCellTestCO(ReflectionCheckingTest):
    ...
    def runTest(self):
        peaks_CO = PoldiCreatePeaksFromCell(
            SpaceGroup="P 21 3", Atoms="C -0.042 -0.042 -0.042 1.0 0.0125; O 0.067 0.067 0.067 1.0 0.0125", a=5.63, LatticeSpacingMin=0.885
        )
