...
class POLDICreatePeaksFromCellTestSiO2(ReflectionCheckingTest):
    ...
    data = [([1, 0, 0], 4.25588, 8.27544, 6), ([1, 0, -1], 3.34393, 22.1494, 6), ([0, 0, 3], 1.80193, 8.70574, 2),
            ([2, 2, 0], 1.22857, 14.4884, 3), ([4, -1, 4], 0.88902, 9.14321, 6)]

    def runTest(self):
        peaks_SiO2 = PoldiCreatePeaksFromCell(SpaceGroup="P 32 2 1",
                                              Atoms="Si 0.4723 0.0 2/3 1.0 0.0075; O 0.416 0.2658 0.7881 1.0 0.0175",
                                              a=4.91427,
                                              c=5.4058,
                                              LatticeSpacingMin=0.885)
...
class POLDICreatePeaksFromCellTestAl2O3(ReflectionCheckingTest):
    ...
    data = [([1, 0, -2], 3.481144, 21.873, 6), ([1, 0, 4], 2.551773, 23.6714, 6), ([0, 0, 6], 2.165933, 68.8749, 2),
            ([5, -2, -5], 0.88880, 23.6113, 12)]

    def runTest(self):
        peaks_Al2O3 = PoldiCreatePeaksFromCell(SpaceGroup="R -3 c",
...
class POLDICreatePeaksFromCellTestFeTiO3(ReflectionCheckingTest):
    ...
    data = [([0, 0, 3], 4.6970, 2.0748, 2), ([1, 0, 1], 4.20559, 1.60512, 6), ([1, 0, 4], 2.75153, 76.1855, 6),
...
class POLDICreatePeaksFromCellTestCO(ReflectionCheckingTest):
    ...
    data = [([1, 1, 0], 3.98101, 1.93291, 12), ([1, 1, -1], 3.25048, 40.6203, 4), ([2, 0, 0], 2.815, 37.248, 6),
            ([6, 2, 0], 0.89018, 9.45489, 12)]

    def runTest(self):
        peaks_CO = PoldiCreatePeaksFromCell(SpaceGroup="P 21 3",
...
class POLDICreatePeaksFromCellTestBetaQuartz(ReflectionCheckingTest):
    ...
    data = [([1, 0, 0], 4.32710, 7.74737, 6), ([1, 0, 1], 3.38996, 19.7652, 12), ([1, 0, 2], 2.30725, 2.96401, 12),
            ([1, 0, 6], 0.88968, 3.15179, 12)]

    def runTest(self):
        peaks_betaSiO2 = PoldiCreatePeaksFromCell(SpaceGroup="P 62 2 2",
