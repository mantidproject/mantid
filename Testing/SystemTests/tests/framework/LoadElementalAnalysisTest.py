...
class LoadElementalAnalysisTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        self.assertAlmostEqual(detector1_ws.readE(1)[3318], 0.454742, places=4, delta=0.0001)
        ...
        self.assertAlmostEqual(detector2_ws.readE(2)[230], 15.6118, places=4, delta=0.0001)
        ...
        self.assertAlmostEqual(detector3_ws.readE(0)[2915], 9.95216, places=4, delta=0.0001)
        ...
        self.assertAlmostEqual(detector4_ws.readE(2)[4083], 10.9752, places=4, delta=0.0001)
...
class LoadPartialElementalAnalysisTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        self.assertAlmostEqual(detector1_ws.readYE(2)[5237], 2.0, places=4, delta=0.0001)
        ...
        self.assertAlmostEqual(detector3_ws.readE(2)[4697], 3.16227, places=4, delta=0.0001)
        # Check that the directory output is not empty
        self.assertIsNotNone(ws[1])
