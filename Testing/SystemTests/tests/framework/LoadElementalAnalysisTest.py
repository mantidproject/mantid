...
class LoadElementalAnalysisTest(systemtesting.MantidSystemTest):
    ...
    def requiredFiles(self):
        return [
            "ral09999.rooth2010.dat",
            "ral09999.rooth2020.dat",
            "ral09999.rooth2099.dat",
            "ral09999.rooth3010.dat",
            "ral09999.rooth3020.dat",
            "ral09999.rooth3099.dat",
            "ral09999.rooth4010.dat",
            "ral09999.rooth4020.dat",
            "ral09999.rooth4099.dat",
            "ral09999.rooth5010.dat",
            "ral09999.rooth5020.dat",
            "ral09999.rooth5099.dat",
        ]
    ...
    def runTest(self):
        ...
        self.assertAlmostEqual(detector1_ws.y(1)[3318], 0.206791, places=4)
        # Check that error in Bin 3318 of the Prompt spectra of the workspace of Detector 1 is 0.454742
        self.assertAlmostEqual(detector1_ws.e(1)[3318], 0.454742, places=4)
        ...
        self.assertAlmostEqual(detector2_ws.y(2)[230], 243.729, places=4)
        # Check that error in Bin 230 of the Total spectra of the workspace of Detector 2 is 15.6118
        self.assertAlmostEqual(detector2_ws.e(2)[230], 15.6118, places=4)
        ...
        self.assertAlmostEqual(detector3_ws.y(0)[2915], 99.0456, places=4)
        # Check that error in Bin 2915 of the Delayed spectra of the workspace of Detector 3 is 9.95216
        self.assertAlmostEqual(detector3_ws.e(0)[2915], 9.95216, places=4)
        ...
        self.assertAlmostEqual(detector4_ws.y(2)[4083], 120.457, places=4)
        # Check that the error in Bin 4083 of the Total spectra of the workspace of Detecror 4 is 10.9753
        self.assertAlmostEqual(detector4_ws.e(2)[4083], 10.9753, places=4)
...
class LoadPartialElementalAnalysisTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        detector1_prompt = detector1_ws.y(0)
        detector1_delay = detector1_ws.y(1)
        ...
        self.assertAlmostEqual(detector1_ws.y(2)[5237], 4.0, places=4)
        # Check that error in Bin 5237 of the Total spectra of the workspace of Detector 1 is 2.0
        self.assertAlmostEqual(detector1_ws.e(2)[5237], 2.0, places=4)
        ...
        self.assertAlmostEqual(detector3_ws.y(2)[4697], 10.0, places=4)
        # Check that error in Bin 4697 of the Total spectra of the workspace of Detector 3 is 3.16227
        self.assertAlmostEqual(detector3_ws.e(2)[4697], 3.16227, places=4)
        # Check that the directory output is not empty
        self.assertIsNotNone(ws[1])
