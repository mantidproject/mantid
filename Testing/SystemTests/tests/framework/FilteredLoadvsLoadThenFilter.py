...
class FilteredLoadvsLoadThenFilter(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        filteredLoad = LoadEventNexus("CNCS_7860_event.nxs",
                                      FilterByTimeStart=60.0,
                                      FilterByTimeStop=120.0,
                                      FilterByTofMin=-1e10,
                                      FilterByTofMax=1e10)
        loadAll = LoadEventNexus("CNCS_7860_event.nxs",
                                 FilterByTimeStart=-1e10,
                                 FilterByTimeStop=1e10,
                                 FilterByTofMin=-1e10,
                                 FilterByTofMax=1e10)
