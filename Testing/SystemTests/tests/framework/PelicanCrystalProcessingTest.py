...
class PelicanCrystalProcessingSingleTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        PelicanCrystalProcessing('44464', EnergyTransfer='-2,0.05,2',
                                 MomentumTransfer='0,0.05,2',
                                 OutputFolder=saveFolder, ConfigurationFile='pelican_doctest.ini',
...
class PelicanCrystalProcessingScratchTest(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        PelicanCrystalProcessing('44464', EnergyTransfer='-2,0.05,2',
                                 MomentumTransfer='0,0.05,2',
                                 OutputFolder=saveFolder, ScratchFolder=saveFolder,
