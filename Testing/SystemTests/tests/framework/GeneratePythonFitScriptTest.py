...
class GeneratePythonFitScriptTest(MantidSystemTest):
    ...
    def setUp(self):
        Load(Filename="MUSR62260_Group_fwd_Asymmetry_MA.nxs",
             OutputWorkspace="MUSR62260; Group; fwd; Asymmetry; MA")
        Load(Filename="MUSR62260_Group_bottom_Asymmetry_MA.nxs",
             OutputWorkspace="MUSR62260; Group; bottom; Asymmetry; MA")
        Load(Filename="MUSR62260_Group_top_Asymmetry_MA.nxs",
             OutputWorkspace="MUSR62260; Group; top; Asymmetry; MA")
        Load(Filename="MUSR62260_Group_bkwd_Asymmetry_MA.nxs",
             OutputWorkspace="MUSR62260; Group; bkwd; Asymmetry; MA")

    def cleanup(self):
        AnalysisDataService.clear()

    def requiredFiles(self):
        return ["MUSR62260_Group_fwd_Asymmetry_MA.nxs", "MUSR62260_Group_bottom_Asymmetry_MA.nxs",
    ...
    def _generate_sequential_fit_script():
        ...
        script_text = GeneratePythonFitScript(InputWorkspaces=["MUSR62260; Group; fwd; Asymmetry; MA",
                                              ...
                                              WorkspaceIndices=[0, 0, 0, 0], StartXs=[0.1, 0.1, 0.1, 0.1],
                                              EndXs=[15.0, 15.0, 15.0, 15.0], Function=function, MaxIterations=500,
    ...
    def _generate_simultaneous_fit_script():
        ...
        script_text = GeneratePythonFitScript(InputWorkspaces=["MUSR62260; Group; fwd; Asymmetry; MA",
                                                               ...
                                                               "MUSR62260; Group; bkwd; Asymmetry; MA"],
                                              WorkspaceIndices=[0, 0, 0, 0], StartXs=[0.1, 0.1, 0.1, 0.1],
                                              EndXs=[15.0, 15.0, 15.0, 15.0], FittingType="Simultaneous",
