...
class VTKFILTERSCORE_EXPORT AlignedCutter : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(AlignedCutter,vtkPolyDataAlgorithm);
 ...
 */
inline const char *AlignedCutter::GetSortByAsString(void)
{
