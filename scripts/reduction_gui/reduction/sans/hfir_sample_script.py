...
class SampleData(BaseScriptElement):
    class DirectBeam(BaseScriptElement):
        ...
        def from_xml(self, dom):
            ...
            if len(element_list) > 0:
                ...
                self.beam_radius = BaseScriptElement.getFloatElement(
                    instrument_dom, "beam_radius", default=SampleData.DirectBeam.beam_radius
                )
        ...
        def from_setup_info(self, xml_str):
            ...
            self.beam_radius = BaseScriptElement.getPropertyValue(alg, "TransmissionBeamRadius", default=SampleData.DirectBeam.beam_radius)
    ...
    class BeamSpreader(BaseScriptElement):
        ...
        def to_script(self):
            ...
            """
            if (
                len(str(self.sample_scatt).strip()) == 0
        ...
        def from_xml(self, dom):
            ...
            if len(element_list) > 0:
                ...
                self.spreader_trans = BaseScriptElement.getFloatElement(
                    instrument_dom, "spreader_trans", default=SampleData.BeamSpreader.spreader_trans
                )
        ...
        def from_setup_info(self, xml_str):
            ...
            self.spreader_trans = BaseScriptElement.getPropertyValue(
                alg, "SpreaderTransmissionValue", default=SampleData.BeamSpreader.spreader_trans
            )
    ...
    def from_xml(self, xml_str):
        ...
        if len(element_list) > 0:
            instrument_dom = element_list[0]
            self.transmission = BaseScriptElement.getFloatElement(instrument_dom, "trans", default=SampleData.transmission)
            self.transmission_spread = BaseScriptElement.getFloatElement(
                instrument_dom, "trans_spread", default=SampleData.transmission_spread
            )
            self.calculate_transmission = BaseScriptElement.getBoolElement(
                instrument_dom, "calculate_trans", default=SampleData.calculate_transmission
            )
            self.theta_dependent = BaseScriptElement.getBoolElement(instrument_dom, "theta_dependent", default=SampleData.theta_dependent)
        ...
        if len(element_list) > 0:
            ...
            self.sample_thickness = BaseScriptElement.getFloatElement(
                sample_data_dom, "sample_thickness", default=SampleData.sample_thickness
            )
            self.separate_jobs = BaseScriptElement.getBoolElement(sample_data_dom, "separate_jobs", default=SampleData.separate_jobs)
    ...
    def from_setup_info(self, xml_str):
        ...
        self.theta_dependent = BaseScriptElement.getPropertyValue(alg, "ThetaDependentTransmission", default=SampleData.theta_dependent)
        self.sample_thickness = BaseScriptElement.getPropertyValue(alg, "SampleThickness", default=SampleData.sample_thickness)
