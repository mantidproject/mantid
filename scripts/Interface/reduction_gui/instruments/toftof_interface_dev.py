...
class TOFTOFWidget(BaseWidget):
    ...
    def __init__(self, settings, scriptElement):
        ...
        grid.addWidget(self.vanCmts,              0, 3)
        ...
        grid.addWidget(QLabel('rebin in Q'),      3, 0)
        grid.addWidget(self.rebinQ,               3, 1)
        ...
        self.runDataModel = TOFTOFWidget.DataRunModel(self, self.dataRuns)
