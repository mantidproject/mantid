...
instruments = {
    ...
    'Lagrange': {
        ...
        'final_neutron_energy': 4.5 *
        MILLI_EV_TO_WAVENUMBER,  # Final energy on the crystal analyser in cm-1 (converted from eV)
        ...
        'settings': {
            ...
            'Si(311) (Lagrange)': {
                'Ei_range_meV': [16.5, 60],
                'abs_resolution_meV': 0.8
            },
            'Si(111) (Lagrange)': {
                'Ei_range_meV': [4.5, 20],
                'abs_resolution_meV': 0.8
