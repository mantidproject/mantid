...
class PawleyPattern2D(Poldi2DEvalMixin, PawleyPatternBase):
    ...
    def set_params_from_pawley1d(self, pawley1d: PawleyPattern1D, param_bounds_frac: float = None, param_bounds_abs_min: float = None) -> None:
    ...
    def create_no_constriants_fit(self, param_bounds_frac: float = None, param_bounds_abs_min: float = 1e-6) -> PawleyPattern2DNoConstraints:
