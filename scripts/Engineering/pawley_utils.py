...
class PawleyPattern2DNoConstraints:
    ...
    def set_profile_isfree(self, isfree=False):
        ...
        pk_par_names.pop(self.comp_func[0].getParameterIndex(self.intens_par_name))
        pk_par_names.pop(self.comp_func[0].getParameterIndex(self.comp_func[0].function.getCentreParameterName()))
