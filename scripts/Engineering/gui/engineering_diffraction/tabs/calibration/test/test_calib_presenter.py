...
class CalibrationPresenterTest(unittest.TestCase):
    ...
    def test_set_current_calibration(self, update_sig):
        ...
        pending = CalibrationInfo(vanadium_path="/test/set/path", ceria_path="test/set/path/2", instrument="TEST_INS")
        pendcpy = CalibrationInfo(vanadium_path="/test/set/path", ceria_path="test/set/path/2", instrument="TEST_INS")
