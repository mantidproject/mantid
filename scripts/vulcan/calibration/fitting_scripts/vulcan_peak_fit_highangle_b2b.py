...
# Load data
if True:
    # diamond_nxs = '/home/wzz/Projects/Mantid/mantid/scripts/vulcan/calibration/pdcalib_0003/
    # VULCAN_164960_diamond_3banks.nxs'
...
for pi in peak_info_list:
    ...
    out = Fit(Function=f'name=BackToBackExponential,I={pi.intensity},A=3423.58,B=1336.86,X0={pi.obs_pos},'
                       f'S=0.000393873;name=LinearBackground,A0={pi.a0_obs},A1=0.',
