...
if True:
    ...
    fit_window_list = [0.58800, 0.61600, 0.61600, 0.64500, 0.67500, 0.7000, 0.7050, 0.750, 0.79300, 0.84300, 0.87000, 0.93000, 1.05000, 1.100,    1.20, 1.35]
    # bank specific
    peakparvalues = f'1200 , 800 , 0.000566765'
...
out_ws_name = f'Bank{bank_name}_Peaks'
