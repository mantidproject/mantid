...
class LoadRunWidgetView(QtGui.QWidget):
    ...
    def setup_interface_layout(self):
        ...
        self.load_current_run_button.setMinimumSize(QtCore.QSize(100, 25))
        ...
        self.increment_run_button.setMinimumSize(QtCore.QSize(25, 25))
        ...
        self.decrement_run_button.setMinimumSize(QtCore.QSize(25, 25))
        ...
        self.run_edit.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.spacer_item = QtGui.QSpacerItem(25, 25, QtGui.QSizePolicy.Minimum,
