...
class ListSelectorPresenter(object):
    ...
    def get_selected_items_and_positions(self):
        ...
        """
        selected_items = [(name, self.model[name][model_position]) for name in self.model
    ...
    def get_filtered_list(self):
        if self.show_only_selected:
            filtered_list = [[name, vals[model_selected], vals[model_enabled]] for (name, vals) in self.model.items()
