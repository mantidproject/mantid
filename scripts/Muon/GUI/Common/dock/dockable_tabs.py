...
#
#     Additional Features:
#         - Detach tabs by dragging the tabs away from the tab bar or double clicking the tab
#         - Re-attach tabs by closing the detached tab's window or double clicking the detached tab's window frame
#         - Re-ordering (moving) tabs by dragging.
#     """
#
...
#         detached_tab = self.DetachedTab(content_widget, self.parentWidget())
#         detached_tab.setWindowModality(QtCore.Qt.NonModal)
#         detached_tab.setWindowTitle(name + " (Close to re-dock the tab)")
...
#     @pyqtSlot(str, int, QtCore.QPoint)
...
class DetachableTabWidget(QtGui.QTabWidget):
    ...
    #         self.drag_dropped_pos = QtCore.QPoint()
    ...
    #
    #         self.drag_dropped_pos.setX(0)
    #         self.drag_dropped_pos.setY(0)
    #
    #         self.dragInitiated = False
    #
    ...
    #                 if not self.drag_dropped_pos.isNull():
    #                     event.accept()
    #                     self.onMoveTabSignal.emit(self.tabAt(self.dragStartPos), self.tabAt(self.drag_dropped_pos))
    #         else:
    ...
    #         :return:
    #         """
    #         self.drag_dropped_pos = event.pos()
