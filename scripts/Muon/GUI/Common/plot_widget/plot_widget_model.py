...
class PlotWidgetModel(object):
    ...
    def get_workspaces_to_plot(self, is_raw, plot_type):
        ...
        currently_selected_diffs = self.context.group_pair_context.selected_diffs
        workspace_list = []

        if FREQ_PLOT_TYPE in plot_type:
            for grouppair in currently_selected_groups + currently_selected_pairs+currently_selected_diffs:
