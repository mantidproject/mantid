...
ui_tf_asymmetry_fitting_options, base_widget = load_ui(__file__, "tf_asymmetry_fitting_options.ui")


class TFAsymmetryFittingOptionsView(base_widget, ui_tf_asymmetry_fitting_options):
    """
