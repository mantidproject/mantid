...
class GeneralFittingModel(BasicFittingModel):
    ...
    def get_selected_runs_groups_and_pairs(self):
    ...
    def _transform_group_or_pair_to_float(self, workspace_name):
    ...
    def _add_multiple_fit_workspaces_to_ADS(self, output_workspace, covariance_matrix):
    ...
    def _get_names_in_group_workspace(self, group_name):
    ...
    def _rename_members_of_fitted_workspace_group(self, group_workspace):
    ...
    def _rename_workspace(self, input_name, workspace_name):
    ...
    def update_ws_fit_function_parameters(self, dataset_names, parameter_values):
        if self.simultaneous_fitting_mode:
    ...
    def _update_fit_function_parameters_for_single_fit(self, dataset_names, parameter_values):
    ...
    @staticmethod
    def _set_fit_function_parameter_values(fit_function, parameter_values):
    ...
    def get_fit_workspace_names_from_groups_and_runs(self, runs, groups_and_pairs):
        workspace_names = [self._get_workspace_name_from_run_and_group_or_pair(run, group_or_pair)
                           for run in runs for group_or_pair in groups_and_pairs]
        return workspace_names

    def _get_workspace_name_from_run_and_group_or_pair(self, run, group_or_pair):
