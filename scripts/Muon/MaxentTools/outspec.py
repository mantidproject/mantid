...
def OUTSPEC(datum, f, sigma, datt, CHANNELS_itzero, CHANNELS_itotal, PULSESHAPE_convol, FAC_ratio, DETECT_a, DETECT_b,
            DETECT_d, DETECT_e, SAVETIME_I2, RUNDATA_fnorm, mylog):
    ...
    guess = (
        (guess + np.outer(DETECT_e, DETECT_d)) / RUNDATA_fnorm)  # convert from 10Mevent normalisation to original stats
