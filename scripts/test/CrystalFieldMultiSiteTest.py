...
class CrystalFieldMultiSiteTests(unittest.TestCase):
    ...
    def test_init_parameters(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions='Ce', Symmetries='C2', Temperatures=[15], FWHM=[1.0],
    ...
    def test_init_parameters_multi_ions(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions=('Pm', 'Eu'), Symmetries=('D2', 'C3v'), Temperatures=[20, 52],
                                                  FWHM=[1.0, 1.0], parameters={'ion0.B40': -0.02, 'ion0.B42': -0.11, 'ion1.B42': -0.12})
    ...
    def test_peak_values_gaussian(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions='Ce', Symmetries='C2', Temperatures=[25], FWHM=[1.0], PeakShape='Gaussian',
                                                  BmolX=1.0, B40=-0.02)
    ...
    def test_peak_values_multi_ions(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions=('Pr', 'Nd'), Symmetries=('D2', 'C3v'), Temperatures=[20], FWHM=[1.5],
                                                  parameters={'ion0.B60': -0.02, 'ion1.B62': -0.12})
    ...
    def test_peak_values_multi_ions_and_spectra(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions=('Pm', 'Ce'), Symmetries=('D2', 'C3v'), Temperatures=[20, 52], FWHM=[1.0, 1.0],
    ...
    def test_peak_values_multi_gaussian(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions=('Pm', 'Dy'), Symmetries=('D2', 'C3v'), Temperatures=[20, 52], FWHM=[1.0, 1.5],
                                                  parameters={'ion0.B40': -0.02, 'ion1.B42': -0.12}, PeakShape='Gaussian')
    ...
    def test_get_spectrum_from_list(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions=['Ce'], Symmetries=['C2v'], Temperatures=[4.0], FWHM=[0.1], B20=0.035, B40=-0.012,
                                                  B43=-0.027, B60=-0.00012, B63=0.0025, B66=0.0068, ToleranceIntensity=0.001 * c_mbsr)
    ...
    def test_get_spectrum_ws(self):
        cfms = CrystalField.CrystalFieldMultiSite(['Ce'], ['C2v'], B20=0.035, B40=-0.012, B43=-0.027, B60=-0.00012, B63=0.0025, B66=0.0068,
                                                  Temperatures=[4.0], FWHM=[0.1], ToleranceIntensity=0.001 * c_mbsr)
    ...
    def test_get_spectrum_from_list_multi_spectra(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions=['Ce'], Symmetries=['C2v'], Temperatures=[4.0, 50.0], FWHM=[0.1, 0.2], B20=0.035,
                                                  B40=-0.012, B43=-0.027, B60=-0.00012, B63=0.0025, B66=0.0068)
        r = [0.0, 1.45, 2.4, 3.0, 3.85]
    ...
    def test_get_spectrum_list_multi_ion_and_spectra(self):
        ...
        cfms = CrystalField.CrystalFieldMultiSite(Ions=['Ce', 'Pr'], Symmetries=['C2v', 'C2v'], Temperatures=[44.0, 50.0],
    ...
    def test_fit_multi_ion_single_spectrum(self):
        ...
        params = {'ion0.B20': 0.37737, 'ion0.B22': 3.9770, 'ion0.B40': -0.031787, 'ion0.B42': -0.11611,
                  'ion0.B44': -0.12544, 'ion1.B20': 0.37737, 'ion1.B22': 3.9770, 'ion1.B40': -0.031787,
                  'ion1.B42': -0.11611, 'ion1.B44': -0.12544}
        cf = CrystalField.CrystalFieldMultiSite(Ions=['Ce', 'Pr'], Symmetries=['C2v', 'C2v'], Temperatures=[44.0], FWHM=[1.1],
    ...
    def test_fit_multi_ion_and_spectra(self):
        ...
        params = {'ion0.B20': 0.37737, 'ion0.B22': 3.9770, 'ion0.B40': -0.031787, 'ion0.B42': -0.11611,
                  'ion0.B44': -0.12544, 'ion1.B20': 0.37737, 'ion1.B22': 3.9770, 'ion1.B40': -0.031787,
                  'ion1.B42': -0.11611, 'ion1.B44': -0.12544}
        cf = CrystalField.CrystalFieldMultiSite(Ions=['Ce', 'Pr'], Symmetries=['C2v', 'C2v'], Temperatures=[44.0, 50.0],
    ...
    def test_set_background(self):
        cf = CrystalField.CrystalFieldMultiSite(Ions='Ce', Symmetries='C2v', Temperatures=[20], FWHM=[1.0],
    ...
    def test_constraints_single_spectrum(self):
        cf = CrystalField.CrystalFieldMultiSite(Ions=['Ce'], Symmetries=['C2v'], Temperatures=[50], FWHM=[0.9],
    ...
    def test_constraints_multi_spectrum(self):
        cf = CrystalField.CrystalFieldMultiSite(Ions=['Ce'], Symmetries=['C2v'], Temperatures=[44, 50], FWHM=[1.1, 0.9],
    ...
    def test_constraints_multi_spectrum_and_ion(self):
        cf = CrystalField.CrystalFieldMultiSite(Ions=['Ce', 'Pr'], Symmetries=['C2v', 'C2v'], Temperatures=[44, 50], FWHM=[1.1, 0.9],
                                                Background=FlatBackground(), BackgroundPeak=Gaussian(Height=10, Sigma=0.3),
    ...
    def test_add_CrystalField(self):
        cfms = CrystalField.CrystalFieldMultiSite(Ions=['Pr'], Symmetries=['C2v'], Temperatures=[44, 50], FWHM=[1.1, 0.9],
    ...
    def test_add_CrystalFieldMultiSite(self):
        cfms1 = CrystalField.CrystalFieldMultiSite(Ions=['Pm'], Symmetries=['D2'], Temperatures=[44, 50], FWHM=[1.1, 0.9],
                                                   B20=0.37737, B40=-0.031787, B42=-0.11611, B44=-0.15)
        cfms2 = CrystalField.CrystalFieldMultiSite(Ions=['Ce', 'Pr'], Symmetries=['C2v', 'C2v'], Temperatures=[44, 50],
