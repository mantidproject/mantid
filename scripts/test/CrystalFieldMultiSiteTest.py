...
class CrystalFieldMultiSiteTests(unittest.TestCase):
    ...
    def test_init_multi_ions(self):
        cfms = CrystalFieldMultiSite(Ions=('Pm', 'Eu'),
                                     Symmetries=('D2', 'C3v'),
                                     Temperatures=[20, 52],
                                     FWHM=[1.0, 1.0])
    ...
    def test_peak_values(self):
        cfms = CrystalFieldMultiSite(Ions='Ce', Symmetries='C2', Temperatures=[25], FWHM=[1.5], BmolX=1.0, B40=-0.02)
    ...
    def test_peak_values_multi_ions(self):
        cfms = CrystalFieldMultiSite(Ions=('Pr', 'Nd'),
                                     Symmetries=('D2', 'C3v'),
                                     Temperatures=[20],
                                     FWHM=[1.5],
                                     parameters={
    ...
    def test_peak_values_multi_ions_and_spectra(self):
        cfms = CrystalFieldMultiSite(Ions=('Pm', 'Ce'),
                                     Symmetries=('D2', 'C3v'),
                                     Temperatures=[20, 52],
                                     FWHM=[1.0, 1.0],
                                     parameters={
    ...
    def test_peak_values_multi_gaussian(self):
        cfms = CrystalFieldMultiSite(Ions=('Pm', 'Dy'),
                                     Symmetries=('D2', 'C3v'),
                                     Temperatures=[20, 52],
                                     FWHM=[1.0, 1.5],
                                     parameters={
    ...
    def test_add_CrystalField(self):
        ...
        cfms = CrystalFieldMultiSite(Ions=['Pr'],
                                     Symmetries=['C2v'],
                                     Temperatures=[44, 50],
                                     FWHM=[1.1, 0.9],
                                     B20=0.37737,
    ...
    def test_add_CrystalFieldMultiSite(self):
        cfms1 = CrystalFieldMultiSite(Ions=['Pm'],
                                      Symmetries=['D2'],
                                      Temperatures=[44, 50],
                                      FWHM=[1.1, 0.9],
                                      B20=0.37737,
                                      ...
                                      B42=-0.11611,
                                      B44=-0.15)
        cfms2 = CrystalFieldMultiSite(Ions=['Ce', 'Pr'],
                                      Symmetries=['C2v', 'C2v'],
                                      Temperatures=[44, 50],
                                      FWHM=[1.1, 0.9],
                                      parameters={
