...
class AtomsDataTest(unittest.TestCase):
    _good_data = {
        ...
        "atom_1": {"sort": 1, "symbol": "Si", "coord": np.asarray([0.25, 0.25, 0.25]), "mass": 28.085500},
    }
    ...
    def test_direct_access(self):
        ...
        self.assertEqual([self._good_data["atom_0"], self._good_data["atom_1"]], self._tester[0:])
    ...
    def test_wrong_set(self):
        data = {"atom_1": self._good_data["atom_0"], "atom_2": self._good_data["atom_1"]}
        with self.assertRaises(ValueError):
            AtomsData(data)
