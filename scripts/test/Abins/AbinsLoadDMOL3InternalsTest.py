...
""")
    ...
    def test_read_modes(self):
        ...
        full_frequencies = [1045.7, 1047.6, 1049.7, 1051.0, 1051.8, 1052.7,
                            1053.4, 1053.7, 1054.7, 1057.4, 1062.6, 1065.5,
                            1066.9, 1067.0, 1067.7, 1070.0, 1084.5, 1097.8 ]

        full_disp_block = np.array([
            [0.0072, 0.0268, -0.0375, 0.0055, 0.0316, 0.1012, 0.0200,
             0.0205, 0.0119, -0.0709, -0.0254, 0.0002, 0.0899, 0.1173,
             0.0038, -0.0008, 0.0118, -0.0022],
            [0.0062, -0.0568, 0.0104, -0.0921, -0.0009, -0.0170, -0.0244,
             -0.0052, 0.0035, -0.0161, 0.0189, 0.0000, -0.0027, -0.0381,
             0.0033, 0.0004, -0.0012, -0.0035],
            [-0.0044, -0.0101, 0.0183, 0.0825, -0.0096, -0.0162, 0.0128,
             0.0013, -0.0016, 0.0255, -0.0044, 0.0007, -0.0340, 0.0036,
             -0.0070, -0.0002, -0.0057, 0.0044],
            [0.0783, -0.0072, -0.0411, 0.0207, -0.0214, 0.0246, 0.0174,
             0.0184, -0.1040, -0.0171, 0.0115, -0.1400, -0.0007, -0.0003,
             -0.0100, 0.0000, -0.0029, -0.0023],
            [0.0996, -0.0124, -0.0267, 0.0060, 0.0362, -0.0169, -0.0070,
             0.0056, 0.0110, 0.0073, 0.0167, -0.0241, -0.0019, 0.0013,
             0.0012, -0.0002, -0.0176, -0.0016],
            [-0.0102, -0.0177, -0.0405, 0.0090, 0.0633, -0.0362, 0.0065,
             0.0122, -0.0178, -0.0073, 0.0014, -0.0015, -0.0039, 0.0013,
             0.0151, 0.0001, 0.0012, -0.0014]])

        file_with_18_modes = BytesIO(b"""
