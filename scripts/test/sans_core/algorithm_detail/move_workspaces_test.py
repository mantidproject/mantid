...
from sans_core.algorithm_detail.move_workspaces import SANSMoveZOOM, SANSMoveSANS2D
from sans_core.common.enums import SANSFacility, SANSInstrument, DetectorType
