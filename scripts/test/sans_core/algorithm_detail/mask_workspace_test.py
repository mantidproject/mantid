...
from sans_core.algorithm_detail.mask_workspace import mask_with_mask_files


class MaskWorkspaceTest(unittest.TestCase):
    @mock.patch("sans_core.algorithm_detail.mask_workspace.find_full_file_path")
    @mock.patch("sans_core.algorithm_detail.mask_workspace.create_unmanaged_algorithm")
