...
from sans_core.common.enums import CanonicalCoordinates, SANSFacility, DetectorType, SANSInstrument
from sans_core.state.StateObjects.StateData import get_data_builder
from sans_core.state.StateObjects.StateMoveDetectors import (
    StateMoveLOQ,
    StateMoveSANS2D,
    StateMoveLARMOR,
    StateMoveZOOM,
