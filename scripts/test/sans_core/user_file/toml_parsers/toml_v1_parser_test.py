...
from sans_core.state.StateObjects.StateMaskDetectors import StateMaskDetectors, StateMask
from sans_core.test_helper.file_information_mock import SANSFileInformationMock
from sans_core.user_file.parser_helpers.toml_parser_impl_base import MissingMandatoryParam
from sans_core.user_file.toml_parsers.toml_v1_parser import TomlV1Parser
...
class TomlV1ParserTest(unittest.TestCase):
    ...
    def test_validate_is_called_on_init(self):
        ...
        with mock.patch("sans_core.user_file.toml_parsers.toml_v1_parser.TomlV1Parser._get_impl"):
