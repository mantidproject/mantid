...
def create_multi_function_background():
    return CrystalField.Background(functions=[CrystalField.Function('PseudoVoigt', Intensity=101, FWHM=0.8, Mixing=0.84),
...
class CrystalFieldTests(unittest.TestCase):
    ...
    def test_pseudo_multispectrum_ties(self):
        cf = CrystalField.CrystalField('Ce', 'C2v', Temperature=[5.0], FWHM=[10.0], B20=0.9607, B22=-1.6, B40=-0.04365, B42=0.2101,
                                       B44=0.393)
        cf.PeakShape = 'Lorentzian'
        cf.PhysicalProperty = [
            CrystalField.PhysicalProperties('susc', Hdir=[1, 0, 0], Inverse=True, Unit='cgs', Lambda=0.01, Chi0=0.001)]
    ...
    def test_that_the_peak_and_background_in_a_Background_object_are_stored_in_the_functions_variable(self):
        ...
        cf.background = CrystalField.Background(peak=CrystalField.Function('PseudoVoigt', Intensity=101, FWHM=0.8, Mixing=0.84),
...
class CrystalFieldFitTest(unittest.TestCase):
    ...
    def test_CrystalFieldFit(self):
        ...
        origin.background = CrystalField.Background(peak=CrystalField.Function('Gaussian', Height=10 * c_mbsr, Sigma=1),
    ...
    def test_CrystalFieldFit_multi_spectrum(self):
        ...
        origin.background = CrystalField.Background(peak=CrystalField.Function('Gaussian', Height=10, Sigma=0.3),
                                                    background=CrystalField.Function('FlatBackground', A0=1.0))
    ...
    def test_fit_single_multi_check(self):
        cf = CrystalField.CrystalField('Nd', 'C2v', B20=-0.4, Temperature=[5, 10], FWHM=[0.5, 1.])
        x, y = cf.getSpectrum()
        ws = CrystalField.fitting.makeWorkspace(x, y)
    ...
    def test_constraints_single_spectrum(self):
        ...
        cf.PeakShape = 'Lorentzian'
        cf.background = CrystalField.Background(peak=CrystalField.Function('Gaussian', Height=10.0, Sigma=0.3),
                                                background=CrystalField.Function('LinearBackground', A0=1.0))
    ...
    def test_bad_input(self):
        self.assertRaises(Exception, CrystalField.CrystalField, 'Ce', 'C2v', B20='aaa', B22=3.97, B40=-0.0317, B42=-0.116, B44=-0.12,
                          Temperature=44.0, FWHM=1.0)

        self.assertRaises(Exception, CrystalField.CrystalField, 'Ce', 'C2v', B20=1, B22=3.97, B40=[-0.0317], B42=-0.116, B44=-0.12,
                          Temperature=44.0, FWHM=1.0)

        self.assertRaises(Exception, CrystalField.CrystalField, 'Ce', 'C2v', B20=1, B22=3.97, B40=np.array([-0.0317]), B42=-0.116,
                          B44=-0.12, Temperature=44.0, FWHM=1.0)

        self.assertRaises(Exception, CrystalField.CrystalField, 'Ce', 'C2v', B20=1, B22=3.97, B40=np.array([1.2, 2.3]), B42=-0.116,
                          B44=-0.12, Temperature=44.0, FWHM=1.0)

        cf = CrystalField.CrystalField('Ce', 'C2v', B20=1, B22=3.97, B40=-0.0317, B42=-0.116, B44=-0.12,
                                       Temperature=44.0, FWHM=1.0)
    ...
    def test_resolution_single_spectrum_fit(self):
        origin = CrystalField.CrystalField('Ce', 'C2v', B20=0.37, B22=3.97, B40=-0.0317, B42=-0.116, B44=-0.12,
                                           Temperature=44.0, FWHM=1.0)
    ...
    def test_peak_width_update(self):
        ...
        cf1 = CrystalField.CrystalField('Ce', 'C2v', B20=0.37, B22=3.97, B40=-0.0317, B42=-0.116, B44=-0.12,
                                        Temperature=44.0, FWHM=1.0, ResolutionModel=rm, FWHMVariation=0.01)

        cf2 = CrystalField.CrystalField('Ce', 'C2v', B20=0.57, B22=2.97, B40=-0.0317, B42=-0.116, B44=-0.12,
                                        Temperature=44.0, FWHM=1.0, ResolutionModel=rm, FWHMVariation=0.01)
    ...
    def test_monte_carlo_single_spectrum(self):
        ...
        cf = CrystalField.CrystalField('Ce', 'C2v', B20=0, B22=0, B40=0, B42=0, B44=0,
                                       Temperature=44.0, FWHM=1.0)
    ...
    def test_monte_carlo_multi_spectrum(self):
        ...
        # Define a CrystalField object with parameters slightly shifted.
        cf = CrystalField.CrystalField('Ce', 'C2v', B20=0.37737, B22=3.9770, B40=0, B42=0, B44=0, NPeaks=11,
                                       Temperature=[44.0, 50.0], FWHM=[1.0, 1.0])
    ...
    def test_intensity_scaling_single_spectrum_1(self):
        # Define a CrystalField object with parameters slightly shifted.
        cf = CrystalField.CrystalField('Ce', 'C2v', IntensityScaling=2.5, B20=0.37737, B22=3.9770, B40=-0.031787,
    ...
    def test_CrystalFieldFit_physical_properties(self):
        ...
        cf = CrystalField.CrystalField('Ce', 'C2v', B20=0.37, B22=3.97, B40=-0.0317, B42=-0.116, B44=-0.12,
                                       Temperature=[10, 100], FWHM=[1.1, 1.2],
                                       PhysicalProperty=[CrystalField.PhysicalProperties('susc', 'powder'),
                                                         CrystalField.PhysicalProperties('M(H)', Hdir=[0, 1, 0])])
