...
class GuiStateDirectorTest(unittest.TestCase):
    ...
    def test_that_can_construct_state_from_models(self):
        ...
        self.assertEqual(state.wavelength.wavelength_interval.wavelength_min,  1.5)
        self.assertEqual(state.wavelength.wavelength_interval.wavelength_max,  12.5)
    ...
    def test_that_column_options_are_set_on_state(self):
        ...
        self.assertTrue(isinstance(state, StateGuiModel))
        self.assertEqual(state.all_states.wavelength.wavelength_interval.wavelength_min,  3.14)
        self.assertEqual(state.all_states.wavelength.wavelength_interval.wavelength_max,  10.3)
