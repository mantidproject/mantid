...
class CommandInterfaceStateDirectorTest(unittest.TestCase):
    ...
    def test_can_set_commands_without_exceptions(self):
        ...
        self.assertEqual(state.wavelength.wavelength_interval.wavelength_min,  1.23)
        self.assertEqual(state.adjustment.normalize_to_monitor.wavelength_interval.wavelength_max,  23.)
