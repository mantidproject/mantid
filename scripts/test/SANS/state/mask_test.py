...
class StateMaskTest(unittest.TestCase):
    ...
    def assert_raises_for_bad_value_and_raises_nothing_for_good_value(self,
                                                                      entry_name=None,
    ...
    def test_that_raises_when_bin_mask_lengths_are_mismatched(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("bin_mask_general_start", [1., 3.], None,
                                                                           [1., 2., 3.], None)
    ...
    def test_that_raises_when_spectrum_range_lengths_are_mismatched(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("spectrum_range_start", None, [1, 3], None,
                                                                           [1, 5, 7])
    ...
    def test_that_raises_when_horizontal_block_lengths_are_mismatched(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("block_horizontal_start", None, [1, 2], None,
                                                                           [1, 2, 4])

    def test_that_raises_lower_bound_is_larger_than_upper_bound_for_horiztonal_block(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("block_horizontal_start", None, [1, 10, 3],
                                                                           None, [1, 2, 4])

    def test_that_raises_when_only_one_vertical_block_has_been_set(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("block_vertical_start", None, EXPLICIT_NONE,
                                                                           None, [1, 2, 4])

    def test_that_raises_when_vertical_block_lengths_are_mismatched(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("block_vertical_start", None, [1, 2], None,
                                                                           [1, 2, 4])

    def test_that_raises_lower_bound_is_larger_than_upper_bound_for_vertical_block(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("block_vertical_start", None, [1, 10, 3],
                                                                           None, [1, 2, 4])

    def test_that_raises_when_only_one_time_mask_has_been_set(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("bin_mask_start", None, EXPLICIT_NONE, None,
                                                                           [1., 2., 4.])

    def test_that_raises_when_time_mask_lengths_are_mismatched(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("bin_mask_start", None, [1., 2.], None,
                                                                           [1., 2., 4.])

    def test_that_raises_lower_bound_is_larger_than_upper_bound_for_time_mask(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("bin_mask_start", None, [1., 10., 3.], None,
                                                                           [1., 2., 4.])

    def test_that_raises_if_detector_names_have_not_been_set(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("detector_name", None, EXPLICIT_NONE, None,
                                                                           "name")

    def test_that_raises_if_short_detector_names_have_not_been_set(self):
        self.assert_raises_for_bad_value_and_raises_nothing_for_good_value("detector_name_short", None, EXPLICIT_NONE,
                                                                           None, "name")
