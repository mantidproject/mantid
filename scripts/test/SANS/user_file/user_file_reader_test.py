...
from sans.user_file.settings_tags import (DetectorId, BackId, range_entry, back_single_monitor_entry,
                                          ...
                                          range_entry_with_detector, SampleId, SetId, set_scales_entry, position_entry,
                                          TransId, TubeCalibrationFileId, QResolutionId, FitId, fit_general, MonId,
                                          monitor_file, GravityId, monitor_spectrum, PrintId, q_rebin_values)
...
class UserFileReaderTest(unittest.TestCase):
    def test_that_can_read_user_file(self):
        ...
        expected_values = {
            ...
            FitId.GENERAL: [
                fit_general(start=1.5, stop=12.5, fit_type=FitType.LOGARITHMIC, data_type=None, polynomial_order=0)
            ],
            ...
            MonId.SPECTRUM: [monitor_spectrum(1, True, True),
