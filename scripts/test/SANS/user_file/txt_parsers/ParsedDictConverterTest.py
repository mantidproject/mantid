...
class ParsedDictConverterTest(unittest.TestCase):
    ...
    def _assert_adjustment(self, state):
        ...
        self.assertTrue(wavelength_and_pixel_adjustment.adjustment_files[
            DetectorType.LAB.value].wavelength_adjustment_file == "DIRECTM1_15785_12m_31Oct12_v12.dat")
        self.assertTrue(wavelength_and_pixel_adjustment.adjustment_files[
            DetectorType.HAB.value].wavelength_adjustment_file == "DIRECTM1_15785_12m_31Oct12_v12.dat")
