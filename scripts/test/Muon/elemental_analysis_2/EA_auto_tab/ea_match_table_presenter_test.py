...
class EAMatchTablePresenterTest(unittest.TestCase):
    ...
    @mock.patch(
        "Muon.GUI.ElementalAnalysis2.auto_widget.ea_match_table_presenter.EAMatchTablePresenter.find_entry_index")
    @mock.patch("Muon.GUI.ElementalAnalysis2.auto_widget.ea_match_table_presenter.EAMatchTablePresenter.remove_entry")
