...
class FitInformationTest(unittest.TestCase):
    ...
    def test_equality_with_no_globals(self):
        fit_info = FitInformation(mock.MagicMock(), 'MuonGuassOsc', mock.MagicMock(), mock.MagicMock())
        self.assertEqual(fit_info, fit_info)

    def test_equality_with_globals(self):
        fit_info = FitInformation(mock.MagicMock(), 'MuonGuassOsc', mock.MagicMock(), mock.MagicMock(), ['A'])
        self.assertEqual(fit_info, fit_info)

    def test_inequality_with_globals(self):
        fit_info1 = FitInformation(mock.MagicMock(), 'MuonGuassOsc', mock.MagicMock(), ['A'])
        fit_info2 = FitInformation(mock.MagicMock(), 'MuonGuassOsc', mock.MagicMock(), ['B'])
        self.assertNotEqual(fit_info1, fit_info2)

    def test_empty_global_parameters_if_none_specified(self):
        fit_information_object = FitInformation(mock.MagicMock(), mock.MagicMock(), mock.MagicMock(), mock.MagicMock())
    ...
    def test_parameters_are_readonly(self):
        fit_info = FitInformation(mock.MagicMock(), mock.MagicMock(), mock.MagicMock(), mock.MagicMock())
    ...
    def test_logs_from_workspace_without_logs_returns_emtpy_list(self):
        ...
        fit = FitInformation(mock.MagicMock(), 'func1', fake_ws.name(), fake_ws.name())
    ...
    def test_log_names_from_list_of_workspaces_gives_combined_set(self):
        time_series_logs = (('ts_1', (1., )), ('ts_2', (3., )), ('ts_3', [2.]), ('ts_4', [3.]))
        ...
        fit = FitInformation(mock.MagicMock(), 'func1', [fake1.name(), fake2.name()], [fake1.name(), fake2.name()])
