...
class WorkspaceNamingTest(unittest.TestCase):
    ...
    def test_getGroupOrPairName(self):
        self.assertEqual(ws_naming.get_group_or_pair_from_name('MUSR62260; Group; bkwd; Asymmetry; Periods; #1; MA'),"bkwd")
        self.assertEqual(ws_naming.get_group_or_pair_from_name('MUSR62260; Group; fwd; Asymmetry; Periods; #2; MA'),"fwd")
