...
class PlottingPresenterTest(unittest.TestCase):
    ...
    def test_removeSubplotConnection(self):
        ...
        self.assertEquals(
            self.view.subplotRemovedSignal.connect.call_count,
            1)
        self.view.subplotRemovedSignal.connect.assert_called_with(
            self.mock_func)
    ...
    def test_rmOneSubplot(self):
        ...
        self.assertEquals(
            self.mock_selector.subplotSelectorSignal.connect.call_count,
            0)
        self.assertEquals(
            self.mock_selector.closeEventSignal.connect.call_count,
            0)
    ...
    def test_rmTwoSubplots(self):
        ...
        self.presenter.createSelectWindow.assert_called_with(
            self.view.subplot_names)
        self.assertEquals(
            self.mock_selector.subplotSelectorSignal.connect.call_count,
            1)
        self.mock_selector.subplotSelectorSignal.connect.assert_called_with(
            self.presenter.getRmWindow)
        self.assertEquals(
            self.mock_selector.closeEventSignal.connect.call_count,
            1)
        self.mock_selector.closeEventSignal.connect.assert_called_with(
            self.presenter.closeSelectorWindow)
    ...
    def test_getRmWindow(self):
        ...
        self.assertEquals(
            self.mock_rmWindow.applyRemoveSignal.connect.call_count,
            1)
        self.mock_rmWindow.applyRemoveSignal.connect.assert_called_with(
            self.presenter.applyRm)
        self.assertEquals(
            self.mock_rmWindow.closeEventSignal.connect.call_count,
            1)
        self.mock_rmWindow.closeEventSignal.connect.assert_called_with(
            self.presenter.closeRmWindow)
