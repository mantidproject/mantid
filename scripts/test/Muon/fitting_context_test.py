...
class FittingContextTest(unittest.TestCase):
    ...
    def test_context_constructor_accepts_fit_list(self):
        fit_list = [FitInformation(mock.MagicMock(), 'MuonGuassOsc', mock.MagicMock(), mock.MagicMock())]
    ...
    def test_items_can_be_added_to_fitting_context(self):
        fit_information_object = FitInformation(mock.MagicMock(), 'MuonGuassOsc', mock.MagicMock(), mock.MagicMock())
    ...
    def test_can_add_fits_with_global_parameters_without_creating_fit_information(self):
        ...
        fit_function_name = 'MuonGuassOsc'
        global_params = ['A']
        fit_information_object = FitInformation(parameter_workspace, fit_function_name, input_workspace, global_params)

        self.fitting_context.add_fit_from_values(parameter_workspace, fit_function_name, input_workspace, global_params)
    ...
    def test_parameters_are_readonly(self):
        ...
        fit_info = FitInformation(fit_params._parameter_workspace, mock.MagicMock(), mock.MagicMock(), mock.MagicMock())
    ...
    def test_log_names_returns_logs_from_all_fits_by_default(self):
        ...
        self.fitting_context.add_fit(FitInformation(mock.MagicMock(), 'func1', fake1.name(), fake1.name()))
        self.fitting_context.add_fit(FitInformation(mock.MagicMock(), 'func1', fake2.name(), fake2.name()))
