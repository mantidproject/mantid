...
class LoadRunWidgetIncrementDecrementSingleFileModeTest(unittest.TestCase):
    ...
    def load_single_run(self):
        ...
        self.load_utils_patcher.load_workspace_from_filename = mock.Mock(return_value=(self._loaded_workspace,
                                                                                       self._loaded_run,
    ...
    def test_that_decrement_run_loads_the_data_correctly(self):
        ...
        new_filename = "EMU00001233.nxs"
        self.load_utils_patcher.load_workspace_from_filename = mock.Mock(return_value=({
