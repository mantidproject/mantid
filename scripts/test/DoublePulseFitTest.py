...
class SingleDomainDoublePulseFitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        x_offset = np.linspace(delta / 2, 15.0 + delta / 2, 100)
        x_offset_neg = np.linspace(-delta / 2, 15.0 - delta / 2, 100)
...
class MultiDomainDoublePulseFitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        DoublePulseFit(
            Function=MultiDomainSingleFunction,
            InputWorkspace=ws,
            InputWorkspace_1=ws,
            CreateOutput=True,
            PulseOffset=delta,
        ...
        Fit(
            Function=MultiDomainConvolutionFunction,
            InputWorkspace=ws,
            InputWorkspace_1=ws,
            CreateOutput=True,
            StartX=0.0,
