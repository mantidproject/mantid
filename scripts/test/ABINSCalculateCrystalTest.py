...
class ABINSCalculateCrystalTest(unittest.TestCase):
    ...
    _c6h6 = "benzene_CalculateCrystal"
    ...
    def test_wrong_input(self):
        ...
        # wrong temperature
        self.assertRaises(ValueError, CalculateCrystal, filename=full_path_filename,
    ...
    def _good_case(self, name=None):
        ...
        good_tester = CalculateCrystal(filename=AbinsTestHelpers.find_file(filename=name + ".phonon"),
        ...
        new_tester = CalculateCrystal(filename=AbinsTestHelpers.find_file(filename=name + ".phonon"),
                                      temperature=self._temperature,
                                      abins_data=good_data["DFT"])
