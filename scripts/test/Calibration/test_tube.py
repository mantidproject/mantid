...
class TestTube(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for directory in config.getDataSearchDirs():
            if 'UnitTest' in directory:
                ...
                break
        wire_positions_pixels = [0.03043, 0.04544, 0.06045, 0.07546, 0.09047, 0.10548, 0.12049, 0.13550,
                                 0.15052, 0.16553, 0.18054, 0.19555, 0.21056, 0.22557]  # in mili-meters, 14 wires
        ...
        cls.corelli = {'workspace': workspace,
                       'bank_name': 'bank20',
    ...
    def test_calibrate(self):
        data = self.corelli
        calibrate(data['workspace'], data['bank_name'], data['wire_positions'],
                  data['peaks_form'], fitPar=data['fit_parameters'], outputPeak=True,
        ...
        for tube_index, expected in [(0, {'A0': -0.446804, 'A1': 0.003513, 'A2': 0.0}),
                                     (15, {'A0': -0.452107, 'A1': 0.003528, 'A2': 0.00})]:
