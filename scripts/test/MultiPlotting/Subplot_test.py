...
class SubplotTest(unittest.TestCase):
    ...
    def test_applyRmAll(self):
       ...
       self.assertEquals(self.subplot._context.subplots["test"].removeLine.call_count,3)
    ...
    def test_applyRmNone(self):
       ...
       self.assertEquals(self.subplot._context.subplots["test"].removeLine.call_count,0)
       self.assertEquals(self.subplot._close_rm_window.call_count,1)
    ...
    def test_applyRmSome(self):
       ...
       self.assertEquals(self.subplot._context.subplots["test"].removeLine.call_count,2)
       self.assertEquals(self.subplot._close_rm_window.call_count,1)
