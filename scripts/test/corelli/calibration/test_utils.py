...
from mantid.simpleapi import CreateEmptyTableWorkspace, DeleteWorkspaces, GroupWorkspaces, LoadEmptyInstrument, LoadNexusProcessed, mtd
...
class TestUtils(unittest.TestCase):
    ...
    def test_wire_positions(self):
        ...
        expected = [-0.396, -0.343, -0.290, -0.238, -0.185, -0.132, -0.079, -0.026, 0.026, 0.079, 0.132, 0.185, 0.238, 0.290, 0.343, 0.396]
        assert_allclose(wire_positions(units="meters"), np.array(expected), atol=0.001)
        expected = [15.4, 30.4, 45.4, 60.4, 75.4, 90.5, 105.5, 120.5, 135.5, 150.5, 165.5, 180.6, 195.6, 210.6, 225.6, 240.6]
    ...
    def test_peak_y_table(self) -> None:
        ...
        parameters_table = GroupWorkspaces(InputWorkspaces=["parameters_table_0", "parameters_table_1"], OutputWorkspace="parameters_table")
