...
from sans_core.common.general_functions import get_ranges_from_event_slice_setting
...
from sans_core.state.StateObjects.wavelength_interval import WavRangePairs, WavRange
