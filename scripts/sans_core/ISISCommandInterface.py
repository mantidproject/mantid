...
warnings.warn(
    ...
    "to use 'sans_core.command_interface.ISISCommandInterface' instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
def CompWavRanges(wavelens, plot=True, combineDet=None, resetSetup=True):
    ...
    if plot:
        raise NotImplementedError(
            ...
            " longer implemented. Please switch to sans_core.command_interface.ISISCommandInterface"
        )
...
def ViewCurrentMask():
    ...
    """
    raise NotImplementedError(
        "This is no longer implemented as it required MantidPlot, please switch"
        "to sans_core.command_interface.ISISCommandInterface instead"
    )
