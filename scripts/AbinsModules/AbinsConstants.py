...
first_overtone = 1 # value of first overtone (n = 1)
first_overtone_dim = 1

fundamentals = 0 # value of fundamental parameter  (n = 0)
fundamentals_dim = 1
...
eps = 1.0e-4 # definition of numerical zero
...
max_quantum_order_array_size = 1000000  # maximum size for storing frequencies for each quantum order
acoustic_phonon_threshold = 0.0 # frequencies below this value are not taken into account for gamma point type of calculation.
####################################### Constants end #################################