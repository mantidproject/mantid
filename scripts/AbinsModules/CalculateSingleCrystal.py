...
class CalculateSingleCrystal(IOmodule):
    ...
    def _calculate_crystal(self):
        ...
        _dw_crystal = CalculateDWSingleCrystal(temperature=self._temperature, abins_data=self._abins_data)
        _dw_crystal_data = _dw_crystal.calculate_data()
        _crystal_data = SingleCrystalData()
    ...
    def load_data(self):
        ...
        _dw_crystal_data = DWSingleCrystalData(temperature=self._temperature, num_atoms=_num_atoms)
