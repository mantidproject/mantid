...
q_threads = 1  # number of threads used in parallel calculations over q2
# ABINS internal parameters end ###########################

q2_start = 0.0  # beginning of q2 interval
q2_end = 30  # end of q2 interval
q2_step = 0.1  # sampling of q2
