...
def extract_child_ws_for_added_eventdata(ws_group, appendix):
    ...
    # If we have more than 2 workspaces then we have added multi-peroiod data
    is_multiperiod_workspace = len(ws_handles) > 2
    ...
    for ws_handle in ws_handles:
        ...
        new_ws_handle = RenameWorkspace(InputWorkspace = ws_handle, OutputWorkspace=new_workspace_name)
