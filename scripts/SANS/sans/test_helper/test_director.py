...
class TestDirector(object):
    ...
    def construct(self):
        ...
        if self.wavelength_state is None:
            ...
            wavelength_builder.state.wavelength_interval.wavelength_min = 1.0
            wavelength_builder.state.wavelength_interval.wavelength_max = 10.0
            wavelength_builder.state.wavelength_interval.wavelength_step = 2.0
        ...
        if self.adjustment_state is None:
            ...
            normalize_to_monitor_builder.state.wavelength_interval.wavelength_min = 1.0
            normalize_to_monitor_builder.state.wavelength_interval.wavelength_max = 10.0
            ...
            calculate_transmission_obj.wavelength_interval.wavelength_min = 1.0
            calculate_transmission_obj.wavelength_interval.wavelength_max = 10.0
            ...
            wavelength_and_pixel_builder.state.wavelength_interval.wavelength_min = 1.0
            wavelength_and_pixel_builder.state.wavelength_interval.wavelength_max = 10.0
