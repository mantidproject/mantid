...
class TestDirector(object):
    ...
    def construct(self):
        ...
        if self.data_state is None:
            data_info = StateData()
            data_info.instrument = SANSInstrument.SANS2D
            data_info.facility = SANSFacility.ISIS
            data_info.sample_scatter_run_number = 22024
            data_info.sample_scatter_is_multi_period = False
            data_info.idf_file_path = ''
            data_info.ipf_file_path = ''
            self.data_state = data_info
        ...
        if self.move_state is None:
            ...
            move_info = StateMoveSANS2D()
            move_info.center_position = 0.3175
            move_info.monitor_names = {'1': 'monitor1', '2': 'monitor2'}
