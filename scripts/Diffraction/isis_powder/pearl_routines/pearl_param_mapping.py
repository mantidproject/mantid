...
attr_mapping = \
    [
        ...
        ParamMapEntry(ext_name="focus_mode",                 int_name="focus_mode"), # TODO move to enum
        ParamMapEntry(ext_name="long_mode",                  int_name="long_mode"),  # TODO move to enum
        ...
        ParamMapEntry(ext_name="tt_mode",                    int_name="tt_mode"), # TODO move to enum
