...
attr_mapping = \
    [
        ...
        ParamMapEntry(ext_name="create_cal_cross_correlate_params",      int_name="cal_cross_correlate"),
        ParamMapEntry(ext_name="create_cal_get_detector_offsets_params", int_name="cal_get_det_offsets"),
        ...
        ParamMapEntry(ext_name="focus_mode",                             int_name="focus_mode",
                      enum_class=PEARL_FOCUS_MODES),
