...
def _focus_one_ws(input_workspace, run_number, instrument, perform_vanadium_norm, absorb, sample_details,
                  vanadium_path, empty_can_subtraction_method, paalman_pings_events_per_point=None, placzek_run_number=None):
...
def _batched_run_focusing(instrument, perform_vanadium_norm, run_number_string, absorb, sample_details,
                          placzek_run_number, empty_can_subtraction_method, paalman_pings_events_per_point=None):
...
def _individual_run_focusing(instrument, perform_vanadium_norm, run_number, absorb, sample_details, placzek_run_number,
