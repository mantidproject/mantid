...
from isis_powder.osiris_routines import osiris_algs

# This file generates the various outputs for the OSIRIS instruments and saves them to their respective files
...
def _focus_mode_all(output_file_paths, processed_spectra, attenuation_filepath):
    ...
    if attenuation_filepath:
        summed_spectra = osiris_algs.attenuate_workspace(attenuation_file_path=attenuation_filepath, ws_to_correct=summed_spectra)
...
def _focus_mode_trans(output_file_paths, attenuation_filepath, calibrated_spectra):
    ...
    if attenuation_filepath:
        summed_ws = osiris_algs.attenuate_workspace(attenuation_file_path=attenuation_filepath, ws_to_correct=summed_ws)
