...
FitTab *TabFactory::makeMSDFitTab(int const index) const {
  auto tab = new FitTab(MSDFit::TAB_NAME, m_tabWidget->widget(index));
...
FitTab *TabFactory::makeIqtFitTab(int const index) const {
  auto tab = new FitTab(IqtFit::TAB_NAME, m_tabWidget->widget(index));
...
FitTab *TabFactory::makeConvFitTab(int const index) const {
  auto tab = new FitTab(ConvFit::TAB_NAME, m_tabWidget->widget(index));
...
FitTab *TabFactory::makeFqFitTab(int const index) const {
  auto tab = new FitTab(FqFit::TAB_NAME, m_tabWidget->widget(index));
