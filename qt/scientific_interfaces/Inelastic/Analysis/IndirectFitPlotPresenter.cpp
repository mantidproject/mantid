...
void IndirectFitPlotPresenter::handleHWHMMinimumChanged(double maximum) {
...
void IndirectFitPlotPresenter::handlePlotCurrentPreview() {
...
void IndirectFitPlotPresenter::handlePlotGuess(bool doPlotGuess) {
  if (doPlotGuess) {
