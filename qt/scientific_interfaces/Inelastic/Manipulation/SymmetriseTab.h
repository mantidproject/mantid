...
/** SymmetriseTab
  ...
  @date 23/07/2014
*/
class MANTIDQT_INELASTIC_DLL SymmetriseTab : public DataManipulationTab, public ISymmetrisePresenter {
public:
  SymmetriseTab(QWidget *parent, ISymmetriseView *view);
  ~SymmetriseTab() override;
