...
#include "DataManipulationTab.h"
#include "IMomentsView.h"
#include "MomentsTabModel.h"
#include "MomentsTabView.h"
...
/** MomentsTab : Calculates the S(Q,w) Moments of the provided data with
  ...
  @date 13/08/2013
*/
class MANTIDQT_INELASTIC_DLL MomentsTab : public DataManipulationTab, public IMomentsPresenter {

public:
  MomentsTab(QWidget *parent, IMomentsView *view);
  ~MomentsTab() = default;
