...
/** Constructor
 */
SqwTabModel::SqwTabModel() { m_rebinInEnergy = false; }

void SqwTabModel::setupRebinAlgorithm(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner) {
  if (m_rebinInEnergy) {
...
void SqwTabModel::setupSofQWAlgorithm(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner) {
...
void SqwTabModel::setupAddSampleLogAlgorithm(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner) {
  auto const sqwWsName = getOutputWorkspace();
...
void SqwTabModel::setInputWorkspace(const std::string &workspace) {
...
void SqwTabModel::setQMin(double qMin) { m_qLow = qMin; }

void SqwTabModel::setQWidth(double qWidth) { m_qWidth = qWidth; }

void SqwTabModel::setQMax(double qMax) { m_qHigh = qMax; }

void SqwTabModel::setEMin(double eMin) { m_eLow = eMin; }

void SqwTabModel::setEWidth(double eWidth) { m_eWidth = eWidth; }

void SqwTabModel::setEMax(double eMax) { m_eHigh = eMax; }

void SqwTabModel::setEFixed(const double eFixed) { m_eFixed = eFixed; }

void SqwTabModel::setRebinInEnergy(bool scale) { m_rebinInEnergy = scale; }

std::string SqwTabModel::getOutputWorkspace() { return m_baseName + "_sqw"; }

MatrixWorkspace_sptr SqwTabModel::getRqwWorkspace() {
...
UserInputValidator SqwTabModel::validate(std::tuple<double, double> const qRange,
...
std::string SqwTabModel::getEFixedFromInstrument(std::string const &instrumentName, std::string analyser,
 ...
 */
MatrixWorkspace_sptr SqwTabModel::loadInstrumentWorkspace(const std::string &instrumentName,
                                                          const std::string &analyser, const std::string &reflection) {
