...
/** Constructor
 */
SymmetriseTabModel::SymmetriseTabModel() {}

void SymmetriseTabModel::setupPreviewAlgorithm(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner,
...
std::string SymmetriseTabModel::setupSymmetriseAlgorithm(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner) {
...
void SymmetriseTabModel::reflectNegativeToPositive() {
...
void SymmetriseTabModel::setWorkspaceName(std::string const &workspaceName) {
...
void SymmetriseTabModel::setEMin(double value) { m_eMin = value; }

void SymmetriseTabModel::setEMax(double value) { m_eMax = value; }

void SymmetriseTabModel::setIsPositiveReflect(bool value) { m_isPositiveReflect = value; }

bool SymmetriseTabModel::getIsPositiveReflect() const { return m_isPositiveReflect; }
