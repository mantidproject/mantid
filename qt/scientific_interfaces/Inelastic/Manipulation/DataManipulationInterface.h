...
private:
  ...
  template <typename TabPresenter, typename TabView> void addMVPTab(const QString &name) {
    ...
    DataManipulationTab *tabIDRContent = new TabPresenter(tabContent, new TabView(tabContent));
  ...
  friend class DataManipulationTab;
  /// The .ui form generated by Qt Designer
  Ui::DataManipulationInterface m_uiForm;

  // All indirect tabs
  QMap<QString, QPair<QWidget *, DataManipulationTab *>> m_tabs;
