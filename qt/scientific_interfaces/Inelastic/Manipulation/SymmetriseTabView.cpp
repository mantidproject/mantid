...
/** Constructor
 */
SymmetriseTabView::SymmetriseTabView(QWidget *parent) : m_presenter() {
...
/** Destructor
 */
SymmetriseTabView::~SymmetriseTabView() {}

void SymmetriseTabView::subscribePresenter(ISymmetrisePresenter *presenter) { m_presenter = presenter; }

void SymmetriseTabView::setDefaults() {
...
OutputPlotOptionsView *SymmetriseTabView::getPlotOptions() const { return m_uiForm.ipoPlotOptions; }

void SymmetriseTabView::notifyDoubleValueChanged(QtProperty *prop, double value) {
  m_presenter->handleDoubleValueChanged(prop->propertyName().toStdString(), value);
}

void SymmetriseTabView::notifyDataReady(QString const &dataName) {
  m_presenter->handleDataReady(dataName.toStdString());
}

void SymmetriseTabView::notifyRunClicked() { m_presenter->handleRunOrPreviewClicked(false); }

void SymmetriseTabView::notifyPreviewClicked() { m_presenter->handleRunOrPreviewClicked(true); }

void SymmetriseTabView::notifySaveClicked() { m_presenter->handleSaveClicked(); }
/**
 * Handles the X minimum value being changed from a range selector.
 *
 * @param value New range selector value
 */
void SymmetriseTabView::notifyXrangeLowChanged(double value) {
 ...
 * @param value New range selector value
 */
void SymmetriseTabView::notifyXrangeHighChanged(double value) {
  m_dblManager->setValue(m_properties["Ehigh"], value);
  m_dblManager->setMaximum(m_properties["Elow"], value);
}

void SymmetriseTabView::notifyReflectTypeChanged(QtProperty *prop, int value) {
 ...
 *
 */
void SymmetriseTabView::resetEDefaults(bool isPositive, QPair<double, double> range) {
  auto rangeESelector = m_uiForm.ppRawPlot->getRangeSelector("rangeE");
 ...
 */
bool SymmetriseTabView::verifyERange(std::string const &workspaceName) {
 ...
 */
void SymmetriseTabView::updateRangeSelectors(std::string const &propName, double value) {
  auto rangeESelector = m_uiForm.ppRawPlot->getRangeSelector("rangeE");
...
void SymmetriseTabView::setFBSuffixes(QStringList const &suffix) { m_uiForm.dsInput->setFBSuffixes(suffix); }

void SymmetriseTabView::setWSSuffixes(QStringList const &suffix) { m_uiForm.dsInput->setWSSuffixes(suffix); }
 ...
 */
void SymmetriseTabView::plotNewData(std::string const &workspaceName) {
 ...
 */
void SymmetriseTabView::updateMiniPlots() {
 ...
 *
 */
void SymmetriseTabView::updateHorizontalMarkers(QPair<double, double> yrange) {
 ...
 */
void SymmetriseTabView::replotNewSpectrum(double value) {
...
bool SymmetriseTabView::validate() {
...
void SymmetriseTabView::setRawPlotWatchADS(bool watchADS) { m_uiForm.ppRawPlot->watchADS(watchADS); }

double SymmetriseTabView::getElow() const { return m_dblManager->value(m_properties["Elow"]); }

double SymmetriseTabView::getEhigh() const { return m_dblManager->value(m_properties["Ehigh"]); }

double SymmetriseTabView::getPreviewSpec() { return m_dblManager->value(m_properties["PreviewSpec"]); }

std::string SymmetriseTabView::getDataName() const { return m_uiForm.dsInput->getCurrentDataName().toStdString(); }

void SymmetriseTabView::previewAlgDone() {
...
void SymmetriseTabView::enableSave(bool save) { m_uiForm.pbSave->setEnabled(save); }

void SymmetriseTabView::enableRun(bool run) { m_uiForm.pbRun->setEnabled(run); }

void SymmetriseTabView::showMessageBox(std::string const &message) const {
