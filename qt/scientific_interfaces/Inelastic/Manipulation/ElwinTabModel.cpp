...
/** Constructor
 */
ElwinTabModel::ElwinTabModel() {}

void ElwinTabModel::setupLoadAlgorithm(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner,
...
void ElwinTabModel::setupGroupAlgorithm(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner,
...
void ElwinTabModel::setupElasticWindowMultiple(MantidQt::API::BatchAlgorithmRunner *batchAlgoRunner,
                                               std::string const &workspaceBaseName,
...
void ElwinTabModel::ungroupAlgorithm(std::string const &inputWorkspace) const {
...
void ElwinTabModel::groupAlgorithm(std::string const &inputWorkspaces, std::string const &outputWorkspace) const {
...
std::string ElwinTabModel::createGroupedWorkspaces(MatrixWorkspace_sptr workspace,
...
void ElwinTabModel::setOutputWorkspaceNames(std::string const &workspaceBaseName) {
...
std::string ElwinTabModel::getOutputWorkspaceNames() const {
...
void ElwinTabModel::setIntegrationStart(double integrationStart) { m_integrationStart = integrationStart; }

void ElwinTabModel::setIntegrationEnd(double integrationEnd) { m_integrationEnd = integrationEnd; }

void ElwinTabModel::setBackgroundStart(double backgroundStart) { m_backgroundStart = backgroundStart; }

void ElwinTabModel::setBackgroundEnd(double backgroundEnd) { m_backgroundEnd = backgroundEnd; }

void ElwinTabModel::setBackgroundSubtraction(bool backgroundSubtraction) {
  m_backgroundSubtraction = backgroundSubtraction;
}

void ElwinTabModel::setNormalise(bool normalise) { m_normalise = normalise; }
