...
#include "Manipulation/IqtTabModel.h"
...
class IqtTabModelTest : public CxxTest::TestSuite {
public:
  static IqtTabModelTest *createSuite() { return new IqtTabModelTest(); }

  static void destroySuite(IqtTabModelTest *suite) { delete suite; }

  void setUp() override { m_model = std::make_unique<IqtTabModel>(); }
...
private:
  ...
  std::unique_ptr<IqtTabModel> m_model;
};