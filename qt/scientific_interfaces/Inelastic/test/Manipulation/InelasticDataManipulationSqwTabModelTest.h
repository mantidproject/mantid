...
public:
  static InelasticDataManipulationSqwTabModelTest *createSuite() {
    return new InelasticDataManipulationSqwTabModelTest();
  }

  static void destroySuite(InelasticDataManipulationSqwTabModelTest *suite) { delete suite; }
