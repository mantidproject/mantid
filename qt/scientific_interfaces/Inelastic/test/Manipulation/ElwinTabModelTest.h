...
#include "Manipulation/ElwinTabModel.h"
...
class ElwinTabModelTest : public CxxTest::TestSuite {
public:
  static ElwinTabModelTest *createSuite() { return new ElwinTabModelTest(); }

  static void destroySuite(ElwinTabModelTest *suite) { delete suite; }

  void setUp() override { m_model = std::make_unique<ElwinTabModel>(); }
...
private:
  ...
  std::unique_ptr<ElwinTabModel> m_model;
};