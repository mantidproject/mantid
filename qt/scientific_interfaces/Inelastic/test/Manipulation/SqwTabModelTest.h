...
#include "Manipulation/SqwTabModel.h"
...
class SqwTabModelTest : public CxxTest::TestSuite {
public:
  static SqwTabModelTest *createSuite() { return new SqwTabModelTest(); }

  static void destroySuite(SqwTabModelTest *suite) { delete suite; }

  void setUp() override { m_model = std::make_unique<SqwTabModel>(); }
...
private:
  ...
  std::unique_ptr<SqwTabModel> m_model;
};
