...
#include "Manipulation/SymmetriseTabModel.h"
...
class SymmetriseTabModelTest : public CxxTest::TestSuite {
public:
  static SymmetriseTabModelTest *createSuite() { return new SymmetriseTabModelTest(); }

  static void destroySuite(SymmetriseTabModelTest *suite) { delete suite; }

  void setUp() override { m_model = std::make_unique<SymmetriseTabModel>(); }
...
private:
  ...
  std::unique_ptr<SymmetriseTabModel> m_model;
};