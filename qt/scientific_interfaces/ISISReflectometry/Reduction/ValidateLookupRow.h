...
template <typename T> using ValidatorT = std::optional<T>;
...
private:
  ValidatorT<double> parseThetaOrWhitespace(LookupRow::ValueArray const &cellText);
  ValidatorT<boost::regex> parseTitleMatcherOrWhitespace(LookupRow::ValueArray const &cellText);
  ValidatorT<TransmissionRunPair> parseTransmissionRuns(LookupRow::ValueArray const &cellText);
  ValidatorT<std::string> parseTransmissionProcessingInstructions(LookupRow::ValueArray const &cellText);
  ValidatorT<RangeInQ> parseQRange(LookupRow::ValueArray const &cellText);
  ValidatorT<double> parseScaleFactor(LookupRow::ValueArray const &cellText);
  ValidatorT<std::map<std::string, std::string>> parseOptions(LookupRow::ValueArray const &cellText);
  ValidatorT<std::string> parseProcessingInstructions(LookupRow::ValueArray const &cellText);
  ValidatorT<std::string> parseBackgroundProcessingInstructions(LookupRow::ValueArray const &cellText);
  ValidatorT<std::string> parseROIDetectorIDs(LookupRow::ValueArray const &cellText);

  void validateThetaAndRegex();

  std::unordered_set<int> m_invalidColumns;
  ValidatorT<double> m_thetaOrInvalid;
  ValidatorT<boost::regex> m_titleMatcherOrInvalid;
};
