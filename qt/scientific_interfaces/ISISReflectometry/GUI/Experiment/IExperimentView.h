...
public:
  ...
  virtual void enableInputSpinStateOrder() = 0;
  virtual void disableInputSpinStateOrder() = 0;
  ...
  virtual std::string getInputSpinStateOrder() const = 0;
  virtual void setInputSpinStateOrder(std::string const &spinStates) = 0;
