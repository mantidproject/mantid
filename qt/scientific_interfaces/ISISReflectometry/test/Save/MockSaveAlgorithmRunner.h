...
public:
  ...
  MOCK_CONST_METHOD7(runSaveORSOAlgorithm, void(std::vector<std::string> const &, std::string const &, const bool &,
                                                const bool &, std::string const &, const bool &, std::string const &));
};
} // namespace MantidQt::CustomInterfaces::ISISReflectometry
