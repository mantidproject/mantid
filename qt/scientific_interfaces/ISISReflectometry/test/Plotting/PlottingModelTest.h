...
#include "../../../ISISReflectometry/GUI/Plotting/model/PlottingModel.h"
...
public:
  ...
  void testAlignmentUsesInitialPeakCentreWhenGaussianFitCannotBeAttempted() {
    ...
    auto const workspacesForPlotting =
        model.workspacesForPlotting(workspaceSelections({"IvsQ_12345"}), alignmentOutputSelection());
  ...
  void testAlignmentMapsProfileFitAndOptimizedPeakCentreToTheta() {
    ...
    auto const workspacesForPlotting =
        model.workspacesForPlotting(workspaceSelections({"IvsQ_12345"}), outputSelection);
...
private:
  PlotOutputSelection alignmentOutputSelection() {
    auto outputSelection = PlotOutputSelection{PlotOutputType::Alignment};
    outputSelection.instrumentName = "POLREF";
    return outputSelection;
  }

  PlotOutputSelection detectorMapOutputSelection(DetectorMapXAxis xAxis = DetectorMapXAxis::TimeOfFlight,
                                                 DetectorMapYAxis yAxis = DetectorMapYAxis::DetectorId) {
    auto outputSelection = PlotOutputSelection{PlotOutputType::DetectorMap, xAxis, yAxis};
    outputSelection.instrumentName = "POLREF";
    return outputSelection;
  }
