...
public:
  ...
  MOCK_METHOD(void, enableInputSpinStateOrder, (), (override));
  MOCK_METHOD(void, disableInputSpinStateOrder, (), (override));
  ...
  MOCK_METHOD(std::string, getInputSpinStateOrder, (), (const, override));
  MOCK_METHOD(void, setInputSpinStateOrder, (std::string const &), (override));
