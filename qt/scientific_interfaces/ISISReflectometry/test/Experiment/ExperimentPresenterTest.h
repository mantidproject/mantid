...
public:
  ...
  void testInstrumentChangedUpdatesLookupRowInView() {
    auto lookupRow =
        LookupRow(std::nullopt, std::nullopt, TransmissionRunPair(), boost::none, RangeInQ(0.01, 0.03, 0.2), 0.7,
                  std::string("390-415"), std::string("370-389,416-430"), boost::none);
  ...
  void testInstrumentChangedUpdatesLookupRowInModel() {
    auto model = makeModelWithLookupRow(LookupRow(std::nullopt, std::nullopt, TransmissionRunPair(), boost::none,
                                                  RangeInQ(0.01, 0.03, 0.2), 0.7, std::string("390-415"),
                                                  std::string("370-389,416-430"), boost::none));
    auto defaultOptions = expectDefaults(model);
    auto presenter = makePresenter(std::move(defaultOptions));
    presenter.notifyInstrumentChanged("POLREF");
    auto expected = LookupRow(std::nullopt, std::nullopt, TransmissionRunPair(), boost::none, RangeInQ(0.01, 0.03, 0.2),
...
private:
  ...
  LookupRow defaultsWithFirstAngle() {
    return LookupRow(0.5, std::nullopt, TransmissionRunPair("13463", ""), boost::none, RangeInQ(), std::nullopt,
                     boost::none, boost::none, boost::none);
  }

  OptionsRow optionsRowWithSecondAngle() { return {"2.3", "", "13463", "13464"}; }
  LookupRow defaultsWithSecondAngle() {
    return LookupRow(2.3, std::nullopt, TransmissionRunPair("13463", "13464"), boost::none, RangeInQ(), std::nullopt,
                     boost::none, boost::none, boost::none);
  }
