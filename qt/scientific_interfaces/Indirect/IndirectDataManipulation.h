...
class IndirectDataManipulationTab;

/**
This class defines the IndirectDataManipulation interface. It handles the overall
instrument settings
...
private:
  ...
  template <typename T> void addTab(const QString &name) {
    ...
    IndirectDataManipulationTab *tabIDRContent = new T(tabContent);
  ...
  // All indirect tabs
  QMap<QString, QPair<QWidget *, IndirectDataManipulationTab *>> m_tabs;
