	...
	namespace CustomInterfaces {
		namespace IDA {
			...
			public:
				...
				virtual void setAvailableSpectra(std::size_t minimum, std::size_t maximum) = 0;
				virtual void setAvailableSpectra(const std::vector<std::size_t>::const_iterator &from,
				...
				virtual void setNameInDataSelection(const std::string &dataName, std::size_t index) = 0;
				virtual void clearDataSelection() = 0;

				virtual void plotInTopPreview(const QString &name,
					Mantid::API::MatrixWorkspace_sptr workspace,
					std::size_t spectrum, Qt::GlobalColor colour) = 0;
