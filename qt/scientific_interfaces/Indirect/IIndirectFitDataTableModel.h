...
public:
  ...
  virtual std::vector<double> getExcludeRegionVector(TableDatasetIndex dataIndex, WorkspaceIndex index) const = 0;
  ...
  virtual void setResolution(const std::string &name, TableDatasetIndex index) = 0;
