...
static const std::map<std::string, std::string> widthFits{
    {{"None", ""},
     ...
     {std::string("HallRoss"),
      std::string("name=Hallross, Tau=1, L=0.2, constraints=(Tau>0, L>0)")},
     {std::string("FickDiffusion"),
      std::string("name=FickDiffusion, D=1, constraints=(D>0)")},
     {std::string("TeixeiraWater"),
      std::string(
...
static const std::map<std::string, std::string> EISFFits{
    {{std::string("EISFDiffCylinder"),
     ...
     {std::string("EISFDiffSphere"),
      std::string("name=EISFDiffSphere, A=1, R=1, constraints=(A>0, R>0)")},
     {std::string("EISFDiffSphereAlkyl"),
      std::string("name=EISFDiffSphereAlkyl, A=1, Rmin=1, Rmax=2, "
