...
namespace MantidQt {
	namespace CustomInterfaces {
		namespace IDA {
			...
			public:
				virtual Mantid::API::MatrixWorkspace_sptr getWorkspace(std::size_t index) const = 0;
				...
				virtual bool isPreviouslyFit(std::size_t dataIndex, std::size_t spectrum) const = 0;
				...
				virtual void setSpectra(const std::string &spectra, std::size_t dataIndex) = 0;
				...
				virtual void setStartX(double startX, std::size_t dataIndex, std::size_t spectrum) = 0;
				virtual void setEndX(double endX, std::size_t dataIndex, std::size_t spectrum) = 0;
				...
				virtual void addWorkspace(const std::string &workspaceName, const Spectra &spectra) = 0;
				...
				virtual boost::optional<ResultLocation> getResultLocation(std::size_t dataIndex,
					std::size_t spectrum) const = 0;
				...
				virtual Mantid::API::IAlgorithm_sptr getSingleFit(std::size_t dataIndex,
					std::size_t spectrum) const = 0;

				virtual void saveResult() const = 0;
				virtual void cleanFailedRun(Mantid::API::IAlgorithm_sptr fittingAlgorithm) = 0;
				virtual void cleanFailedSingleRun(Mantid::API::IAlgorithm_sptr fittingAlgorithm,
					std::size_t index) = 0;		
			};
		}
	}
