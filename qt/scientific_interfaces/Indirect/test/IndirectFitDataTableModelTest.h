...
public:
  ...
  void test_getDomainIndex_calculates_correct_value() {
    ...
    m_fitData->addWorkspace("data workspace 2");
    TS_ASSERT_EQUALS(
        m_fitData->getDomainIndex(TableDatasetIndex(0),
                                  MantidQt::MantidWidgets::WorkspaceIndex(0)),
        FitDomainIndex{0});
    TS_ASSERT_EQUALS(
        m_fitData->getDomainIndex(TableDatasetIndex(0),
    ...
    TS_ASSERT_EQUALS(
        m_fitData->getDomainIndex(TableDatasetIndex(0),
                                  MantidQt::MantidWidgets::WorkspaceIndex(2)),
        FitDomainIndex{2});
    TS_ASSERT_EQUALS(
        m_fitData->getDomainIndex(TableDatasetIndex(0),
                                  MantidQt::MantidWidgets::WorkspaceIndex(3)),
        FitDomainIndex{3});
    TS_ASSERT_EQUALS(
        m_fitData->getDomainIndex(TableDatasetIndex(1),
                                  MantidQt::MantidWidgets::WorkspaceIndex(0)),
        FitDomainIndex{4});
  }
  ...
  void test_getQValuesForData_returns_correct_value() {
    auto dataWorkspace = Mantid::IndirectFitDataCreationHelper::
        createWorkspaceWithInelasticInstrument(5, 4);
    Mantid::API::AnalysisDataService::Instance().addOrReplace(
        "data workspace 2", dataWorkspace);
    m_fitData->addWorkspace("data workspace 2");
  ...
  void test_getWorkspaceNames_returns_all_names() {
    ...
    Mantid::API::AnalysisDataService::Instance().addOrReplace(
        "data workspace 2", std::move(dataWorkspace));
    m_fitData->addWorkspace("data workspace 2");
    std::vector<std::string> wsNames = {"data workspace", "data workspace 2"};
  ...
  void test_removeWorkspace_functions_as_required() {
    ...
    Mantid::API::AnalysisDataService::Instance().addOrReplace(
        "data workspace 2", std::move(dataWorkspace));
    m_fitData->addWorkspace("data workspace 2");
    std::vector<std::string> wsNames = {"data workspace"};
  ...
  void test_getExcludeRegion_returns_range_for_spectra() {
    ...
    TS_ASSERT_EQUALS(
        m_fitData->getExcludeRegion(TableDatasetIndex{0},
                                   MantidQt::MantidWidgets::WorkspaceIndex{0}),
        excludeString);
    TS_ASSERT_EQUALS(
        m_fitData->getExcludeRegionVector(TableDatasetIndex{0},
                                    MantidQt::MantidWidgets::WorkspaceIndex{0}),
        exclusionVector);
    TS_ASSERT_EQUALS(m_fitData->getExcludeRegion(FitDomainIndex{0}),
                     excludeString);
    TS_ASSERT_EQUALS(m_fitData->getExcludeRegionVector(FitDomainIndex{0}),
                     exclusionVector);
  ...
  void test_getFittingRange_returns_range_for_spectra() {
    ...
    TS_ASSERT_EQUALS(
        m_fitData->getFittingRange(TableDatasetIndex{0},
                                   MantidQt::MantidWidgets::WorkspaceIndex{0}),
        fittingPair);
    TS_ASSERT_EQUALS(m_fitData->getFittingRange(FitDomainIndex{0}),
                     fittingPair);
  }
  ...
  void test_getSubIndices_returns_correct_value() {
    ...
    Mantid::API::AnalysisDataService::Instance().addOrReplace(
        "data workspace 2", std::move(dataWorkspace));
    m_fitData->addWorkspace("data workspace 2");
    std::pair<TableDatasetIndex, MantidQt::MantidWidgets::WorkspaceIndex>
        subindices = {0, 3};
