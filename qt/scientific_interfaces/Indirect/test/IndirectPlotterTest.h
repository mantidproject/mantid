...
public:
  IndirectPlotterTest() : m_ads(AnalysisDataService::Instance()) { m_ads.clear(); }
  ...
  void test_that_plotSpectra_will_attempt_to_run_python_code_using_the_IPyRunner() {
  ...
  void test_that_plotBins_will_attempt_to_run_python_code_using_the_IPyRunner() {
    m_ads.addOrReplace(WORKSPACE_NAME, createMatrixWorkspace(5, 5));
