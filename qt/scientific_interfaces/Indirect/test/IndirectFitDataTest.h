...
public:
  ...
  void test_that_DiscontinuousSpectra_is_set_up_correctly() {
    ...
    std::vector<int> const spectraVec{0, 1, 2, 3, 4, 5, 8, 10};

    TS_ASSERT_EQUALS(spectra.getString(), spectraString);
    for (auto it = spectra.begin(); it < spectra.end(); ++it)
      TS_ASSERT_EQUALS(it->value, spectraVec[it - spectra.begin()]);
  }
  ...
  test_displayName_returns_a_valid_name_when_provided_a_rangeDelimiter_and_spectrum_number() {
    ...
    TS_ASSERT_EQUALS(data->displayName(formatStrings[1], rangeDelimiter),
                     "_f0+s0_Parameter");
    TS_ASSERT_EQUALS(
        data->displayName(formatStrings[2], IDAWorkspaceIndex{spectrum}),
        "_s1_Parameter");
  }
  ...
  test_that_the_number_of_spectra_returned_matches_the_instantiated_value() {
    ...
    TS_ASSERT_EQUALS(data->numberOfSpectra(), SpectrumRowIndex{10});
  }

  void test_that_getSpectrum_returns_the_expected_spectrum_numbers() {
    auto const data = getIndirectFitData(4);

    for (SpectrumRowIndex i{0}; i < data->numberOfSpectra(); ++i) {
      auto const spectrumNum = data->getSpectrum(i);
      TS_ASSERT_EQUALS(spectrumNum, IDAWorkspaceIndex{i.value});
    }
  }
  ...
  test_that_correct_excludeRegion_is_returned_when_regions_are_in_correct_order() {
    ...
    data->setExcludeRegionString("1,8", IDAWorkspaceIndex{0});
    data->setExcludeRegionString("2,5", IDAWorkspaceIndex{1});
    data->setExcludeRegionString("1,2,5,6,3,4", IDAWorkspaceIndex{2});

    TS_ASSERT_EQUALS(data->getExcludeRegion(IDAWorkspaceIndex{0}),
                     "1.000,8.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(IDAWorkspaceIndex{1}),
                     "2.000,5.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(IDAWorkspaceIndex{2}),
                     "1.000,2.000,5.000,6.000,3.000,4.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(IDAWorkspaceIndex{3}), "");
  }
  ...
  test_that_correct_excludeRegionVector_is_returned_when_regions_are_in_correct_order() {
    ...
    TS_ASSERT_EQUALS(data->excludeRegionsVector(IDAWorkspaceIndex{0}),
                     regionVector1);
    TS_ASSERT_EQUALS(data->excludeRegionsVector(IDAWorkspaceIndex{1}),
                     regionVector2);
    TS_ASSERT_EQUALS(data->excludeRegionsVector(IDAWorkspaceIndex{3}).empty(),
                     true);
  }
  ...
  void test_that_excludeRegion_pairs_are_stored_in_an_order_of_low_to_high() {
    ...
    data->setExcludeRegionString("6,2", IDAWorkspaceIndex{0});
    data->setExcludeRegionString("6,2,1,2,3,4,7,6", IDAWorkspaceIndex{1});
    data->setExcludeRegionString("1,2,2,3,20,18,21,22,7,8",
                                 IDAWorkspaceIndex{2});
    ...
    TS_ASSERT_EQUALS(
        data->getExcludeRegion(IDAWorkspaceIndex{2}),
  ...
  test_that_excludeRegion_is_stored_without_spaces_when_there_are_many_spaces_in_input_string() {
    ...
    data->setExcludeRegionString("  6,     2", IDAWorkspaceIndex{0});
    data->setExcludeRegionString("6,  2,1  ,2,  3,4  ,7,6",
                                 IDAWorkspaceIndex{1});
    data->setExcludeRegionString("1,2 ,2,3,  20,  18,21,22,7, 8   ",
                                 IDAWorkspaceIndex{2});
  ...
  test_that_setExcludeRegion_rounds_the_numbers_in_the_input_string_to_the_appropriate_decimal_place() {
    ...
    data->setExcludeRegionString("6.29445,2.93343", IDAWorkspaceIndex{0});
    data->setExcludeRegionString("2.6,2.3,1.9999,3.0125", IDAWorkspaceIndex{1});
  ...
  void test_throws_when_setSpectra_is_provided_an_out_of_range_spectra() {
    ...
    std::vector<Spectra> const spectraPairs{
        Spectra(IDAWorkspaceIndex{0}, IDAWorkspaceIndex{11}),
        Spectra(IDAWorkspaceIndex{0}, IDAWorkspaceIndex{1000}),
        Spectra(IDAWorkspaceIndex{10}, IDAWorkspaceIndex{10})};
    std::vector<std::string> const spectraStrings{"10", "1000", "1,5,10",
                                                  "1,2,3,4,5,6,22"};
  ...
  void test_no_throw_when_setSpectra_is_provided_a_valid_spectra() {
    ...
    std::vector<Spectra> const spectraPairs{
        Spectra(IDAWorkspaceIndex{0}, IDAWorkspaceIndex{9}),
        Spectra(IDAWorkspaceIndex{4}, IDAWorkspaceIndex{4}),
        Spectra(IDAWorkspaceIndex{7}, IDAWorkspaceIndex{4})};
  ...
  test_no_throw_when_setStartX_is_provided_a_valid_xValue_and_spectrum_number() {
    ...
    TS_ASSERT_THROWS_NOTHING(data->setStartX(0.0, IDAWorkspaceIndex{0}));
    TS_ASSERT_THROWS_NOTHING(data->setStartX(-5.0, IDAWorkspaceIndex{0}));
    TS_ASSERT_THROWS_NOTHING(data->setStartX(5000000, IDAWorkspaceIndex{10}));
  }

  void test_the_provided_startX_is_stored_in_range_after_using_setStartX() {
    auto data = getIndirectFitData(3);

    data->setStartX(-5.0, IDAWorkspaceIndex{0});
    data->setStartX(6.53, IDAWorkspaceIndex{1});
    data->setStartX(100000000000000.0, IDAWorkspaceIndex{2});

    TS_ASSERT_EQUALS(data->getRange(IDAWorkspaceIndex{0}).first, -5.0);
    TS_ASSERT_EQUALS(data->getRange(IDAWorkspaceIndex{1}).first, 6.53);
    TS_ASSERT_EQUALS(data->getRange(IDAWorkspaceIndex{2}).first,
                     100000000000000.0);
  }
  ...
  void test_the_provided_endX_is_stored_in_range_after_using_setEndX() {
    ...
    data->setEndX(-5.0, IDAWorkspaceIndex{0});
    data->setEndX(6.53, IDAWorkspaceIndex{1});
    data->setEndX(100000000000000.0, IDAWorkspaceIndex{2});

    TS_ASSERT_EQUALS(data->getRange(IDAWorkspaceIndex{0}).second, -5.0);
    TS_ASSERT_EQUALS(data->getRange(IDAWorkspaceIndex{1}).second, 6.53);
    TS_ASSERT_EQUALS(data->getRange(IDAWorkspaceIndex{2}).second,
                     100000000000000.0);
  }
  ...
  test_that_the_startX_of_two_data_sets_are_combined_when_relating_to_two_seperate_spectra() {
    ...
    data1->setStartX(6.53, IDAWorkspaceIndex{0});
    data2->setStartX(5.0, IDAWorkspaceIndex{1});
    auto const combinedData = data2->combine(*data1);

    TS_ASSERT_EQUALS(combinedData.getRange(IDAWorkspaceIndex{0}).first, 6.53);
    TS_ASSERT_EQUALS(combinedData.getRange(IDAWorkspaceIndex{1}).first, 5.0);
  }
  ...
  test_that_the_endX_of_two_datasets_are_combined_when_relating_to_two_seperate_spectra() {
    ...
    data1->setEndX(2.34, IDAWorkspaceIndex{0});
    data2->setEndX(5.9, IDAWorkspaceIndex{1});
    auto const combinedData = data2->combine(*data1);

    TS_ASSERT_EQUALS(combinedData.getRange(IDAWorkspaceIndex{0}).second, 2.34);
    TS_ASSERT_EQUALS(combinedData.getRange(IDAWorkspaceIndex{1}).second, 5.9);
  }
  ...
  test_that_the_excludeRegion_of_two_datasets_are_combined_when_relating_to_two_seperate_spectra() {
    ...
    data1->setExcludeRegionString("1,2,6,5", IDAWorkspaceIndex{0});
    data1->setExcludeRegionString("6,2", IDAWorkspaceIndex{1});
    auto const combinedData = data2->combine(*data1);

    TS_ASSERT_EQUALS(combinedData.getExcludeRegion(IDAWorkspaceIndex{0}),
                     "1.000,2.000,5.000,6.000");
    TS_ASSERT_EQUALS(combinedData.getExcludeRegion(IDAWorkspaceIndex{1}),
                     "2.000,6.000");
  }
  ...
  test_that_the_spectra_pair_of_two_datasets_are_combined_correctly_when_spectra_do_not_overlap() {
    ...
    data1->setSpectra(Spectra(IDAWorkspaceIndex{0}, IDAWorkspaceIndex{4}));
    data2->setSpectra(Spectra(IDAWorkspaceIndex{5}, IDAWorkspaceIndex{9}));
    auto const combinedData = data2->combine(*data1);
    Spectra const spec(Spectra(IDAWorkspaceIndex{0}, IDAWorkspaceIndex{9}));
  ...
  test_that_the_spectra_pair_of_two_datasets_are_combined_correctly_when_spectra_are_discontinuous() {
    ...
    data1->setSpectra(Spectra(IDAWorkspaceIndex{0}, IDAWorkspaceIndex{4}));
    data2->setSpectra(Spectra(IDAWorkspaceIndex{8}, IDAWorkspaceIndex{9}));
    auto const combinedData = data2->combine(*data1);
  ...
  test_that_the_spectra_pair_of_two_datasets_are_combined_correctly_when_spectra_overlap() {
    ...
    data1->setSpectra(Spectra(IDAWorkspaceIndex{0}, IDAWorkspaceIndex{8}));
    data2->setSpectra(Spectra(IDAWorkspaceIndex{4}, IDAWorkspaceIndex{9}));
    auto const combinedData = data2->combine(*data1);
