...
public:
  ...
  void test_that_DiscontinuousSpectra_is_set_up_correctly() {
    ...
    std::vector<IDA::WorkspaceIndex> const spectraVec{
        IDA::WorkspaceIndex(0), IDA::WorkspaceIndex(1), IDA::WorkspaceIndex(2), IDA::WorkspaceIndex(3),
        IDA::WorkspaceIndex(4), IDA::WorkspaceIndex(5), IDA::WorkspaceIndex(8), IDA::WorkspaceIndex(10)};
  ...
  void test_that_getSpectrum_returns_the_expected_spectrum_numbers() {
    ...
    for (auto i = FitDomainIndex{0}; i < data->numberOfSpectra(); ++i) {
      MantidQt::CustomInterfaces::IDA::WorkspaceIndex const spectrumNum = data->getSpectrum(i);
  ...
  void test_that_correct_excludeRegion_is_returned_when_regions_are_in_correct_order() {
    ...
    data->setExcludeRegionString("1,8", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0});
    data->setExcludeRegionString("2,5", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{1});
    data->setExcludeRegionString("1,2,5,6,3,4", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{2});

    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0}), "1.000,8.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{1}), "2.000,5.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{2}),
                     "1.000,2.000,5.000,6.000,3.000,4.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{3}), "");
  }
  ...
  void test_that_correct_excludeRegionVector_is_returned_when_regions_are_in_correct_order() {
    ...
    TS_ASSERT_EQUALS(data->excludeRegionsVector(IDA::WorkspaceIndex{0}), regionVector1);
    TS_ASSERT_EQUALS(data->excludeRegionsVector(IDA::WorkspaceIndex{1}), regionVector2);
    TS_ASSERT_EQUALS(data->excludeRegionsVector(IDA::WorkspaceIndex{3}).empty(), true);
  }
  ...
  void test_that_excludeRegion_pairs_are_stored_in_an_order_of_low_to_high() {
    ...
    data->setExcludeRegionString("6,2", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0});
    data->setExcludeRegionString("6,2,1,2,3,4,7,6", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{1});
    data->setExcludeRegionString("1,2,2,3,20,18,21,22,7,8", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{2});

    std::vector<double> const regionVector{2.0, 6.0};

    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0}), "2.000,6.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{1}),
                     "2.000,6.000,1.000,2.000,3.000,4.000,6.000,7.000");
    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{2}),
                     "1.000,2.000,2.000,3.000,18.000,20.000,21.000,22.000,7.000,8.000");
    TS_ASSERT_EQUALS(data->excludeRegionsVector(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0}), regionVector);
  }
  ...
  void test_that_setExcludeRegion_rounds_the_numbers_in_the_input_string_to_the_appropriate_decimal_place() {
    ...
    data->setExcludeRegionString("6.29445,2.93343", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0});
    data->setExcludeRegionString("2.6,2.3,1.9999,3.0125", MantidQt::CustomInterfaces::IDA::WorkspaceIndex{1});

    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0}), "2.933,6.294");
    TS_ASSERT_EQUALS(data->getExcludeRegion(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{1}),
  ...
  void test_throws_when_setSpectra_is_provided_an_out_of_range_spectra() {
    ...
    std::vector<FunctionModelSpectra> const spectraPairs{
        ...
        FunctionModelSpectra(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{10},
  ...
  void test_the_provided_startX_is_stored_in_range_after_using_setStartX() {
    ...
    TS_ASSERT_EQUALS(data->getRange(IDA::WorkspaceIndex{2}).first, 100000000000000.0);
  }
  ...
  void test_the_provided_endX_is_stored_in_range_after_using_setEndX() {
    ...
    TS_ASSERT_EQUALS(data->getRange(IDA::WorkspaceIndex{2}).second, 100000000000000.0);
  }
  ...
  void test_that_the_endX_of_two_datasets_are_combined_when_relating_to_two_seperate_spectra() {
    ...
    TS_ASSERT_EQUALS(combinedData.getRange(IDA::WorkspaceIndex{0}).second, 2.34);
  ...
  void test_that_the_excludeRegion_of_two_datasets_are_combined_when_relating_to_two_seperate_spectra() {
    ...
    TS_ASSERT_EQUALS(combinedData.getExcludeRegion(IDA::WorkspaceIndex{0}), std::string("1.000,2.000,5.000,6.000"));
    TS_ASSERT_EQUALS(combinedData.getExcludeRegion(IDA::WorkspaceIndex{1}), std::string("2.000,6.000"));
  }
  ...
  void test_that_the_spectra_pair_of_two_datasets_are_combined_correctly_when_spectra_do_not_overlap() {
    ...
    data1->setSpectra(FunctionModelSpectra(IDA::WorkspaceIndex{0}, IDA::WorkspaceIndex{4}));
    data2->setSpectra(FunctionModelSpectra(IDA::WorkspaceIndex{5}, IDA::WorkspaceIndex{9}));
    auto const combinedData = data2->combine(*data1);
    FunctionModelSpectra const spec(FunctionModelSpectra(IDA::WorkspaceIndex{0}, IDA::WorkspaceIndex{9}));
  ...
  void test_that_the_spectra_pair_of_two_datasets_are_combined_correctly_when_spectra_are_discontinuous() {
    ...
    data1->setSpectra(FunctionModelSpectra(IDA::WorkspaceIndex{0}, IDA::WorkspaceIndex{4}));
    data2->setSpectra(FunctionModelSpectra(IDA::WorkspaceIndex{8}, IDA::WorkspaceIndex{9}));
    auto const combinedData = data2->combine(*data1);
  ...
  void test_that_the_spectra_pair_of_two_datasets_are_combined_correctly_when_spectra_overlap() {
    ...
    data1->setSpectra(FunctionModelSpectra(IDA::WorkspaceIndex{0}, IDA::WorkspaceIndex{8}));
    data2->setSpectra(FunctionModelSpectra(IDA::WorkspaceIndex{4}, IDA::WorkspaceIndex{9}));
    auto const combinedData = data2->combine(*data1);
  ...
  void test_that_getQValues() {
    auto const workspace =
        createWorkspaceWithInelasticInstrument(10,10);
    FunctionModelSpectra const spec =
        FunctionModelSpectra(MantidQt::CustomInterfaces::IDA::WorkspaceIndex{0},
                             MantidQt::CustomInterfaces::IDA::WorkspaceIndex{
                                 workspace->getNumberHistograms() - 1});
    auto data =
        std::make_unique<IndirectFitData>(IndirectFitData(workspace, spec));
    ...
    double q =
        Mantid::Kernel::UnitConversion::convertToElasticQ(usignTheta, efixed);
