...
public:
  ...
  void test_that_single_function_correctly_identified() {
    ...
    auto occurances = IndirectFitAnalysisTab::getNumberOfSpecificFunctionContained(functionName, fitFunction.get());
  ...
  void test_that_single_layer_composite_function_handled_correctly() {
    ...
    auto occurances = IndirectFitAnalysisTab::getNumberOfSpecificFunctionContained("ExpDecay", fitFunction.get());
    auto stretchOccurances =
        IndirectFitAnalysisTab::getNumberOfSpecificFunctionContained("StretchExp", fitFunction.get());
    TS_ASSERT_EQUALS(occurances, 1);
  ...
  void test_that_no_matched_name_is_correct() {
    std::string functionName = "name=ExpDecay;name=StretchExp";
    auto fitFunction = Mantid::API::FunctionFactory::Instance().createInitialized(functionName);
    auto occurances = IndirectFitAnalysisTab::getNumberOfSpecificFunctionContained("NotHere", fitFunction.get());
