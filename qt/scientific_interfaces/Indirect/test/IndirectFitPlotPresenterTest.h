...
public:
  ...
  //   EXPECT_CALL(*m_fittingModel, getFittingRange(index,
  ...
  //   EXPECT_CALL(*m_fittingModel, setStartX(1.0,
  //   TableDatasetIndex(0))).Times(1);

  //   m_view->emitStartXChanged(1.0);
  // }

  // void test_that_the_endXChanged_signal_will_set_the_fitting_models_endX() {
  //   EXPECT_CALL(*m_fittingModel, setEndX(2.0,
  //   TableDatasetIndex(0))).Times(1); m_view->emitEndXChanged(2.0);
  // }
  ...
  //   EXPECT_CALL(*m_view,
  //   setHWHMMinimum(-0.00875)).Times(1).After(setVisible);
  ...
  //           .Times(1);
  //   EXPECT_CALL(*m_view,
  //               setNameInDataSelection("DisplayName-1",
  //               TableDatasetIndex(0)))
  //       .Times(1)
  //       .After(createName);
