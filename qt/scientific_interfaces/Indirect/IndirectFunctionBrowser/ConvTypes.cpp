...
std::map<ParamID, QString> g_paramName{
    ...
    {ParamID::DP_DIFFUSION, "Diffusion"},
    {ParamID::DP_SHIFT, "Shift"},
    ...
    {ParamID::DRDC_INTENSITY, "Intensity"},
    {ParamID::DRDC_RADIUS, "Radius"},
    {ParamID::DRDC_DECAY, "Decay"},
    {ParamID::DRDC_SHIFT, "Shift"},
