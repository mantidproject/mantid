...
public:
  /// constructor
  MuonAnalysisDataLoader(const Muon::DeadTimesType &deadTimesType, const QStringList &instruments,
                         const std::string &deadTimesFile = "");
  /// change dead times type
  void setDeadTimesType(const Muon::DeadTimesType &deadTimesType, const std::string &deadTimesFile = "");
  ...
  Mantid::API::Workspace_sptr correctAndGroup(const Muon::LoadResult &loadedData,
                                              const Mantid::API::Grouping &grouping) const;
  /// create analysis workspace
  Mantid::API::Workspace_sptr createAnalysisWorkspace(const Mantid::API::Workspace_sptr &inputWS,
                                                      const Muon::AnalysisOptions &options) const;
  /// Get dead time table
  Mantid::API::ITableWorkspace_sptr getDeadTimesTable(const Muon::LoadResult &loadedData) const;
  /// Load dead times from file
  Mantid::API::Workspace_sptr loadDeadTimesFromFile(const std::string &filename) const;
  // empty the cache
  void clearCache();
...
protected:
  ...
  void setProcessAlgorithmProperties(const Mantid::API::IAlgorithm_sptr &alg,
                                     const Muon::AnalysisOptions &options) const;
...
private:
  ...
  std::string getInstrumentName(const Mantid::API::Workspace_sptr &workspace) const;
