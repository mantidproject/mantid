...
public:
  ...
  CommandProviderBase(CommandProviderBase&&) = default;

  CommandProviderBase(const CommandProviderBase&) = delete;
  CommandProviderBase& operator=(const CommandProviderBase&) = delete;
