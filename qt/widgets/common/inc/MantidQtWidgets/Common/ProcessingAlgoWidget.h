...
class EXPORT_OPT_MANTIDQT_COMMON ProcessingAlgoWidgetSettings {
public:
  explicit ProcessingAlgoWidgetSettings(QString lastFile = {});

  [[nodiscard]] const QString &lastFile() const;

  /// Query persistent storage without changing widgets or writing settings.
  [[nodiscard]] static ProcessingAlgoWidgetSettings readSettings(const QSettings &settings);
...
public:
  ...
  [[nodiscard]] ProcessingAlgoWidgetSettings captureSettings() const;
