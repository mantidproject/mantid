...
public:
  ...
  virtual void showCustomInterface(const std::string &name, const std::string &section = std::string());
  virtual void showCustomInterface(const QString &name, const QString &section = QString());
