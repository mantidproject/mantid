...
void EXPORT_OPT_MANTIDQT_COMMON provideSkewMatrix(Mantid::Kernel::DblMatrix &skewMatrix,
...
size_t EXPORT_OPT_MANTIDQT_COMMON getMissingHKLDimensionIndex(const Mantid::API::IMDWorkspace_const_sptr &workspace,
                                                              size_t dimX, size_t dimY);

void EXPORT_OPT_MANTIDQT_COMMON transformFromDoubleToCoordT(const Mantid::Kernel::DblMatrix &skewMatrix,
                                                            std::array<Mantid::coord_t, 9> &skewMatrixCoord);

template <typename T>
void transformLookpointToWorkspaceCoord(T &lookPoint, const std::array<Mantid::coord_t, 9> &skewMatrix,
...
getGridLineAnglesInRadian(const std::array<Mantid::coord_t, 9> &skewMatrixCoord, size_t dimX, size_t dimY);
} // namespace API
} // namespace MantidQt
