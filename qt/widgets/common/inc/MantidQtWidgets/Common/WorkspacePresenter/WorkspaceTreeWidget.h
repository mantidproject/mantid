...
private:
  ...
  QAction *m_showData, *m_showInst, *m_plotSpec, *m_plotSpecErr, *m_plotAdvanced, *m_showDetectors, *m_showBoxData,
      *m_showVatesGui, *m_showSpectrumViewer, *m_showSliceViewer, *m_colorFill, *m_showLogs, *m_showSampleMaterial,
      *m_showHist, *m_showMDPlot, *m_showListData, *m_ascendingSortAction, *m_descendingSortAction, *m_byNameChoice,
