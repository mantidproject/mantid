...
namespace MantidQt {
	namespace MantidWidgets {
		...
		\brief  WorkspaceTreeWidget implementation for the Workbench - required for some function overides
		\author Elliot Oram
		\date   16-01-2018
		\version 1.0
		...
		*/
		class EXPORT_OPT_MANTIDQT_COMMON WorkspaceTreeWidgetSimple
			...
			Q_OBJECT
		public:
			explicit WorkspaceTreeWidgetSimple(MantidQt::MantidWidgets::MantidDisplayBase *mdb,
