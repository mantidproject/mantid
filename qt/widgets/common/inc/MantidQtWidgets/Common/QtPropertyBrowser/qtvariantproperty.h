...
public:
  ...
  void slotValueChanged(QtProperty *const &property, int val);
  void slotRangeChanged(QtProperty *const &property, int min, int max);
  void slotSingleStepChanged(QtProperty *const &property, int step);
  void slotValueChanged(QtProperty *const &property, double val);
  void slotRangeChanged(QtProperty *const &property, double min, double max);
  void slotSingleStepChanged(QtProperty *const &property, double step);
  void slotDecimalsChanged(QtProperty *const &property, int prec);
  void slotValueChanged(QtProperty *const &property, bool val);
  void slotValueChanged(QtProperty *const &property, const QString &val);
  void slotRegExpChanged(QtProperty *const &property, const QRegExp &regExp);
  void slotValueChanged(QtProperty *const &property, const QDate &val);
  void slotRangeChanged(QtProperty *const &property, const QDate &min, const QDate &max);
  void slotValueChanged(QtProperty *const &property, const QTime &val);
  void slotValueChanged(QtProperty *const &property, const QDateTime &val);
  void slotValueChanged(QtProperty *const &property, const QKeySequence &val);
  void slotValueChanged(QtProperty *const &property, const QChar &val);
  void slotValueChanged(QtProperty *const &property, const QLocale &val);
  void slotValueChanged(QtProperty *const &property, const QPoint &val);
  void slotValueChanged(QtProperty *const &property, const QPointF &val);
  void slotValueChanged(QtProperty *const &property, const QSize &val);
  void slotRangeChanged(QtProperty *const &property, const QSize &min, const QSize &max);
  void slotValueChanged(QtProperty *const &property, const QSizeF &val);
  void slotRangeChanged(QtProperty *const &property, const QSizeF &min, const QSizeF &max);
  void slotValueChanged(QtProperty *const &property, const QRect &val);
  void slotConstraintChanged(QtProperty *const &property, const QRect &val);
  void slotValueChanged(QtProperty *const &property, const QRectF &val);
  void slotConstraintChanged(QtProperty *const &property, const QRectF &val);
  void slotValueChanged(QtProperty *const &property, const QColor &val);
  void slotEnumChanged(QtProperty *property, int val);
  void slotEnumNamesChanged(QtProperty *const &property, const QStringList &enumNames);
  void slotEnumIconsChanged(QtProperty *const &property, const QMap<int, QIcon> &enumIcons);
  void slotValueChanged(QtProperty *const &property, const QSizePolicy &val);
  void slotValueChanged(QtProperty *const &property, const QFont &val);
  void slotValueChanged(QtProperty *const &property, const QCursor &val);
  void slotFlagChanged(QtProperty *property, int val);
  void slotFlagNamesChanged(QtProperty *const &property, const QStringList &flagNames);
  void slotPropertyInserted(QtProperty *property, QtProperty *const &parent, QtProperty *const &after);
  void slotPropertyRemoved(QtProperty *const &property, QtProperty *parent);

  void valueChanged(QtProperty *const &property, const QVariant &val);
