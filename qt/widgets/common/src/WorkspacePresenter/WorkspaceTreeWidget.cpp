...
void WorkspaceTreeWidget::onClickShowVates() { m_presenter->notifyFromView(ViewNotifiable::Flag::ShowVatesGUI); }

void WorkspaceTreeWidget::showVatesGUI() { m_mantidDisplayModel->showVatesSimpleInterface(); }
