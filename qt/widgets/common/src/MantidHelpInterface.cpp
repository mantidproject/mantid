...
void MantidHelpInterface::showCustomInterface(const std::string &name, const std::string &section) {
  UNUSED_ARG(name);
  UNUSED_ARG(section);
}

void MantidHelpInterface::showCustomInterface(const QString &name, const QString &section) {
  UNUSED_ARG(name);
  UNUSED_ARG(section);
}
