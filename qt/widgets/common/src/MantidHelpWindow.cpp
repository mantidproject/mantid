 ...
 */
void MantidHelpWindow::showCustomInterface(const QString &name, const QString &section) {
 ...
 * @param section :: the section of the interface to show
 */
void MantidHelpWindow::showCustomInterface(const std::string &name, const std::string &section) {
  if (bool(g_helpWindow)) {
    QString url(BASE_URL);
    url += "interfaces/";
    if (name.empty()) {
