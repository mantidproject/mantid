 ...
 */
void SlicingAlgorithmDialog::customiseLayoutForVsi(const std::string &initialWorkspace) {
  // File back-end
 ...
 */
void SlicingAlgorithmDialog::resestAlignedDimProperty(size_t index, const QString &propertyValue) {
