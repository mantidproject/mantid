...
namespace MantidWidgets {
    ...
    AlgorithmProgressModel::AlgorithmProgressModel(AlgorithmProgressPresenter* presenter)
        : AlgorithmObserver()
        , m_dialogPresenter { nullptr }
        , m_mainWindowPresenter { presenter }
    {
    ...
    inline void AlgorithmProgressModel::setDialog(AlgorithmProgressDialogPresenter* presenter)
    {
    ...
    {
        m_mainWindowPresenter->updateProgressBar(alg->getAlgorithmID(), progress, message);
        if (m_dialogPresenter) {
            m_dialogPresenter->updateProgressBar(alg->getAlgorithmID(), progress, message);
        }
    }
