...
namespace MantidWidgets {
        ...
        , m_tree { new QTreeWidget(this) }
    {
        ...
        connect(button, &QPushButton::clicked, this, &AlgorithmProgressDialogPresenter::close);
        connect(this, &AlgorithmProgressDialogWidget::close, m_presenter.get(), &AlgorithmProgressDialogPresenter::close);
    ...
    std::pair<QTreeWidgetItem*, QProgressBar*> AlgorithmProgressDialogWidget::addAlgorithm(std::string name, std::vector<Mantid::Kernel::Property*> properties)
    {
