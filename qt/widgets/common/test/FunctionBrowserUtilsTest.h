...
public:
  void test_splitConstraintString_returns_empty_if_given_empty_string() {
    ...
    auto splitConstraints =
        MantidQt::MantidWidgets::splitConstraintString(testConstraint);
  ...
  void test_splitConstraintString_double_constraint() {
    ...
    auto splitConstraints =
        MantidQt::MantidWidgets::splitConstraintString(testConstraint);
    auto expected_value = std::make_pair(
        QString("A"), std::make_pair(QString("0.1"), QString("0.2")));
  ...
  void test_splitConstraintString_lower_bound() {
    ...
    auto splitConstraints =
        MantidQt::MantidWidgets::splitConstraintString(testConstraint);
    auto expected_value = std::make_pair(
        QString("A"), std::make_pair(QString("0.1"), QString("")));
    TS_ASSERT_EQUALS(splitConstraints, expected_value);
  }
  ...
  void test_splitConstraintString_upper_bound() {
    ...
    auto splitConstraints =
        MantidQt::MantidWidgets::splitConstraintString(testConstraint);
    auto expected_value = std::make_pair(
        QString("A"), std::make_pair(QString(""), QString("0.2")));
    TS_ASSERT_EQUALS(splitConstraints, expected_value);
  }
