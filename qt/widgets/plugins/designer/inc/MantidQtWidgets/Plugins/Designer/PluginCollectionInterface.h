...
#define DECLARE_WIDGET_PLUGIN(PluginClass, WidgetClass, ToolTip)                                                       \
  ...
  public:                                                                                                              \
    ...
    QWidget *createWidget(QWidget *parent) override { return new WidgetClass(parent); }                                \
...
//==============================================================================
DECLARE_WIDGET_PLUGIN(AlgorithmSelectorWidgetPlugin, MantidQt::MantidWidgets::AlgorithmSelectorWidget,
                      "Widget for picking algorithms");

DECLARE_WIDGET_PLUGIN(ScriptEditorPlugin, ScriptEditor, "Widget for editing python script");
...
DECLARE_WIDGET_PLUGIN(InstrumentSelectorPlugin, MantidQt::MantidWidgets::InstrumentSelector,
                      "Sets the current instrument within Mantid");

DECLARE_WIDGET_PLUGIN(MuonFitBrowserPlugin, MantidQt::MantidWidgets::MuonFitPropertyBrowser,
                      "The menu for fitting functions within Muon Analysis");

DECLARE_WIDGET_PLUGIN(FitBrowserPlugin, MantidQt::MantidWidgets::FitPropertyBrowser, "The menu for fitting functions");

DECLARE_WIDGET_PLUGIN(WorkspaceSelectorPlugin, MantidQt::MantidWidgets::WorkspaceSelector,
                      "Select a workspace for use in this operation");

DECLARE_WIDGET_PLUGIN(ColorBarWidgetPlugin, MantidQt::MantidWidgets::ColorBarWidget,
                      "Shows a color scale and allow user to change it");

DECLARE_WIDGET_PLUGIN(SliceViewerPlugin, MantidQt::SliceViewer::SliceViewer, "Shows 2D slices of MDWorkspaces");

DECLARE_WIDGET_PLUGIN(LineViewerPlugin, MantidQt::SliceViewer::LineViewer, "Shows 1D lines selected in a LineViewer");
...
DECLARE_WIDGET_PLUGIN(MWViewPlugin, MantidQt::MantidWidgets::MWView, "2D view of a MatrixWorkspace");

DECLARE_WIDGET_PLUGIN(AlgorithmPropertiesWidgetPlugin, MantidQt::API::AlgorithmPropertiesWidget,
                      "List of algorithm properties");

DECLARE_WIDGET_PLUGIN(ProcessingAlgoWidgetPlugin, MantidQt::MantidWidgets::ProcessingAlgoWidget,
                      "Choose an algorithm or write a script as a processing step");

DECLARE_WIDGET_PLUGIN(MessageDisplayPlugin, MantidQt::MantidWidgets::MessageDisplay,
...
DECLARE_WIDGET_PLUGIN(PreviewPlotPlugin, MantidQt::MantidWidgets::PreviewPlot, "Curve plots for workspace spectra");

DECLARE_WIDGET_PLUGIN(DisplayCurveFitPlugin, MantidQt::MantidWidgets::DisplayCurveFit,
                      "Curve plots for workspace spectra");

DECLARE_WIDGET_PLUGIN(MuonFitDataSelectorPlugin, MantidQt::MantidWidgets::MuonFitDataSelector,
                      "Data selection for muon fits");

DECLARE_WIDGET_PLUGIN(LogValueSelectorPlugin, MantidQt::MantidWidgets::LogValueSelector,
