...
LoadDAEDialog::LoadDAEDialog(QWidget *parent)
    : MantidQt::API::AlgorithmDialog(parent), lineHost(nullptr), lineName(nullptr),
      minSpLineEdit(nullptr), maxSpLineEdit(nullptr), listSpLineEdit(nullptr),
      updateLineEdit(nullptr) {}
