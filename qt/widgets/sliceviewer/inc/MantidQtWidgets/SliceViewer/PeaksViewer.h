...
public:
  ...
  bool removePeaksWorkspace(const std::shared_ptr<const Mantid::API::IPeaksWorkspace> &toRemove);
...
public slots:
  void onPeakColorChanged(Mantid::API::IPeaksWorkspace_const_sptr /*peaksWS*/, PeakViewColor /*newColor*/);
  void onBackgroundColorChanged(Mantid::API::IPeaksWorkspace_const_sptr /*peaksWS*/, PeakViewColor /*newColor*/);
  void onBackgroundRadiusShown(Mantid::API::IPeaksWorkspace_const_sptr /*peaksWS*/, bool /*show*/);
  void onRemoveWorkspace(const Mantid::API::IPeaksWorkspace_const_sptr & /*peaksWS*/);
...
private:
  ...
  std::set<QString> chooseVisibleColumnsFromDialog(const std::set<QString> &columns);
  /// Get a peaks workspaces from the ADS
  Mantid::API::IPeaksWorkspace_const_sptr getPeaksWorkspace(const std::string &name) const;
  ...
  std::string savePresentedWorkspace(const Mantid::API::IPeaksWorkspace_const_sptr &ws) const;
