...
public:
  ...
  void setNonOrthogonal(bool nonOrthogonalEnabled) override { (void)nonOrthogonalEnabled; }
  ...
  PeakViewColor getBackgroundPeakViewColor() const override { return PeakViewColor(); }
  PeakViewColor getForegroundPeakViewColor() const override { return PeakViewColor(); }
  ...
  PeakBoundingBox getBoundingBox(const int /*peakIndex*/) const override { return PeakBoundingBox(); }
  ...
  bool deletePeaksIn(PeakBoundingBox /*plotCoordsBox*/) override { return false; /*Do nothing. Delete nothing.*/ }
