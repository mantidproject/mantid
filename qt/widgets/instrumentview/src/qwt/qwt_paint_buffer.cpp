...
QwtPaintBuffer::QwtPaintBuffer()
    : d_device(0), d_painter(0), d_devicePainter(0) {}
...
/*!
    ...
    \sa close()
*/
QwtPaintBuffer::~QwtPaintBuffer() { close(); }
...
QPainter *QwtPaintBuffer::painter() { return d_painter; }

/*!
  \return Device to paint on
*/
const QPaintDevice *QwtPaintBuffer::device() { return d_device; }
...
*/
void QwtPaintBuffer::setEnabled(bool enable) { d_enabled = enable; }

/*!
  \return true if double buffering is enabled, false otherwise.
*/
bool QwtPaintBuffer::isEnabled() { return d_enabled; }
