...
//! Unite 2 intervals
QwtDoubleInterval
QwtDoubleInterval::unite(const QwtDoubleInterval &other) const {
  /*
...
QwtDoubleInterval
QwtDoubleInterval::intersect(const QwtDoubleInterval &other) const {
...
operator|=(const QwtDoubleInterval &interval) {
  *this = *this | interval;
  return *this;
}
...
QwtDoubleInterval QwtDoubleInterval::extend(double value) const {
  ...
  return QwtDoubleInterval(qwtMin(value, d_minValue), qwtMax(value, d_maxValue),
                           d_borderFlags);
}
