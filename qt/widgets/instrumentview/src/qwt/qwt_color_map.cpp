...
//! Constructor
QwtColorMap::QwtColorMap(Format format) : d_format(format) {}
...
//! Destructor
QwtLinearColorMap::~QwtLinearColorMap() { delete d_data; }

//! Assignment operator
QwtLinearColorMap &QwtLinearColorMap::
operator=(const QwtLinearColorMap &other) {
...
/*!
   ...
   \sa mode()
*/
void QwtLinearColorMap::setMode(Mode mode) { d_data->mode = mode; }

/*!
   \return Mode of the color map
   \sa setMode()
*/
QwtLinearColorMap::Mode QwtLinearColorMap::mode() const { return d_data->mode; }
...
//! Destructor
QwtAlphaColorMap::~QwtAlphaColorMap() { delete d_data; }
...
/*!
  ...
  \sa setColor()
*/
QColor QwtAlphaColorMap::color() const { return d_data->color; }
...
/*!
  ...
  \return Always 0
*/
unsigned char QwtAlphaColorMap::colorIndex(const QwtDoubleInterval &,
                                           double) const {
  return 0;
}
