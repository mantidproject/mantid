...
*/
QwtTextLabel::QwtTextLabel(QWidget *parent) : QFrame(parent) { init(); }
...
//! Destructor
QwtTextLabel::~QwtTextLabel() { delete d_data; }
...
//! Return the text
const QwtText &QwtTextLabel::text() const { return d_data->text; }
...
int QwtTextLabel::indent() const { return d_data->indent; }
...
//! Return label's text indent in pixels
int QwtTextLabel::margin() const { return d_data->margin; }
...
QSize QwtTextLabel::sizeHint() const { return minimumSizeHint(); }
