 ...
 */
void InstrumentWidgetRenderTab::showResetView(int iv) { m_resetViewFrame->setVisible(iv == 0); }
 ...
 */
void InstrumentWidgetRenderTab::saveImage(const QString &filename) { m_instrWidget->saveImage(std::move(filename)); }
