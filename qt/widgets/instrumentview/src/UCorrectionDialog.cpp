 ...
 */
bool UCorrectionDialog::applyCorrection() const { return ui->cbApply->isChecked(); }

/**
 * Get the value of the manual u-correction.
 */
QPointF UCorrectionDialog::getValue() const { return QPointF(ui->dsbUMin->value(), ui->dsbUMax->value()); }
