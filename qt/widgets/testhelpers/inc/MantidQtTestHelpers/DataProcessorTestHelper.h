...
// prefix
DLLExport void addPropertyValue(const MantidQt::MantidWidgets::DataProcessor::RowData_sptr &rowData,
                                const std::vector<std::string> &list, const size_t index, const std::string &property,
...
makeRowData(const std::vector<std::string> &list, const std::vector<std::string> &prefixes = {"TOF_", "", "TRANS_"},
