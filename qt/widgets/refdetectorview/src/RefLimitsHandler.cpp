 ...
 **/
int RefLimitsHandler::getPeakLeft() const { return m_ui->lineEdit_peakLeft->text().toInt(); }

/**
 * return the value of the peak right
 **/
int RefLimitsHandler::getPeakRight() const { return m_ui->lineEdit_peakRight->text().toInt(); }

/**
 * return the value of the back left
 **/
int RefLimitsHandler::getBackLeft() const { return m_ui->lineEdit_backLeft->text().toInt(); }

/**
 * return the value of the back right
 **/
int RefLimitsHandler::getBackRight() const { return m_ui->lineEdit_backRight->text().toInt(); }

/**
 * return the value of the TOF min
 **/
int RefLimitsHandler::getTOFmin() const { return m_ui->lineEdit_TOFmin->text().toInt(); }

/**
 * return the value of the TOF max
 **/
int RefLimitsHandler::getTOFmax() const { return m_ui->lineEdit_TOFmax->text().toInt(); }

/**
 * set the peak left
 */
void RefLimitsHandler::setPeakLeft(const int value) { m_ui->lineEdit_peakLeft->setText(QString::number(value)); }

/**
 * set the peak right
 */
void RefLimitsHandler::setPeakRight(const int value) { m_ui->lineEdit_peakRight->setText(QString::number(value)); }

/**
 * set the back left
 */
void RefLimitsHandler::setBackLeft(const int value) { m_ui->lineEdit_backLeft->setText(QString::number(value)); }

/**
 * set the back right
 */
void RefLimitsHandler::setBackRight(const int value) { m_ui->lineEdit_backRight->setText(QString::number(value)); }

/**
 * set the TOF min
 */
void RefLimitsHandler::setTOFmin(const int value) { m_ui->lineEdit_TOFmin->setText(QString::number(value)); }

/**
 * set the TOF max
 */
void RefLimitsHandler::setTOFmax(const int value) { m_ui->lineEdit_TOFmax->setText(QString::number(value)); }
