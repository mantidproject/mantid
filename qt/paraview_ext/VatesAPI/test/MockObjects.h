...
public:
  ...
  std::string getName() const override { throw std::runtime_error("Not implemented"); }
  const Mantid::Kernel::UnitLabel getUnits() const override { throw std::runtime_error("Not implemented"); }
  ...
  coord_t getX(size_t) const override { throw std::runtime_error("Not implemented"); };
...
public:
  ...
  MOCK_METHOD1(mockSetMDMasking, void(Mantid::Geometry::MDImplicitFunction *ptr));
  void setMDMasking(std::unique_ptr<Mantid::Geometry::MDImplicitFunction> ptr) { mockSetMDMasking(ptr.get()); }
  ...
  Mantid::API::IMDWorkspace::LinePlot getLinePlot(const Mantid::Kernel::VMD &, const Mantid::Kernel::VMD &,
  ...
  createIterators(size_t = 1, Mantid::Geometry::MDImplicitFunction * = NULL) const override {
    throw std::runtime_error("Not Implemented");
  }

  Mantid::signal_t getSignalAtCoord(const Mantid::coord_t *, const Mantid::API::MDNormalization &) const override {
    return 0;
  }

  Mantid::signal_t getSignalWithMaskAtCoord(const Mantid::coord_t *,
...
public:
  ...
  /// non-copyable params.
  virtual void SetSuccessor(std::unique_ptr<vtkDataSetFactory> successor) { setSuccessorProxy(successor.get()); }
...
*/
GNU_UNUSED_FUNCTION vtkFieldData *createFieldDataWithCharArray(std::string testData) {
...
*/
std::string constrctGeometryOnlyXML(const std::string &xDimensionIdMapping, const std::string &yDimensionIdMapping,
                                    const std::string &zDimensionIdMapping, const std::string &tDimensionIdMapping,
                                    std::string xBins = "10", std::string yBins = "10", std::string zBins = "10",
                                    std::string tBins = "10") {
  std::string body =
      std::string("<DimensionSet>") + "<Dimension ID=\"en\">" + "<Name>Energy</Name>" + "<Units>None</Units>" +
      "<UpperBounds>150.0000</UpperBounds>" + "<LowerBounds>0.0000</LowerBounds>" + "<NumberOfBins>" + xBins +
      "</NumberOfBins>" + "</Dimension>" + "<Dimension ID=\"qx\">" + "<Name>Qx</Name>" + "<Units>None</Units>" +
      "<UpperBounds>5.0000</UpperBounds>" + "<LowerBounds>-1.5000</LowerBounds>" + "<NumberOfBins>" + yBins +
      "</NumberOfBins>" + "</Dimension>" + "<Dimension ID=\"qy\">" + "<Name>Qy</Name>" + "<Units>None</Units>" +
      "<UpperBounds>6.6000</UpperBounds>" + "<LowerBounds>-6.6000</LowerBounds>" + "<NumberOfBins>" + zBins +
      "</NumberOfBins>" + "</Dimension>" + "<Dimension ID=\"qz\">" + "<Name>Qz</Name>" + "<Units>None</Units>" +
      "<UpperBounds>6.6000</UpperBounds>" + "<LowerBounds>-6.6000</LowerBounds>" + "<NumberOfBins>" + tBins +
      "</NumberOfBins>" + "</Dimension>" + "<XDimension>" + "<RefDimensionId>" + xDimensionIdMapping +
      "</RefDimensionId>" + "</XDimension>" + "<YDimension>" + "<RefDimensionId>" + yDimensionIdMapping +
      "</RefDimensionId>" + "</YDimension>" + "<ZDimension>" + "<RefDimensionId>" + zDimensionIdMapping +
      "</RefDimensionId>" + "</ZDimension>" + "<TDimension>" + "<RefDimensionId>" + tDimensionIdMapping +
      "</RefDimensionId>" + "</TDimension>" + "</DimensionSet>";
  return body;
}
...
*/
GNU_UNUSED_FUNCTION std::string constructXML(const std::string &xDimensionIdMapping,
...
@return xml snippet as string.
*/
std::string constructGeometryOnlyXMLForMDEvHelperData(const std::string &xDimensionIdMapping,
                                                      const std::string &yDimensionIdMapping,
                                                      const std::string &zDimensionIdMapping,
  ...
  std::string cardDirSpec =
      std::string("<DimensionSet>") + "<Dimension ID=\"Axis0\">" + "<Name>Axis0</Name>" + "<Units>m</Units>" +
      "<UpperBounds>10.0000</UpperBounds>" + "<LowerBounds>0.0000</LowerBounds>" + "<NumberOfBins>" + xBins +
      "</NumberOfBins>" + "</Dimension>" + "<Dimension ID=\"Axis1\">" + "<Name>Axis1</Name>" + "<Units>m</Units>" +
      "<UpperBounds>10.0000</UpperBounds>" + "<LowerBounds>0.0000</LowerBounds>" + "<NumberOfBins>" + yBins +
      "</NumberOfBins>" + "</Dimension>" + "<Dimension ID=\"Axis2\">" + "<Name>Axis2</Name>" + "<Units>m</Units>" +
      "<UpperBounds>10.0000</UpperBounds>" + "<LowerBounds>0.0000</LowerBounds>" + "<NumberOfBins>" + zBins +
      "</NumberOfBins>" + "</Dimension>";
  std::string timeSpec;
  if (!tDimensionIdMapping.empty()) {
    timeSpec = std::string("<Dimension ID=\"Axis3\">") + "<Name>Axis3</Name>" + "<Units>s</Units>" +
               "<UpperBounds>10.0000</UpperBounds>" + "<LowerBounds>0.0000</LowerBounds>" + "<NumberOfBins>" + tBins +
               "</NumberOfBins>" + "</Dimension>";
  }
  std::string cardDirRef = std::string("<XDimension>") + "<RefDimensionId>" + xDimensionIdMapping +
                           "</RefDimensionId>" + "</XDimension>" + "<YDimension>" + "<RefDimensionId>" +
                           yDimensionIdMapping + "</RefDimensionId>" + "</YDimension>" + "<ZDimension>" +
                           "<RefDimensionId>" + zDimensionIdMapping + "</RefDimensionId>" + "</ZDimension>";
  std::string timeRef;
  if (!tDimensionIdMapping.empty()) {
    timeRef =
        std::string("<TDimension>") + "<RefDimensionId>" + tDimensionIdMapping + "</RefDimensionId>" + "</TDimension>";
  } else {
    timeRef = std::string("<TDimension>") + "<RefDimensionId>" + "</RefDimensionId>" + "</TDimension>";
  }
...
@return full xml as string.
*/
GNU_UNUSED_FUNCTION std::string constructXMLForMDEvHelperData(const std::string &xDimensionIdMapping,
                                                              const std::string &yDimensionIdMapping,
                                                              const std::string &zDimensionIdMapping,
                                                              const std::string &tDimensionIdMapping) {
  return std::string("<?xml version=\"1.0\" encoding=\"utf-8\"?>") + "<MDInstruction>" +
         "<MDWorkspaceName>Input</MDWorkspaceName>" +
         "<MDWorkspaceLocation>test_horace_reader.sqw</MDWorkspaceLocation>" +
         constructGeometryOnlyXMLForMDEvHelperData(xDimensionIdMapping, yDimensionIdMapping, zDimensionIdMapping,
                                                   tDimensionIdMapping) +
         "</MDInstruction>";
}
...
Mantid::API::Workspace_sptr createSimple3DWorkspace() {
  ...
  auto create = AlgorithmManager::Instance().createUnmanaged("CreateMDWorkspace");
...
GNU_UNUSED_FUNCTION Mantid::API::Workspace_sptr get3DWorkspace(bool integratedTDimension, bool sliceMD) {
  using namespace Mantid::API;
 ...
 */
GNU_UNUSED_FUNCTION std::string getStringFieldDataValue(vtkDataSet *ds, std::string fieldName) {
