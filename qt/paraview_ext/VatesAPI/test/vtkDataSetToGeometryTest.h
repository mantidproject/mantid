...
private:
  ...
  static std::string constructXML(const std::string &xDimensionIdMapping, const std::string &yDimensionIdMapping,
    ...
    return std::string("<?xml version=\"1.0\" encoding=\"utf-8\"?>") + "<MDInstruction>" + "<DimensionSet>" +
           "<Dimension ID=\"en\">" + "<Name>Energy</Name>" + "<UpperBounds>150</UpperBounds>" +
           "<LowerBounds>0</LowerBounds>" + "<NumberOfBins>5</NumberOfBins>" + "</Dimension>" +
           "<Dimension ID=\"qx\">" + "<Name>Qx</Name>" + "<UpperBounds>5</UpperBounds>" +
           "<LowerBounds>-1.5</LowerBounds>" + "<NumberOfBins>5</NumberOfBins>" + "</Dimension>" +
           "<Dimension ID=\"qy\">" + "<Name>Qy</Name>" + "<UpperBounds>6.6</UpperBounds>" +
           ...
           "<LowerBounds>-6.6</LowerBounds>" + "<NumberOfBins>5</NumberOfBins>" + "</Dimension>" + "<XDimension>" +
...
public:
  void testNoDimensionMappings() {
    ...
    data->SetFieldData(createFieldDataWithCharArray(constructXML("", "", "", ""),
  ...
  void testGetXDimension() {
    using namespace Mantid::VATES;
    vtkNew<vtkRectilinearGrid> data;
    data->SetFieldData(createFieldDataWithCharArray(constructXML("en", "", "", ""),
  ...
  void testAllDimensions() {
    using namespace Mantid::VATES;
    vtkNew<vtkRectilinearGrid> data;
    data->SetFieldData(createFieldDataWithCharArray(constructXML("qy", "qx", "en", "qz"),
  ...
  void testAssignment() {
    ...
    dataA->SetFieldData(createFieldDataWithCharArray(constructXML("qy", "qx", "en", "qz"),
                                                     Mantid::VATES::XMLDefinitions::metaDataId()));

    vtkNew<vtkRectilinearGrid> dataB;
    dataB->SetFieldData(
        createFieldDataWithCharArray(constructXML("", "", "", ""), Mantid::VATES::XMLDefinitions::metaDataId()));
