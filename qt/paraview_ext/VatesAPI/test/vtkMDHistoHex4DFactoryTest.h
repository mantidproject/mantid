...
public:
  void testProgressUpdating() {
    ...
    vtkMDHistoHex4DFactory<TimeStepToTimeStep> factory(Mantid::VATES::VolumeNormalization, 0);
  ...
  void testSignalAspects() {
    ...
    vtkMDHistoHex4DFactory<TimeStepToTimeStep> factory =
        vtkMDHistoHex4DFactory<TimeStepToTimeStep>(Mantid::VATES::VolumeNormalization, 0);
    factory.initialize(ws_sptr);
    ...
    auto signalData = vtkSmartPointer<vtkDataArray>::Take(product->GetCellData()->GetArray(0));
  ...
  void testIsValidThrowsWhenNoWorkspace() {
    ...
    vtkMDHistoHex4DFactory<TimeStepToTimeStep> factory(Mantid::VATES::VolumeNormalization, 1);
  ...
  void testInitializationDelegates() {
    ...
    // mesh information.
    vtkMDHistoHex4DFactory<TimeStepToTimeStep> factory =
        vtkMDHistoHex4DFactory<TimeStepToTimeStep>(Mantid::VATES::VolumeNormalization, (double)0);
