 ...
 */
bool SingleWorkspaceProvider::canProvideWorkspace(std::string) const { return m_workspace != nullptr; }

/**
 * SingleWorkspaceProvider::fetchWorkspace
 * @returns the underlying workspace
 */
Mantid::API::Workspace_sptr SingleWorkspaceProvider::fetchWorkspace(std::string) const { return m_workspace; }
