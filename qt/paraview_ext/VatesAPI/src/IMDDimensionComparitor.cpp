...
IMDDimensionComparitor::IMDDimensionComparitor(Mantid::API::IMDWorkspace_sptr workspace)
    : m_workspace(std::move(workspace)) {}

IMDDimensionComparitor::~IMDDimensionComparitor() {}

bool IMDDimensionComparitor::isXDimension(const Mantid::Geometry::IMDDimension &queryDimension) {
...
bool IMDDimensionComparitor::isYDimension(const Mantid::Geometry::IMDDimension &queryDimension) {
...
bool IMDDimensionComparitor::isZDimension(const Mantid::Geometry::IMDDimension &queryDimension) {
...
bool IMDDimensionComparitor::istDimension(const Mantid::Geometry::IMDDimension &queryDimension) {
