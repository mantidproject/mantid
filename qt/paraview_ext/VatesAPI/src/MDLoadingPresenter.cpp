...
void MDLoadingPresenter::setDefaultCOBandBoundaries(vtkDataSet *visualDataSet) {
  ...
  if (!vtkPVChangeOfBasisHelper::AddChangeOfBasisMatrixToFieldData(visualDataSet, cobMatrix)) {
  ...
  if (!vtkPVChangeOfBasisHelper::AddBoundingBoxInBasis(visualDataSet, boundingBox)) {
