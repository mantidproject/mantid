...
public:
  ...
  Mantid::API::IPeaksWorkspace_sptr getPeaksWorkspace() const override {
    throw std::runtime_error("NullPeaksPresenterVsi does not implement this method. Misused");
  }
  ...
  void getPeaksInfo(Mantid::API::IPeaksWorkspace_sptr, int, Mantid::Kernel::V3D &, double &,
