...
public:
  ...
  vtkDataSetToPeaksFilteredDataSet(const vtkDataSetToPeaksFilteredDataSet &) = default;
  vtkDataSetToPeaksFilteredDataSet &operator=(const vtkDataSetToPeaksFilteredDataSet &) = delete;
  virtual ~vtkDataSetToPeaksFilteredDataSet();
  /// Set the name of the peaks workspace
  void initialize(const std::vector<Mantid::API::IPeaksWorkspace_sptr> &peaksWorkspaces, double radiusNoShape,
                  Geometry::PeakShape::RadiusType radiusType, int coordinateSystem);
...
private:
  ...
  getPeaksInfo(const std::vector<Mantid::API::IPeaksWorkspace_sptr> &peaksWorkspaces);
  ...
  Mantid::Kernel::SpecialCoordinateSystem m_coordinateSystem;       ///< A coordinate system.
