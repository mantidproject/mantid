...
using DimensionVec = std::vector<boost::shared_ptr<Mantid::Geometry::IMDDimension>>;
...
/// virtual.
using Dimension_const_sptr = boost::shared_ptr<const Mantid::Geometry::IMDDimension>;
