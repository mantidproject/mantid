...
private:
  ...
  /// color editor
  static void colorScaleEditedCallbackFunc(vtkObject *caller, long unsigned int eventID, void *clientData,
                                           void *callData);
  /// vtk callback function for user clicks on log-scale in the Paraview color
  /// editor
  static void logScaleClickedCallbackFunc(vtkObject *caller, long unsigned int eventID, void *clientData,
                                          void *callData);
