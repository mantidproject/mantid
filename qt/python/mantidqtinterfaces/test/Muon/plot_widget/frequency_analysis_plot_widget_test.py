...
from mantidqtinterfaces.Muon.GUI.FrequencyDomainAnalysis.plot_widget.frequency_analysis_plot_widget import (
    FrequencyAnalysisPlotWidget,
    MAXENT,
)
...
class FrequencyAnalysisPlotWidgetTest(unittest.TestCase):
    ...
    def setUp(
        self, mock_dual_view, mock_quick_edit, mock_base_view, mock_plot_canvas, mock_main_view, mock_muon_base_view, mock_muon_canvas
    ):
