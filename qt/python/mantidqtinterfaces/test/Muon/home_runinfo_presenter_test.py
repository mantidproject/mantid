...
class HomeTabRunInfoPresenterTest(unittest.TestCase):
    ...
    def test_runinfo_correct(self):
        ...
        self.view.add_text_line.assert_any_call("Counts (MEv)              : 20.076704")
        self.view.add_text_line.assert_any_call("Good Frames               : 88540")
        self.view.add_text_line.assert_any_call("Counts per Good Frame     : 226.753")
        self.view.add_text_line.assert_any_call("Counts per Good Frame per det : 3.543")
        self.view.add_text_line.assert_any_call("Average Temperature (K)   : 19.700")
        self.view.add_text_line.assert_any_call("Sample Temperature (K)    : 1.000")
        self.view.add_text_line.assert_any_call("Sample Magnetic Field (G) : 100.000")
