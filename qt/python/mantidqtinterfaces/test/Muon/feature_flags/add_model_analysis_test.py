...
class AddModelAnalysisTest(unittest.TestCase):
    ...
    def test_add_observers_to_feature(self, mock_model):
        ...
        self.GUI.results_tab.results_tab_presenter.results_table_created_notifier.add_subscriber.assert_called_once_with(
            mock_model.return_value.model_fitting_tab_presenter.results_table_created_observer
        )
    ...
    def test_add_feature_observables(self, mock_model):
        ...
        mock_model.return_value.model_fitting_tab_presenter.remove_plot_guess_notifier.add_subscriber.assert_called_once_with(
            self.GUI.plot_widget.model_fit_mode.remove_plot_guess_observer
        )
        mock_model.return_value.model_fitting_tab_presenter.update_plot_guess_notifier.add_subscriber.assert_called_once_with(
            self.GUI.plot_widget.model_fit_mode.update_plot_guess_observer
        )
        mock_model.return_value.model_fitting_tab_presenter.selected_fit_results_changed.add_subscriber.assert_called_once_with(
            self.GUI.plot_widget.model_fit_mode.plot_selected_fit_observer
        )
        mock_model.return_value.model_fitting_tab_presenter.update_plot_x_range_notifier.add_subscriber.assert_called_once_with(
            self.GUI.plot_widget.model_fit_mode.update_x_range_observer
        )
        mock_model.return_value.model_fitting_tab_presenter.update_override_tick_labels_notifier.add_subscriber.assert_called_once_with(
            self.GUI.plot_widget.model_fit_mode.update_override_tick_labels_observer
        )
