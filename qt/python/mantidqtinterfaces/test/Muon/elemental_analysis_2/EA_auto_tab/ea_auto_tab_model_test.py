...
class EAAutoTabModelTest(unittest.TestCase):
    ...
    @mock.patch("mantidqtinterfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.peak_matching_algorithm")
    @mock.patch("mantidqtinterfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.GroupWorkspaces")
    @mock.patch("mantidqtinterfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.EAAutoTabModel.update_match_table")
