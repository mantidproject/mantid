...
from mantidqtinterfaces.Muon.GUI.Common.plot_widget.quick_edit.quick_edit_view import QuickEditView
from mantidqtinterfaces.Muon.GUI.Common.plot_widget.quick_edit.quick_edit_presenter import DualQuickEditPresenter
