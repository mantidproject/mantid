...
from mantidqtinterfaces.Muon.GUI.Common.ADSHandler.workspace_naming import (MAXENT_STR, get_maxent_workspace_name,
...
from mantidqtinterfaces.Muon.GUI.FrequencyDomainAnalysis.plot_widget.dual_plot_maxent_pane.dual_plot_maxent_pane_model \
     import DualPlotMaxentPaneModel
...
class DuelPlotMaxentPaneModelTest(unittest.TestCase):
    ...
    @mock.patch('mantidqtinterfaces.Muon.GUI.FrequencyDomainAnalysis.plot_widget.'
                'dual_plot_maxent_pane.dual_plot_maxent_pane_model.retrieve_ws')
