...
from mantidqtinterfaces.Muon.GUI.ElementalAnalysis.Plotting.subPlot_object import subPlot
from mantidqtinterfaces.Muon.GUI.ElementalAnalysis.Plotting.plotting_view import PlotView
from mantidqtinterfaces.Muon.GUI.ElementalAnalysis.Plotting.AxisChanger.axis_changer_presenter import AxisChangerPresenter
...
class PlottingViewHelperFunctionTests(unittest.TestCase):
    ...
    @mock.patch("mantidqtinterfaces.Muon.GUI.ElementalAnalysis.Plotting.plotting_utils.get_layout")
