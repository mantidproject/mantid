...
class MuonWorkspaceTest(unittest.TestCase):
    ...
    def test_that_showing_the_workspace_puts_it_in_ADS(self):
        ...
        self.assertCountEqual(ads_workspace.x(0), [1, 2, 3, 4])
        self.assertCountEqual(ads_workspace.y(0), [10, 10, 10, 10])
    ...
    def test_that_workspace_property_returns_workspace_when_not_in_ADS(self):
        ...
        self.assertCountEqual(ws_property.x(0), [1, 2, 3, 4])
        self.assertCountEqual(ws_property.y(0), [10, 10, 10, 10])
