...
class FittingContextTest(unittest.TestCase):
    ...
    def test_items_can_be_added_to_fitting_context(self):
        fit_information_object = FitInformation(mock.MagicMock(), "MuonGuassOsc", mock.MagicMock(), mock.MagicMock(), mock.MagicMock())
        ...
        self.assertEqual(fit_information_object, self.fitting_context.all_latest_fits()[0])
    ...
    def test_fitfunctions_gives_list_of_unique_function_names(self):
        ...
        self.fitting_context.all_latest_fits = mock.MagicMock(
            return_value=[FitInformation(mock.MagicMock(), test_fit_function, mock.MagicMock(), mock.MagicMock(), mock.MagicMock())]
        )

        self.fitting_context.add_fit_from_values(mock.MagicMock(), test_fit_function, mock.MagicMock(), mock.MagicMock(), mock.MagicMock())
        self.fitting_context.add_fit_from_values(mock.MagicMock(), test_fit_function, mock.MagicMock(), mock.MagicMock(), mock.MagicMock())
    ...
    def test_can_add_fits_without_first_creating_fit_information_objects(self):
        ...
        fit_information_object = FitInformation(mock.MagicMock(), fit_function_name, mock.MagicMock(), mock.MagicMock(), mock.MagicMock())

        self.fitting_context.all_latest_fits = mock.MagicMock(return_value=[fit_information_object])

        self.fitting_context.add_fit_from_values(mock.MagicMock(), fit_function_name, mock.MagicMock(), mock.MagicMock(), mock.MagicMock())
    ...
    def test_can_add_fits_with_global_parameters_without_creating_fit_information(self):
        ...
        fit_information_object = FitInformation(
            [input_workspace], fit_function_name, mock.MagicMock(), parameter_workspace, mock.MagicMock(), global_params
        )
    ...
    def test_parameters_are_readonly(self):
        ...
        fit_info = FitInformation(mock.MagicMock(), mock.MagicMock(), mock.MagicMock(), fit_params._parameter_workspace, mock.MagicMock())

        self.assertRaises(AttributeError, setattr, fit_info, "parameters", fit_params)
    ...
    def test_log_names_respects_filter(self):
        ...
        log_names = self.fitting_context.log_names(filter_fn=lambda log: log.name in required_logs)
