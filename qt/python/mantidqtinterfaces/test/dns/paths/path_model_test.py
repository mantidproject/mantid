...
class DNSPathModelTest(unittest.TestCase):
    ...
    @patch('mantidqtinterfaces.dns.paths.path_model.DNSFile')
    @patch('mantidqtinterfaces.dns.paths.path_model.glob.iglob')
    ...
    @patch('mantidqtinterfaces.dns.paths.path_model.os.remove')
    @patch('mantidqtinterfaces.dns.paths.path_model.os.path.isfile')
