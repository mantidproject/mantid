...
from mantidqtinterfaces.dns.data_structures.dns_obs_model import \
    DNSObsModel
from mantidqtinterfaces.dns.data_structures.dns_treemodel import \
    DNSTreeModel
...
class DNSFileSelectorModelTest(unittest.TestCase):
    ...
    @patch('mantidqtinterfaces.dns.file_selector.file_selector_model.'
    ...
    def read3files(self, mock_save):
        ...
        self.model.alldatafiles = get3files()
    ...
    def test_get_start_end_filenumbers(self):
        self.model.alldatafiles = get2files()
    ...
    def test_load_saved_filelist(self, mock_load):
        ...
        for name in [
                'filenumber', 'det_rot', 'sample_rot', 'field', 'temp_samp',
                'sample', 'endtime', 'tofchannels', 'channelwidth', 'filename',
                'wavelength', 'selector_speed', 'scannumber', 'scancommand',
