...
from mantidqtinterfaces.dns_powder_tof.script_generator.tof_powder_script_generator_model import DNSTofPowderScriptGeneratorModel
from mantidqtinterfaces.dns_powder_tof.helpers.helpers_for_testing import get_fake_tof_options, get_file_selector_full_data, get_paths
...
class DNSTofPowderScriptGeneratorModelTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.model._standard_data.format_dataset = mock.Mock(return_value="test")
        cls.model._standard_data.get_empty_scan_name.return_value = "test_empty.d_dat"
        cls.model._standard_data.get_vana_scan_name.return_value = "test_vana.d_dat"
        cls.model._sample_data.get_sample_filename.return_value = "test_sample.d_dat"
    ...
    def test_setup_sample_data(self):
        ...
        self.model._sample_data.format_dataset = mock.Mock(return_value="test2")
    ...
    def test_setup_standard_data(self):
        ...
        self.model._standard_data.format_dataset = mock.Mock(return_value="test")
