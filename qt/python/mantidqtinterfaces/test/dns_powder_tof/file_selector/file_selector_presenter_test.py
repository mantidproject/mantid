...
from mantidqtinterfaces.dns_powder_tof.helpers.helpers_for_testing import get_fileselector_param_dict
...
class DNSFileSelectorPresenterTest(unittest.TestCase):
    ...
    def test___init__(self):
        ...
        self.model.get_standard_data_model.return_value = 1
    ...
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter._filter_scans")
    ...
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter._filter_standard")
    ...
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter._read_all")
    ...
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter._check_all_visible_scans")
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter._read_standard")
    def test_automatic_select_all_standard_files(self, mock_read_standard, mock_check):
        self.model.model_is_standard.return_value = False
        self.presenter._automatic_select_all_standard_files()
        self.presenter._check_all_visible_scans.assert_called_once()
        mock_read_standard.assert_called_once()
        mock_check.assert_called_once()

    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter._get_non_hidden_rows")
    ...
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter.get_option_dict")
    def test_dataset_changed(self, mock_get_option):
        mock_get_option.return_value = {"auto_select_standard": False}
        self.presenter._dataset_changed(True)
        self.model.set_active_model.assert_called_once_with(standard=True)
        self.view.sig_read_all.disconnect.assert_called_once_with(self.presenter._read_all)
        self.view.sig_read_all.connect.assert_called_once_with(self.presenter._read_standard)
        self.model.reset_mock()
        self.view.reset_mock()
        self.presenter._dataset_changed(False)
        self.model.set_active_model.assert_called_once_with()
        self.view.sig_read_all.disconnect.assert_called_once_with(self.presenter._read_standard)
        self.view.sig_read_all.connect.assert_called_once_with(self.presenter._read_all)
    ...
    @patch(
        "mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_"
        "presenter.DNSFileSelectorPresenter._automatic_select_all_standard_files"
    )
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.DNSFileSelectorPresenter.get_option_dict")
    ...
    @patch("mantidqtinterfaces.dns_powder_tof.file_selector.file_selector_" "presenter.print")
