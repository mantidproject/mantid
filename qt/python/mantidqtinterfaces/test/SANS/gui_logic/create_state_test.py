...
class GuiCommonTest(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = mock.patch('mantidqtinterfaces.sans.gui_logic.models.create_state.GuiStateDirector')
    ...
    @mock.patch('mantidqtinterfaces.sans.gui_logic.models.create_state._get_thickness_for_row')
