...
from mantidqtinterfaces.sans.test_helper.mock_objects import create_mock_diagnostics_tab
from mantidqtinterfaces.sans.test_helper.mock_objects import (create_run_tab_presenter_mock)
