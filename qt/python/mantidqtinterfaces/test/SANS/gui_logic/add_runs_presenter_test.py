...
from mantidqtinterfaces.sans.gui_logic.models.sum_runs_model import SumRunsModel
...
from mantidqtinterfaces.sans.gui_logic.presenter.add_runs_presenter import AddRunsPagePresenter, AddRunsFilenameManager
from mantidqtinterfaces.ui.sans_isis.add_runs_page import AddRunsPage
...
class InitializationTest(AddRunsPagePresenterTestCase):
    ...
    @mock.patch('mantidqtinterfaces.sans.gui_logic.presenter.add_runs_presenter.RunSelectionModel', autospec=True)
    @mock.patch('mantidqtinterfaces.sans.gui_logic.presenter.add_runs_presenter.RunSelectorPresenter', autospec=True)
    ...
    @mock.patch('mantidqtinterfaces.sans.gui_logic.presenter.add_runs_presenter.SummationSettingsModel', autospec=True)
    @mock.patch('mantidqtinterfaces.sans.gui_logic.presenter.add_runs_presenter.SummationSettingsPresenter', autospec=True)
