...
from mantidqtinterfaces.sans.gui_logic.presenter.masking_table_presenter import (MaskingTablePresenter, masking_information)
from mantidqtinterfaces.sans.test_helper.mock_objects import (FakeState, create_mock_masking_table, create_run_tab_presenter_mock)
