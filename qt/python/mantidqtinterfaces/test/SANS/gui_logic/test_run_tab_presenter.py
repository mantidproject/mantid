...
from mantidqtinterfaces.sans.gui_logic.models.file_loading import UserFileLoadException
...
from mantidqtinterfaces.sans.test_helper.mock_objects import (create_mock_view)
