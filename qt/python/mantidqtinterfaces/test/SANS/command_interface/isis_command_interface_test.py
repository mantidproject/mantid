...
from mantidqtinterfaces.sans.command_interface.ISISCommandInterface import MaskFile
...
class ISISCommandInterfaceTest(unittest.TestCase):
    ...
    def test_mask_file_for_existing_file(self):
        ...
        with mock.patch('mantidqtinterfaces.sans.command_interface.ISISCommandInterface.find_full_file_path') as mocked_finder:
