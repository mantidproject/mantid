...
class DNSElasticPowderPlotModelTest(unittest.TestCase):
    ...
    def test__convert_x_axis(self):
        test_v = elastic_powder_plot_model._convert_x_axis(self.test_array, 'tt',
                                                           4.74)
        self.assertEqual(test_v[0], 1)
        self.assertEqual(test_v[1], 3)
        test_v = elastic_powder_plot_model._convert_x_axis(self.test_array, 'd',
                                                           4.74)
        self.assertAlmostEqual(test_v[0], 271.58544194790886)
        self.assertAlmostEqual(test_v[1], 90.53767353344176)
        test_v = elastic_powder_plot_model._convert_x_axis(self.test_array, 'q',
                                                           4.74)
    ...
    def test__scale_simulation(self):
        test_v = elastic_powder_plot_model._scale_simulation('a',
                                                             self.test_array,
                                                             self.test_array, 5)
        self.assertEqual(test_v[0][0], 1)
        test_v = elastic_powder_plot_model._scale_simulation('simulation',
                                                             self.test_array,
                                                             self.test_array, 5)
