...
class DNSElasticPowderScriptGeneratorModelTest(unittest.TestCase):
    ...
    def test_check_all_fields_there(self):
        test_v = self.model._check_xyz_separation(
    ...
    def test_get_xyz_lines(self):
        ...
        self.assertEqual(
            test_v[4], "SaveAscii('mat_knso_magnetic', '1234//kns"
                       "o_magnetic.csv', Wr"
    ...
    def test_get_nonmag_lines(self):
        ...
        self.assertEqual(
            test_v[1],
            "knso_x_nuclear_coh, knso_x_spin_incoh = non_magnetic_separation('knso_x_sf',"
            " 'knso_x_nsf')")
        self.assertEqual(
            test_v[2],
        ...
        self.assertEqual(
            test_v[6],
            "knso_y_nuclear_coh, knso_y_spin_incoh = non_magnetic_separation('knso_y_sf'"
            ", 'knso_y_nsf')")
        self.assertEqual(
            test_v[7],
        ...
        self.assertEqual(
            test_v[11],
            "knso_z_nuclear_coh, knso_z_spin_incoh = non_magnetic_separation('knso_z_sf',"
            " 'knso_z_nsf')")
        self.assertEqual(
            test_v[12],
    ...
    def test_get_header_lines(self):
        ...
        self.assertEqual(
            test_v[0], "from mantidqtinterfaces.dns_powder_elastic.scripts."
                       "md_powder_elastic import "
                       "load_all, background_subtraction")
        self.assertEqual(
            test_v[1], "from mantidqtinterfaces.dns_powder_elastic.scripts."
                       "md_powder_elastic import "
                       "vanadium_correction, flipping_ratio_correction")
        self.assertEqual(
            test_v[2], "from mantidqtinterfaces.dns_powder_elastic.scripts."
                       "md_powder_elastic import "
    ...
    @patch('mantidqtinterfaces.dns_powder_elastic.script_generator.'
           'elastic_powder_script_generator_model.DNSElasticDataset')
