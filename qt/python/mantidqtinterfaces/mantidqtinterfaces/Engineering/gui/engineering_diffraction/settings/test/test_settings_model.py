...
class SettingsModelTest(unittest.TestCase):
    ...
    def test_set_setting(self, set_setting_mock):
        ...
        set_setting_mock.assert_called_with("CustomInterfaces", "EngineeringDiffraction2/", "name", "value", rb=None)

    @patch(dir_path + "settings_model.set_setting")
    def test_set_setting_passes_rb_through(self, set_setting_mock):
        self.model.set_setting("name", "value", rb="12345")
        set_setting_mock.assert_called_with("CustomInterfaces", "EngineeringDiffraction2/", "name", "value", rb="12345")

    @patch(dir_path + "settings_model.get_setting")
    def test_get_setting(self, get_setting_mock):
        self.model.get_setting("name")
        get_setting_mock.assert_called_with("CustomInterfaces", "EngineeringDiffraction2/", "name", return_type=str, rb=None)

    @patch(dir_path + "settings_model.get_setting")
    def test_get_setting_passes_rb_through(self, get_setting_mock):
        self.model.get_setting("name", rb="12345")
        get_setting_mock.assert_called_with("CustomInterfaces", "EngineeringDiffraction2/", "name", return_type=str, rb="12345")
    ...
    def test_set_settings_dict(self, set_setting_mock):
        ...
        set_setting_mock.assert_any_call("CustomInterfaces", "EngineeringDiffraction2/", "name", "value", rb=None)
        set_setting_mock.assert_any_call("CustomInterfaces", "EngineeringDiffraction2/", "namebool", False, rb=None)
        set_setting_mock.assert_any_call("CustomInterfaces", "EngineeringDiffraction2/", "namenum", 10, rb=None)
