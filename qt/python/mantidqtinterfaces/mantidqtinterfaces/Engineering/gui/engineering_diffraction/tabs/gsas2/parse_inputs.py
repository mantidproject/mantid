...
class Gsas2Inputs:
    ...
    def __init__(self, *, path_to_gsas2, temporary_save_directory, project_name,
                 refinement_method, refine_background, refine_microstrain, refine_sigma_one,
                 refine_gamma, refine_histogram_scale_factor, data_files,
                 phase_files, instrument_files, limits, mantid_pawley_reflections,
                 override_cell_lengths, refine_unit_cell, d_spacing_min, number_of_regions):
