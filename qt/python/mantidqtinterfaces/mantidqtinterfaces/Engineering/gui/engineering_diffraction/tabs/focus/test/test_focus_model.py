...
from Engineering.EnggUtils import GROUP, _save_output_files, _load_run_and_convert_to_dSpacing, process_vanadium
...
class FocusModelTest(unittest.TestCase):
    ...
    def test_save_output_files_both_banks_no_RB_number_path_exists(self, mock_add_log, mock_save_nxs, mock_save_gss,
        ...
        save_nxs_calls = [call(InputWorkspace=ws_foc, Filename=focused_files[0], WorkspaceIndexList=[0]),
