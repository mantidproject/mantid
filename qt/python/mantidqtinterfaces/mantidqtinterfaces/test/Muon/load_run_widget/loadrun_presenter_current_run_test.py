...
class LoadRunWidgetLoadCurrentRunTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = mock.patch('scientific_interfaces.Muon.GUI.Common.load_run_widget.load_run_model.load_utils')
    ...
    @patch("scientific_interfaces.Muon.GUI.Common.load_run_widget.load_run_presenter.thread_model.warning")
