...
from mantidqtinterfaces.Muon.GUI.Common.utilities.muon_test_helpers import IteratorWithException
...
class LoadRunWidgetModelTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.Common.load_run_widget.load_run_model.load_utils')
