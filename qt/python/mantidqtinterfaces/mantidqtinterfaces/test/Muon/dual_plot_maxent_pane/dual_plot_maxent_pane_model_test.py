...
from mantidqtinterfaces.Muon.GUI.Common.ADSHandler.workspace_naming import (MAXENT_STR, get_maxent_workspace_name, get_raw_data_workspace_name,
...
class DuelPlotMaxentPaneModelTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.FrequencyDomainAnalysis.plot_widget.dual_plot_maxent_pane.dual_plot_maxent_pane_model.retrieve_ws')
