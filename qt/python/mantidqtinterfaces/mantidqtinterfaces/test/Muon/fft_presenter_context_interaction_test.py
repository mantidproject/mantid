...
class FFTPresenterTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.FrequencyDomainAnalysis.FFT.fft_presenter.run_PaddingAndApodization')
    @mock.patch('scientific_interfaces.Muon.GUI.FrequencyDomainAnalysis.FFT.fft_presenter.run_FFT')
    @mock.patch('scientific_interfaces.Muon.GUI.FrequencyDomainAnalysis.FFT.fft_presenter.convert_to_field')
