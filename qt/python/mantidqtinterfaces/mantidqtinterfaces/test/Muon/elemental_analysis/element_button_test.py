...
from mantidqtinterfaces.Muon.GUI.ElementalAnalysis.PeriodicTable.periodic_table import ColoredPeriodicTableItem, _ElementButton
...
class _ElementButtonTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.PeriodicTable.periodic_table._ElementButton._setBrush')
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.PeriodicTable.periodic_table.QtGui.QBrush')
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.PeriodicTable.periodic_table.QtWidgets.QPushButton.paintEvent')
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.PeriodicTable.periodic_table.QtGui.QPainter.fillRect')
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.PeriodicTable.periodic_table.QtWidgets.QPushButton.paintEvent')
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.PeriodicTable.periodic_table.QtGui.QPen.setWidth')
