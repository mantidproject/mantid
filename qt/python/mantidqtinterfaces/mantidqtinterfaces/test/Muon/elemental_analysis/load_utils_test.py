...
class LoadUtilsTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_utils.glob.iglob')
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_utils.os.path.join')
