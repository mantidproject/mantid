...
class LModelTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_utils.mantid')
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_utils.merge_workspaces')
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_utils.search_user_dirs')
