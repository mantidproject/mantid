...
class CoLoadModel(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_model.lutils.replace_workspace_name_suffix')
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_model.mantid')
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis.LoadWidget.load_model.lutils')
