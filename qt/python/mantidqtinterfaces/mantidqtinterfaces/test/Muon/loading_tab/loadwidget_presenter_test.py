...
class LoadRunWidgetPresenterTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.load_patcher = mock.patch(
            'scientific_interfaces.Muon.GUI.Common.load_file_widget.model.load_utils.load_workspace_from_filename')
        self.addCleanup(self.load_patcher.stop)
        self.load_mock = self.load_patcher.start()

        self.load_run_patcher = mock.patch(
            'scientific_interfaces.Muon.GUI.Common.load_run_widget.load_run_model.load_utils.load_workspace_from_filename')
        ...
        self.popup_patcher = mock.patch('scientific_interfaces.Muon.GUI.Common.thread_model.warning')
