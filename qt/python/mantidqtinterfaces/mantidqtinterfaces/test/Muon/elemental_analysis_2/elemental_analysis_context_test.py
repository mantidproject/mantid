...
class ElementalAnalysisContextTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis2.context.context.retrieve_ws')
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis2.context.context.remove_ws_if_present')
    @mock.patch('scientific_interfaces.Muon.GUI.ElementalAnalysis2.context.ea_group_context.EAGroupContext.__getitem__')
...
class EAGroupContextTest(unittest.TestCase):
    ...
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.ea_group.EAGroup.remove_rebinned_workspace")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.ea_group.EAGroup.remove_peak_table")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.ea_group.EAGroup.remove_matches_group")
    ...
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.ea_group.remove_ws_if_present")
