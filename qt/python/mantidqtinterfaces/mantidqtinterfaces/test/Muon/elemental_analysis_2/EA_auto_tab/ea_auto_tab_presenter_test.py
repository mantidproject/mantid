...
from mantidqtinterfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model import PEAKS_WS_SUFFIX, MATCH_GROUP_WS_SUFFIX
...
class EAAutoTabPresenterTest(unittest.TestCase):
    ...
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_presenter.EAAutoPopupTable")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_presenter.check_if_workspace_exist")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_presenter.retrieve_ws")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_presenter.EAAutoTabPresenter.extract_rows")
    ...
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_presenter.message_box.warning")
