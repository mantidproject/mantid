...
class EAAutoTabModelTest(unittest.TestCase):
    ...
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.retrieve_ws")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.EAAutoTabModel._run_find_peak_algorithm")
    @mock.patch(
        "scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.EAAutoTabModel._run_peak_matching_algorithm")
    ...
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.retrieve_ws")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.remove_ws")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.find_peak_algorithm")
    ...
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.peak_matching_algorithm")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.GroupWorkspaces")
    @mock.patch("scientific_interfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model.EAAutoTabModel.update_match_table")
