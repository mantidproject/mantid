...
class PhaseTablePresenterTest(unittest.TestCase):
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.Common.phase_table_widget.phase_table_presenter.MuonWorkspaceWrapper')
    ...
    @mock.patch('scientific_interfaces.Muon.GUI.Common.phase_table_widget.phase_table_presenter.run_CalMuonDetectorPhases')
