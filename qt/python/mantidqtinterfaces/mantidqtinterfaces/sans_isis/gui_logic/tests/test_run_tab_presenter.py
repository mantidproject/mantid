...
class RunTabPresenterTest(unittest.TestCase):
    ...
    def test_setup_instrument_specific_settings(self):
        ...
        self.presenter._view.set_instrument_settings.assert_called_once_with(instrument)
        self.presenter._beam_centre_presenter.on_update_instrument.assert_called_once_with(instrument)
        self.presenter._workspace_diagnostic_presenter.set_instrument_settings.assert_called_once_with(instrument)
