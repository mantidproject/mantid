...
class PlotDataPaneModel(PlotGroupPairModel):
    def __init__(self, context):
        ...
        self.context.plot_panes_context[self.name].set_defaults([0.0, 15.0], [-0.3, 0.3])
    ...
    def get_time_workspaces_to_plot(self, current_group_pair, is_raw, plot_type):
        ...
        try:
            ...
            if plot_type == "Counts":
                workspace_list = [item.replace("Asymmetry", "Counts") for item in workspace_list if "Asymmetry" in item]
