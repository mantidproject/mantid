...
class RawPaneModel(BasePaneModel):
    def __init__(self, context):
        ...
        self.context.plot_panes_context[self.name].set_defaults([0.0, 9.9], [0.0, 1e3])
    ...
    def get_ws_names(self, run_string, multi_period, period, detectors: str):
        name = get_raw_data_workspace_name(
            self.context.data_context.instrument, run_string, multi_period, period=period, workspace_suffix=self.context.workspace_suffix
        )
