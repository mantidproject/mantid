...
from mantidqtinterfaces.Muon.GUI.Common.home_tab.home_tab_model import HomeTabModel
from mantidqtinterfaces.Muon.GUI.Common.home_tab.home_tab_view import HomeTabView
...
class HomeTabWidget(object):
    def __init__(self, context, parent):
        ...
        self.home_tab_widget = HomeTabPresenter(
            self.home_tab_view, self.home_tab_model, subwidgets=[self.instrument_widget, self.run_info_widget]
        )
