...
class FrequencyDomainAnalysisContext(MuonContext):
    def __init__(
        ...
        super().__init__(
            ...
            model_fitting_context=model_fitting_context,
    ...
    def get_workspace_names_for_FFT_analysis(self, use_raw=True):
        ...
        workspace_options = self.get_names_of_time_domain_workspaces_to_fit(runs="All", group_and_pair=groups_and_pairs, rebin=not use_raw)
        return workspace_options

    def get_workspace_names_for(self, runs="", group_and_pair="", rebin=False):
    ...
    def get_names_of_frequency_domain_workspaces_to_fit(self, runs="", group_and_pair="", frequency_type="None"):
