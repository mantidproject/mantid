...
from mantidqtinterfaces.Muon.GUI.Common.results_tab_widget.results_tab_view import ResultsTabView
...
class ResultsTabWidget(object):
    ...
    def __init__(self, fit_context, context, parent):
        ...
        self.results_tab_presenter = ResultsTabPresenter(self.results_tab_view, ResultsTabModel(fit_context, context.results_context))
