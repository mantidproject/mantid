...
from mantidqtinterfaces.Muon.GUI.ElementalAnalysis2.context.context import REBINNED_VARIABLE_WS_SUFFIX, REBINNED_FIXED_WS_SUFFIX
from mantidqtinterfaces.Muon.GUI.ElementalAnalysis2.auto_widget.ea_auto_tab_model import (
    PEAKS_WS_SUFFIX,
...
INVALID_STRINGS_FOR_GROUP_NAMES = [
    REBINNED_VARIABLE_WS_SUFFIX,
