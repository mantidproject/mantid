...
from mantidqtinterfaces.Muon.GUI.FrequencyDomainAnalysis.MaxEnt.maxent_view import MaxEntView
from mantidqtinterfaces.Muon.GUI.FrequencyDomainAnalysis.MaxEnt.maxent_presenter import MaxEntPresenter
