...
from mantidqtinterfaces.Muon.GUI.FrequencyDomainAnalysis.Transform.transform_view import TransformView

from mantidqtinterfaces.Muon.GUI.FrequencyDomainAnalysis.TransformSelection.transform_selection_widget import TransformSelectionWidget
...
class TransformWidget(QtWidgets.QWidget):
    def __init__(self, context, fft_widget, maxent_widget, parent=None):
        ...
        try:
            self.context.update_view_from_model_notifier.add_subscriber(self.update_view_from_model_observer)
        except:
            pass
