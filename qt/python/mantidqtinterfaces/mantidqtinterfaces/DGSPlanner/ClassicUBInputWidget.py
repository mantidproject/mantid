...
class ClassicUBInputWidget(QtWidgets.QWidget):
    ...
    def __init__(self, ol=None, parent=None):
        ...
        # validators
        self.latticeLengthValidator = QtGui.QDoubleValidator(0.1, 1000.0, 5, self)
        self.latticeAngleValidator = QtGui.QDoubleValidator(5.0, 175.0, 5, self)
        ...
        self._edita.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editb.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editc.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editalpha.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editbeta.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editgamma.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editux.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._edituy.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._edituz.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editvx.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editvy.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        self._editvz.setFixedWidth(metrics.horizontalAdvance("8888.88888"))
        # layout
    ...
    def validateAll(self):
        ...
        if (
            self.latt_alpha < 5
            or self.latt_alpha > 175
            or self.latt_beta < 5
            or self.latt_beta > 175
            or self.latt_gamma < 5
            or self.latt_gamma > 175
        ):
            return
