...
class ErrorReportPresenterTest(unittest.TestCase):
    ...
    def test_send_error_report_to_server_calls_ErrorReport_correctly(self):
        ...
        self.errorreport_mock.assert_called_once_with(self.app_name, uptime, self.exit_code, False, name, email,
                                                      text_box, '')
    ...
    def test_send_error_report_to_server_calls_ErrorReport_correctly_and_triggers_view_upon_failure(self):
        ...
        self.errorreport_mock.assert_called_once_with(self.app_name, uptime, self.exit_code, True, name, email,
                                                      text_box, '')
        self.errorreport_mock_instance.sendErrorReport.assert_called_once_with()
    ...
    def test_error_handler_share_all_sunny_day_case(self):
        ...
        self.error_report_presenter._send_report_to_server.called_once_with(share_identifiable=True,
                                                                            name=name,
                                                                            email=email,
                                                                            uptime=mock.ANY,
                                                                            text_box=text_box)
