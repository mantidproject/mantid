...
class WorkspaceCalculatorViewTest(unittest.TestCase, QtWidgetFinder):
    ...
    def test_validator(self):
        ...
        self.assertTrue(scale_validator.validate('1.0', 1), QtGui.QValidator.Acceptable)
        self.assertTrue(scale_validator.validate('1e3', 1), QtGui.QValidator.Acceptable)
        self.assertTrue(scale_validator.validate('0', 1), QtGui.QValidator.Intermediate)
        self.assertTrue(scale_validator.validate('not_at_number', 1), QtGui.QValidator.Invalid)
        self.assertTrue(scale_validator.validate('1e', 1), QtGui.QValidator.Invalid)
