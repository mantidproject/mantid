...
class AlgorithmFactoryObserverTest(unittest.TestCase):
    ...
    def test_can_toggle_algorithm_factory_notifications(self):
        ...
        self.assertTrue(
            notifyee.refresh.call_count == 0, "We expect the widget to be refreshed when the Algorithm Factory "
    ...
    def test_that_selector_is_refreshed_on_alg_sibscribe_from_same_thread(self):
        ...
        self.assertTrue(
            notifyee.refresh.call_count == 1, f"We expect the widget to be refreshed when the Algorithm Factory "
    ...
    def test_that_selector_is_refreshed_on_alg_subscribe_from_a_different_thread(self, mock_qappcall):
        notifyee = MagicMock()
        # variable keeps object alive
        _ = AlgorithmSelectorFactoryObserver(notifyee)  # noqa: F841
        ...
        self.assertTrue(
            mock_qappcall.call_count == 1, f"We expect the widget to be refreshed when the Algorithm Factory "
            f"subscribes to a new algorithm. refresh was called "
