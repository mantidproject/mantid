...
class SuperplotViewTest(unittest.TestCase):
    ...
    def test_getSideWidget(self):
        self.assertEqual(self.view.getSideWidget(), self.view._sideView)

    def test_getBottomWidget(self):
        self.assertEqual(self.view.getBottomWidget(), self.view._bottomView)
    ...
    def test_getSelectedWorkspace(self):
        self.view.getSelectedWorkspace()
    ...
    def test_getSelection(self):
        ...
        self.mDockSide.workspacesList.selectedItems.return_value = [sp1Item,
                                                                    sp2Item,
                                                                    ws2Item]
        self.assertDictEqual(self.view.getSelection(), {"ws1": [1, 2],
                                                        "ws2": [-1]})
    ...
    def test_modifySpectrumLabel(self):
        ...
        self.view.modifySpectrumLabel("wsName", 1, "label", "#000000")
    ...
    def test_setWorkspacesList(self):
        self.view.setWorkspacesList(["ws1", "ws2", "ws3"])
    ...
    def test_setSpectraList(self):
        ...
        self.view.setSpectraList("wsName", [1, 2, 3])
    ...
    def test_getSpectraList(self):
        ...
        self.assertEqual(self.view.getSpectraList("wsName"), [1, 2])

    def test_checkHoldButton(self):
        widget = self.mDockBottom.holdButton
        self.view.checkHoldButton(True)
    ...
    def test_setSpectrumDisabled(self):
        ...
        self.view.setSpectrumDisabled(True)
