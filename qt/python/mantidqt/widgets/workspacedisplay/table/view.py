...
class TableWorkspaceDisplayView(QTableWidget):
    ...
    def __init__(self, presenter, parent=None):
        ...
        self.DELETE_ROW = mantidqt.icons.icons.get_icon("fa.minus-square-o")
        self.STATISTICS_ON_ROW = mantidqt.icons.icons.get_icon('fa.fighter-jet')
        self.GRAPH_ICON = mantidqt.icons.icons.get_icon('fa.line-chart')
        self.TBD = mantidqt.icons.icons.get_icon('fa.question')
