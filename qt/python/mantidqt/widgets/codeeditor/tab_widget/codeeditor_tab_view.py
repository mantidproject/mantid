...
class CodeEditorTabWidget(QTabWidget):
    ...
    def setup_options_actions(self, parent):
        ...
        tabs_to_spaces_action = create_action(self,
                                              'Tabs to Spaces',
                                              on_triggered=parent.tabs_to_spaces_current,
                                              shortcut_visible_in_context_menu=True)

        spaces_to_tabs_action = create_action(self,
                                              'Spaces to Tabs',
                                              on_triggered=parent.spaces_to_tabs_current,
                                              shortcut_visible_in_context_menu=True)

        toggle_whitespace_action = create_action(self,
        ...
        editor_actions = [
            run_action, run_all_action, abort_action, None, toggle_find_replace, None, toggle_comment_action,
            toggle_whitespace_action, None, tabs_to_spaces_action, spaces_to_tabs_action
        ]
