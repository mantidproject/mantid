...
from mantidqt.widgets.commonworkspacedisplay.test_mocks.mock_qt import MockQStatusBar
...
class UserNotifierTest(unittest.TestCase):
    ...
    @patch('mantidqt.widgets.commonworkspacedisplay.user_notifier.UserNotifier.show_mouse_toast')
