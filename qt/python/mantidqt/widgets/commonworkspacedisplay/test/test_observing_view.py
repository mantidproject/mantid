...
from mantidqt.widgets.commonworkspacedisplay.test_mocks.mock_observing import MockObservingView
from mantidqt.widgets.commonworkspacedisplay.test_mocks.mock_qt import MockQtEvent
