...
def main(argv: Sequence[str] = None) -> int:
    ...
    # module was generated by pyrcc5 and is checked in; the rcc data format and
    # the qRegisterResourceData API it uses are supported by PyQt6, which ships
    # no resource compiler of its own.
