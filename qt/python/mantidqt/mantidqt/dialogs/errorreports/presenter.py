...
class ErrorReporterPresenter(object):
    ...
    def __init__(self, view, exit_code: str, application: str, ppid: str, traceback: Optional[str] = None):
        """
        ...
        if not traceback:
            ...
            try:
                if os.path.isfile(traceback_file_path):
                    ...
                    self._cpp_traces = retrieve_thread_traces_from_coredump_file(ppid)
            except OSError:
                pass
