...
class UserNotifierTest(unittest.TestCase):
    ...
    def test_notify_no_selection_to_copy(self, mock_show_mouse_toast):
        ...
        self.user_notifier._status_bar.showMessage.assert_called_once_with(
            self.user_notifier.NO_SELECTION_MESSAGE, self.user_notifier.DEFAULT_TIMEOUT
        )
    ...
    def test_notify_successful_copy(self, mock_show_mouse_toast):
        ...
        self.user_notifier._status_bar.showMessage.assert_called_once_with(
            self.user_notifier.COPY_SUCCESSFUL_MESSAGE, self.user_notifier.DEFAULT_TIMEOUT
        )
    ...
    def test_notify_working(self, mock_show_mouse_toast):
        ...
        self.user_notifier._status_bar.showMessage.assert_called_once_with(
            self.user_notifier.WORKING_MESSAGE, self.user_notifier.DEFAULT_TIMEOUT
        )
