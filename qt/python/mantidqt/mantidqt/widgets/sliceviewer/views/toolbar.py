...
class SliceViewerNavigationToolbar(MantidNavigationToolbar):
    ...
    toolitems = (
        ...
        MantidNavigationTool(ToolItemText.APPLY_MASKING, "Apply drawn mask", "mdi.checkbox-marked-outline", "applyMaskingClicked", False),
        MantidNavigationTool(ToolItemText.EXPORT_MASKING, "Export drawn mask to table", "mdi.export", "exportMaskingClicked", False),
        MantidStandardNavigationTools.SEPARATOR,
