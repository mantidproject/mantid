...
class TestCutViewerModel(unittest.TestCase):
    ...
    def test_validate_vectors_when_new_vector_in_slice_plane(self):
        self.assertTrue(array_equal(self.model.validate_vectors(0, 1, array([[1, 1, 0], [0, 1, 0], [0, 0, 1]])),
    ...
    def test_validate_vectors_when_new_vector_out_of_slice_plane(self):
        ...
        self.assertTrue(array_equal(self.model.validate_vectors(0, 1, array([[1, 0, 1], [0, 1, 0], [0, 0, 1]])),
                                    eye(3)))
