...
class TestFullInstrumentViewModel(unittest.TestCase):
    ...
    def test_get_default_projection_3D(self):
        model, mock_workspace = self._setup_model([1, 2, 3])
        mock_workspace.instrumentMetadata = MagicMock(return_value=MagicMock(defaultView=MagicMock(return_value="3D")))
    ...
    def test_get_default_projection_non_3D(self):
        model, mock_workspace = self._setup_model([1, 2, 3])
        mock_workspace.instrumentMetadata = MagicMock(return_value=MagicMock(defaultView=MagicMock(return_value="SPHERICAL_X")))
