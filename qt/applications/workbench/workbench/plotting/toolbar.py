...
class WorkbenchNavigationToolbar(NavigationToolbar2QT):
    ...
    toolitems = (('Home', 'Reset axes limits', 'mdi.home', 'on_home_clicked',
                  None), ('Back', 'Back to previous view', 'mdi.arrow-left', 'back',
                          None), ('Forward', 'Forward to next view', 'mdi.arrow-right', 'forward',
                                  None), (None, None, None, None, None), ('Pan', 'Pan: L-click \nStretch: R-click',
                                                                          'mdi.arrow-all', 'pan', False),
                 ('Zoom', 'Zoom \n In: L-click+drag \n Out: R-click+drag', 'mdi.magnify', 'zoom',
                  False), (None, None, None, None, None), ('Grid', 'Grids on/off', 'mdi.grid', 'toggle_grid', False),
                 ('Copy', 'Copy image to clipboard', 'mdi.content-copy', 'copy_to_clipboard',
                  None), ('Save', 'Save image file', 'mdi.content-save', 'save_figure',
                          None), ('Print', 'Print image', 'mdi.printer', 'print_figure', None),
                 (None, None, None, None, None), ('Customize', 'Options menu', 'mdi.settings', 'launch_plot_options',
                                                  None), (None, None, None, None, None),
                 ('Create Script', 'Generate script to recreate the current figure', 'mdi.script-text-outline',
                  'generate_plot_script', None), (None, None, None, None,
                                                  None), ('Fit', 'Open/close fitting tab', None, 'toggle_fit',
                                                          False), (None, None, None, None, None),
                 ('Offset', 'Adjust curve offset %', 'mdi.arrow-expand-horizontal', 'waterfall_offset_amount',
                  None), ('Reverse Order', 'Reverse curve order', 'mdi.swap-horizontal', 'waterfall_reverse_order',
                          None), ('Fill Area', 'Fill area under curves', 'mdi.format-color-fill', 'waterfall_fill_area',
                                  None), (None, None, None, None, None), ('Help', 'Open plotting help documentation',
                                                                          'mdi.help', 'launch_plot_help', None))
    ...
    def _init_toolbar(self):
        ...
        if self.coordinates:
            ...
            self.locLabel.setSizePolicy(QtWidgets.QSizePolicy(QtWidgets.Expanding, QtWidgets.QSizePolicy.Ignored))
