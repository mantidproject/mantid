...
class PlotsSettingsModelTest(BaseSettingsModelTest):
    ...
    def test_get_x_min(self, get_saved_value_mock: MagicMock):
        self._test_getter_with_different_values(get_saved_value_mock, self.model.get_x_min, ["5", "-5"], call(PlotProperties.X_MIN.value))

    @patch(GET_SAVED_VALUE_PATCH_PATH)
    def test_get_x_max(self, get_saved_value_mock: MagicMock):
        self._test_getter_with_different_values(get_saved_value_mock, self.model.get_x_max, ["5", "-5"], call(PlotProperties.X_MAX.value))

    @patch(GET_SAVED_VALUE_PATCH_PATH)
    def test_get_y_min(self, get_saved_value_mock: MagicMock):
        self._test_getter_with_different_values(get_saved_value_mock, self.model.get_y_min, ["5", "-5"], call(PlotProperties.Y_MIN.value))

    @patch(GET_SAVED_VALUE_PATCH_PATH)
    def test_get_y_max(self, get_saved_value_mock: MagicMock):
        self._test_getter_with_different_values(get_saved_value_mock, self.model.get_y_max, ["5", "-5"], call(PlotProperties.Y_MAX.value))
    ...
    def test_set_show_title(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_show_title, ["Off", "On"], PlotProperties.SHOW_TITLE.value)
    ...
    def test_set_line_width(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_line_width, ["3", "4.1"], PlotProperties.LINE_WIDTH.value)

    @patch(ADD_CHANGE_PATCH_PATH)
    def test_set_x_min(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_x_min, ["5", "-3.8"], PlotProperties.X_MIN.value)

    @patch(ADD_CHANGE_PATCH_PATH)
    def test_set_x_max(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_x_max, ["5", "-3.8"], PlotProperties.X_MAX.value)

    @patch(ADD_CHANGE_PATCH_PATH)
    def test_set_y_min(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_y_min, ["5", "-3.8"], PlotProperties.Y_MIN.value)

    @patch(ADD_CHANGE_PATCH_PATH)
    def test_set_y_max(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_y_max, ["5", "-3.8"], PlotProperties.Y_MAX.value)
    ...
    def test_set_error_width(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_error_width, ["5", "20"], PlotProperties.ERROR_WIDTH.value)

    @patch(ADD_CHANGE_PATCH_PATH)
    def test_set_capsize(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_capsize, ["5", "20"], PlotProperties.CAPSIZE.value)
    ...
    def test_set_error_every(self, add_change_mock: MagicMock):
        self._test_setter_with_different_values(add_change_mock, self.model.set_error_every, ["5", "20"], PlotProperties.ERROR_EVERY.value)
