...
from workbench.widgets.settings.newtab.presenter import NewTabSettings
...
class SettingsPresenter(object):
    ...
    SETTINGS_TABS = {'general_settings' : "General",
                     'newtab_settings' : "Tab Name"}

    def __init__(self, parent, view=None, general_settings=None, newtab_settings=None):
        ...
        self.newtab_settings = newtab_settings if newtab_settings else NewTabSettings(parent)
        self.parent = parent
        ...
        self.view.container.addWidget(self.newtab_settings.view)
