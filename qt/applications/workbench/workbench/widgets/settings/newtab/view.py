...
form, base = load_ui(__file__, "tab.ui")


class NewTabSettingsView(form, base):
    """
    ...
    def __init__(self, parent=None, presenter=None):
        super(NewTabSettingsView, self).__init__(parent)
        self.setupUi(self)
    ...
    def closeEvent(self, event):
        self.deleteLater()
        super(NewTabSettingsView, self).closeEvent(event)
