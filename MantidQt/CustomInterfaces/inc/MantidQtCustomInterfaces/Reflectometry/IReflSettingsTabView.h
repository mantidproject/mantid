...
public:
  ...
  virtual void createPlusHints(const std::map<std::string, std::string> &hints) = 0;
  virtual void createTransmissionHints(const std::map<std::string, std::string> &hints) = 0;
  /// Processing
  virtual std::string getReductionOptions() const = 0;
  virtual void createReductionHints(const std::map<std::string, std::string> &hints) = 0;
  /// Post-processing
  virtual std::string getStitchOptions() const = 0;
  virtual void createStitchHints(const std::map<std::string, std::string> &hints) = 0;
};
}
}
