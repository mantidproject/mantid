...
std::string DLLExport tableString(QReflTableModel_sptr model,
                                  ColNumbers col_nums,
...
boost::tuple<std::string, std::string> DLLExport
rebinString(const int rowNo, const std::string &runNo,
            QReflTableModel_sptr model, ColNumbers col_nums);
...
public:
  ReflGenerateNotebook(std::string name, QReflTableModel_sptr model,
                       const std::string instrument, const int col_runs,
                       const int col_transmission, const int col_options,
                       const int col_angle, const int col_qmin,
                       const int col_qmax, const int col_dqq,
