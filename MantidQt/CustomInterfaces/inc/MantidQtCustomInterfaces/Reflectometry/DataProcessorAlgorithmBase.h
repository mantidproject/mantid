#ifndef MANTID_CUSTOMINTERFACES_DATAPROCESSORALGORITHMBASE_H
#define MANTID_CUSTOMINTERFACES_DATAPROCESSORALGORITHMBASE_H
...
/** @class DataProcessorAlgorithmBase

DataProcessorAlgorithmBase defines shared code to be used by derived classes
(DataPreprocessorAlgorithm, DataProcessorAlgorithm and
...
*/
class MANTIDQT_CUSTOMINTERFACES_DLL DataProcessorAlgorithmBase {
public:
  // Constructor
  DataProcessorAlgorithmBase(
...
#endif /*MANTID_CUSTOMINTERFACES_DATAPROCESSORALGORITHMBASE_H*/
