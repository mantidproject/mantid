...
/** QtReflOptionsDialog : Provides a dialog for setting Reflectometry UI
options.
...
class DLLExport QtReflOptionsDialog : public QDialog {
  Q_OBJECT
public:
  QtReflOptionsDialog(ReflTableView *view,
                      boost::shared_ptr<IReflTablePresenter> presenter);
