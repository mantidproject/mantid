...
namespace MantidQt
{
  namespace CustomInterfaces
  {
    ...
    /** SANSBackgroundCorrectionWidget: Widget for background correction of SANS experiments.
    ...
    */
    class MANTIDQT_CUSTOMINTERFACES_DLL SANSBackgroundCorrectionWidget: public QWidget
    {
      Q_OBJECT
    public:
