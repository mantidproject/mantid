...
.. math::
   ...
   S(Q,E\equiv \hbar \omega) = A_{0,0}(Q) \delta (\omega) + \frac{1}{\pi} \sum_{l=1}^{N-1} (2l+1) A_{n,l} (Q) \frac{x_{n,l}^2 D/R^2}{[x_{n,l}^2 D/R^2]^2+\omega^2}

.. math::

   A_{n,l} = \frac{6x_{n,l}^2}{x_{n,l}^2-l(l+1)} \left[\frac{QRj_{l+1}(QR) - lj_l(QR)}{(QR)^2 - x_{n,l}^2}\right]^2
