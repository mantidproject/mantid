...
.. raw :: html
    ...
    <br>
    <ul>
    <li>Fitting functions describes the different functions available, with a list of the parameters 
    for setting up the function, as well as some examples of how to use different functions.</li>
