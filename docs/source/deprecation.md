...
- Algorithms that have not been used for 3 years or more. We will use Usage Data to determine this. For more information
  about how we record Usage data please see our [Privacy Policy: Usage Data Recorded in Mantid](https://www.mantidproject.org/privacy.html#usage-data-recorded-in-mantid)
...
Working Group](https://github.com/mantidproject/governance/tree/main/technical-working-group).
