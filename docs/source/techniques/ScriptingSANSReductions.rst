...
- ``output_diagnostic_names``: If ``True``, this command will make the reduction output a second parameter containing a list of non-reduced workspace names in the ADS. Mainly to be used as part of :ref:`BatchReduce <SANSScriptingBatchReduce>` to delete
