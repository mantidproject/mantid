...
- converts the x units to momentum transfer
- converts the differential cross-section into an S(Q) distribution by multipling by :math:`4 \pi /\sigma_s`
...
- subtracts the Placzek self scattering correction from S(Q)
- converts the corrected S(Q) distribution into a PDF using :ref:`algm-PDFFourierTransform`
