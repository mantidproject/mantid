...
:math:`\chi^2` distribution :cite:`perring1993` which has a variance :math:`\tau_{\mathrm{mod}}^2
...
it was found that this underestimates the widths at high energy :cite:`perring1991`, so that a
...
:cite:`perring1991`, :cite:`marseguerra1959`
...
terms, :math:`\tau_{\mathrm{mod}}` and :math:`\tau_{\mathrm{chop}}` :cite:`carlile1985`:
