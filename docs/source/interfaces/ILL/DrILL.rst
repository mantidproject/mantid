...
default save directory (if no default save directory is provided, there will be
no export). If the algorithm is not adapted to the data, it will be skipped. For
