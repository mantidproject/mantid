...
- \* :ref:`IndexPeaks <algm-IndexPeaks>` **now has options to enter modulation vectors and additional information required for satellite peak indexing. As a result** ``IndexPeaksWithSatellites`` **has been deprecated and will be removed in a future release.** \*
