...
#########
  ...
  * Fixed an issue in the ALC interface where the failure of the auto button caused Mantid to crash. It will now throw up an error if the auto button cannot determine a last file.
