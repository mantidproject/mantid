...
| One of the major changes for this release is the new Direct :ref:`ALF View <ALFView-ref>` GUI for aligning samples on the ALF Instrument. There have also been serious developments in the :doc:`Indirect <indirect_geometry>` Interfaces:
...
- *Mantid 4.2.0: Manipulation and Analysis Toolkit for Instrument Data.; Mantid Project*. `doi: 10.5286/SOFTWARE/MANTID4.2 <https://doi.org/10.5286/SOFTWARE/MANTID4.2>`_
