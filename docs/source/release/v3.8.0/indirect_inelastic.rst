...
- The plotting and saving of the results of all Inelastic Interfaces has been re-factored to be only accessible via the interface and once the algorithm is completed.
