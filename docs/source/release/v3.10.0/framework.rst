...
- Framework changes now mean scanning workspaces (workspaces with moving detectors) can be created. Currently this can be tested using a new option in :ref:`FilterEvents <algm-CreateSampleWorkspace-v1>`, by setting `NumScanPoints`.
