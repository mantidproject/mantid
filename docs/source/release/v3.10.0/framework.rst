...
- :ref:`SaveYDA <algm-SaveYDA>` do export :py:obj:`Workspace2D <mantid.dataobjects.Workspace2D>` to `Frida 2.0 <http://apps.jcns.fz-juelich.de/doku/frida/start>`_ YAML format.
