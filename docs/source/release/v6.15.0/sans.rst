...
New Features
------------
- (`#40443 <https://github.com/mantidproject/mantid/pull/40443>`_) A new option in the :ref:`sans_toml_v1-ref` and
  :ref:`ISIS_Sans_interface_contents` Interface allows users to compute wide-angle corrections on transmission data.
