...
- (`#40393 <https://github.com/mantidproject/mantid/pull/40393>`_) In the ISIS SANS workflow, the default number of cylindrical slices used in the calculation of the solid angle correction performed by the :ref:`Q1D <algm-Q1D>` and :ref:`Qxy <algm-Qxy>` algorithms has been changed from 10 to 11.
