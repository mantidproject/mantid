...
- Toolbar of Matplotlib plots (**non-mantid axes**) and plots of 1D :py:obj:`MDHistoWorkspace <mantid.dataobjects.MDHistoWorkspace>` (for which the data have no workspace index) no longer display Fit and Superplot buttons:
