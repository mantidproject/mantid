...
Bugfixes
--------
- (`#41250 <https://github.com/mantidproject/mantid/pull/41250>`_) The ``Stretch`` tab of the :ref:`Bayes Fitting interface <interface-inelastic-bayes-fitting>` now verifies workspaces have more than one bin before creating :ref:`Colorfill_Plots`.
