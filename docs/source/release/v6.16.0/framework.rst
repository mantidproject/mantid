...
- (`#40712 <https://github.com/mantidproject/mantid/pull/40712>`_) :ref:`ConjoinWorkspaces <algm-ConjoinWorkspaces>` no longer has a fencepost error when determining spectrum numbers.
...
- (`#40855 <https://github.com/mantidproject/mantid/pull/40855>`_) A performance issue in :ref:`MaskDetectors <algm-MaskDetectors>`, when using a MatrixWorkspace as the source of the mask, has been fixed.
