- Performance of :ref:`FilterEvents <algm-FilterEvents>` algorithm has been significantly improved for a use case with fast changing logs.
  The REF_M_40380 was acquired with a 10 kHz trigger (on/off). It has 1.3 M events and 15 M splitters. The execution time of :ref:`MRFilterCrossSections <algm-MRFilterCrossSections>`
