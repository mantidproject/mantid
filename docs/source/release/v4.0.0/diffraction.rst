...
- ``PDConvertReciprocalSpace`` new algorithm to convert between reciprocal space units.
- ``PDConvertRealSpace`` new algorithm to convert between real space units.
...
- :ref:`HB2AReduce <algm-HB2AReduce>` algorithm reduces HFIR POWDER (HB-2A) data
- :ref:`LoadGudrunOutput <algm-LoadGudrunOutput>` is a new algorithm that allows users to load the standard Gudrun output files into Mantid.
- New algorithm ``PDConvertReciprocalSpace`` to convert between reciprocal space units.
- New algorithm ``PDConvertRealSpace`` to convert between real space units.
