...
- Fixed an issue where the *Plot Current Preview* in the Container Subtraction and Apply Paalman Pings interfaces would not plot the transformed container or result.
