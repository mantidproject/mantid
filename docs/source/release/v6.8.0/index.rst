...
- New algorithms :ref:`BayesQuasi2 <algm-BayesQuasi2>` and :ref:`BayesStretch2 <algm-BayesStretch2>` based on the quickBayes package (these replace the now deprecated BayesQuasi and BayesStretch algorithms).
...
- *Mantid 6.8.0: Manipulation and Analysis Toolkit for Instrument Data.; Mantid Project*. `doi: 10.5286/SOFTWARE/MANTID6.8 <https://doi.org/10.5286/SOFTWARE/MANTID6.8>`_
