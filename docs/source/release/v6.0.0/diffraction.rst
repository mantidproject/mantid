...
- New algorithm :ref:`SCDAdjustSampleNorm <algm-SCDAdjustSampleNorm>` to convert DEMAND data to Q-space and allow the detector position to be adjusted by offsets.
