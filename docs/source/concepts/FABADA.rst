...
.. code-block:: python
  ...
  minimizer_str = "FABADA,Chain Length=1000000,StepsBetweenValues=10,ConvergenceCriteria=0.01,PDF=pdf,Chains=chain,ConvergedChain=conv,CostFunctionTable=CostFunction,Parameters=Errors"
