...
A Workspace object will always be one of the following Python types: :ref:`ITableWorkspace <04_table_ws_py>`,
:ref:`MatrixWorkspace <03_matrix_ws_py>`, :ref:`WorkspaceGroup <05_group_ws_py>` or :py:obj:`MDWorkspace <mantid.api.IMDWorkspace>`.
The MatrixWorkspace is the most commonly used type and is often referred to simply as a :py:obj:`~mantid.api.Workspace`.
Usage of the MDWorkspace is not required for this course.
