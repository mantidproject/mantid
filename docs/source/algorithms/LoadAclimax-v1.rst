...
Description
-----------
LoadAclimax loads csv output aCLIMAX files. Only dynamical structure factor which corresponds to 1, 2, 3, 4-10  (origin_quantum_event_1-4).
...
aCLIMAX. In case PhononWings are ticked on also workspaces for phonon wings are created (phonon_wing1-4).
