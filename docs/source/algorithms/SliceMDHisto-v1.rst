...
SliceMDHisto extracts a hyperslab of data from a :py:obj:`MDHistoWorkspace <mantid.dataobjects.MDHistoWorkspace>`. Beyond
...
For a more up-to-date way of performing slices on a :py:obj:`MDHistoWorkspace <mantid.dataobjects.MDHistoWorkspace>` this see :ref:`algm-IntegrateMDHistoWorkspace`
