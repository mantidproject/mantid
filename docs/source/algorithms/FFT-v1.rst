...
.. testcode:: FFTBackwards
   ...
   print("DataX(0)[1] equals DataX(0)[99]? : " + str((round(abs(outworkspace.x(0)[1]), 3)) == (round(outworkspace.x(0)[99], 3))))
   print("DataX(0)[10] equals DataX(0)[90]? : " + str((round(abs(outworkspace.x(0)[10]), 3)) == (round(outworkspace.x(0)[90], 3))))
   print("DataX((0)[50] equals 0? : " + str((round(abs(outworkspace.x(0)[50]), 3)) == 0))
   print("DataY(0)[40] equals DataY(0)[60]? : " + str((round(abs(outworkspace.y(0)[40]), 5)) == (round(outworkspace.y(0)[60], 5))))
