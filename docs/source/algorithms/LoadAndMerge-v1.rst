...
.. testcode:: LoadAndMerge
  ...
  print('the first item is the merged output of the runs 170257 and 170258 with the name {0}'.format(out.getItem(0).name()))
  print('the second item is the merged output of the runs 170300 and 170302 with the name {0}'.format(out.getItem(1).name()))
