...
.. testcode:: ExSANSILLAutoProcess
    ...
    print('Distance 1 Q-range:{0:4f}-{1:4f} AA'.format(mtd['iq_s1_#1_d39.0m_c40.5m_w5.6A'].x(0)[0],
                                                       mtd['iq_s1_#1_d39.0m_c40.5m_w5.6A'].x(0)[-1]))
    print('Distance 2 Q-range:{0:4f}-{1:4f} AA'.format(mtd['iq_s1_#2_d8.0m_c8.0m_w5.6A'].x(0)[0],
                                                       mtd['iq_s1_#2_d8.0m_c8.0m_w5.6A'].x(0)[-1]))
    print('Distance 3 Q-range:{0:4f}-{1:4f} AA'.format(mtd['iq_s1_#3_d2.0m_c5.5m_w5.6A'].x(0)[0],
                                                       mtd['iq_s1_#3_d2.0m_c5.5m_w5.6A'].x(0)[-1]))
