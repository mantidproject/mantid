...
.. testcode:: ExTOFTOFMergeRuns2ws
    ...
    # Temperature 
    print("Temperature of experiment for 1st workspace (in K):  " + str(ws1.getRun().getLogData('temperature').value)
    print("Temperature of experiment for 2nd workspace (in K):  " + str(ws2.getRun().getLogData('temperature').value)
    ...
    # Duration
    print("Duration of experiment for 1st workspace (in s):  " + str(ws1.getRun().getLogData('duration').value))
    print("Duration of experiment for 2nd workspace (in s):  " + str(ws2.getRun().getLogData('duration').value))
    print("Duration of experiment for merged workspaces = sum of all durations (in s):  " + str(ws3.getRun().getLogData('duration').value))

    # Run start 
    print("Start of experiment for 1st workspace:  " + str(ws1.getRun().getLogData('run_start').value))
    print("Start of experiment for 2nd workspace:  " + str(ws2.getRun().getLogData('run_start').value))
    print("Start of experiment for merged workspaces = miminum of all workspaces:  " + str(ws3.getRun().getLogData('run_start').value))

    # Run end 
    print("End of experiment for 1st workspace:  " + str(ws1.getRun().getLogData('run_end').value))
    print("End of experiment for 2nd workspace:  " + str(ws2.getRun().getLogData('run_end').value))
    print("End of experiment for merged workspaces = maximum of all workspaces:  " + str(ws3.getRun().getLogData('run_end').value))
    
    # Run number 
    print("Run number for 1st workspace:  " + str(ws1.getRun().getLogData('run_number').value))
    print("Run number for 2nd workspace:  " + str(ws2.getRun().getLogData('run_number').value))
    print("Run number for merged workspaces = list of all workspaces:  " + str(ws3.getRun().getLogData('run_number').value))
 
    # Monitor counts
    print("Monitor counts for 1st workspace:  " + str(ws1.getRun().getLogData('monitor_counts').value))
    print("Monitor counts for 2nd workspace:  " + str(ws2.getRun().getLogData('monitor_counts').value))
    print("Monitor counts for merged workspaces = sum over all workspaces:  " + str(ws3.getRun().getLogData('monitor_counts').value))
...
.. testcode:: ExTOFTOFMergeRunsGroup
    ...
    print("Monitor counts for 1st workspace:  " + str(ws1.getRun().getLogData('monitor_counts').value))
    print("Monitor counts for 2nd workspace:  " + str(ws2.getRun().getLogData('monitor_counts').value))
    print("Monitor counts for merged workspaces = sum over all workspaces:  " + str(groupmerged.getRun().getLogData('monitor_counts').value))
