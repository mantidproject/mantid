...
.. testcode:: ExponentialCorrection
    ...
    print("The first Y value before correction is: {}".format((ws.y(0)[1])))
    ...
    print("The first Y value after divide correction is: {:.11e}".format(ws_divide.y(0)[1]))
    print("The first Y value after multiply correction is: {:.11e}".format(ws_multiply.y(0)[1]))
