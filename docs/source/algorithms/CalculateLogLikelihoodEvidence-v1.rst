...
.. code-block:: python
  ...
  Fit(Function = function_str,InputWorkspace=ws_data,WorkspaceIndex=3,StartX=-0.25,EndX=0.25,CreateOutput=True,Output = 'result_lorentzian',OutputCompositeMembers=True,MaxIterations=2000000, Minimizer=minimizer_str)

  function_str = 'composite=CompositeFunction,NumDeriv=true;name=Gaussian, Height=1, PeakCentre=0.01, Sigma=0.5;name=Gaussians, Height=1, PeakCentre=0.01, Sigma=0.5'
  minimizer_str = "FABADA,Chain Length=1000000,Steps between values=10,Convergence Criteria=0.01,PDF=Gaussian"


  Fit(Function = function_str,InputWorkspace=ws_data,WorkspaceIndex=3,StartX=-0.25,EndX=0.25,CreateOutput=True,Output = 'result_gaussian',OutputCompositeMembers=True,MaxIterations=2000000, Minimizer=minimizer_str)
