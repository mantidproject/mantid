...
.. testcode:: ExCreateTransWSAutoSimple
    ...
    print("{:.4f}".format(transWS.y(0)[26]))
    print("{:.4f}".format(transWS.y(0)[27]))
    print("{:.4f}".format(transWS.y(0)[28]))
    print("{:.4f}".format(transWS.y(0)[29]))
...
.. testcode:: ExCreateTransWSAutoOverload
    ...
    print("{:.3f}".format(transWS.y(0)[26]))
    print("{:.3f}".format(transWS.y(0)[27]))
    print("{:.3f}".format(transWS.y(0)[28]))
    print("{:.3f}".format(transWS.y(0)[29]))
