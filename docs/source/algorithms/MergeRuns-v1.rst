...
.. testcode:: ExWs
   ...
   print("a      = {}".format(a.y(0)))
   print("b      = {}".format(b.y(0)))
   print("merged = {}".format(merged.y(0)))
...
.. testcode:: ExWsGroup
   ...
   print("group_1 = [{},".format(group_1[0].y(0)))
   print("           {}]".format(group_1[1].y(0)))

   print("group_2 = [{},".format(group_2[0].y(0)))
   print("           {}]".format(group_2[1].y(0)))
