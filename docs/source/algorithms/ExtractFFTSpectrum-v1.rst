...
.. testcode:: Ex
    ...
    fitStatus, chiSq, covarianceTable, paramTable, fitWorkspace, nIter = Fit(Function=myFunc, InputWorkspace='wsfr', StartX=-40, EndX=40, CreateOutput=1)
    ...
    fitStatus, chiSq, covarianceTable, paramTable, fitWorkspace, nIter = Fit(Function=myFunc, InputWorkspace='wsfi', StartX=-15, EndX=15, CreateOutput=1)
