...
When a workspace group is passed in, dataset names are generated for each individual workspace in the group as described above. However, where the generated name is either "Stitched" or the
theta value, then the individual workspace name is also included to ensure a unique dataset name.
...
|                     | :ref:`algm-GeneratePythonScript`. This is excluded for workspaces that were passed in as part |
|                     | of a workspace group.                                                                         |
+---------------------+-----------------------------------------------------------------------------------------------+
