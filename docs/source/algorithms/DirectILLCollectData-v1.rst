...
* *ElasticChannelIndexPrecision*: number of significant digits to use when the index of the elastic peak position comes from fitting. The default is 0, corresponding to integral value of the bin index.
