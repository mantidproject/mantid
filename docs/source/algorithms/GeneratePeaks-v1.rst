...
parameters are either (1) given in a :py:obj:`TableWorkspace <mantid.api.ITableWorkspace>`
...
sensitive in input :py:obj:`TableWorkspace <mantid.api.ITableWorkspace>`

The definition of this table workspace is consistent with the output
peak and background parameter :py:obj:`TableWorkspace <mantid.api.ITableWorkspace>`
