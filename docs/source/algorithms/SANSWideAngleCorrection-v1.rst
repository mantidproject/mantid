...
.. [#Brulet] Annie Brûlet et al. - Improvement of data treatment in small-angle neutron scattering - `Journal of Applied Crystallography. (2007). 40 <https://doi.org/10.1107/S0021889806051442>`_
...
.. testcode:: ExCorrection
   ...
   print("{:.6f} was corrected to {:.6f}.".format(sample.y(19)[0], corrected_data.y(19)[0]))
