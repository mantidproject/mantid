...
.. testcode:: ExExpTempWS2D
  ...
  # Check
  print("Length of X = %d, Length of Y = %d." % (len(propws.x(0)), len(propws.y(0))))
  print("X[0]  = {:.1f}, Y[0]  = {:.5f}".format(propws.x(0)[0], propws.y(0)[0]))
  print("X[20] = {:.1f}, Y[20] = {:.5f}".format(propws.x(0)[20], propws.y(0)[20]))
  print("X[40] = {:.1f}, Y[40] = {:.5f}".format(propws.x(0)[40], propws.y(0)[40]))
...
.. testcode:: ExExpTempEvent
  ...
  # Check
  print("Length of X = {}, Length of Y = {}.".format(len(propws.x(0)), len(propws.y(0))))
  print("X[0]  = {:.1f}, Y[0]  = {:.5f}".format(propws.x(0)[0], propws.y(0)[0]))
