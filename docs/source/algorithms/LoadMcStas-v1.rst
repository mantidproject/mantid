...
In addition a workspace with the name 'EventData' + '_' + name of the OutputWorkspace
is created which contains the sum of all event data in the Nexus file.  
...
.. testcode:: CheckEqualScattering
    ...
    single_scatter_event_ws = mtd['k01_events_dat_list_p_x_y_n_id_t_ws']
    total_single = 0
    ...
    multiple_scatter_event_ws = mtd['k02_events_dat_list_p_x_y_n_id_t_ws']
    total_multiple = 0
