...
A :py:obj:`PeaksWorkspace <mantid.dataobjects.PeaksWorkspace>` is created containing the new UB matrix with peaks
...
:py:obj:`WorkspaceGroup <mantid.api.WorkspaceGroup>` with a peaks workspace
