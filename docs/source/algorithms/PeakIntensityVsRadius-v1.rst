...
The algorithm requires a :py:obj:`MDWorkspace <mantid.api.IMDWorkspace>` of SCD data in
reciprocal space; generated by e.g.
:ref:`algm-ConvertToDiffractionMDWorkspace`.
Also, you will need a :py:obj:`PeaksWorkspace <mantid.dataobjectsPeaksWorkspace>` as the list of
peaks to integrate. This can be generated using
:ref:`algm-FindPeaksMD`, for example.

The output will be a :py:obj:`Workspace2D <mantid.dataobjects.Workspace2D>` with one spectrum per
peak, where:
