...
sensitivity outside the given limits are masked and the sensitivity is recomputed 
...
.. testcode:: ExEff
   ...
   sensitivity = CalculateSensitivity('workspace', MinSensitivity=0.5, MaxSensitivity=1.5)
