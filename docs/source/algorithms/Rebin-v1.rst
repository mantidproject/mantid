...
"Logarithmic", or "ReverseLogarithmic".  When set, the algorithm will use the
specified binning method regardless of how other parameters are set.  This can help reduce
inadvertent sign errors in logarithmic binning calculations.
