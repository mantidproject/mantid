...
If BinningMode is set to either "Linear" or "Logarithmic", the algorithm will use the
specified binning method regardless of the sign of the bin width.  This can help reduce
inadvertent calculation errors in logarithmic binning calculations.
