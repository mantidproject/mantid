...
.. testcode:: IN5Example
   ...
   print("Monitor {0} distance from origin: {1:.3f}".format(0, ws.getDetector(monitorIndex).getPos().norm()))
   for i in range(0, 5):
   ...
   print("Monitor {0} distance from origin: {1:.3f}".format(0, converted_ws.getDetector(monitorIndex).getPos().norm()))
   for i in range(0, 5):
