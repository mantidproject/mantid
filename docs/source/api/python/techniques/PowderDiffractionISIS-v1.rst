...
:ref:`Scripting Window <interface-ScriptingWindow>`
...
*is ran inside* :ref:`Scripting Window <interface-ScriptingWindow>`

The script which is required to be written inside :ref:`Scripting Window <interface-ScriptingWindow>`
on Mantid contains:
