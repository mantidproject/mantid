...
public:
  ...
  Interpolation(ApplicationWindow *parent, Table *t, const QString &xCol, const QString &yCol, int start = 0,
                int end = -1, int m = 0);
...
private:
  ...
  int sortedCurveData(QwtPlotCurve *c, double start, double end, double **x, double **y) override;
