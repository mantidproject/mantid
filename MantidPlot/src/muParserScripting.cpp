...
const muParserScripting::mathFunction muParserScripting::math_functions[] = {
    ...
    {"bessel_j0", 1, bessel_J0, nullptr, nullptr, "bessel_j0(x):\n  Regular "
                                            "cylindrical Bessel function of "
                                            "zeroth order, J_0(x)."},
    {"bessel_j1", 1, bessel_J1, nullptr, nullptr, "bessel_j1(x):\n  Regular "
                                            "cylindrical Bessel function of "
                                            "first order, J_1(x)."},
    {"bessel_jn", 2, nullptr, bessel_Jn, nullptr, "bessel_jn(double x, int n):\n "
    ...
    {"bessel_y0", 1, bessel_Y0, nullptr, nullptr, "bessel_y0(x):\n Irregular "
                                            "cylindrical Bessel function of "
                                            "zeroth order, Y_0(x), for x>0."},
    {"bessel_y1", 1, bessel_Y1, nullptr, nullptr, "bessel_y1(x):\n Irregular "
                                            "cylindrical Bessel function of "
    ...
    {"beta", 2, nullptr, beta, nullptr, "beta(a,b):\n Computes the Beta Function, "
                                  "B(a,b) = Gamma(a)*Gamma(b)/Gamma(a+b) for a "
                                  "> 0, b > 0."},
    {"ceil", 1, ceil, nullptr, nullptr, "ceil(x):\n Round to the next larger "
    ...
    {"floor", 1, floor, nullptr, nullptr, "floor(x):\n Round to the next smaller "
                                    "integer,\n largest integer smaller or "
                                    "equal to x."},
    {"gamma", 1, gamma, nullptr, nullptr, "gamma(x):\n Computes the Gamma function, "
    ...
    {"hazard", 1, hazard, nullptr, nullptr, "hazard(x):\n Computes the hazard "
