...
const muParserScripting::mathFunction muParserScripting::math_functions[] = {
    ...
    {"hazard", 1, hazard, nullptr, nullptr,
     ...
     "h(x) = erfz(x)/erfq(x)."},
    {"if", 3, nullptr, nullptr, nullptr, "if(e1, e2, e3):\n if e1 then e2 else e3."},
    {"ln", 1, nullptr, nullptr, nullptr, "ln(x):\n Calculate natural logarithm log_e."},
    {"log", 1, nullptr, nullptr, nullptr, "log(x):\n Calculate decimal logarithm log_10."},
    {"log10", 1, nullptr, nullptr, nullptr, "log10(x):\n Calculate decimal logarithm log_10."},
    {"log2", 1, nullptr, nullptr, nullptr, "log2(x):\n Calculate binary logarithm log_2."},
    {"min", -1, nullptr, nullptr, nullptr, "min(x,y,...):\n Calculate minimum of all arguments."},
    {"max", -1, nullptr, nullptr, nullptr, "max(x,y,...):\n Calculate maximum of all arguments."},
    {"mod", 2, nullptr, mod, nullptr, "mod(x,y):\n Calculate rest of integer division x/y,\n x modulo y."},
    {"pow", 2, nullptr, mypow, nullptr, "pow(x,y):\n Raise x to the power of y, x^y."},
    {"rint", 1, nullptr, nullptr, nullptr, "rint(x):\n Round to nearest integer."},
    {"sign", 1, nullptr, nullptr, nullptr, "sign(x):\n Sign function: -1 if x<0; 1 if x>0."},
    {"sin", 1, nullptr, nullptr, nullptr, "sin(x):\n Calculate sine."},
    {"sinh", 1, nullptr, nullptr, nullptr, "sinh(x):\n Hyperbolic sin function."},
    {"sqrt", 1, nullptr, nullptr, nullptr, "sqrt(x):\n Square root function."},
    {"sum", -1, nullptr, nullptr, nullptr, "sum(x,y,...):\n Calculate sum of all arguments."},
    {"tan", 1, nullptr, nullptr, nullptr, "tan(x):\n Calculate tangent function."},
    {"tanh", 1, nullptr, nullptr, nullptr, "tanh(x):\n Hyperbolic tan function."},
