...
ProjectRecoveryView::ProjectRecoveryView(QWidget *parent, ProjectRecoveryPresenter *presenter)
    : QDialog(parent), m_ui(std::make_unique<Ui::ProjectRecoveryWidget>()), m_presenter(presenter) {
  m_ui->setupUi(this);
...
void ProjectRecoveryView::onClickLastCheckpoint() {
  ...
  Mantid::Kernel::UsageService::Instance().registerFeatureUsage(
      Mantid::Kernel::FeatureType::Feature, {"ProjectRecoveryWindow", "RecoverLastCheckpoint"}, false);
}
...
void ProjectRecoveryView::onClickStartMantidNormally() {
  ...
  Mantid::Kernel::UsageService::Instance().registerFeatureUsage(
      Mantid::Kernel::FeatureType::Feature, {"ProjectRecoveryWindow", "StartMantidNormally"}, false);
}
...
void ProjectRecoveryView::setProgressBarMaximum(int newValue) { m_ui->progressBar->setMaximum(newValue); }
...
void ProjectRecoveryView::changeStartMantidButton(const QString &string) { m_ui->startmantidButton->setText(string); }