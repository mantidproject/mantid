...
public:
  ...
  void setNumberFormat(MantidMatrixTabExtension &extension, const QChar &format, int precision) override;
  void recordFormat(MantidMatrixTabExtension &extension, const QChar &format, int precision) override;
  QChar getFormat(MantidMatrixTabExtension &extension) override;
  int getPrecision(MantidMatrixTabExtension &extension) override;
  void setColumnWidth(MantidMatrixTabExtension &extension, int width, int numberOfColumns) override;
  ...
  void setColumnWidthPreference(MantidMatrixTabExtension &extension, int width) override;
