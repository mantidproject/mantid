...
class MantidPlotTiledWindowTest(unittest.TestCase):
    ...
    def test_addWidget(self):
        ...
        t1 = newTable()
        t2 = newTable()
        self.assertNotEqual( folder.findWindow(t1.name()), None )
        self.assertNotEqual( folder.findWindow(t2.name()), None )
        tw = newTiledWindow()
        tw.addWidget(t1,0,0)
        tw.addWidget(t2,0,1)
        self.assertNotEqual( folder.findWindow(t1.name()), None )
    ...
    def test_dockSelected(self):
        ...
        self.assertNotEqual( folder.findWindow(t1.name()), None )
        self.assertNotEqual( folder.findWindow(t2.name()), None )
        self.assertNotEqual( folder.findWindow(t3.name()), None )
        self.assertNotEqual( folder.findWindow(t4.name()), None )
        tw.close()
        t1.close()
        t2.close()
    ...
    def test_getWidget(self):
        ...
        self.assertNotEqual( tt0._getHeldObject(), None )
        tw.close()
    ...
    def test_clear(self):
        ...
        self.assertNotEqual( tw.getWidget(0,0)._getHeldObject(), None )
        tw.close()
    ...
    def test_move_from_one_to_another(self):
        ...
        self.assertNotEqual( tw1.getWidget(0,0)._getHeldObject(), None )
        self.assertNotEqual( tw2.getWidget(0,0)._getHeldObject(), None )
