...
const int ExcitationsDiagResults::numTests = 3;
/// the list of tests that we display results for
const QString ExcitationsDiagResults::tests[ExcitationsDiagResults::numTests] =
...
//----------------------
///Constructor
ExcitationsDiagResults::ExcitationsDiagResults(QWidget *parent) : 
...
void ExcitationsDiagResults::initLayout()
{
}

void ExcitationsDiagResults::notifyDialog(TestSummary display)
{
...
int ExcitationsDiagResults::addRow(QString firstColumn, QString secondColumn)
{
...
/// insert a row at the bottom of the grid
void ExcitationsDiagResults::updateRow(int row, QString firstColumn,
                                      int secondColumn)
{
...
/// insert a row at the bottom of the grid
void ExcitationsDiagResults::addButtonsDisab(int row)
{
...
/// insert a row at the bottom of the grid
void ExcitationsDiagResults::showButtons(int row, QString test)
{
  QPushButton *bpList =
...
void ExcitationsDiagResults::tableList(const QString &name)
{
...
//  viewTablePy.append("tbBad.setC)\n");
  ...
  emit pythonCodeConstructed(viewTablePy);
}

void ExcitationsDiagResults::instruView(const QString &name)
{
  QString workspace = outputWorkS[name];
  ...
  emit pythonCodeConstructed(startInstruViewPy);
}
