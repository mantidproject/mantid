...
void indirectAnalysis::initLayout()
{
    ...
    connect(m_uiForm.fury_pbBrowseIcon, SIGNAL(clicked()), this, SLOT(furyBrowseIcon()));
    connect(m_uiForm.fury_pbBrowseRes, SIGNAL(clicked()), this, SLOT(furyBrowseRes()));
    // elwin
    connect(m_uiForm.elwin_pbRun, SIGNAL(clicked()), this, SLOT(elwinRun()));
    connect(m_uiForm.elwin_pbBrowse, SIGNAL(clicked()), this, SLOT(elwinBrowse()));
    // slice
    connect(m_uiForm.slice_pbRun, SIGNAL(clicked()), this, SLOT(sliceRun()));
    connect(m_uiForm.slice_pbBrowse, SIGNAL(clicked()), this, SLOT(sliceBrowseRaw()));
    connect(m_uiForm.slice_pbBrowseCalib, SIGNAL(clicked()), this, SLOT(sliceBrowseCalib()));
    // msd
    connect(m_uiForm.msd_pbRun, SIGNAL(clicked()), this, SLOT(msdRun()));
    connect(m_uiForm.msd_pbBrowse, SIGNAL(clicked()), this, SLOT(msdBrowse()));
    // absorption
    connect(m_uiForm.abs_pbRun, SIGNAL(clicked()), this, SLOT(absorptionRun()));
    connect(m_uiForm.abs_pbBrowse, SIGNAL(clicked()), this, SLOT(absorptionBrowse()));
...
bool indirectAnalysis::validateFury()
{
    ...
    if ( m_uiForm.fury_leIconFile->text() == "" )
    {
        m_uiForm.fury_valIconFile->setText("*");
        valid = false;
    }
    else
    {
    ...
    if ( m_uiForm.fury_leResFile->text() == "" )
    {
        m_uiForm.fury_valResFile->setText("*");
        valid = false;
    }
    else
    {
...
bool indirectAnalysis::validateElwin()
{
    bool valid = true;
    // ...
    if ( m_uiForm.elwin_leInputFile->text() == "" )
    {
        m_uiForm.elwin_valFile->setText("*");
        valid = false;
    }
    else
    {
...
bool indirectAnalysis::validateSlice()
{
    bool valid = true;
    // ...
    if ( m_uiForm.slice_leInputFile->text() == "" )
    {
        m_uiForm.slice_valInputFile->setText("*");
        valid = false;
    }
    else
    {
    ...
    if ( m_uiForm.slice_leCalib->text() == "" )
    {
        m_uiForm.slice_valCalib->setText("*");
        valid = false;
    }
    else
    {
...
bool indirectAnalysis::validateMsd()
{
    ...
    // ...
    if ( m_uiForm.msd_leInputFile->text() == "" )
    {
        m_uiForm.msd_valInputFile->setText("*");
        valid = false;
    }
    else
    {
...
bool indirectAnalysis::validateAbsorption()
{
    ...
    if ( m_uiForm.abs_leFile->text() == "" )
    {
        m_uiForm.abs_valFile->setText("*");
        valid = false;
    }
    else
    {
...
void indirectAnalysis::furyRun()
{
    ...
    QString pyInput =
        ...
        "sample = r'" + m_uiForm.fury_leIconFile->text() + "'\n"
        "resolution = r'" + m_uiForm.fury_leResFile->text() + "'\n"
...
void indirectAnalysis::furyBrowseIcon()
{
    QString samFile = QFileDialog::getOpenFileName(this, "Select Sample File",
        m_dataDir, "NeXuS Files (*.nxs)");
    m_uiForm.fury_leIconFile->setText(samFile);

}
void indirectAnalysis::furyBrowseRes()
{
    QString resFile = QFileDialog::getOpenFileName(this, "Select Resolution File",
        m_dataDir, "RES NeXuS Files (*_res.nxs)");
    m_uiForm.fury_leResFile->setText(resFile);
...
void indirectAnalysis::elwinRun()
{
    ...
    QString pyInput =
        ...
        "input = [r'" + m_uiForm.elwin_leInputFile->text() + "']\n"
...
void indirectAnalysis::elwinBrowse()
{
    QString samFile = QFileDialog::getOpenFileName(this, "Select Sample File",
        m_dataDir, "NeXuS Files (*.nxs)");
    m_uiForm.elwin_leInputFile->setText(samFile);
}
...
void indirectAnalysis::sliceRun()
{
    ...
    QString pyInput =
        ...
        "rawfile = [r'" + m_uiForm.slice_leInputFile->text() + "']\n"
        "calib = r'" + m_uiForm.slice_leCalib->text() + "'\n"
...
void indirectAnalysis::sliceBrowseRaw()
{
    QString rawFile = QFileDialog::getOpenFileName(this, "Select Raw File",
        m_dataDir, "ISIS Raw Files (*.raw)");
    m_uiForm.slice_leInputFile->setText(rawFile);
}
void indirectAnalysis::sliceBrowseCalib()
{
    QString calFile = QFileDialog::getOpenFileName(this, "Select Calib File",
        m_dataDir, "Calib Files (*_calib.nxs)");
    m_uiForm.slice_leCalib->setText(calFile);
}
...
void indirectAnalysis::msdRun()
{
    ...
    QString pyInput =
        ...
        "elwin = r'" + m_uiForm.msd_leInputFile->text() + "'\n";
...
void indirectAnalysis::msdBrowse()
{
    QString elwFile = QFileDialog::getOpenFileName(this, "Select Elwin File",
        m_dataDir, "Elwin Files (*_elw.nxs)");
    m_uiForm.msd_leInputFile->setText(elwFile);
}
// absorption slots
void indirectAnalysis::absorptionRun()
{
    ...
    QString pyInput =
        ...
        "efixed = " + m_uiForm.set_leEFixed->text() + "\n"
        "file = r'" + m_uiForm.abs_leFile->text() + "'\n"
...
void indirectAnalysis::absorptionBrowse()
{
    QString samFile = QFileDialog::getOpenFileName(this, "Select Sample File",
        m_dataDir, "NeXuS Files (*.nxs)");
    m_uiForm.abs_leFile->setText(samFile);
}
