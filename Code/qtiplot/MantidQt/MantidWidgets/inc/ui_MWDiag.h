...
**
** Created: Fri 8. Jan 18:57:34 2010
...
public:
    ...
    void setupUi(QWidget *MWDiag)
    {
    if (MWDiag->objectName().isEmpty())
        MWDiag->setObjectName(QString::fromUtf8("MWDiag"));
    MWDiag->resize(388, 377);
    gridLayout = new QGridLayout(MWDiag);
    gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
    lbIFile = new QLabel(MWDiag);
    ...
    leSignificance = new QLineEdit(MWDiag);
    ...
    gbVariation = new QGroupBox(MWDiag);
    ...
    gbBackTest = new QGroupBox(MWDiag);
    ...
    retranslateUi(MWDiag);

    QMetaObject::connectSlotsByName(MWDiag);
    } // setupUi

    void retranslateUi(QWidget *MWDiag)
    {
    MWDiag->setWindowTitle(QApplication::translate("MWDiag", "Form", 0, QApplication::UnicodeUTF8));
    lbIFile->setText(QApplication::translate("MWDiag", "Input Mask File", 0, QApplication::UnicodeUTF8));
    leIFile->setText(QString());
    pbIFile->setText(QApplication::translate("MWDiag", "Browse", 0, QApplication::UnicodeUTF8));
    lbOFile->setText(QApplication::translate("MWDiag", "Output Mask File", 0, QApplication::UnicodeUTF8));
    pbOFile->setText(QApplication::translate("MWDiag", "Browse", 0, QApplication::UnicodeUTF8));
    lbError->setText(QApplication::translate("MWDiag", "Errorbar Criterion", 0, QApplication::UnicodeUTF8));
    ckAngles->setText(QApplication::translate("MWDiag", "No Solid Angles", 0, QApplication::UnicodeUTF8));
    gbIndividual->setTitle(QApplication::translate("MWDiag", "Individual White Beam Tests", 0, QApplication::UnicodeUTF8));
    lbWBV1->setText(QApplication::translate("MWDiag", "White Beam Van1", 0, QApplication::UnicodeUTF8));
    lbHighAbs->setText(QApplication::translate("MWDiag", "High Counts", 0, QApplication::UnicodeUTF8));
    validatorSpace_6->setText(QString());
    lbLowAbs->setText(QApplication::translate("MWDiag", "Low Counts", 0, QApplication::UnicodeUTF8));
    validatorSpace_4->setText(QString());
    lbHighMed->setText(QApplication::translate("MWDiag", "Median Test High", 0, QApplication::UnicodeUTF8));
    validatorSpace_5->setText(QString());
    validatorSpace_3->setText(QString());
    validatorSpace_9->setText(QString());
    pbWBV1->setText(QApplication::translate("MWDiag", "Browse", 0, QApplication::UnicodeUTF8));
    lbLowMed->setText(QApplication::translate("MWDiag", "Median Test Low", 0, QApplication::UnicodeUTF8));
    gbVariation->setTitle(QApplication::translate("MWDiag", "Efficiency Variation Test", 0, QApplication::UnicodeUTF8));
    lbWBV2->setText(QApplication::translate("MWDiag", "WhiteBeamVan 2", 0, QApplication::UnicodeUTF8));
    pbWBV2->setText(QApplication::translate("MWDiag", "Browse", 0, QApplication::UnicodeUTF8));
    lbVariation->setText(QApplication::translate("MWDiag", "Proportional change criterion", 0, QApplication::UnicodeUTF8));
    validator_label->setText(QString());
    gbBackTest->setTitle(QApplication::translate("MWDiag", "Background check", 0, QApplication::UnicodeUTF8));
    lbStartTime->setText(QApplication::translate("MWDiag", "Start TOF", 0, QApplication::UnicodeUTF8));
    lbEndTime->setText(QApplication::translate("MWDiag", "End TOF", 0, QApplication::UnicodeUTF8));
    validator_label_3->setText(QString());
    lbAcceptance->setText(QApplication::translate("MWDiag", "Acceptance Factor", 0, QApplication::UnicodeUTF8));
    ckZeroCounts->setText(QApplication::translate("MWDiag", "Find spectra with zero counts", 0, QApplication::UnicodeUTF8));
    Q_UNUSED(MWDiag);
    } // retranslateUi
