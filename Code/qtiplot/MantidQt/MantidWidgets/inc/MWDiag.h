...
namespace MantidQt
{
  namespace MantidWidgets
  {
    ...
    public:
      ...
      MWDiag(QWidget *parent=NULL, QString prevSettingsGr="CustomWidgets/Diag", const QComboBox * const instru=NULL, QWidget *childHook=NULL);
    ...
    private:
      ...
      /// points to parent window of the result window this application creates
      QWidget * const m_mainApp;
