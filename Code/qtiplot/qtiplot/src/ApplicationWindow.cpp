...
void ApplicationWindow::initGlobalConstants()
{
	...
	autoSaveTime = 15;
	d_backup_files = true;
	defaultScriptingLang = "Python";  //M. Gigg
    ...
    if (list.count() < 2 || list[0] != "QtiPlot"){
        ...
        if (QFile::exists(fname + "~")){
            ...
            if (choice == QMessageBox::Yes)
                ...
                QMessageBox::critical(this, tr("MantidPlot - File opening error"),  tr("The file: <b> %1 </b> was not created using QtiPlot!").arg(fn));//Mantid
            return 0;
		}
    }
...
void ApplicationWindow::readSettings()
{
	...
	defaultScriptingLang = settings.value("/ScriptingLang","Python").toString();    //M. Gigg
