...
void ApplicationWindow::createActions()
{
	...
	actionOpenProj=new QAction(QIcon(QPixmap(folder_open_xpm)), tr("&Project"), this);
...
//#endif
	...
	actionShowScriptInterpreter = new QAction(QPixmap(python_xpm), tr("Script &Interpreter"), this);
...
void ApplicationWindow::addListViewItem(MdiSubWindow *w)
{
	...
	if (w->isA("Matrix")){
		...
		it->setPixmap(0, QPixmap(mantid_matrix_xpm));
