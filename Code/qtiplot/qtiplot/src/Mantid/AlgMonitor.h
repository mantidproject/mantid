...
signals:
    ...
    void needUpdateProgress(const Mantid::API::IAlgorithm* alg,int p, const QString& msg);
protected:
...
public slots:
    void update(int n);
    void updateProgress(const Mantid::API::IAlgorithm* alg,int p, const QString& msg);
private:
    QVector<const Mantid::API::IAlgorithm*> m_algorithms;
