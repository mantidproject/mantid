...
void testConstruction()
{
  ...
  vtkDataArray* data = mdPresenter.getScalarData();
...
void testGetScalarDataThrows()
{
  ...
  TSM_ASSERT_THROWS("Accessing scalar data without first calling execute should not be possible", mdPresenter.getScalarData(), std::runtime_error);
}
