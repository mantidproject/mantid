...
addDlls('../Third_Party/lib/win64','3dDll',MantidDlls,['hdf5dll.dll','libNeXus-0.dll'])
...
addFileV('hdf5dlldll','hdf5dll.dll','hdf5dll.dll','../Third_Party/lib/win64/hdf5dll.dll',Plugins)
addFileV('libNeXus0dll','lNeXus-0.dll','libNeXus-0.dll','../Third_Party/lib/win64/libNeXus-0.dll',Plugins)
...
#addFileV('Sconstruct','Sconstr','Sconstruct','toget64/UserAlgorithms/Sconstruct',UserAlgorithms)
#addFileV('build_bat','build.bat','build.bat','toget64/UserAlgorithms/build.bat',UserAlgorithms)
addAllFiles('toget64/UserAlgorithms','UA',UserAlgorithms)
...
addFileV('poco_foundation_lib','poco_f.lib','PocoFoundation.lib','../Third_Party/lib/win64/PocoFoundation.lib',UserAlgorithms)
...
#-----------------------------------------------------------------------
sfiles = os.listdir('toget64/PyQt4');
i=1;
for file in sfiles:
  if( file == '.svn' ):
    continue;
...
addModules('toget64/VCRedist',Redist)
