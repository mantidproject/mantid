...
cl runner.cpp /I "..\inc" /I "..\..\..\Third_Party\include" /I "..\..\..\Third_Party\src\cxxtest" /I "..\..\kernel\inc" /I "..\..\DataHandling\inc" /I "..\..\DataObjects\inc" /I "..\..\Geometry\inc" /I "..\..\API\inc" /I "../../Nexus/inc" /I "../../CurveFitting\inc" /I "..\inc\MantidMDAlgorithms" /I "..\..\MDDataObjects\inc\MDDataObjects" /DBOOST_ALL_DYN_LINK /DBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG /EHsc /MDd /W3 /wd4275 /nologo /c /ZI /TP 

link /OUT:"runner.exe" /NOLOGO /LIBPATH:"../../Debug" /LIBPATH:"../../../Third_Party/lib/win32" /DEBUG /PDB:".\runner.pdb" Mantidkernel.lib Mantidapi.lib Mantidalgorithms.lib MantidCurveFitting.lib Mantiddatahandling.lib Mantiddataobjects.lib Mantidgeometry.lib MantidNexus.lib MDAlgorithms.lib runner.obj 
