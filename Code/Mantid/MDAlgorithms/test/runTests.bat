...
link /OUT:"runner.exe" /NOLOGO /LIBPATH:"../../Debug" /LIBPATH:"../../../Third_Party/lib/win32" /DEBUG /PDB:".\runner.pdb" gmock.lib Mantidkernel.lib Mantidapi.lib Mantidalgorithms.lib MantidCurveFitting.lib Mantiddatahandling.lib Mantiddataobjects.lib Mantidgeometry.lib MantidNexus.lib MDAlgorithms.lib MDDataObjects.lib  hdf5ddll.lib runner.obj 
