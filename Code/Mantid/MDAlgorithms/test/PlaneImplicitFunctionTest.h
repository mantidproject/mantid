...
public:
	...
	{   
	    using namespace Mantid::MDAlgorithms;
	    PlaneImplicitFunction A(NormalParameter(1, 2, 3), OriginParameter(4, 5, 6));
		PlaneImplicitFunction B(NormalParameter(1, 2, 3), OriginParameter(4, 5, 6));
	...
	{ 
	    using namespace Mantid::MDAlgorithms;
	    PlaneImplicitFunction A(NormalParameter(1, 2, 3), OriginParameter(4, 5, 6));
		PlaneImplicitFunction B(NormalParameter(0, 0, 0), OriginParameter(4, 5, 6));
		PlaneImplicitFunction C(NormalParameter(1, 2, 3), OriginParameter(0, 0, 0));
