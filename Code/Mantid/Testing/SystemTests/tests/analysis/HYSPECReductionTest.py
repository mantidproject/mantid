...
class HYSPECReductionTest(stresstesting.MantidStressTest):
	...
	def runTest(self):
		...
		DgsReduction(SampleInputWorkspace='splitc',IncidentBeamNormalisation='ByCurrent',OutputWorkspace='reduced',GroupingFile=self.groupingFile,TimeIndepBackgroundSub ='1',TibTofRangeStart =10400,TibTofRangeEnd =12400,IncidentEnergyGuess=50)
