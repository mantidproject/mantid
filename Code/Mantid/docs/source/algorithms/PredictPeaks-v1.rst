...
use the :ref:`_algm-CopySample` algorithm (with CopyLattice=1) to
...
:ref:`_algm-FindPeaksMD` followed by :ref:`_algm-IndexPeaks` to
...
:ref:`_algm-CreatePeaksWorkspace` to create a workspace
