...
*DeadTimeTable* is expected to have a six-row header, including overall information, and 6 columns:
...
.. testcode:: ExCompSquash
   ...
   # Create a PhaseTable file with some arbitrary detector information
   file = open('PhaseTable.txt','w')
   file.write("MuSR\n")
   ...
   output = PhaseQuad('input','PhaseTable.txt')
