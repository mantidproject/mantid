...
:ref:`workspace <workspace>`_. This algorithm will fail if the
:ref:`workspace <workspace>`_ does not already point to a full
:ref:`instrument <instrument>`_ :ref:`geometry <geometry>`_ (which usually means
