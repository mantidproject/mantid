...
.. [#f1] The algorithm does not use `MD Transformation factory <MD_Transformation_factory>`_ so can be used as 
         independent verification of `MD Transformation factory <MD_Transformation_factory>`_ work on a spherical instrument.
