...
The code iteslef works but disabled from doc tests as takes too long to complete. It shows how applying centroid peaks changes the peak posisions previously calculated by 
