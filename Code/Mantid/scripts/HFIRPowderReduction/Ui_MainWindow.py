...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_wavelength.setItemText(0, _translate("MainWindow", "2.41 Å (Ge 113 IN)", None))
        self.comboBox_wavelength.setItemText(1, _translate("MainWindow", "1.54 Å (115) ", None))
        self.comboBox_wavelength.setItemText(2, _translate("MainWindow", "1.12 Å (117) ", None))
