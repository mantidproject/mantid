...
#
# Created: Mon Mar 18 17:51:53 2013
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.att_scale_factor_label.setMinimumSize(QtCore.QSize(160, 0))
        self.att_scale_factor_label.setMaximumSize(QtCore.QSize(160, 16777215))
        ...
        self.extension_combo.setMaximumSize(QtCore.QSize(360, 16777215))
        ...
        self.horizontalLayout_6.addWidget(self.sum_checkbox)
        ...
        self.direct_beam_label.setMinimumSize(QtCore.QSize(160, 0))
        self.direct_beam_label.setMaximumSize(QtCore.QSize(160, 16777215))
        ...
        self.correction_gridlayout.addWidget(self.disablevanbkgdcorr_chkbox, 2, 4, 1, 1)
        ...
        self.override_vanrun_checkBox = QtGui.QCheckBox(self.geometry_options_groupbox)
        self.override_vanrun_checkBox.setObjectName(_fromUtf8("override_vanrun_checkBox"))
        self.correction_gridlayout.addWidget(self.override_vanrun_checkBox, 1, 2, 1, 1)
        ...
        self.correction_gridlayout.addWidget(self.disablebkgdcorr_chkbox, 0, 4, 1, 1)
        ...
        self.override_emptyrun_checkBox = QtGui.QCheckBox(self.geometry_options_groupbox)
        self.override_emptyrun_checkBox.setObjectName(_fromUtf8("override_emptyrun_checkBox"))
        self.correction_gridlayout.addWidget(self.override_emptyrun_checkBox, 0, 2, 1, 1)
        ...
        self.correction_gridlayout.addWidget(self.disablevancorr_chkbox, 1, 4, 1, 1)
        ...
        self.correction_gridlayout.addItem(spacerItem10, 0, 5, 1, 1)
        self.override_vanbkgdrun_checkBox = QtGui.QCheckBox(self.geometry_options_groupbox)
        self.override_vanbkgdrun_checkBox.setObjectName(_fromUtf8("override_vanbkgdrun_checkBox"))
        self.correction_gridlayout.addWidget(self.override_vanbkgdrun_checkBox, 2, 2, 1, 1)
        spacerItem11 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        self.correction_gridlayout.addItem(spacerItem11, 0, 3, 1, 1)
...
"The corrections can be overriden and disabled though.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.override_vanrun_checkBox.setText(QtGui.QApplication.translate("Frame", "Override", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.override_emptyrun_checkBox.setText(QtGui.QApplication.translate("Frame", "Override", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.override_vanbkgdrun_checkBox.setText(QtGui.QApplication.translate("Frame", "Override", None, QtGui.QApplication.UnicodeUTF8))
