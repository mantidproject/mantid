...
#
# Created: Tue Mar 19 20:38:30 2013
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.gridLayout_2.addWidget(self.pushdatapostive_labe, 0, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.file_extension_label, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.preserveevents_checkbox, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.filterbadpulses_chkbox, 4, 3, 1, 1)
    ...
    def retranslateUi(self, Frame):
        ...
        self.help_button.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Advanced setup is for professional users. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.help_button.setText(QtGui.QApplication.translate("Frame", "Help", None, QtGui.QApplication.UnicodeUTF8))
        self.advanced_options_group.setTitle(QtGui.QApplication.translate("Frame", "Advanced Setup", None, QtGui.QApplication.UnicodeUTF8))
        self.unwrap_label.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Reference total flight path for frame unwrapping.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.unwrap_label.setText(QtGui.QApplication.translate("Frame", "Unwrap Ref", None, QtGui.QApplication.UnicodeUTF8))
        self.pushdatapostive_labe.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Method/algorithm to process data if negative intensity in corrected diffraction data exists. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.pushdatapostive_labe.setText(QtGui.QApplication.translate("Frame", "Push Data Positive", None, QtGui.QApplication.UnicodeUTF8))
        self.pushdatapos_combo.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Choose a method/algorithm to process negative intensity data. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.low_resolution_label.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Reference DIFC for resolution removal. Zero skips the correction.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.low_resolution_label.setText(QtGui.QApplication.translate("Frame", "Low Resolution Ref", None, QtGui.QApplication.UnicodeUTF8))
        self.lowres_edit.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Enter value for reference DIFC for resolution removal.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.removepromptwidth_edit.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Enter value for width of events (in microseconds) near the prompt pulse to remove</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Width of events (in microseconds) near the prompt pulse to remove. 0 disables. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setText(QtGui.QApplication.translate("Frame", "Remove Prompt Pulse Width", None, QtGui.QApplication.UnicodeUTF8))
        self.extension_combo.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Select a type of file extension to load run with. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.file_extension_label.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>File extension of the run file to load. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.file_extension_label.setText(QtGui.QApplication.translate("Frame", "File Extension", None, QtGui.QApplication.UnicodeUTF8))
        self.maxchunksize_edit.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Enter maximum Gbytes of file to read in one chunk. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Specify maximum Gbytes of file to read in one chunk. Default is whole file. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("Frame", "Maximum Chunk Size", None, QtGui.QApplication.UnicodeUTF8))
        self.unwrap_edit.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Enter value for reference total flight path for frame unwrapping. Zero skips the correction. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("Frame", "Minumum Cropped Wavelength", None, QtGui.QApplication.UnicodeUTF8))
        self.preserveevents_checkbox.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Check to preserve events.  Uncheck to change from events to histograms.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.filterbadpulses_chkbox.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Check to filter out events measured while proton charge is more than 5% below average </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.vanadium_correction_groupbox.setTitle(QtGui.QApplication.translate("Frame", "Strip Vanadium Peaks", None, QtGui.QApplication.UnicodeUTF8))
...
"", None, QtGui.QApplication.UnicodeUTF8))
        self.stripvanpeaks_chkbox.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Check to subtract fitted vanadium peaks from the known positions. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.vansmoothpar_edit.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Enter 2 values for FFT smooth on reduced vanadium diffraction data. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.vanpeaktol_edit.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Enter a value for vanadium peak tolerance. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.vanpeakfwhm_edit.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Enter the estimated vanadium peak FWHM. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_11.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Estimated vanadium peak\'s FWHM.  Default is 7 (data points). </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_11.setText(QtGui.QApplication.translate("Frame", "Peak FWHM", None, QtGui.QApplication.UnicodeUTF8))
        self.label_12.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>How far from the ideal position a vanadium peak can be during StripVanadiumPeaks. Default=0.05, negative turns off </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_12.setText(QtGui.QApplication.translate("Frame", "Peak Tolerance", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setToolTip(QtGui.QApplication.translate("Frame", "<html><head/><body><p>Smooth parameter for vanadium diffraction pattern.  Default=20,2. </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
