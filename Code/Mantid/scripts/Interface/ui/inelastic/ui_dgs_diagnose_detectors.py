...
class Ui_DiagDetsFrame(object):
    def setupUi(self, DiagDetsFrame):
        DiagDetsFrame.setObjectName("DiagDetsFrame")
        DiagDetsFrame.resize(883, 743)
        ...
        self.find_bad_det_gb.setObjectName("find_bad_det_gb")
        ...
        self.errorbar_crit_label.setMinimumSize(QtCore.QSize(150, 0))
        self.errorbar_crit_label.setObjectName("errorbar_crit_label")
        ...
        self.errorbar_crit_edit.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.errorbar_crit_edit.setObjectName("errorbar_crit_edit")
        ...
        self.white_beam_tests_gb.setObjectName("white_beam_tests_gb")
        ...
        self.high_counts_label.setObjectName("high_counts_label")
        ...
        self.high_counts_edit.setObjectName("high_counts_edit")
        ...
        self.low_counts_label.setObjectName("low_counts_label")
        ...
        self.low_counts_edit.setObjectName("low_counts_edit")
        ...
        self.median_test_high_label.setObjectName("median_test_high_label")
        ...
        self.median_test_high_edit.setObjectName("median_test_high_edit")
        ...
        self.median_test_low_label.setObjectName("median_test_low_label")
        ...
        self.median_test_low_edit.setObjectName("median_test_low_edit")
        ...
        self.eff_var_test_gb.setObjectName("eff_var_test_gb")
        ...
        self.prop_change_crit_label.setMinimumSize(QtCore.QSize(133, 0))
        self.prop_change_crit_label.setObjectName("prop_change_crit_label")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.prop_change_crit_edit.sizePolicy().hasHeightForWidth())
        self.prop_change_crit_edit.setSizePolicy(sizePolicy)
        self.prop_change_crit_edit.setObjectName("prop_change_crit_edit")
        ...
        self.background_check_gb.setObjectName("background_check_gb")
        ...
        self.accept_factor_label.setMinimumSize(QtCore.QSize(133, 0))
        self.accept_factor_label.setObjectName("accept_factor_label")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.accept_factor_edit.sizePolicy().hasHeightForWidth())
        self.accept_factor_edit.setSizePolicy(sizePolicy)
        self.accept_factor_edit.setObjectName("accept_factor_edit")
        ...
        self.reject_zero_bg_cb.setObjectName("reject_zero_bg_cb")
        ...
        self.psd_bleed_gb.setObjectName("psd_bleed_gb")
        ...
        self.max_framerate_label.setObjectName("max_framerate_label")
        ...
        self.max_framerate_edit.setObjectName("max_framerate_edit")
        ...
        self.ignored_pixels_label.setObjectName("ignored_pixels_label")
        ...
        self.ignored_pixels_edit.setObjectName("ignored_pixels_edit")
