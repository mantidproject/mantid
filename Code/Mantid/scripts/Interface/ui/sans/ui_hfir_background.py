...
#
# Created: Thu Aug 18 13:12:17 2011
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.thickness_label = QtGui.QLabel(self.scrollAreaWidgetContents)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.thickness_label.sizePolicy().hasHeightForWidth())
        self.thickness_label.setSizePolicy(sizePolicy)
        self.thickness_label.setMinimumSize(QtCore.QSize(175, 0))
        self.thickness_label.setMaximumSize(QtCore.QSize(175, 16777215))
        self.thickness_label.setObjectName("thickness_label")
        self.horizontalLayout_5.addWidget(self.thickness_label)
        spacerItem2 = QtGui.QSpacerItem(78, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem2)
        self.thickness_edit = QtGui.QLineEdit(self.scrollAreaWidgetContents)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        spacerItem6 = QtGui.QSpacerItem(63, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
