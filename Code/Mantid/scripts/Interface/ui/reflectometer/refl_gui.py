...
#
# Created: Wed Nov 20 10:06:21 2013
...
class Ui_ref_gui(object):
    def setupUi(self, ref_gui):
        ...
        self.layoutMainRow = QtGui.QWidget(ref_gui)
        ...
        self.tableMain.setColumnCount(17)
        ...
        ref_gui.setCentralWidget(self.layoutMainRow)
    ...
    def retranslateUi(self, ref_gui):
        ...
        self.comboInstrument.setItemText(0, QtGui.QApplication.translate("ref_gui", "Inter", None, QtGui.QApplication.UnicodeUTF8))
        self.comboInstrument.setItemText(1, QtGui.QApplication.translate("ref_gui", "SURF", None, QtGui.QApplication.UnicodeUTF8))
        self.comboInstrument.setItemText(2, QtGui.QApplication.translate("ref_gui", "CRISP", None, QtGui.QApplication.UnicodeUTF8))
        self.comboInstrument.setItemText(3, QtGui.QApplication.translate("ref_gui", "PolRef", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboPolarCorrect.setItemText(0, QtGui.QApplication.translate("ref_gui", "None", None, QtGui.QApplication.UnicodeUTF8))
        self.comboPolarCorrect.setItemText(1, QtGui.QApplication.translate("ref_gui", "1-PNR", None, QtGui.QApplication.UnicodeUTF8))
        self.comboPolarCorrect.setItemText(2, QtGui.QApplication.translate("ref_gui", "2-PA", None, QtGui.QApplication.UnicodeUTF8))
        self.comboPolarCorrect.setItemText(3, QtGui.QApplication.translate("ref_gui", "3-Other", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tableMain.horizontalHeaderItem(0).setText(QtGui.QApplication.translate("ref_gui", "Run(s)", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(1).setText(QtGui.QApplication.translate("ref_gui", "Angle 1", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("ref_gui", "trans 1", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("ref_gui", "qmin_1", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("ref_gui", "qmax_1", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(5).setText(QtGui.QApplication.translate("ref_gui", "Run(s)", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(6).setText(QtGui.QApplication.translate("ref_gui", "Angle 2", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(7).setText(QtGui.QApplication.translate("ref_gui", "trans 2", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(8).setText(QtGui.QApplication.translate("ref_gui", "qmin_2", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(9).setText(QtGui.QApplication.translate("ref_gui", "qmax_2", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(10).setText(QtGui.QApplication.translate("ref_gui", "Run(s)", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(11).setText(QtGui.QApplication.translate("ref_gui", "Angle 3", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(12).setText(QtGui.QApplication.translate("ref_gui", "qmin_3", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(13).setText(QtGui.QApplication.translate("ref_gui", "qmax_3", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(14).setText(QtGui.QApplication.translate("ref_gui", "dq/q", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(15).setText(QtGui.QApplication.translate("ref_gui", "Scale", None, QtGui.QApplication.UnicodeUTF8))
        self.tableMain.horizontalHeaderItem(16).setText(QtGui.QApplication.translate("ref_gui", "Stitch?", None, QtGui.QApplication.UnicodeUTF8))
