...
BinToMDHistoWorkspace(InputWorkspace=ws_in,OutputWorkspace='binned_axis_aligned',AxisAligned=True,
...
BinToMDHistoWorkspace(InputWorkspace=ws_in,OutputWorkspace='binned_rotated',AxisAligned=False,
