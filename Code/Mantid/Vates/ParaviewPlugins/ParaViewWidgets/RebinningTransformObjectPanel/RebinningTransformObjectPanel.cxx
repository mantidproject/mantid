...
RebinningTransformObjectPanel::RebinningTransformObjectPanel(pqProxy* pxy, QWidget* p) :
...
void RebinningTransformObjectPanel::updateInformationAndDomains()
{
...
void RebinningTransformObjectPanel::constructGeometry(QGridLayout* gLayout)
{
...
void RebinningTransformObjectPanel::constructThresholdRanges(QGridLayout* gLayout)
{
...
void RebinningTransformObjectPanel::removeAutoGeneratedWidgets()
{
...
void RebinningTransformObjectPanel::popWidget()
{
