#include "MDEWNexusReaderObjectPanel.h"
...
MDEWNexusReaderObjectPanel::MDEWNexusReaderObjectPanel(pqProxy* pxy, QWidget* p) :
...
void MDEWNexusReaderObjectPanel::updateInformationAndDomains()
{
...
void MDEWNexusReaderObjectPanel::constructGeometry(QGridLayout* gLayout)
{
...
void MDEWNexusReaderObjectPanel::constructThresholdRanges(QGridLayout* gLayout)
{
...
void MDEWNexusReaderObjectPanel::removeAutoGeneratedWidgets()
{
...
void MDEWNexusReaderObjectPanel::popWidget()
{
...
void MDEWNexusReaderObjectPanel::ignoreBinChangesListner()
{
  QLayoutItem *child;
  unsigned int size = layout()->count();
