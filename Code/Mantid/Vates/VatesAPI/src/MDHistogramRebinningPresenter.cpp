...
namespace Mantid
{
  namespace VATES
  {
    ...
    */
    MDHistogramRebinningPresenter::MDHistogramRebinningPresenter(vtkDataSet* input, RebinningActionManager* request, MDRebinningView* view, Clipper* clipper, const WorkspaceProvider& wsProvider) :
    m_inputParser(input), 
      m_input(input), 
      m_request(request), 
      m_view(view), 
    ...
    */
    void MDHistogramRebinningPresenter::forumulateBinChangeRequest(Mantid::Geometry::MDGeometryXMLParser& old_geometry, Mantid::Geometry::MDGeometryXMLParser& new_geometry)
    {
    ...
    */
    Mantid::Geometry::MDImplicitFunction_sptr MDHistogramRebinningPresenter::constructBoxFromVTKBox(vtkBox* box) const
    {
      ...
      return Mantid::Geometry::MDImplicitFunction_sptr(boxFunction);
    }

    /** Constructs a box from the inputs vtkdataset.
    * @return ImplicitFunction_sptr containing ImplicitFunction box.
    */
    Mantid::Geometry::MDImplicitFunction_sptr MDHistogramRebinningPresenter::constructBoxFromInput() const
    {
      using namespace Mantid::MDAlgorithms;
    ...
    */
    vtkDataSet* MDHistogramRebinningPresenter::execute(vtkDataSetFactory* factory, ProgressAction& eventHandler)
    {
      using namespace Mantid::API;
    ...
    const std::string& MDHistogramRebinningPresenter::getAppliedGeometryXML() const
    {
    ...
    bool
      MDHistogramRebinningPresenter::hasTDimensionAvailable() const
    {
    ...
    std::vector<double> MDHistogramRebinningPresenter::getTimeStepValues() const
    {
      Mantid::Geometry::MDGeometryXMLParser sourceGeometry(m_view->getAppliedGeometryXML());
      sourceGeometry.execute();
