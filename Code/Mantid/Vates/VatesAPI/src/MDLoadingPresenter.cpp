...
namespace Mantid
{
	namespace VATES
	{
		...
		{
				/// Static logger
				Kernel::Logger g_log("MDLoadingPresenter");
		}
		/**
		 ...
		 */
		std::string MDLoadingPresenter::extractInstrument(Mantid::API::IMDWorkspace_sptr workspace)
		{
		 ...
		 */
		QwtDoubleInterval MDLoadingPresenter::getMinAndMax(Mantid::API::IMDWorkspace_sptr workspace)
		{
     ...
     */
		QwtDoubleInterval MDLoadingPresenter::getRange(Mantid::API::IMDIterator * it)
    {
      if (!it)
