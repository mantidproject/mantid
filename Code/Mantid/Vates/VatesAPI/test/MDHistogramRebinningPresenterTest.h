...
public:
  ...
  void testConstruction()
  {
    ...
    MDHistogramRebinningPresenter presenter(pDataSetFactory, dataSet, pRequest, &view, pClipper);
  ...
  void testUpdateModelWithNoChanges()
  {
    ...
    EXPECT_CALL(view, getAppliedGeometryXML()).WillOnce(Return(constrctGeometryOnlyXML("qx", "qy", "qz", "en")));
  ...
  void testUpdateModelWithDifferentMaxThreshold()
  {
    ...
    MockRebinningActionManager* pRequest = new MockRebinningActionManager;
    EXPECT_CALL(*pRequest, ask(RecalculateAll)).Times(1); //Maxthreshold updated should reflect on request.
  ...
  void testUpdateModelWithSwapped4DGeometry()
  {
    ...
    EXPECT_CALL(view, getMinThreshold()).WillOnce(Return(0));
    EXPECT_CALL(view, getApplyClip()).WillOnce(Return(true));
    EXPECT_CALL(view, getAppliedGeometryXML()).Times(3).WillRepeatedly(Return(constrctGeometryOnlyXML("qx", "qy", "en", "qz"))); //Geometr (4D) should reflect on request.
  ...
  void testUpdateModelWithMoreXBins()
  {
    ...
    EXPECT_CALL(view, getMinThreshold()).WillOnce(Return(0));
    EXPECT_CALL(view, getApplyClip()).WillOnce(Return(true));
    EXPECT_CALL(view, getAppliedGeometryXML()).Times(3).WillRepeatedly(Return(constrctGeometryOnlyXML("qx", "qy", "qz", "en", "11"))); //Geometr (4D) should reflect on request.
  ...
  void testUpdateModelWithMoreXYBins()
  {
    ...
    EXPECT_CALL(view, getMinThreshold()).WillOnce(Return(0));
    EXPECT_CALL(view, getApplyClip()).WillOnce(Return(true));
    EXPECT_CALL(view, getAppliedGeometryXML()).Times(3).WillRepeatedly(Return(constrctGeometryOnlyXML("qx", "qy", "qz", "en", "11", "11"))); //Geometr (4D) should reflect on request.
  ...
  void testUpdateModelWithMoreXYZBins()
  {
    ...
    EXPECT_CALL(view, getMinThreshold()).WillOnce(Return(0));
    EXPECT_CALL(view, getApplyClip()).WillOnce(Return(true));
    EXPECT_CALL(view, getAppliedGeometryXML()).Times(3).WillRepeatedly(Return(constrctGeometryOnlyXML("qx", "qy", "qz", "en", "11", "11", "11"))); //Geometr (4D) should reflect on request.
  ...
  void testExecutionWithFullRebin()
  {
    ...
    ****/
    ...
    EXPECT_CALL(view, getAppliedGeometryXML()).WillOnce(Return(constrctGeometryOnlyXML("qx", "qy", "qz", "en"))); //NoChange

    MockRebinningActionManager* pRequest = new MockRebinningActionManager;
    EXPECT_CALL(*pRequest, ask(_)).Times(0);
    EXPECT_CALL(*pRequest, action()).WillOnce(Return(RecalculateAll)); //Request is preset to RecalculateAll.
    ...
    MDHistogramRebinningPresenter presenter(pDataSetFactory, dataSet, pRequest, &view, pClipper);
    presenter.updateModel();
    vtkUnstructuredGrid* product = presenter.execute(progressAction);
