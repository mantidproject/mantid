#ifndef AXISINTERACTORNEW_H_
#define AXISINTERACTORNEW_H_
 ...
 */
class AxisInteractorNew : public QWidget
{
	Q_OBJECT
...
public:
	 ...
	 */
	AxisInteractorNew(QWidget *parent = 0);
	/// Default destructor.
	virtual ~AxisInteractorNew() {}
	/**
