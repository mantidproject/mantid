...
BinMD(InputWorkspace='SEQ', AlignedDim0='[Qh,0,0],0,0.5,20', AlignedDim1='DeltaE,17,22,20', AlignedDim2='[0.5Qh,0.866Qk,0],-0.75,-0.25,20', AlignedDimT='[0,0,Ql],-0.9,-0.55,1', OutputWorkspace='SEQ_3D_int')
