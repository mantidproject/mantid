...
public:
	...
	Table *table(const QString &name, bool recursive=false) { return dynamic_cast<Table*>(window(name, "Table", recursive)); }
	//! Return matrix named name or NULL
	Matrix *matrix(const QString &name, bool recursive=false) { return dynamic_cast<Matrix*>(window(name, "Matrix", recursive)); }
	//! Return graph named name or NULL
	MultiLayer *graph(const QString &name, bool recursive=false) { return dynamic_cast<MultiLayer*>(window(name, "MultiLayer", recursive)); }
	//! Return note named name or NULL
	Note *note(const QString &name, bool recursive=false) { return dynamic_cast<Note*>(window(name, "Note", recursive)); }
