...
class RemoteAlgorithmDockWidget;
...
private:
  ...
  RemoteAlgorithmDockWidget *m_exploreRemoteAlgorithms;   // Dock window for using remote algorithms
  ...
  QAction *actionToggleRemoteAlgorithms;
