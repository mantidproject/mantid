...
/// Constructor
MantidQwtIMDWorkspaceData::MantidQwtIMDWorkspaceData(Mantid::API::IMDWorkspace_const_sptr workspace,const bool logScale, bool distr)
: QObject(),
...
void MantidQwtIMDWorkspaceData::applyOffsets(const double xOffset, const double yOffset)
{
