...
public:
  ...
  void testMultiPeriod()
  {
    ...
    TS_ASSERT_THROWS_NOTHING( output1 = AnalysisDataService::Instance().retrieve("multiperiod2") );
    TS_ASSERT_EQUALS( output1->getNumberHistograms(), 4 )
    Workspace_sptr output2;
    TS_ASSERT_THROWS_NOTHING( output2 = AnalysisDataService::Instance().retrieve("multiperiod2_2") );
    TS_ASSERT_EQUALS( output2->getNumberHistograms(), 4 )
    Workspace_sptr output3;
    TS_ASSERT_THROWS_NOTHING( output3 = AnalysisDataService::Instance().retrieve("multiperiod2_3") );
    TS_ASSERT_EQUALS( output3->getNumberHistograms(), 4 )
    Workspace_sptr output4;
    TS_ASSERT_THROWS_NOTHING( output4 = AnalysisDataService::Instance().retrieve("multiperiod2_4") );
    TS_ASSERT_EQUALS( output4->getNumberHistograms(), 4 )
    Workspace_sptr output5;
    TS_ASSERT_THROWS_NOTHING( output5 = AnalysisDataService::Instance().retrieve("multiperiod2_5") );
    TS_ASSERT_EQUALS( output5->getNumberHistograms(), 4 )
    Workspace_sptr output6;
    TS_ASSERT_THROWS_NOTHING( output6 = AnalysisDataService::Instance().retrieve("multiperiod2_6") );
    TS_ASSERT_EQUALS( output6->getNumberHistograms(), 4 )
    Workspace_sptr output7;
    TS_ASSERT_THROWS_NOTHING( output7 = AnalysisDataService::Instance().retrieve("multiperiod2_7") );
    TS_ASSERT_EQUALS( output7->getNumberHistograms(), 4 )
    Workspace_sptr output8;
    TS_ASSERT_THROWS_NOTHING( output8 = AnalysisDataService::Instance().retrieve("multiperiod2_8") );
    TS_ASSERT_EQUALS( output8->getNumberHistograms(), 4 )
    Workspace_sptr output9;
    TS_ASSERT_THROWS_NOTHING( output9 = AnalysisDataService::Instance().retrieve("multiperiod2_9") );
    TS_ASSERT_EQUALS( output9->getNumberHistograms(), 4 )
    Workspace_sptr output10;
    TS_ASSERT_THROWS_NOTHING( output10 = AnalysisDataService::Instance().retrieve("multiperiod2_10") );
    TS_ASSERT_EQUALS( output10->getNumberHistograms(), 4 )
    Workspace_sptr output11;
    TS_ASSERT_THROWS_NOTHING( output11 = AnalysisDataService::Instance().retrieve("multiperiod2_11") );
    TS_ASSERT_EQUALS( output11->getNumberHistograms(), 4 )
    Workspace_sptr output12;
    TS_ASSERT_THROWS_NOTHING( output12 = AnalysisDataService::Instance().retrieve("multiperiod2_12") );
