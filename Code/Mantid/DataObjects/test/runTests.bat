...
cl runner.cpp /D "BOOST_ALL_DYN_LINK" /I "..\inc" /I "..\..\..\Third_Party\include" /I "..\..\..\Third_Party\src\cxxtest" /I "..\..\kernel\inc" /I "..\..\DataObjects\inc" /I "..\..\Geometry\inc" /I "..\..\API\inc" /I "..\inc" /EHsc /MDd /wd4275 /wd4996 /W3 /nologo /c /ZI /TP 
