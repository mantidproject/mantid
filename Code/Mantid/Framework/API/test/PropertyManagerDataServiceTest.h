...
public:
  ...
  PropertyManagerDataServiceTest() : inst1(new PropertyManager), inst2(new PropertyManager)
	...
	void testAdd()
	{
		...
		TS_ASSERT_THROWS(PropertyManagerDataService::Instance().add("",inst1),std::runtime_error);
	...
	void testAddOrReplace()
	{
		...
		TS_ASSERT_THROWS(PropertyManagerDataService::Instance().addOrReplace("",inst2),std::runtime_error);
	...
	void testRetrieve()
	{
		...
		TS_ASSERT_THROWS(PropertyManagerDataService::Instance().retrieve("notregistered"),Mantid::Kernel::Exception::NotFoundError);
	}
	void testRemove()
	{
