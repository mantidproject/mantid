...
{
public:
  typedef boost::shared_ptr<Mantid::API::IkedaCarpenterModerator> IkedaCarpenterModerator_sptr;
  ...
  void test_Initializing_With_String_Containing_Some_Parameters_Leaves_Others_At_Default_Values()
  {
    Mantid::API::IkedaCarpenterModerator ikmod;
  ...
  void test_Initializing_With_String_Containing_All_Parameters_Gives_Correct_Coefficients()
  {
    Mantid::API::IkedaCarpenterModerator ikmod;
  ...
  void test_sampleTimeDistribution_With_Values_Less_Than_Zero_Throws()
  {
    ...
    TS_ASSERT_THROWS(ikmod->sampleTimeDistribution(-0.01), std::invalid_argument);
    TS_ASSERT_THROWS(ikmod->sampleTimeDistribution(-1.5), std::invalid_argument);
  }

  void test_sampleTimeDistribution_With_Value_Equal_To_Zero_Returns_Negative_Of_Mean()
  {
    IkedaCarpenterModerator_sptr ikmod = createTestModerator();
  ...
  void test_sampleTimeDistribution_With_Values_Within_Range_Return_Expected_Numbers()
  {
    IkedaCarpenterModerator_sptr ikmod = createTestModerator();
  ...
  void test_sampleTimeDistribution_With_Value_Greater_Than_One_Throws()
  {
    ...
    TS_ASSERT_THROWS(ikmod->sampleTimeDistribution(1.01), std::invalid_argument);
...
private:
  ...
  void checkParametersAreSet(const Mantid::API::IkedaCarpenterModerator & ikmod,
                             const double tilt, const double alpha, const double beta, const double rmix)
  {
  ...
  boost::shared_ptr<Mantid::API::IkedaCarpenterModerator> createTestModerator()
  {
    using namespace Mantid::API;
    IkedaCarpenterModerator_sptr moderator = boost::make_shared<IkedaCarpenterModerator>();
