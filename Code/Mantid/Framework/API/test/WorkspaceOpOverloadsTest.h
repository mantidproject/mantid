...
public:
  //-------------------------------------------------------------------------------------------
  // WorkspaceHelpers tests (N.B. Operator overload tests are in the algorithms that they call)
  //-------------------------------------------------------------------------------------------
  ...
  void test_commonBoundaries()
  {
    ...
    TSM_ASSERT("A single-spectrum workspace should always pass", WorkspaceHelpers::commonBoundaries(singlespectrum) );
