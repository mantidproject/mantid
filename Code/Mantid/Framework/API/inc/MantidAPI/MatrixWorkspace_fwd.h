...
/**
  ...
  @link Mantid::API::MatrixWorkspace
...
/// forward declare of @link Mantid::API::MatrixWorkspace
class MatrixWorkspace;
/// shared pointer to @link Mantid::API::MatrixWorkspace
typedef boost::shared_ptr<MatrixWorkspace> MatrixWorkspace_sptr;
/// shared pointer to @link Mantid::API::MatrixWorkspace (const version)
