...
/* Used to register Catalog classes into the factory. creates a global object in an
...
#define DECLARE_CATALOG(classname) \
  namespace { \
    Mantid::Kernel::RegistrationHelper register_alg_##classname( \
       ((Mantid::API::CatalogFactory::Instance().subscribe<classname>(#classname)) \
       , 0)); \
  } 
...
*/
class EXPORT_OPT_MANTID_API CatalogFactoryImpl : public Kernel::DynamicFactory<ICatalog>
{
public:
...
// this breaks new namespace declaraion rules; need to find a better fix
  template class EXPORT_OPT_MANTID_API Mantid::Kernel::SingletonHolder<CatalogFactoryImpl>;
#endif /* _WIN32 */
