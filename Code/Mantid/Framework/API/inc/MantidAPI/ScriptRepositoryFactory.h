...
// this breaks new namespace declaraion rules; need to find a better fix
        template class MANTID_API_DLL Mantid::Kernel::SingletonHolder<ScriptRepositoryFactoryImpl>;
#endif /* _WIN32 */
        typedef MANTID_API_DLL Mantid::Kernel::SingletonHolder<ScriptRepositoryFactoryImpl> ScriptRepositoryFactory;
...
#define DECLARE_SCRIPTREPOSITORY(classname) \
  ...
  ((Mantid::API::ScriptRepositoryFactory::Instance().subscribe<classname>(#classname)) \
        , 0)); \
        }
