...
namespace API
{
  ...
  */
  ...
  public:
    ...
    inline uint64_t getFilePosition() const
    { return m_filePos; }
     ...
     * @return true if the merge was successful and the "other" block should be dropped
