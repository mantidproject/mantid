...
namespace Mantid
{
  namespace API
  {
    ...
    /// Default constructor. Notification handlers are not connected to any algorithm
...
/// @cond Doxygen cannot handle the macro around the argument name
    ...
    */
    void AlgorithmObserver::startingHandle(IAlgorithm_sptr alg)
    {
      UNUSED_ARG(alg)
    }
    ...
    /** Handler of the start notifications. Must be overriden in inherited classes.
        ...
        the corresponding Algorithm type object.
    */
    void AlgorithmObserver::startHandle(const IAlgorithm* alg)
    {
      UNUSED_ARG(alg)
    }
   ...
   /** Handler of the finish notifications. Must be overriden in inherited classes.
        ...
        the corresponding Algorithm type object.
    */
    void AlgorithmObserver::finishHandle(const IAlgorithm* alg)
    {
      UNUSED_ARG(alg)
    }
