...
namespace Mantid
{
  namespace API
  {
    ...
    */
     ...
     */
    std::string AlgorithmProperty::value() const
    {
      return m_algStr;
    }
     ...
     */
    std::string AlgorithmProperty::getDefault() const
    {
      return "";
    }
     ...
     * @return An empty string if the value is valid, otherwise the string will contain the error
    */
