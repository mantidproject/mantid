#ifndef MANTID_ALGORITHMS_SCD_TOFINT_H_
#define MANTID_ALGORITHMS_SCD_TOFINT_H_
 ...
 */
class DLLExport SCD_TOFINT: public API::Algorithm
{
public:
  /// Default constructor
  SCD_TOFINT();
  ...
  virtual const std::string name() const { return "SCD_TOFINT"; }
...
private:
  ...
  double TOFmin;        ///< The start of the TOF range for fitting
  double TOFmax;        ///< The end of the TOF range for fitting
...
#endif /*MANTID_ALGORITHM_SCD_TOFINT_H_*/
