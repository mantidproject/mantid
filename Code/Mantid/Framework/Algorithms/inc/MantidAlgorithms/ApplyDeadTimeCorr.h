...
namespace Algorithms
{
  ...
  /** ApplyDeadTimeCorr : The dead-time is here applied according to the non-extendable paralyzable dead time model.
  ...
  */
  ...
  public:
    ...
    virtual const std::string category() const { return "Muon;CorrectionFunctions\\EfficiencyCorrections";}
