#ifndef ALIGNDETECTORSTEST2_H_
#define ALIGNDETECTORSTEST2_H_
...
class AlignDetectorsTest2 : public CxxTest::TestSuite
{
public:
  // This pair of boilerplate methods prevent the suite being created statically
  // This means the constructor isn't called when running other tests
  static AlignDetectorsTest2 *createSuite() { return new AlignDetectorsTest2(); }
  static void destroySuite( AlignDetectorsTest2 *suite ) { delete suite; }
  ...
  void testTheBasics()
  {
    ...
    TS_ASSERT_EQUALS( align.version(), 2 );
