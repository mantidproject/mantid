#ifndef MANTID_ALGORITHMS_CONJOINWORKSPACES2TEST_H_
#define MANTID_ALGORITHMS_CONJOINWORKSPACES2TEST_H_
...
class ConjoinWorkspaces2Test : public CxxTest::TestSuite
{

public:
  // This pair of boilerplate methods prevent the suite being created statically
  // This means the constructor isn't called when running other tests
  static ConjoinWorkspaces2Test *createSuite() { return new ConjoinWorkspaces2Test(); }
  static void destroySuite( ConjoinWorkspaces2Test *suite ) { delete suite; }

  ConjoinWorkspaces2Test() :
  ...
  void testTheBasics()
  {
    ConjoinWorkspaces2 conj;
    TS_ASSERT_EQUALS( conj.name(), "ConjoinWorkspaces" );
    TS_ASSERT_EQUALS( conj.version(), 2 );
  ...
  void testExec()
  {
    ...
    TS_ASSERT_THROWS_NOTHING( conj.setPropertyValue("OutputWorkspace","top") );
  ...
  void testExecMismatchedWorkspaces()
  {
    ...
    TS_ASSERT_THROWS_NOTHING( conj.setPropertyValue("OutputWorkspace","outevent") );
    conj.execute();
    TS_ASSERT( ! conj.isExecuted() );
  ...
  void testDoCheckForOverlap()
  {
    ...
    TS_ASSERT_THROWS_NOTHING( conj.setPropertyValue("OutputWorkspace",ws1_name) );
  ...
  void performTestNoOverlap(bool event)
  {
    ...
    TS_ASSERT_THROWS_NOTHING( conj.setPropertyValue("OutputWorkspace",ws1Name) );
...
#endif /* MANTID_ALGORITHMS_CONJOINWORKSPACES2TEST_H_ */
