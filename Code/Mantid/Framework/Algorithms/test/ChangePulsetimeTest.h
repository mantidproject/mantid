...
public:
  ...
  void do_test(std::string in_ws_name, std::string out_ws_name, std::string WorkspaceIndexList)
  {
    ...
    {
      double secs;
      secs = DateAndTime::secondsFromDuration(out_ws->getEventList(wi).getEvent(0).pulseTime() - DateAndTime("2010-01-01T00:00:00"));
      TS_ASSERT_DELTA(secs, 1000.0, 1e-5);
      secs = DateAndTime::secondsFromDuration(out_ws->getEventList(wi).getEvent(2).pulseTime() - DateAndTime("2010-01-01T00:00:00"));
    ...
    {
      double secs;
      secs = DateAndTime::secondsFromDuration(out_ws->getEventList(0).getEvent(2).pulseTime() - DateAndTime("2010-01-01T00:00:00"));
      TS_ASSERT_DELTA(secs, 1.0, 1e-5);
      secs = DateAndTime::secondsFromDuration(out_ws->getEventList(30).getEvent(2).pulseTime() - DateAndTime("2010-01-01T00:00:00"));
      TS_ASSERT_DELTA(secs, 1.0, 1e-5);
    }
    ...
    {
      double secs;
      secs = DateAndTime::secondsFromDuration(in_ws->getEventList(0).getEvent(2).pulseTime() - DateAndTime("2010-01-01T00:00:00"));
      TS_ASSERT_DELTA(secs, 1.0, 1e-5);
    }
