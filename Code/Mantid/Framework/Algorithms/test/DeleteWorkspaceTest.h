...
public:
  ...
  void test_That_An_Existing_Workspace_Is_Deleted_After_Execution()
  {
    ...
    Workspace2D_sptr testWS1 = WorkspaceCreationHelper::Create2DWorkspace(10,yLength1);
    const int yLength2 = 20;
    Workspace2D_sptr testWS2 = WorkspaceCreationHelper::Create2DWorkspace(10,yLength2);
