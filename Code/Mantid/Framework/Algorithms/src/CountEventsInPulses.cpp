...
namespace Algorithms
{
  ...
  void CountEventsInPulses::exec()
  {
      ...
      DataObjects::EventWorkspace_sptr outputWS = this->createEventWorkspace(inpWS, mSumSpectra);
   ...
   */
  DataObjects::EventWorkspace_sptr CountEventsInPulses::createEventWorkspace(DataObjects::EventWorkspace_const_sptr parentws, bool sumspectrum)
  {
      size_t numspec;
      bool diffsize;
      if (sumspectrum)
   ...
   */
  void CountEventsInPulses::convertEvents(DataObjects::EventWorkspace_sptr outWS, bool sumspectra)
  {
      ...
      for (int wsindex = 0; wsindex < static_cast<int>(inpWS->getNumberHistograms()); wsindex++)
      {
