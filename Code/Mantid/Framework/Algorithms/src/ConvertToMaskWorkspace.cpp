...
DECLARE_ALGORITHM(ConvertToMaskWorkspace)

//----------------------------------------------------------------------------------------------
/** Constructor
 */
ConvertToMaskWorkspace::ConvertToMaskWorkspace()
{
}
...
void ConvertToMaskWorkspace::initDocs()
{
  this->setWikiSummary("Convert a Workspace to a Mask workspace");
  this->setOptionalMessage("Convert Workspace to a MaskWorkspace.");
}

void ConvertToMaskWorkspace::init()
{
...
void ConvertToMaskWorkspace::exec()
{
  // 1. Get Input
