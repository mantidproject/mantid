...
//    std::cout << "D-RANGE[" << inputW->getSpectrum(wi)->getSpectrumNo() << "]: " << minD << " -> " << maxD << std::endl;
...
//      std::cout << " h:" << height << " c:" << centre << " w:" << (width/(2.*std::sqrt(2.*std::log(2.))))
//                << " b:" << background << " chisq:" << chi2 << std::endl;
