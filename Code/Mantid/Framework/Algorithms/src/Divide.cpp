...
namespace Mantid
{
  namespace Algorithms
  {
    ...
    void Divide::init()
    {
      ...
      declareProperty("WarnOnZeroDivide",true, "Algorithm usually warns if division by 0 occurs. Set this value to true if one does not want this message appearing ");
    }
