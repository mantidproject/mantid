...
namespace Algorithms
{
   ...
   */
  MatrixWorkspace_sptr WorkspaceJoiners::execWS2D(API::MatrixWorkspace_const_sptr ws1, API::MatrixWorkspace_const_sptr ws2)
  {
   ...
   */
  void WorkspaceJoiners::validateInputs(API::MatrixWorkspace_const_sptr ws1, API::MatrixWorkspace_const_sptr ws2)
  {
   ...
   */
  void WorkspaceJoiners::getMinMax(MatrixWorkspace_const_sptr ws, specid_t& min, specid_t& max)
  {
    specid_t temp;
