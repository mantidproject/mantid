...
typedef boost::shared_ptr<AbstractSpaceGroupGenerator> AbstractSpaceGroupGenerator_sptr;
...
public:
    ...
    void subscribeUsingGenerator(size_t number, const std::string &hmSymbol, const std::string &generatorString)
    {
        ...
        AbstractSpaceGroupGenerator_sptr generator = boost::make_shared<T>(number, hmSymbol, generatorString);
