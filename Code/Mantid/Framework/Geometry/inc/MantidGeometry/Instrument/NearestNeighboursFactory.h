...
namespace Geometry
{
  ...
  /** NearestNeighboursFactory : Implementation of INearestNeighbours factory returning a NearestNeighbours object upon create.
  ...
  */
  class MANTID_GEOMETRY_DLL NearestNeighboursFactory : public INearestNeighboursFactory
  {
  public:
    /// Constructor
