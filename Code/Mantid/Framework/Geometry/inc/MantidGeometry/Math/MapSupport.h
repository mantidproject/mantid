...
/**
  ...
  equal.
*/
template <typename KeyPart, typename NumPart> class valEqual {
private:
...
template <typename KeyPart, typename PtrPart> class mapDelete {
public:
...
public:
  /// Create with Map
  sndValue(const std::map<KeyPart, NumPart> &Mr) : MRef(Mr) {}
