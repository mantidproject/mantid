...
namespace Mantid
{
  namespace Geometry
  {
    ...
    *
    * A builder for the MDHistogram workspace. Required to construct a valid MDHistogram dimension, where values can
    * cannot easily be brought togeter at once. Also allows potential construction values to be overwritten simply.
    * 
