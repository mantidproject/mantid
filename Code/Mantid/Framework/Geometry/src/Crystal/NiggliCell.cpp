...
namespace Geometry
{
  ...
  */    
  NiggliCell::NiggliCell(const NiggliCell& other) : UnitCell(other),U(other.U),UB(other.UB)
  {
  }
  ...
  */
  ...
  @param Umatrix :: orientation matrix U
  */
  NiggliCell::NiggliCell(const double _a,const double _b,const double _c,const double _alpha,
  ...
  */
   ...
   */
  bool NiggliCell::HasNiggliAngles( const V3D    & a_dir,
                                       const V3D    & b_dir,
                                       const V3D    & c_dir,
                                             double   epsilon  )
  {
  ...
  bool NiggliCell::MakeNiggliUB( const DblMatrix  & UB,
                                          DblMatrix  & newUB )
  {
    V3D a;
    V3D b;
