...
namespace Mantid
{
  ...
  namespace Geometry
  {
    ...
    Cone::Cone(const Cone& A) :
        Quadratic(A), Centre(A.Centre), Normal(A.Normal), alpha(A.alpha), cangle(A.cangle)
    /**
    ...
    void Cone::getBoundingBox(double &xmax, double &ymax, double &zmax, double &xmin, double &ymin,
        double &zmin)
    {
      /**
       Cone bounding box
