...
namespace Mantid { namespace Geometry {
namespace ComponentHelper
  {
     ...
     * @param positionType Defines how the given position should be interpreted @see TransformType enumeration
     */
        ...
        const Kernel::V3D & pos, const TransformType positionType)
    {
      ...
      case Relative:
        ...
        break;
      default:
        throw std::invalid_argument("moveComponent -  Unknown positionType: " + boost::lexical_cast<std::string>(positionType));
      }
                         ...
                         const Kernel::Quat & rot, const TransformType rotType)
    {
      ...
      {
        throw std::invalid_argument("rotateComponent -  Unknown rotType: " + boost::lexical_cast<std::string>(rotType));
      }
