...
namespace Geometry
{
   ...
   *
   * @return a mangled name combining the filename and the "last-modified" attribute of the XML contents
   * */
   ...
   *
   * @param prog :: Optional Progress reporter object. If NULL, no progress reporting.
   * @return the instrument that was created
   */
  Instrument_sptr InstrumentDefinitionParser::parseXML(Kernel::ProgressBase * prog)
  {
    if (!pDoc)
  ...
  */
  Kernel::V3D InstrumentDefinitionParser::getRelativeTranslation(const Geometry::IComponent* comp, const Poco::XML::Element* pElem,
                                    const double angleConvertConst, const bool deltaOffsets)
  {
  ...
  */
  void InstrumentDefinitionParser::makeXYplaneFaceComponent(Geometry::IComponent* &in, const Geometry::ObjComponent* facing)
  {
