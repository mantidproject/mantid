  ...
  namespace ISISLiveData
  {
    ...
    */
    ...
    public:
      ...
      */
      TestServerConnection( const Poco::Net::StreamSocket & soc, int nper, int nspec,int rate, int nevents, boost::shared_ptr<Progress> prog ):
    ...
    */
    ...
    public:
      ...
      * Constructor.
      */
      TestServerConnectionFactory(int nper, int nspec,int rate, int nevents, boost::shared_ptr<Progress> prog):
