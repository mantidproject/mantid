...
namespace MDEvents
{
  ...
  /** QueryMDWorkspace : Query an MDWorkspace in order to extract overview information as a table workspace. Signal and Error squared values as well as extent information are exported.
  ...
  */
  ...
  public:
    ...
    virtual const std::string summary() const {return "Query the IMDWorkspace in order to extract summary information.";}
