...
namespace Mantid
{
  namespace MDEvents
  {
    ...
    */
    coord_t** AffineMatrixParameter::getRawMatrix()
    {
      return rawMatrix;
    }
    ...
    */
    ...
    {
      return new AffineMatrixParameter(affineMatrix.numRows()-1, affineMatrix.numCols()-1);
    }
    ...
    */
    bool AffineMatrixParameter::isValid() const
    {
      return m_isValid;
    }
    ...
    */
    ...
    {
      if((other.affineMatrix.numCols() != this->affineMatrix.numCols()) || (other.affineMatrix.numRows() != this->affineMatrix.numRows()))
      {
        throw std::runtime_error("Cannot make assignemnts between AffineMatrixParameter when the matrixes are of different sizes.");
      }
      if(this != &other)
      {
    ...
    */
    AffineMatrixParameter::AffineMatrixParameter(const AffineMatrixParameter& other) : affineMatrix(other.affineMatrix)
    {
