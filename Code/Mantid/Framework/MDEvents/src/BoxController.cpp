...
namespace MDEvents
{
  ...
  //------------------------------------------------------------------------------------------------------
  /** Static method that constructs a BoxController from an XML string
   *
   * @param xml :: string generated by BoxController::toXMLString()
   * @return the BoxController object.
   */
  BoxController * BoxController::fromXMLString(const std::string & xml)
  {
    using namespace Poco::XML;
    ...
    BoxController * out = new BoxController(nd);
