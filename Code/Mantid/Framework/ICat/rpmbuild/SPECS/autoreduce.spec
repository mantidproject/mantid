...
install -m 755	 ../autoreduce/usr/lib/autoreduce/icat3-xmllingest-client-1.0.0-SNAPSHOT.jar	 %{buildroot}%{_libdir}/autoreduce/icat3-xmllingest-client-1.0.0-SNAPSHOT.jar
...
%attr(755, -, -) %{_libdir}/autoreduce/icat3-xmllingest-client-1.0.0-SNAPSHOT.jar
