...
{	soap_imode(this, imode);
    ...
    std::string s = Mantid::Kernel::ConfigService::Instance().getFacility().getSoapEndPoint();
    soap_endpoint = new char[s.size()+1];
    memcpy(soap_endpoint,s.c_str(),s.size()+1);
