...
int ICATPortBindingProxy::getUserDetails(const char *endpoint, const char *soap_action, ns1__getUserDetails *ns1__getUserDetails_, ns1__getUserDetailsResponse *ns1__getUserDetailsResponse_)
{ struct soap *soap = this;
