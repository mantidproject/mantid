...
void PoldiSpectrumLinearBackground::function1DSpectrum(const FunctionDomain1DSpectrum &domain, FunctionValues &values) const
{
...
void PoldiSpectrumLinearBackground::functionDeriv1DSpectrum(const FunctionDomain1DSpectrum &domain, Jacobian &jacobian)
{
    double wsIndexDouble = static_cast<double>(domain.getWorkspaceIndex());
...
void PoldiSpectrumLinearBackground::init()
{
    declareParameter("A1");
}
