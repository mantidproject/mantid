 ...
 *
 * The following two functions are exactly inverse, as demonstrated by the unit tests.
 */
...
/** Converts d-spacing in Angstrom to momentum transfer Q (in reciprocal Angstrom). Throws std::domain_error
...
/** Converts momentum transfer Q (in reciprocal Angstrom) to d-spacing in Angstrom. Throws std::domain_error
