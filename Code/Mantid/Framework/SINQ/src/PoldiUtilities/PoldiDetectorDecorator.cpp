...
void PoldiDetectorDecorator::setDecoratedDetector(boost::shared_ptr<PoldiAbstractDetector> detector)
{
...
boost::shared_ptr<PoldiAbstractDetector> PoldiDetectorDecorator::decoratedDetector()
{
