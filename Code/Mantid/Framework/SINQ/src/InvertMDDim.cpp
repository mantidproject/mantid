...
void InvertMDDim::recurseDim(IMDHistoWorkspace_sptr inWS, IMDHistoWorkspace_sptr outWS,
...
void InvertMDDim::copyMetaData( Mantid::API::IMDHistoWorkspace_sptr inws,  Mantid::API::IMDHistoWorkspace_sptr outws)
{
...
/**
 * This is here is mostly a workaround for a missing feature in IMDHistoWorkspace.
