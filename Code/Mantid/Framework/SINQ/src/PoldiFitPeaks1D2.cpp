...
PoldiPeakCollection_sptr PoldiFitPeaks1D2::getInitializedPeakCollection(const DataObjects::TableWorkspace_sptr &peakTable) const
{
...
void PoldiFitPeaks1D2::setValuesFromProfileFunction(PoldiPeak_sptr poldiPeak, const IFunction_sptr &fittedFunction) const
{
...
double PoldiFitPeaks1D2::getFwhmWidthRelation(IPeakFunction_sptr peakFunction) const
{
...
int PoldiFitPeaks1D2::getBestChebyshevPolynomialDegree(const Workspace2D_sptr &dataWorkspace, const RefinedRange_sptr &range)
{
    int n = 0;
...
IAlgorithm_sptr PoldiFitPeaks1D2::getFitAlgorithm(const Workspace2D_sptr &dataWorkspace, const RefinedRange_sptr &range, int n)
{
