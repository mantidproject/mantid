...
namespace SINQ
{
  ...
  const std::string PoldiPeakSummary::category() const { return TODO: FILL IN A CATEGORY;}

  /// Algorithm's summary for use in the GUI and help. @see Algorithm::summary
  const std::string PoldiPeakSummary::summary() const { return TODO: FILL IN A SUMMARY;};
