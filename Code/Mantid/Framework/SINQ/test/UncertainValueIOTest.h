...
public:
    ...
    void testFromString()
    {
        ...
        TS_ASSERT_THROWS(UncertainValueIO::fromString(invalidOne), boost::bad_lexical_cast);

        std::string invalidTwo("4.0 +/- 3.0 +/- 1.0");
        TS_ASSERT_THROWS(UncertainValueIO::fromString(invalidTwo), std::runtime_error);
    }
