...
//----------------------------------------------------------------------
  ...
  namespace Poldi
  {
  // N.B. PoldiRemoveDeadWires is used to detecte and remove dead wire from Poldi raw data
  /** @class PoldiRemoveDeadWires PoldiRemoveDeadWires.h Poldi/PoldiRemoveDeadWires.h

      Part of the Poldi scripts set, used to detecte and remove dead wire from Poldi raw data
  ...
  */
    ...
    private:
      ...
      void runExcludWires3(DataObjects::Workspace2D_sptr &localWorkspace, API::ITableWorkspace_sptr &outputws);
      // auto detecte and remove dead wires by average intensity comparison with neighbors
      void autoRemoveDeadWires(DataObjects::Workspace2D_sptr &localWorkspace, API::ITableWorkspace_sptr &outputws);
