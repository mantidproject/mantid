...
/** PoldiDeadWireDecorator :
   *
   *This implementation of PoldiDetectorDecorator forwards all calls to the decorated detector,
   *except the ones regarding available elements. These are "cleaned" from dead wires which
