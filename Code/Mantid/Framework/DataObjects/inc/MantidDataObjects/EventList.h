...
public:
  ...
  ///
  void splitByFullTimeMatrixSplitter(const std::vector<int64_t>& vectimes, const std::vector<int>& vecgroups,
...
private:
  ...
  template< class T >
  void splitByFullTimeVectorSplitterHelper(const std::vector<int64_t>& vectimes,
