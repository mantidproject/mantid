...
public:
  ...
  void test_PeakColumn_Cannot_Be_Resized()
  {
    ...
    TS_ASSERT_THROWS(pc.resize(10), Mantid::Kernel::Exception::NotImplementedError);
  }

  void test_Row_Cannot_Be_Inserted_Into_PeakColumn()
  {
    PeakColumnTestHelper pc(m_peaks, "DetID");
    TS_ASSERT_THROWS(pc.insert(0), Mantid::Kernel::Exception::NotImplementedError);
  }

  void test_Row_Cannot_Be_Removed_From_PeakColumn()
  {
    PeakColumnTestHelper pc(m_peaks, "DetID");
    TS_ASSERT_THROWS(pc.remove(0), Mantid::Kernel::Exception::NotImplementedError);
  }
