...
*/
class DLLExport EQSANSSensitivityCorrection : public API::Algorithm
{
public:
  /// (Empty) Constructor
  EQSANSSensitivityCorrection() : API::Algorithm() {}
  /// Virtual destructor
  virtual ~EQSANSSensitivityCorrection() {}
  /// Algorithm's name
  virtual const std::string name() const { return "EQSANSSensitivityCorrection"; }
  /// Algorithm's version
...
#endif /*MANTID_ALGORITHMS_EQSANSSENSITIVITYCORRECTION_H_*/
