...
instruments need to pass a monitor workspace to ''GetEi'' since they are
separate from the sample workspace. Parameters in italics are controlled by the
  ...
  namespace WorkflowAlgorithms
  {
    ...
    void DgsConvertToEnergyTransfer::exec()
    {
      ...
      if ("ISIS" == facility)
      {
        ...
        IAlgorithm_sptr csvw = this->createChildAlgorithm("CreateSingleValuedWorkspace");
