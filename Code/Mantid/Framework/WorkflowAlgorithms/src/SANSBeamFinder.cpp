...
{
  const int nx_pixels = (int)(HFIRInstrument::readInstrumentParameter("number-of-x-pixels", beamCenterWS));
  const int ny_pixels = (int)(HFIRInstrument::readInstrumentParameter("number-of-y-pixels", beamCenterWS));
  std::vector<int> IDs;
