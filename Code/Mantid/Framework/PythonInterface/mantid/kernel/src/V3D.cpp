...
void export_V3D()
{
  ...
  class_< V3D >("V3D",init<>("Construct a V3D at the origin"))
    ...
    .def("scalarprod", &V3D::scalar_prod, "Computes the scalar product between this and another vector")
    .def("crossprod", &V3D::cross_prod, "Computes the cross product between this and another vector")
