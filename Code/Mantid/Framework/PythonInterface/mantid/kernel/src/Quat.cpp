...
void export_Quat()
{
  ...
  class_< Quat >("Quat", init<>("Construct a default Quat that will perform no transformation."))
    ...
    .def("imag_i", &Quat::imagI, "Returns the ith imaginary component")
    .def("imag_j", &Quat::imagJ, "Returns the jth imaginary component")
    .def("imag_k", &Quat::imagK, "Returns the kth imaginary component")
