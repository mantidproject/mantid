...
class IEventWorkspaceTest(unittest.TestCase):
    ...
    def test_meta_information(self):
        self.assertEquals(self._test_ws.get_number_events(), 164)
        self.assertAlmostEquals(self._test_ws.get_tof_min(), 44704.8984375)
        self.assertAlmostEquals(self._test_ws.get_tof_max(), 55612.3984375)
