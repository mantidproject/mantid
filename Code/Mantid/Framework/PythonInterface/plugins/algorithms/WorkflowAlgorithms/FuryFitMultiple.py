"""*WIKI*
Fits and *_iqt file generated by Fury using one of the specified functions.
The functions available are either one or two exponentials (<math>Intensity \times exp[-(x/\tau)]</math>), a stretched exponential (<math>Intensity \times exp[-(x/\tau)]\beta</math>) or a combination of both an exponential and stretched exponential.
...
class FuryFitMultiple(PythonAlgorithm):
    ...
    def PyInit(self):
        self.setWikiSummary("Fits and *_iqt file generated by Fury using one of the specified functions.")
