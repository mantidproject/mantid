...
MD_FileTestDataGenerator::read_pointDescriptions(void)const
{
    ...
    aPointDescr.NumDimensions     = static_cast<unsigned int>(this->GeomDescription.getNumDims());
    aPointDescr.NumRecDimensions = static_cast<unsigned int>(this->GeomDescription.getNumRecDims());
