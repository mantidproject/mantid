...
private:
 // these values imitate the values that shoud be located in file 
    ...
    //
    std::auto_ptr<MDDataTestHelper::MDDensityHomogeneous> pTestDataSource;
   ...
   /// number of cells in the MDImage;
    ...
    void fill_image();
    /// internal auxiliary function, which returns n-Dimensional cell index calculated from the cell number; -> moved to MDDensityTestHelper
