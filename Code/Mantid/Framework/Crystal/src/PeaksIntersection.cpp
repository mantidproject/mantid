...
namespace Crystal
{
  std::string PeaksIntersection::detectorSpaceFrame()
  {
    return "Detector space";
  }

  std::string PeaksIntersection::qLabFrame()
  {
    return "Q (lab frame)";
  }

  std::string PeaksIntersection::qSampleFrame()
  {
    return "Q (sample frame)";
  }

  std::string PeaksIntersection::hklFrame()
  {
    return "HKL";
  }
