...
namespace Crystal
{
  ...
  HardThresholdBackground::HardThresholdBackground(const HardThresholdBackground& other) :
    m_thresholdSignal(other.m_thresholdSignal), m_normalization(other.m_normalization)
  {
  }
  ...
  HardThresholdBackground& HardThresholdBackground::operator=(const HardThresholdBackground& other)
  {
    if(&other != this)
    {
