...
namespace Crystal
{
  ...
  void SetUB::init()
  {
    ...
    this->declareProperty(new PropertyWithValue<double>("b",1.0,mustBePositive,Direction::Input),"Lattice parameter b");
    this->declareProperty(new PropertyWithValue<double>("c",1.0,mustBePositive,Direction::Input),"Lattice parameter c");
    ...
    this->declareProperty(new PropertyWithValue<double>("beta",90.0,reasonableAngle,Direction::Input),"Lattice parameter beta (degrees)");
    this->declareProperty(new PropertyWithValue<double>("gamma",90.0,reasonableAngle,Direction::Input),"Lattice parameter gamma(degrees) ");
    this->declareProperty(new ArrayProperty<double>("u",u0,mustBe3D),"Vector along k_i, when goniometer is at 0");
    this->declareProperty(new ArrayProperty<double>("v",v0,mustBe3D),"In plane vector perpendicular to k_i, when goniometer is at 0");
