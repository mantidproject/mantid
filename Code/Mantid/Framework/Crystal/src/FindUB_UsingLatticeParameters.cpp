#include "MantidCrystal/FindUB_UsingLatticeParameters.h"
...
namespace Crystal
{
  Kernel::Logger& FindUB_UsingLatticeParameters::g_log = 
                        Kernel::Logger::get("FindUB_UsingLatticeParameters");

  // Register the algorithm into the AlgorithmFactory
  DECLARE_ALGORITHM(FindUB_UsingLatticeParameters)
  ...
  /** Constructor
   */
  FindUB_UsingLatticeParameters::FindUB_UsingLatticeParameters()
  {
  }
  ...
  void FindUB_UsingLatticeParameters::initDocs()
  {
   ...
   */
  void FindUB_UsingLatticeParameters::init()
  {
   ...
   */
  void FindUB_UsingLatticeParameters::exec()
  {
