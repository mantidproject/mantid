...
void LatticeErrors::functionDerivLocal(API::Jacobian* , const double* , const size_t )
{
  throw Mantid::Kernel::Exception::NotImplementedError("functionDerivLocal is not implemented for LatticeErrors.");
}

void LatticeErrors::functionDeriv(const API::FunctionDomain& domain, API::Jacobian& jacobian)
{
