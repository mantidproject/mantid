...
namespace Mantid
{
  namespace Crystal
  {
    ...
    {
      declareProperty(
          new WorkspaceProperty<PeaksWorkspace>("PeaksWorkspace1", "", Kernel::Direction::Input),
          "Input Peaks Workspace for Run 1");

      declareProperty(
          new WorkspaceProperty<PeaksWorkspace>("PeaksWorkspace2", "", Kernel::Direction::InOut),
      ...
      declareProperty(std::string("Phi2"), 0.0, std::string("Phi angle for Run2(def=0.0)"),
