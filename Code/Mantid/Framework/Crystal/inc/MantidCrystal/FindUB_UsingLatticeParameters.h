...
namespace Crystal
{
/** FindUB_UsingLatticeParameters : Algorithm to calculate a UB matrix,
  ...
  */
  class DLLExport FindUB_UsingLatticeParameters : public API::Algorithm
  {
  public:
    FindUB_UsingLatticeParameters();
    ~FindUB_UsingLatticeParameters();
    
    /// Algorithm's name for identification 
    virtual const std::string name() const 
            { return "FindUB_UsingLatticeParameters";};
