...
namespace Crystal
{
  ...
  public:
    ...
    virtual const std::string summary() const {return "Load an ISAW-style ASCII UB matrix and lattice parameters file, and place its information into a workspace.";}
