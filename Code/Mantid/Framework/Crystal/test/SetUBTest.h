...
//    TS_ASSERT_THROWS_NOTHING( alg.setPropertyValue("REPLACE_PROPERTY_NAME_HERE!!!!", "value") );
  ...
  void test_settingUB()
  {
    ...
    TS_ASSERT_THROWS_NOTHING( alg.setPropertyValue("Workspace", wsName) );
    TS_ASSERT_THROWS(alg.setPropertyValue("UB", "1,1"),std::invalid_argument);//should fail to initialize UB, since 9 elements are required
  ...
  void test_settingLattice()
  {
    ...
    TS_ASSERT_THROWS_NOTHING( alg.setPropertyValue("Workspace", wsName) );
    TS_ASSERT_THROWS(alg.setPropertyValue("alpha", "1"),std::invalid_argument);//should fail to initialize alpha, since angle is too small
    TS_ASSERT_THROWS_NOTHING( alg.setPropertyValue("alpha", "90.") );
    TS_ASSERT_THROWS( alg.setPropertyValue("u", "0,0,2,0,4,0,-8,0,0") ,std::invalid_argument);//should fail, only 3 numbers allowed
...
#endif /* MANTID_CRYSTAL_SETUBTEST_H_ */
