#ifndef MANTID_CRYSTAL_UNITCELLTEST_H_
#define MANTID_CRYSTAL_UNITCELLTEST_H_
...
public:
  ...
  void test_Advanced()
  {
    ...
    Mantid::Geometry::Matrix<double> newGstar(3,3);
...
#endif /* MANTID_CRYSTAL_UNITCELLTEST_H_ */
