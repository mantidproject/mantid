...
namespace LiveData
{
  ...
  /// Constructor
  TestGroupDataListener::TestGroupDataListener() : ILiveListener(),
      m_buffer()
  {
  ...
  bool TestGroupDataListener::isConnected()
  {
    return true;
  }

  ILiveListener::RunStatus TestGroupDataListener::runStatus()
  {
    return Running;
  }

  int TestGroupDataListener::runNumber() const
  {
    return 0;
  }

  void TestGroupDataListener::start(Kernel::DateAndTime /*startTime*/) // Ignore the start time
  {
    return;
  }
