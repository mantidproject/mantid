...
public:
  ...
  Poco::Net::HTTPResponse::HTTPStatus lastStatus() { return m_response.getStatus(); }
...
private:
  ...
  Poco::Net::HTTPClientSession *m_session; // Pointer to session object for all our HTTP requests
