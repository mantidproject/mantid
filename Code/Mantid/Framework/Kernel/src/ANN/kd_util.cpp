...
//		These utilities compute the smallest rectangle and cube
// enclosing
...
//		box (Note: most distances to boxes are computed using
// incremental
...
//		rank (median: n_lo = n/2) with respect to dimension d.  It
// places
...
//		that:
//
//		pa[0..n_lo-2][d] <= pa[n_lo-1][d] <= pa[n_lo][d] <=
// pa[n_lo+1..n-1][d].
//
