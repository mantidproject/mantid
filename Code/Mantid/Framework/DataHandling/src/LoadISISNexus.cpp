...
namespace Mantid
{
  namespace DataHandling
  {
    ...
    void LoadISISNexus::init()
    {
      ...
      // but with validation removed so that people reach the error message in exec more easily.
      declareProperty("Filename","","The name of the Nexus file to load" );
      declareProperty(new WorkspaceProperty<Workspace>("OutputWorkspace","None",Direction::Output));
    ...
    {
      throw Kernel::Exception::NotImplementedError("This version of LoadISISNexus has been removed from Mantid. "
