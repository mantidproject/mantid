  ...
  namespace DataHandling
  {
    ...
    */
    void LoadMuonNexus2::exec()
    {
      ...
      Mantid::NeXus::NXInfo info = entry.getDataSetInfo("definition");
      ...
      Mantid::NeXus::NXData dataGroup = entry.openNXData(detectorName);
      ...
      Mantid::NeXus::NXFloat raw_time = dataGroup.openNXFloat("raw_time");
      raw_time.load();
      ...
      Mantid::NeXus::NXEntry entryTimeZero = root.openEntry("run/instrument/detector_fb");
      Mantid::NeXus::NXInfo infoTimeZero = entryTimeZero.getDataSetInfo("time_zero");
      ...
      Mantid::NeXus::NXEntry entryFGB = root.openEntry("run/instrument/detector_fb");
      Mantid::NeXus::NXInfo infoFGB = entryFGB.getDataSetInfo("first_good_time");
    ...
    */
    void LoadMuonNexus2::loadLogs(API::MatrixWorkspace_sptr ws, Mantid::NeXus::NXEntry & entry,int period)
    {
      ...
      Mantid::NeXus::NXMainClass runlogs = entry.openNXClass<Mantid::NeXus::NXMainClass>("sample");
      ws->mutableSample().setName(sampleName);

      for(std::vector<Mantid::NeXus::NXClassInfo>::const_iterator it=runlogs.groups().begin();it!=runlogs.groups().end();it++)
      {
        Mantid::NeXus::NXLog nxLog = runlogs.openNXLog(it->nxname);
