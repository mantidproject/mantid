...
namespace Mantid
{
  namespace DataHandling
  {
    ...
    void LoadBBY::exec() {
      ...
      std::vector<bool> mask = createMaskVector(getPropertyValue("Mask"), maskFileLoaded);
      ...
      loadEvents(prog, "loading neutron events", file, tofMinBoundary, tofMaxBoundary, eventAssigner);
