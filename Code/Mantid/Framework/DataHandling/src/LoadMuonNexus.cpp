...
#include "MantidDataHandling/MuonNexusReader.h"
...
namespace Mantid
{
  namespace DataHandling
  {
    ...
    */
    ...
    {
      Mantid::NeXus::NXRoot root(m_filename);
      Mantid::NeXus::NXInt number = root.openNXInt("run/instrument/detector/number");
      number.load();
    ...
    void LoadMuonNexus::runLoadLog(DataObjects::Workspace2D_sptr localWorkspace)
    {
      ...
      Mantid::NeXus::NXChar orientation = root.openNXChar("run/instrument/detector/orientation");
      orientation.load();
      ...
      Mantid::NeXus::NXEntry entry = root.openEntry("run/histogram_data_1");
      Mantid::NeXus::NXInfo info = entry.getDataSetInfo("time_zero");
      ...
      Mantid::NeXus::NXInfo infoResolution = entry.getDataSetInfo("resolution");
      Mantid::NeXus::NXInt counts = root.openNXInt("run/histogram_data_1/counts");
      ...
      Mantid::NeXus::NXEntry nxRun = root.openEntry("run");
