...
namespace Mantid
{
  namespace DataHandling
  {
    ...
    void LoadRaw2::init()
    {
      ...
      declareProperty(new WorkspaceProperty<>("OutputWorkspace","None",Direction::Output),
      ...
      declareProperty("SpectrumMin",1, "The index number of the first spectrum to read.  Only used if\n"
        "spectrum_max is set.");
      declareProperty("SpectrumMax",Mantid::EMPTY_INT(), "The number of the last spectrum to read. Only used if explicitly\n"
        "set.");
    ...
    void LoadRaw2::exec()
    {
      throw Kernel::Exception::NotImplementedError("This version of LoadRaw has been removed from Mantid. "
          "You should use the current version of this algorithm or try an earlier release of Mantid.");
    }
