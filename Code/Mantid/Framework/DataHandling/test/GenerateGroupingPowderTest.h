...
public:
  ...
  void test_exec()
  {
    ...
    for (std::size_t i=0;i<nDet;++i)
    {
        ...
        tth=ws->detectorTwoTheta(ws->getInstrument()->getDetector(detID))*Geometry::rad2deg;
    ...
    DataObjects::GroupingWorkspace_sptr gws2 = boost::dynamic_pointer_cast<DataObjects::GroupingWorkspace>(API::AnalysisDataService::Instance().retrieve("GroupPowder"));
