...
public:
  ...
  SaveCanSAS1dTest2() : m_workspace1("SaveCanSAS1dTest2_in1"),
    m_workspace2("SaveCanSAS1dTest2_in2"),
    m_workspace3("SaveCanSAS1dTest2_in3"),
    m_filename("./savecansas1d2.xml")
  ...
  void testCanSAS1dXML()
  {
    ...
    sasroot+="\t\t xsi:schemaLocation=\"urn:cansas1d:1.1 http://www.cansas.org/formats/1.1/cansas1d.xsd\"";
    sasroot+="\t\t>";
    ...
    for (int i = 0; i< 10; i++){
      std::getline(testFile,fileLine); // should read some of sample information
    }
