...
public:
  ...
  void testMultiPeriod()
  {
    ...
    TS_ASSERT_EQUALS( output1->getInstrument()->baseInstrument(), output2->getInstrument()->baseInstrument() )
    ...
    TS_ASSERT_EQUALS( output1->getInstrument()->baseInstrument(), output6->getInstrument()->baseInstrument() )
    ...
    TS_ASSERT_EQUALS( output1->getInstrument()->baseInstrument(), output12->getInstrument()->baseInstrument() )
