...
public:
  ...
  void test_Merge2()
  {
    ...
    Kernel::TimeSeriesProperty<double> *p1 = new Kernel::TimeSeriesProperty<double>("SourceLog1");
    Kernel::TimeSeriesProperty<double> *p2 = new Kernel::TimeSeriesProperty<double>("SourceLog2");
