...
public:
  ...
  virtual const std::string summary() const {
    return "*** This version of LoadISISNexus has been removed from Mantid. "
           "You should use the current version of this algorithm or try an "
           "earlier release of Mantid. ***";
  }
