...
namespace Mantid
{
  namespace DataHandling
  {
    ...
    /**
     * Saves a configuration for a tomographic reconstruction into a NeXus/HDF5 file.
     * Operates on table workspaces each representing a plugin definition to add.
    ...
    public:
      ...
      virtual const std::string summary() const {return "Writes a configuration file for a tomographic reconstruction job.";}
