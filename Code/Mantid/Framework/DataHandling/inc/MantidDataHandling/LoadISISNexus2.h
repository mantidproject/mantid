  ...
  namespace DataHandling
  {
    ...
    */
    ...
    private:
      ...
      void loadRunDetails(DataObjects::Workspace2D_sptr local_workspace, NeXus::NXEntry & entry);
      ...
      void loadSampleData(DataObjects::Workspace2D_sptr, NeXus::NXEntry & entry);
      /// Load log data from the nexus file
      void loadLogs(DataObjects::Workspace2D_sptr, NeXus::NXEntry & entry,int period = 1);
      // Load a given period into the workspace
      void loadPeriodData(int period, NeXus::NXEntry & entry, DataObjects::Workspace2D_sptr local_workspace);
      // Load a data block
      void loadBlock(NeXus::NXDataSetTyped<int> & data, int blocksize, int period, int start,
