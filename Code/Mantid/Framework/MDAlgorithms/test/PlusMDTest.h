...
public:
  ...
  void xest_file_plus_mem()
  { do_test(true, false, 0); }

  void xest_file_plus_mem_inPlace()
  { do_test(true, false, 1); }

  void xest_mem_plus_file()
  { do_test(false, true, 0); }

  void xest_mem_plus_file_inPlace()
  { do_test(false, true, 1); }

  void xest_file_plus_file()
  { do_test(true, true, 0); }

  void xest_file_plus_file_inPlace()
  { do_test(true, true, 1); }

  void xest_file_plus_file_inPlace_ofRHS()
  { do_test(true, true, 2); }
