...
public:
 TestDescription_testCPrebinning_testRebinInit() : CxxTest::RealTestDescription( Tests_testCPrebinning, suiteDescription_testCPrebinning, 51, "testRebinInit" ) {}
...
public:
 TestDescription_testCPrebinning_testGetSlicingProperty() : CxxTest::RealTestDescription( Tests_testCPrebinning, suiteDescription_testCPrebinning, 69, "testGetSlicingProperty" ) {}
...
public:
 TestDescription_testCPrebinning_testCPRExec() : CxxTest::RealTestDescription( Tests_testCPrebinning, suiteDescription_testCPrebinning, 76, "testCPRExec" ) {}
