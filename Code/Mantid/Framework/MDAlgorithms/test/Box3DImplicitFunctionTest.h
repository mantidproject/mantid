#ifndef MANTID_MDALGORITHMS_BOX3DIMPLICITFUNCTIONTEST_H_
#define MANTID_MDALGORITHMS_BOX3DIMPLICITFUNCTIONTEST_H_
...
public:
  ...
  Box3DImplicitFunction* constructBox3DImplicitFunction()
  {
    ...
    return new Box3DImplicitFunction(width, height, depth, origin);
  }

  void testBox3DImplicitFunctionConstruction(void)
  {
    boost::scoped_ptr<Box3DImplicitFunction> box(constructBox3DImplicitFunction());
  ...
  bool do_test(boost::scoped_ptr<Box3DImplicitFunction> & box, double x, double y, double z)
  {
  ...
  void testToXML()
  {
    ...
    TSM_ASSERT_EQUALS("The xml generated by this function did not match the expected schema.", "<Function><Type>Box3DImplicitFunction</Type><ParameterList><Parameter><Type>WidthParameter</Type><Value>5.0000</Value></Parameter><Parameter><Type>HeightParameter</Type><Value>4.0000</Value></Parameter><Parameter><Type>DepthParameter</Type><Value>6.0000</Value></Parameter><Parameter><Type>OriginParameter</Type><Value>1.0000, 2.0000, 3.0000</Value></Parameter></ParameterList></Function>", box->toXMLString());
  }
  ...
  void testEqual()
  {
    ...
    Box3DImplicitFunction A(width, height, depth, o);
    Box3DImplicitFunction B(width, height, depth, o);
  ...
  void testNotEqual()
  {
    ...
    Box3DImplicitFunction A(widthA, heightA, depthA, originA); //base-line to compare to.
    Box3DImplicitFunction B(widthB, heightA, depthA, originA);
    Box3DImplicitFunction C(widthA, heightB, depthA, originA);
    Box3DImplicitFunction D(widthA, heightA, depthB, originA);
    Box3DImplicitFunction E(widthA, heightA, depthA, originB);
...
#endif /* MANTID_MDALGORITHMS_BOX3DIMPLICITFUNCTIONTEST_H_ */
