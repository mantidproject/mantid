...
public:
  ...
  void test_histo_histo() {
    ...
    out = BinaryOperationMDTestHelper::doTest("XorMD", "histo_A", "histo_zero",
                                              "out");
  ...
  void test_scalar_or_event_fails() {
    BinaryOperationMDTestHelper::doTest("XorMD", "histo_A", "scalar", "out",
                                        false /*fails*/);
    BinaryOperationMDTestHelper::doTest("XorMD", "event_A", "event_B", "out",
                                        false /*fails*/);
  }
};
