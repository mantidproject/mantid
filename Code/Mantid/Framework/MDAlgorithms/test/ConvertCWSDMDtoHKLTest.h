...
public:
  ...
  void test_convertToHKL()
  {
    ...
    TS_ASSERT_THROWS_NOTHING(alg.setPropertyValue("InputWorkspace", m_qsampleWS->name()));
    ...
    IMDEventWorkspace_sptr hklws = boost::dynamic_pointer_cast<IMDEventWorkspace>
...
private:
  ...
  void createMDEW()
  {
    ...
    FrameworkManager::Instance().exec("CreateMDWorkspace", 18,
                                      "Dimensions", "3",
                                      "EventType", "MDEvent",
                                      "Extents", "-10,10,-10,10,-10,10",
                                      "Names", "Q_sample_x,Q_sample_y,Q_sample_z",
                                      "Units", "Q_Sample_X,Q_Sample_Y,Q_Sample_Z",
                                      "SplitInto", "5",
                                      "SplitThreshold", "20",
    ...
    TS_ASSERT_THROWS_NOTHING(
        m_qsampleWS = AnalysisDataService::Instance().retrieveWS<IMDEventWorkspace>("MDEWS"));
