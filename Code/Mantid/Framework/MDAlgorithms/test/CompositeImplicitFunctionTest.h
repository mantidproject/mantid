...
private:
  ...
  public:
    ...
    bool isPointContained(const std::vector<Mantid::coord_t> & coords)
    {
      return true;
    }
...
public:
  ...
  void testEvaluateNestedFunctionsViaCoordinates()
  {
    ...
    EXPECT_CALL(*a, isPointContained(_)).Times(1).WillOnce(testing::Return(true));
  ...
  void testCannotAddNullDimension()
  {
    ...
    TSM_ASSERT("A null function cannot be added to a function of type CompositeFunction", !function.addFunction(Mantid::Geometry::MDImplicitFunction_sptr(nullFunction)));
  }
