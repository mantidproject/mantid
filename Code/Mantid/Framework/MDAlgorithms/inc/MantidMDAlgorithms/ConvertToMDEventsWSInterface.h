...
/** class describes templated inteface to the methods, dealing with workspaces while performing conversion from usual workspaces to MDEventWorkspace 
  ...
  *e.g.
   template<> class ConvertToMDEventsWS<ModQ,Elastic,ConvertNo,Centered,CrystalType>::public ConvertToMDEventsWSBase
   {
...
class ConvertToMDEventsWS: public ConvertToMDEventsWSBase 
{ 
public:
    ConvertToMDEventsWS(){};
