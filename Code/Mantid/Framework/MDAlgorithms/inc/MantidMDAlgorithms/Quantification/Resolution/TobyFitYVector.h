...
namespace Mantid
{
  namespace MDAlgorithms
  {
    ...
    public:
      ...
      /// enumeration maps to positions in the TobyFitBMatrix matrix so changing these
      ...
      enum Variable 
      {
        ...
        ScatterPointBeam = 4, // beam direction coordinate of point of scattering in sample frame
        ScatterPointPerp = 5, // perpendicular-coordinate of point of scattering in sample frame
        ...
        DetectorWidthCoord = 8, // width-coordinate of point of detection in detector frame
        DetectorHeightCoord  = 9, // height-coordinate of point of detection in detector frame
    ...
    private:
      ...
      bool m_moderator, m_aperture, m_chopper, m_chopperJitter, 
        m_sampleVolume, m_detectorDepth, m_detectorArea, m_detectionTime;
    };
