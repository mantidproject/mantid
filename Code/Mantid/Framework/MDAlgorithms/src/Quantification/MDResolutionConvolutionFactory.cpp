...
namespace Mantid
{
  namespace MDAlgorithms
  {
     ...
     * @param fgModelName :: The name of the foreground model to pair with the convolution
     * @param fitFunction :: A reference to the function undergoing fit
     */
    MDResolutionConvolution *
    MDResolutionConvolutionFactoryImpl::createConvolution(const std::string & name,
