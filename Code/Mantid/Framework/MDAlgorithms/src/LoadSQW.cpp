...
SQW DND/Image data is used to format dimension, with which to work. After the algorithm completes a fully formed [[MDEventWorkspace]] 
and visualization is provided.
...
%   header{i}.emode      Emode=1 direct geometry, =2 indirect geometry, =0 if diffraction
...
General notes about assumptions
