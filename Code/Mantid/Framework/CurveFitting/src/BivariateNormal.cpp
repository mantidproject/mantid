...
double BivariateNormal::initCoeff( const MantidVec &D,
                                 const MantidVec &X,
                                 const MantidVec &Y,
                                 double &coefNorm,
                                 double &expCoeffx2,
