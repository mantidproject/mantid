...
private:
  ...
  std::vector<double> runMinimizer(const CONSTRAINT_TYPE type)
  {
    ...
    {
    case NOCONSTRAINTS:
      lsqmin = boost::make_shared<AugmentedLagrangianOptimizer>(nparams, userFunc);
      break;
    case EMPTYCONSTRAINTS:
      lsqmin = boost::make_shared<AugmentedLagrangianOptimizer>(nparams, userFunc, DblMatrix(), DblMatrix());
      break;
    case EQUALITYCONSTRAINT:
      lsqmin = boost::make_shared<AugmentedLagrangianOptimizer>(nparams, userFunc, equality, DblMatrix());
      break;
    case INEQUALITYCONSTRAINT:
      lsqmin = boost::make_shared<AugmentedLagrangianOptimizer>(nparams, userFunc, DblMatrix(), inequality);
      break;
    case BOTHCONSTRAINTS:
      lsqmin = boost::make_shared<AugmentedLagrangianOptimizer>(nparams, userFunc, equality, inequality);
      break;
    };
