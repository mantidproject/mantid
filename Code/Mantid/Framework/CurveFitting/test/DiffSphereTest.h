...
public:
  ...
  void testDiffSphereElastic()
  {
    ...
    std::string funtion_string = "(composite=Convolution,FixResolution=true,NumDeriv=true;name=Gaussian,Height=1.0,PeakCentre=0.0,Sigma=20.0,ties=(Height=1.0,PeakCentre=0.0,Sigma=20.0);name=ElasticDiffSphere,Q=0.5,Height=47.014,Radius=1.567)";
    ...
    */
    funtion_string = "(composite=Convolution,NumDeriv=true;name=Gaussian,Height=1.0,PeakCentre=0.0,Sigma=20.0,ties=(Height=1.0,PeakCentre=0.0,Sigma=20.0);name=ElasticDiffSphere,Q=0.5,Height=47.014,Radius=6.0,ties=(Height=47.014))";
    fitalg.setProperty( "Function", funtion_string );
