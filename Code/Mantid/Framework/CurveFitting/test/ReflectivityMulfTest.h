...
public:
  void testValues()
  {
      double xs[] = {0.005,0.015,0.025,0.035,0.045,0.055,0.065,0.075,0.085,0.095,0.105,0.115,0.125,0.135,0.145};
      // these values were calculated at a point when ReflectivityMulf was considered to return correct results
      double ys[] = {0.737817797785,
                     0.737817797785,
                     0.0232244527086,
                     0.004187444808788,
                     0.001350372079943,
