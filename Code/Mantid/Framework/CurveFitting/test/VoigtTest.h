...
public:
  ...
  void test_function_has_jacobian_matrix_for_given_input()
  {
    ...
    double dxDa[g_domainSize][4] =
    {
        ...
        {0.01626925356,-0.04574679593,0.17782530103,0.00071014811},{0.03140950610,-0.12178875967,0.33801701863,0.00256582413},
        {0.08273352484,-0.50687692061,0.84298568363,0.01628265653},{0.44963209851,-4.95613687209,2.73013742868,0.20944750234},
        {0.44963209851,4.95613687209,2.73013742868,0.20944750234},{0.08273352484,0.50687692061,0.84298568363,0.01628265653},
        {0.03140950610,0.12178875967,0.33801701863,0.00256582413},{0.01626925356,0.04574679593,0.17782530103,0.00071014811},
        {0.00990389541,0.02179640604,0.10895223988,0.00026811273}
    };
...
private:
  ...
  boost::shared_ptr<IFunction> createFunction(const double a_L, const double pos,
