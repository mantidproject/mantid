...
public:
  ...
  void test_addBckgroundFunctions() {
    ...
    TS_ASSERT_THROWS_ANYTHING(lebailfunction2.addBackgroundFunction(
        "FullprofPolynomial", 4, parnames, parvalues, -1., -1.));
    TS_ASSERT_THROWS_NOTHING(lebailfunction2.addBackgroundFunction(
        "FullprofPolynomial", 6, parnames, parvalues, -1., -1.));
  ...
  void test_CalculateLeBailFunction() {
    ...
    cout << "Peak(111): height = " << height111 << ", Max = " << max111
         << " @ TOF = " << vecX[imax111] << ".\n";
    cout << "Peak(110): height = " << height110 << ", Max = " << max110
         << " @ TOF = " << vecX[imax110] << ".\n";
    ...
    cout << "Max value of peak 110 is at TOF = " << vecX[imax111] << " as the "
         << imax111 << "-th points.\n";
