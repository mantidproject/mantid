/**
 *
 * Uses a similar method to the plugin loading to ensure that the FrameworkManager is
 * called when an executable loads.
 *
 * To use this simply compile this file along with the other source files that
 * generate the executable/library. When the library is loaded/executable started
