...
class RunOldPythonScriptTest(unittest.TestCase):
    """
    Try out RunOldPythonScript
    """
    ...
    def test_emptyCode_inPlace(self):
        RunOldPythonScript(InputWorkspace='ws', Code='', OutputWorkspace='ws')
        ws_out = mtd['ws']
    ...
    def test_emptyCode(self):
        ...
        # then RunOldPythonScript() clones the input
        code = ""
        RunOldPythonScript(InputWorkspace="ws", Code="", OutputWorkspace='ws_out')
        ws = mtd['ws']
        ws_out = mtd['ws_out']
    ...
    def test_simplePlus(self):
        ...
        RunOldPythonScript(InputWorkspace="ws", Code=code, OutputWorkspace='ws_out')
        ws_out = mtd['ws_out']
