...
namespace Mantid
{
  ...
  void export_unit_cell()
  {
    ...
    class_< Geometry::UnitCell >( "UnitCell", init< >() )    
      ...
      .def( init< double, double, double, double, double, double, optional< int > >(( arg("_a"), arg("_b"), arg("_c"), arg("_alpha"), arg("_beta"), arg("_gamma"), arg("Unit")=(int const)((int const)(Geometry::angDegrees)) )) )    
      ...
      .def( "recAngle", (double ( Geometry::UnitCell::* )( double,double,double,double,double,double,int const ) const)( &Geometry::UnitCell::recAngle ), ( arg("h1"), arg("k1"), arg("l1"), arg("h2"), arg("k2"), arg("l2"), arg("Unit")=(int const)((int const)(Geometry::angDegrees)) ) )    
      .def( "recVolume", (double ( Geometry::UnitCell::* )(  ) const)( &Geometry::UnitCell::recVolume ) )    
      .def( "set", (void ( Geometry::UnitCell::* )( double,double,double,double,double,double,int const ) )( &Geometry::UnitCell::set ), ( arg("_a"), arg("_b"), arg("_c"), arg("_alpha"), arg("_beta"), arg("_gamma"), arg("Unit")=(int const)((int const)(Geometry::angDegrees)) ) )    
      .def( "seta", (void ( Geometry::UnitCell::* )( double ) )( &Geometry::UnitCell::seta ), ( arg("_a") ) )    
      .def( "setalpha", (void ( Geometry::UnitCell::* )( double,int const ) )( &Geometry::UnitCell::setalpha ), ( arg("_alpha"), arg("Unit")=(int const)((int const)(Geometry::angDegrees)) ) )    
      .def( "setb", (void ( Geometry::UnitCell::* )( double ) )( &Geometry::UnitCell::setb ), ( arg("_b") ) )    
      .def( "setbeta", (void ( Geometry::UnitCell::* )( double,int const ) )( &Geometry::UnitCell::setbeta ), ( arg("_beta"), arg("Unit")=(int const)((int const)(Geometry::angDegrees)) ) )    
      .def( "setc", (void ( Geometry::UnitCell::* )( double ) )( &Geometry::UnitCell::setc ), ( arg("_c") ) )    
      .def( "setgamma", (void ( Geometry::UnitCell::* )( double,int const ) )( &Geometry::UnitCell::setgamma ), ( arg("_gamma"), arg("Unit")=(int const)((int const)(Geometry::angDegrees)) ) )    
