...
Algorithm that will run a snippet of python code from v1 of the python API.
...
class RunOldPythonScript(PythonAlgorithm):
...
mtd.registerPyAlgorithm(RunOldPythonScript())