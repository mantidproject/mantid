#ifndef MANTID_API_IFITFUNCTION_H_
#define MANTID_API_IFITFUNCTION_H_
...
public:
  ...
  const IFitFunction* function()const{return m_fun;}
protected:
  IFitFunction* m_fun;///< pointer to the handled function
};
