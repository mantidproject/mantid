...
static const Atom Bk("Bk", 97, 0, 0.000000, 247.000000, 14);
static const Atom Bk235("Bk", 97, 235, 0.000000, 235.056580, 13.3230450202);
static const Atom Bk236("Bk", 97, 236, 0.000000, 236.057330, 13.3797676923);
static const Atom Bk237("Bk", 97, 237, 0.000000, 237.057130, 13.4364365182);
static const Atom Bk238("Bk", 97, 238, 0.000000, 238.058270, 13.4931812955);
static const Atom Bk239("Bk", 97, 239, 0.000000, 239.058360, 13.5498665587);
static const Atom Bk240("Bk", 97, 240, 0.000000, 240.059750, 13.6066255061);
static const Atom Bk241("Bk", 97, 241, 0.000000, 241.060220, 13.6633323077);
static const Atom Bk242("Bk", 97, 242, 0.000000, 242.062050, 13.7201161943);
static const Atom Bk243("Bk", 97, 243, 0.000000, 243.063002, 13.7768503158);
static const Atom Bk244("Bk", 97, 244, 0.000000, 244.065168, 13.833653247);
static const Atom Bk245("Bk", 97, 245, 0.000000, 245.066355, 13.8904007109);
static const Atom Bk246("Bk", 97, 246, 0.000000, 246.068670, 13.9472120648);
static const Atom Bk247("Bk", 97, 247, 0.000000, 247.070299, 14.0039845587);
static const Atom Bk248("Bk", 97, 248, 0.000000, 248.073080, 14.0608223482);
static const Atom Bk249("Bk", 97, 249, 0.000000, 249.074980, 14.1176102024);
static const Atom Bk250("Bk", 97, 250, 0.000000, 250.078311, 14.174479166);
static const Atom Bk251("Bk", 97, 251, 0.000000, 251.080753, 14.2312977409);
static const Atom Bk252("Bk", 97, 252, 0.000000, 252.084300, 14.2881789474);
static const Atom Bk253("Bk", 97, 253, 0.000000, 253.086880, 14.3450053441);
static const Atom Bk254("Bk", 97, 254, 0.000000, 254.090600, 14.4018963563);
static const Atom Cf("Cf", 98, 0, 0.000000, 251.000000, NAN);
static const Atom Cf256("Cf", 98, 256, 0.000000, 256.093440, NAN);
static const Atom Cf237("Cf", 98, 237, 0.000000, 237.062070, NAN);
static const Atom Cf238("Cf", 98, 238, 0.000000, 238.061410, NAN);
static const Atom Cf239("Cf", 98, 239, 0.000000, 239.062580, NAN);
static const Atom Cf240("Cf", 98, 240, 0.000000, 240.062300, NAN);
static const Atom Cf241("Cf", 98, 241, 0.000000, 241.063720, NAN);
static const Atom Cf242("Cf", 98, 242, 0.000000, 242.063690, NAN);
static const Atom Cf243("Cf", 98, 243, 0.000000, 243.065420, NAN);
static const Atom Cf244("Cf", 98, 244, 0.000000, 244.065990, NAN);
static const Atom Cf245("Cf", 98, 245, 0.000000, 245.068040, NAN);
static const Atom Cf246("Cf", 98, 246, 0.000000, 246.068799, NAN);
static const Atom Cf247("Cf", 98, 247, 0.000000, 247.070992, NAN);
static const Atom Cf248("Cf", 98, 248, 0.000000, 248.072178, NAN);
static const Atom Cf249("Cf", 98, 249, 0.000000, 249.074847, NAN);
static const Atom Cf250("Cf", 98, 250, 0.000000, 250.076400, NAN);
static const Atom Cf251("Cf", 98, 251, 0.000000, 251.079580, NAN);
static const Atom Cf252("Cf", 98, 252, 0.000000, 252.081620, NAN);
static const Atom Cf253("Cf", 98, 253, 0.000000, 253.085127, NAN);
static const Atom Cf254("Cf", 98, 254, 0.000000, 254.087316, NAN);
static const Atom Cf255("Cf", 98, 255, 0.000000, 255.091040, NAN);
static const Atom Es("Es", 99, 0, 0.000000, 252.000000, NAN);
static const Atom Es256("Es", 99, 256, 0.000000, 256.093590, NAN);
static const Atom Es257("Es", 99, 257, 0.000000, 257.095980, NAN);
static const Atom Es240("Es", 99, 240, 0.000000, 240.068920, NAN);
static const Atom Es241("Es", 99, 241, 0.000000, 241.068660, NAN);
static const Atom Es242("Es", 99, 242, 0.000000, 242.069700, NAN);
static const Atom Es243("Es", 99, 243, 0.000000, 243.069630, NAN);
static const Atom Es244("Es", 99, 244, 0.000000, 244.070970, NAN);
static const Atom Es245("Es", 99, 245, 0.000000, 245.071320, NAN);
static const Atom Es246("Es", 99, 246, 0.000000, 246.072970, NAN);
static const Atom Es247("Es", 99, 247, 0.000000, 247.073650, NAN);
static const Atom Es248("Es", 99, 248, 0.000000, 248.075460, NAN);
static const Atom Es249("Es", 99, 249, 0.000000, 249.076410, NAN);
static const Atom Es250("Es", 99, 250, 0.000000, 250.078650, NAN);
static const Atom Es251("Es", 99, 251, 0.000000, 251.079984, NAN);
static const Atom Es252("Es", 99, 252, 0.000000, 252.082970, NAN);
static const Atom Es253("Es", 99, 253, 0.000000, 253.084818, NAN);
static const Atom Es254("Es", 99, 254, 0.000000, 254.088016, NAN);
static const Atom Es255("Es", 99, 255, 0.000000, 255.090266, NAN);
static const Atom Fm("Fm", 100, 0, 0.000000, 257.000000, NAN);
static const Atom Fm256("Fm", 100, 256, 0.000000, 256.091767, NAN);
static const Atom Fm257("Fm", 100, 257, 0.000000, 257.095099, NAN);
static const Atom Fm258("Fm", 100, 258, 0.000000, 258.097070, NAN);
static const Atom Fm259("Fm", 100, 259, 0.000000, 259.100590, NAN);
static const Atom Fm242("Fm", 100, 242, 0.000000, 242.073430, NAN);
static const Atom Fm243("Fm", 100, 243, 0.000000, 243.074510, NAN);
static const Atom Fm244("Fm", 100, 244, 0.000000, 244.074080, NAN);
static const Atom Fm245("Fm", 100, 245, 0.000000, 245.075380, NAN);
static const Atom Fm246("Fm", 100, 246, 0.000000, 246.075280, NAN);
static const Atom Fm247("Fm", 100, 247, 0.000000, 247.076820, NAN);
static const Atom Fm248("Fm", 100, 248, 0.000000, 248.077184, NAN);
static const Atom Fm249("Fm", 100, 249, 0.000000, 249.079020, NAN);
static const Atom Fm250("Fm", 100, 250, 0.000000, 250.079515, NAN);
static const Atom Fm251("Fm", 100, 251, 0.000000, 251.081566, NAN);
static const Atom Fm252("Fm", 100, 252, 0.000000, 252.082460, NAN);
static const Atom Fm253("Fm", 100, 253, 0.000000, 253.085176, NAN);
static const Atom Fm254("Fm", 100, 254, 0.000000, 254.086848, NAN);
static const Atom Fm255("Fm", 100, 255, 0.000000, 255.089955, NAN);
static const Atom Md("Md", 101, 0, 0.000000, 258.000000, NAN);
static const Atom Md256("Md", 101, 256, 0.000000, 256.094050, NAN);
static const Atom Md257("Md", 101, 257, 0.000000, 257.095535, NAN);
static const Atom Md258("Md", 101, 258, 0.000000, 258.098425, NAN);
static const Atom Md259("Md", 101, 259, 0.000000, 259.100500, NAN);
static const Atom Md260("Md", 101, 260, 0.000000, 260.103650, NAN);
static const Atom Md245("Md", 101, 245, 0.000000, 245.081020, NAN);
static const Atom Md246("Md", 101, 246, 0.000000, 246.081930, NAN);
static const Atom Md247("Md", 101, 247, 0.000000, 247.081800, NAN);
static const Atom Md248("Md", 101, 248, 0.000000, 248.082910, NAN);
static const Atom Md249("Md", 101, 249, 0.000000, 249.083000, NAN);
static const Atom Md250("Md", 101, 250, 0.000000, 250.084490, NAN);
static const Atom Md251("Md", 101, 251, 0.000000, 251.084920, NAN);
static const Atom Md252("Md", 101, 252, 0.000000, 252.086630, NAN);
static const Atom Md253("Md", 101, 253, 0.000000, 253.087280, NAN);
static const Atom Md254("Md", 101, 254, 0.000000, 254.089730, NAN);
static const Atom Md255("Md", 101, 255, 0.000000, 255.091075, NAN);
static const Atom No("No", 102, 0, 0.000000, 259.000000, NAN);
static const Atom No256("No", 102, 256, 0.000000, 256.094276, NAN);
static const Atom No257("No", 102, 257, 0.000000, 257.096850, NAN);
static const Atom No258("No", 102, 258, 0.000000, 258.098200, NAN);
static const Atom No259("No", 102, 259, 0.000000, 259.101020, NAN);
static const Atom No260("No", 102, 260, 0.000000, 260.102640, NAN);
static const Atom No261("No", 102, 261, 0.000000, 261.105740, NAN);
static const Atom No262("No", 102, 262, 0.000000, 262.107520, NAN);
static const Atom No249("No", 102, 249, 0.000000, 249.087820, NAN);
static const Atom No250("No", 102, 250, 0.000000, 250.087490, NAN);
static const Atom No251("No", 102, 251, 0.000000, 251.088960, NAN);
static const Atom No252("No", 102, 252, 0.000000, 252.088966, NAN);
static const Atom No253("No", 102, 253, 0.000000, 253.090650, NAN);
static const Atom No254("No", 102, 254, 0.000000, 254.090949, NAN);
static const Atom No255("No", 102, 255, 0.000000, 255.093232, NAN);
static const Atom Lr("Lr", 103, 0, 0.000000, 262.000000, NAN);
static const Atom Lr256("Lr", 103, 256, 0.000000, 256.098760, NAN);
static const Atom Lr257("Lr", 103, 257, 0.000000, 257.099610, NAN);
static const Atom Lr258("Lr", 103, 258, 0.000000, 258.101880, NAN);
static const Atom Lr259("Lr", 103, 259, 0.000000, 259.102990, NAN);
static const Atom Lr260("Lr", 103, 260, 0.000000, 260.105570, NAN);
static const Atom Lr261("Lr", 103, 261, 0.000000, 261.106940, NAN);
static const Atom Lr262("Lr", 103, 262, 0.000000, 262.109690, NAN);
static const Atom Lr263("Lr", 103, 263, 0.000000, 263.111390, NAN);
static const Atom Lr251("Lr", 103, 251, 0.000000, 251.094360, NAN);
static const Atom Lr252("Lr", 103, 252, 0.000000, 252.095330, NAN);
static const Atom Lr253("Lr", 103, 253, 0.000000, 253.095260, NAN);
static const Atom Lr254("Lr", 103, 254, 0.000000, 254.096590, NAN);
static const Atom Lr255("Lr", 103, 255, 0.000000, 255.096770, NAN);
static const Atom Rf("Rf", 104, 0, 0.000000, 261.000000, NAN);
static const Atom Rf256("Rf", 104, 256, 0.000000, 256.101180, NAN);
static const Atom Rf257("Rf", 104, 257, 0.000000, 257.103070, NAN);
static const Atom Rf258("Rf", 104, 258, 0.000000, 258.103570, NAN);
static const Atom Rf259("Rf", 104, 259, 0.000000, 259.105630, NAN);
static const Atom Rf260("Rf", 104, 260, 0.000000, 260.106430, NAN);
static const Atom Rf261("Rf", 104, 261, 0.000000, 261.108750, NAN);
static const Atom Rf262("Rf", 104, 262, 0.000000, 262.109920, NAN);
static const Atom Rf263("Rf", 104, 263, 0.000000, 263.112540, NAN);
static const Atom Rf264("Rf", 104, 264, 0.000000, 264.113980, NAN);
static const Atom Rf253("Rf", 104, 253, 0.000000, 253.100680, NAN);
static const Atom Rf254("Rf", 104, 254, 0.000000, 254.100170, NAN);
static const Atom Rf255("Rf", 104, 255, 0.000000, 255.101490, NAN);
static const Atom Db("Db", 105, 0, 0.000000, 262.000000, NAN);
static const Atom Db256("Db", 105, 256, 0.000000, 256.108110, NAN);
static const Atom Db257("Db", 105, 257, 0.000000, 257.107860, NAN);
static const Atom Db258("Db", 105, 258, 0.000000, 258.109440, NAN);
static const Atom Db259("Db", 105, 259, 0.000000, 259.109720, NAN);
static const Atom Db260("Db", 105, 260, 0.000000, 260.111430, NAN);
static const Atom Db261("Db", 105, 261, 0.000000, 261.112110, NAN);
static const Atom Db262("Db", 105, 262, 0.000000, 262.114150, NAN);
static const Atom Db263("Db", 105, 263, 0.000000, 263.115080, NAN);
static const Atom Db264("Db", 105, 264, 0.000000, 264.117470, NAN);
static const Atom Db265("Db", 105, 265, 0.000000, 265.118660, NAN);
static const Atom Db255("Db", 105, 255, 0.000000, 255.107400, NAN);
static const Atom Sg("Sg", 106, 0, 0.000000, 266.000000, NAN);
static const Atom Sg258("Sg", 106, 258, 0.000000, 258.113150, NAN);
static const Atom Sg259("Sg", 106, 259, 0.000000, 259.114650, NAN);
static const Atom Sg260("Sg", 106, 260, 0.000000, 260.114440, NAN);
static const Atom Sg261("Sg", 106, 261, 0.000000, 261.116200, NAN);
static const Atom Sg262("Sg", 106, 262, 0.000000, 262.116480, NAN);
static const Atom Sg263("Sg", 106, 263, 0.000000, 263.118310, NAN);
static const Atom Sg264("Sg", 106, 264, 0.000000, 264.118920, NAN);
static const Atom Sg265("Sg", 106, 265, 0.000000, 265.121070, NAN);
static const Atom Sg266("Sg", 106, 266, 0.000000, 266.121930, NAN);
static const Atom Bh("Bh", 107, 0, 0.000000, 264.000000, NAN);
static const Atom Bh260("Bh", 107, 260, 0.000000, 260.121800, NAN);
static const Atom Bh261("Bh", 107, 261, 0.000000, 261.121800, NAN);
static const Atom Bh262("Bh", 107, 262, 0.000000, 262.123010, NAN);
static const Atom Bh263("Bh", 107, 263, 0.000000, 263.123150, NAN);
static const Atom Bh264("Bh", 107, 264, 0.000000, 264.124730, NAN);
static const Atom Bh265("Bh", 107, 265, 0.000000, 265.125200, NAN);
static const Atom Bh266("Bh", 107, 266, 0.000000, 266.127010, NAN);
static const Atom Bh267("Bh", 107, 267, 0.000000, 267.127740, NAN);
static const Atom Hs("Hs", 108, 0, 0.000000, 277.000000, NAN);
static const Atom Hs263("Hs", 108, 263, 0.000000, 263.128710, NAN);
static const Atom Hs264("Hs", 108, 264, 0.000000, 264.128410, NAN);
static const Atom Hs265("Hs", 108, 265, 0.000000, 265.130000, NAN);
static const Atom Hs266("Hs", 108, 266, 0.000000, 266.130040, NAN);
static const Atom Hs267("Hs", 108, 267, 0.000000, 267.131770, NAN);
static const Atom Hs268("Hs", 108, 268, 0.000000, 268.132160, NAN);
static const Atom Hs269("Hs", 108, 269, 0.000000, 269.134110, NAN);
static const Atom Hs277("Hs", 108, 277, 0.000000, 0.000000, NAN);
static const Atom Mt("Mt", 109, 0, 0.000000, 268.000000, NAN);
static const Atom Mt265("Mt", 109, 265, 0.000000, 265.136570, NAN);
static const Atom Mt266("Mt", 109, 266, 0.000000, 266.137940, NAN);
static const Atom Mt267("Mt", 109, 267, 0.000000, 267.137530, NAN);
static const Atom Mt268("Mt", 109, 268, 0.000000, 268.138820, NAN);
static const Atom Mt269("Mt", 109, 269, 0.000000, 269.139110, NAN);
static const Atom Mt270("Mt", 109, 270, 0.000000, 270.140720, NAN);
static const Atom Mt271("Mt", 109, 271, 0.000000, 271.141230, NAN);
static const Atom Ds("Ds", 110, 0, 0.000000, 281.000000, NAN);
static const Atom Ds267("Ds", 110, 267, 0.000000, 267.143960, NAN);
static const Atom Ds268("Ds", 110, 268, 0.000000, 268.143530, NAN);
static const Atom Ds269("Ds", 110, 269, 0.000000, 269.145140, NAN);
static const Atom Ds270("Ds", 110, 270, 0.000000, 270.144630, NAN);
static const Atom Ds271("Ds", 110, 271, 0.000000, 271.146080, NAN);
static const Atom Ds272("Ds", 110, 272, 0.000000, 272.146310, NAN);
static const Atom Ds273("Ds", 110, 273, 0.000000, 273.149250, NAN);
static const Atom Ds281("Ds", 110, 281, 0.000000, 0.000000, NAN);
static const Atom Rg("Rg", 111, 0, 0.000000, 272.000000, NAN);
static const Atom Rg272("Rg", 111, 272, 0.000000, 272.153480, NAN);
static const Atom Cn("Cn", 112, 0, 0.000000, 285.000000, NAN);
static const Atom Cn285("Cn", 112, 285, 0.000000, 0.000000, NAN);
static const Atom Uuq("Uuq", 114, 0, 0.000000, 289.000000, NAN);
static const Atom Uuq289("Uuq", 114, 289, 0.000000, 0.000000, NAN);
static const Atom Uuh("Uuh", 116, 0, 0.000000, 292.000000, NAN);
static const Atom Uuh292("Uuh", 116, 292, 0.000000, 0.000000, NAN);
static Atom ATOMS[] = {
...
Cm248, Cm249, Cm250, Cm251, Cm252, Bk, Bk235, Bk236, Bk237, Bk238,
Bk239, Bk240, Bk241, Bk242, Bk243, Bk244, Bk245, Bk246, Bk247, Bk248,
Bk249, Bk250, Bk251, Bk252, Bk253, Bk254, Cf, Cf256, Cf237, Cf238,
Cf239, Cf240, Cf241, Cf242, Cf243, Cf244, Cf245, Cf246, Cf247, Cf248,
Cf249, Cf250, Cf251, Cf252, Cf253, Cf254, Cf255, Es, Es256, Es257,
Es240, Es241, Es242, Es243, Es244, Es245, Es246, Es247, Es248, Es249,
Es250, Es251, Es252, Es253, Es254, Es255, Fm, Fm256, Fm257, Fm258,
Fm259, Fm242, Fm243, Fm244, Fm245, Fm246, Fm247, Fm248, Fm249, Fm250,
Fm251, Fm252, Fm253, Fm254, Fm255, Md, Md256, Md257, Md258, Md259,
Md260, Md245, Md246, Md247, Md248, Md249, Md250, Md251, Md252, Md253,
Md254, Md255, No, No256, No257, No258, No259, No260, No261, No262,
No249, No250, No251, No252, No253, No254, No255, Lr, Lr256, Lr257,
Lr258, Lr259, Lr260, Lr261, Lr262, Lr263, Lr251, Lr252, Lr253, Lr254,
Lr255, Rf, Rf256, Rf257, Rf258, Rf259, Rf260, Rf261, Rf262, Rf263,
Rf264, Rf253, Rf254, Rf255, Db, Db256, Db257, Db258, Db259, Db260,
Db261, Db262, Db263, Db264, Db265, Db255, Sg, Sg258, Sg259, Sg260,
Sg261, Sg262, Sg263, Sg264, Sg265, Sg266, Bh, Bh260, Bh261, Bh262,
Bh263, Bh264, Bh265, Bh266, Bh267, Hs, Hs263, Hs264, Hs265, Hs266,
Hs267, Hs268, Hs269, Hs277, Mt, Mt265, Mt266, Mt267, Mt268, Mt269,
Mt270, Mt271, Ds, Ds267, Ds268, Ds269, Ds270, Ds271, Ds272, Ds273,
Ds281, Rg, Rg272, Cn, Cn285, Uuq, Uuq289, Uuh, Uuh292
};
