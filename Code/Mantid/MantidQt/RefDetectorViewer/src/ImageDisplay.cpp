 ...
 *               the mouse.
 */
void ImageDisplay::SetPointedAtPoint( QPoint point, int mouseClick)
{
...
void ImageDisplay::ShowPeakBackSelectionValue(double x, double y )
{
    ...
    int ImageDisplay::peakLeft = 0;
    int ImageDisplay::peakRight = 0;
    int ImageDisplay::backLeft = 0;
    int ImageDisplay::backRight = 0;
