                           ...
                           QLineEdit* lineTOFmax)
{
  ...
  image_plot_item = new RefImagePlotItem;
 ...
 *  other threads.
 */
void RefImageDisplay::UpdateRange()
{
  if ( data_source == 0 )
  {
 ...
 *  other threads.
 */
void RefImageDisplay::UpdateImage()
{
  if ( data_source == 0 )
  {
    return;   // no image data to update
 ...
 *                               color table.
 */
void RefImageDisplay::SetColorScales( std::vector<QRgb> & positive_color_table,
 ...
 */
void RefImageDisplay::SetIntensity( double control_parameter )
{
 ...
 *               the mouse.
 */
void RefImageDisplay::SetPointedAtPoint( QPoint point, int mouseClick)
{
 ...
 */
void RefImageDisplay::SetHGraph( double y )
{
 ...
 */
void RefImageDisplay::SetVGraph( double x )
{
 ...
 */
void RefImageDisplay::ShowInfoList( double x, double y )
{
...
*  @param y  The y coordinate of the pointed at location on the image.
*/
void RefImageDisplay::ShowPeakBackSelectionValue(double x, double y )
{
 ...
 */
void RefImageDisplay::GetDisplayRectangle( QRect &rect )
{
...
bool RefImageDisplay::DataSourceRangeChanged()
{
