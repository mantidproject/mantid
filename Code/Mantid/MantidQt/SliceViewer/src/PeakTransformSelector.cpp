...
namespace MantidQt
{
  namespace SliceViewer
  {
    ...
    */
    void PeakTransformSelector::registerCandidate(PeakTransformFactory_sptr candidate)
    {
    ...
    */
    ...
    @return selected factory
    */
    PeakTransformFactory_sptr PeakTransformSelector::makeChoice(const std::string labelX, const std::string labelY) const
    {
      if(labelX.empty())
      {
