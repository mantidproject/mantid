#ifndef FITBROWSERPLUGIN_H
#define FITBROWSERPLUGIN_H

#include <QDesignerCustomWidgetInterface>

/** 
The FitBrowserPlugin creates a Qt designer plugin of the FitPropertyBrowser.
...
*/
class FitBrowserPlugin : public QObject, public QDesignerCustomWidgetInterface
{
  Q_OBJECT
...
public:
  /// Default constructor
  FitBrowserPlugin(QObject *parent = 0);
