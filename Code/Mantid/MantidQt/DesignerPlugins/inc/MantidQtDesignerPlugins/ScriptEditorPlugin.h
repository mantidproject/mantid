#ifndef SCRIPTEDITORPLUGIN_H
#define SCRIPTEDITORPLUGIN_H

#include <QDesignerCustomWidgetInterface>

/** 
The ScriptEditorPlugin creates a Qt designer plugin out of the ScriptEditor widget.
...
*/
class ScriptEditorPlugin : public QObject, public QDesignerCustomWidgetInterface
{
  Q_OBJECT
...
public:
  /// Default constructor
  ScriptEditorPlugin(QObject *parent = 0);
