...
namespace MantidQt
{
  namespace CustomInterfaces
  {
    ...
    /** 
    This class defines the IndirectConvertToEnergy interface. It handles the overall instrument settings
    ...
    */
    ...
    class IndirectConvertToEnergy : public MantidQt::API::UserSubWindow
    {
      Q_OBJECT

    public: // public constructor, destructor and functions
      /// Default Constructor
      IndirectConvertToEnergy(QWidget *parent = 0);
      ///Destructor
