...
namespace MantidQt
{
  namespace MantidWidgets
  {
     ...
     */
    void CatalogSearch::setupTable(QTableWidget* table, size_t numOfRows, size_t numOfColumns)
    {
     ...
     */
    void CatalogSearch::populateTable(QTableWidget* table, Mantid::API::ITableWorkspace_sptr workspace)
    {
     ...
     */
    void CatalogSearch::clearSearch(QTableWidget* table, std::string & workspace)
    {
     ...
     */
    void CatalogSearch::dateSelected(std::string buttonName)
    {
     ...
     */
    std::map<std::string, std::string> CatalogSearch::getSearchFields()
    {
     ...
     */
    std::vector<std::pair<int64_t, std::string>> CatalogSearch::selectedDataFileNames()
    {
     ...
     */
    void CatalogSearch::populateDataFileType(std::set<std::string> extensions)
    {
     ...
     */
    void CatalogSearch::selectAllDataFiles(bool toggled)
    {
      QTableWidget* table = m_icatUiForm.dataFileResultsTbl;
     ...
     */
    void CatalogSearch::doFilter(int index)
    {
      QTableWidget* table = m_icatUiForm.dataFileResultsTbl;
