  ...
  */
{
  ...
  while(FX.good())
	...
	case 0:             // Failed :: therefore exit
	  ELog::EMessages.Estream()<<"XMLgroup::stream failure"<<this->Key;
	  ELog::EMessages.report(1);
	  return -1;
	case 2:
	  if (this->Key!=keyVal)
	    {
	      ELog::EMessages.Estream()<<"XMLgroup::Key mis-match (key:keyVal) "
				       <<this->Key<<" : "<<keyVal;
	      ELog::EMessages.report(1);
	      return -1;
	    }
	...
	default:
	  ...
	  if (!XO)
	    {
	      ELog::EMessages.Estream()<<"XMLgroup::Failed to find "<<keyVal;
	      ELog::EMessages.report(1);
	      return -3;
	    }
	  if (flag<0)
  ...
  ELog::EMessages.Estream()<<"XMLgroup:: End of stream "<<this->Key;
  ELog::EMessages.report(1);
  return -5;
}
