#ifndef MANTID_CURVEFITTING_GAUSSIAN2_H_
#define MANTID_CURVEFITTING_GAUSSIAN2_H_
...
namespace Mantid
{
  namespace CurveFitting
  {
    ...
    */
    class DLLExport GaussianLinearBG : public API::Algorithm
    {
    public:
      /// Default constructor
      GaussianLinearBG() : API::Algorithm() {};
      /// Destructor
      virtual ~GaussianLinearBG() {};
...
#endif /*MANTID_CURVEFITTING_GAUSSIAN2_H_*/
