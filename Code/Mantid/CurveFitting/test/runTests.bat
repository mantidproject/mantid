...
cl runner.cpp /I "..\inc" /I "..\..\..\Third_Party\include" /I "..\..\..\Third_Party\src\cxxtest" /I "..\..\..\Third_Party\include\muParser" /I "..\..\kernel\inc" /I "..\..\DataHandling\inc" /I "..\..\Algorithms\inc" /I "..\..\DataObjects\inc" /I "..\..\Geometry\inc" /I "..\..\API\inc" /I "../../Nexus\inc" /I "..\inc" /DNOMINMAX /EHsc /MDd /W3 /wd4275 /nologo /c /ZI /TP 
