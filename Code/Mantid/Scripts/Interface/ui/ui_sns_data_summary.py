...
# Form implementation generated from reading ui file 'sns_data_summary.ui'
#
# Created: Wed Jan 26 10:40:56 2011
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.reduction_options_groupbox.setGeometry(QtCore.QRect(30, 100, 751, 331))
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(10, 30, 751, 304))
        ...
        self.transmission_chk = QtGui.QCheckBox(self.formLayoutWidget_2)
        self.transmission_chk.setChecked(False)
        self.transmission_chk.setObjectName("transmission_chk")
        self.formLayout_2.setWidget(6, QtGui.QFormLayout.LabelRole, self.transmission_chk)
        self.frame_skipping_chk = QtGui.QCheckBox(self.formLayoutWidget_2)
        self.frame_skipping_chk.setChecked(False)
        self.frame_skipping_chk.setObjectName("frame_skipping_chk")
        self.formLayout_2.setWidget(7, QtGui.QFormLayout.LabelRole, self.frame_skipping_chk)
        self.sampleDetectorDistanceMmLabel = QtGui.QLabel(self.formLayoutWidget_2)
        self.sampleDetectorDistanceMmLabel.setObjectName("sampleDetectorDistanceMmLabel")
        self.formLayout_2.setWidget(8, QtGui.QFormLayout.LabelRole, self.sampleDetectorDistanceMmLabel)
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.transmission_edit = QtGui.QLineEdit(self.formLayoutWidget_2)
        ...
        self.plus_minus_label = QtGui.QLabel(self.formLayoutWidget_2)
        self.plus_minus_label.setObjectName("plus_minus_label")
        self.horizontalLayout_3.addWidget(self.plus_minus_label)
        self.transmission_error_edit = QtGui.QLineEdit(self.formLayoutWidget_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sample_dist_edit = QtGui.QLineEdit(self.formLayoutWidget_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout_2.setWidget(8, QtGui.QFormLayout.FieldRole, self.sample_dist_edit)
