...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.gridLayout.addWidget(self.theta_dep_chk, 1, 0, 1, 1)
        self.calculate_chk = QtGui.QCheckBox(Frame)
        self.calculate_chk.setObjectName("calculate_chk")
        self.gridLayout.addWidget(self.calculate_chk, 2, 0, 1, 1)
        ...
        self.dark_current_label = QtGui.QLabel(Frame)
        ...
        self.dark_current_button = QtGui.QPushButton(Frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout.addLayout(self.widget_placeholder)
