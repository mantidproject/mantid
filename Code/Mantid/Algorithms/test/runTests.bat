...
cl runner.cpp /I "..\..\..\Third_Party\include" /I "..\..\kernel\inc" /I "..\..\API\inc" /EHsc /MDd /W3 /nologo /c /ZI /TP 

link /OUT:"runner.exe" /NOLOGO /LIBPATH:"../../Debug" /LIBPATH:"../../../Third_Party/lib/win32" /DEBUG /PDB:".\runner.pdb" kernel.lib api.lib algorithms.lib dataobjects.lib runner.obj 
