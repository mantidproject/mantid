...
import os
import functools
from reduction.hfir_reduction_steps import Background
...
class BackgroundWidget(BaseWidget):    
    ...
    def initialize_content(self):
        ...
        self.connect(self._content.trans_direct_chk, QtCore.SIGNAL("clicked(bool)"), 
                     functools.partial(self._method_clicked, ":/trans_direct_beam.ui"))
        self.connect(self._content.trans_spreader_chk, QtCore.SIGNAL("clicked(bool)"), 
