...
wav2 = float(input.getPropertyValue("Wavelength_max"))
dwav = input.getPropertyValue("Wavelength_delta")
q1 = input.getPropertyValue("Q_min")
q2 = input.getPropertyValue("Q_max")
dq = input.getPropertyValue("Q_delta")
xshift=str((317.5-float(input.getPropertyValue("Beam_Centre_X")))/1000.0)
yshift=str((317.5-float(input.getPropertyValue("Beam_Centre_Y")))/1000.0)
