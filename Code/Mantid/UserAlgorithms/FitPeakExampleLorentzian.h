...
/** An example algorithm illustrating how to add a fitting function, in 
    particular here the Lorentzian peakshape function as described 
    http://www.mantidproject.org/Lorentzian1D. This implementation does
    not uses derivatives, hence uses the simplex minimisation method
    for miminisation. For an example with uses derivatives see 
    FitPeakExampleLorentzianUseDerivatives.h/.cpp. In general you may
