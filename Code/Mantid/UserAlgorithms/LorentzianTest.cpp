...
// ** MODIFY THIS **
// If you know how to calculate the derivative of your fitting function - here is your chance! 
// If not then instead use the following code:
//      void LorentzianTest::functionDerivLocal(API::Jacobian* out, const double* xValues, const int& nData)
//      {
