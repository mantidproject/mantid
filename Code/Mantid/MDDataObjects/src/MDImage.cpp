...
//----------------------------------------------------------------------------------------------
void MDImage::getPointData(std::vector<point3D> &image_points)const{
...
//----------------------------------------------------------------------------------------------
void MDImage::getPointData(const std::vector<unsigned int> &selection,std::vector<point3D> &image_points)const
{
...
//----------------------------------------------------------------------------------------------
MD_image_point * MDImage::get_pData(void)
{
  if(pData){
    return pData;
  }else{
...
//----------------------------------------------------------------------------------------------
MD_image_point const* MDImage::get_const_pData(void)const
{
  if(pData){
    return pData;
  }else{
...
//*******************************************************************************************************
// ----------------------------------------------------------------------------------------------
size_t MDImage::reshape_geometry(const MDGeometryDescription &transf)
{
  unsigned int i;
...
// ----------------------------------------------------------------------------------------------
void MDImage::alloc_mdd_arrays(const MDGeometryDescription &transf)
{
...
// ----------------------------------------------------------------------------------------------
std::vector<size_t> MDImage::getStrides(void)const
{
...
// ----------------------------------------------------------------------------------------------
void MDImage::identify_SP_points_locations()
{
