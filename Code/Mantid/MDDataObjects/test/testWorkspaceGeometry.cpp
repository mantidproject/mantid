...
#include "testWorkspaceGeometry.h"

static testWorkspaceGm suite_testWorkspaceGm;

static CxxTest::List Tests_testWorkspaceGm = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_testWorkspaceGm( "testWorkspaceGeometry.h", 17, "testWorkspaceGm", suite_testWorkspaceGm, Tests_testWorkspaceGm );
