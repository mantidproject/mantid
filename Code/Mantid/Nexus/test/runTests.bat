...
cl runner.cpp /I "..\inc" /I "..\..\..\Third_Party\include" /I "..\..\..\Third_Party\src\cxxtest" /I "..\.." /I "..\inc"  /I "../../Kernel/inc" /I "../../API/inc" /I "../../Geometry/inc" /I "../../DataObjects/inc" /I "../../DataHandling/inc" /D_CRT_SECURE_NO_DEPRECATE /DBOOST_ALL_DYN_LINK /DBOOST_DATE_TIME_POSIX_TIME_STD_CONFIG /DNOMINMAX /wd4275 /EHsc /MDd /W3 /nologo /c /ZI /TP 
