...
void addNXTransformationBeamDirectionOffset(Json::Value &nxTransformation, const std::vector<int> &arrayShape = {1},
                                            const std::vector<double> &values = {0.049},
                                            const std::vector<double> &vec = {0, 0, -1});

void addNXTransformationLocation(Json::Value &nxTransformation, const std::vector<int> &arrayShape = {1},
                                 const std::vector<double> &values = {0.971},
                                 const std::vector<double> &vec = {1, 0, 0});

void addNXTransformationOrientation(Json::Value &nxTransformation, const std::vector<int> &arrayShape = {1},
                                    const std::vector<double> &values = {90},
                                    const std::vector<double> &vec = {0, 1, 0});

void addDetectorNumbers(Json::Value &nxDetector, const std::vector<int> &arrayShape,
...
void addOffShapeFaces(Json::Value &shape, const std::vector<int> &arrayShape = {1},
                      const std::vector<int> &faces = {0});
void addOffShapeVertices(Json::Value &shape, const std::vector<int> &arrayShape = {4, 3},
                         const std::vector<double> &vertices = {-0.001, -0.001, 0, 0.001, -0.001, 0, 0.001, 0.001, 0,
                                                                -0.001, 0.001, 0});
void addOffShapeWindingOrder(Json::Value &shape, const std::vector<int> &arrayShape = {4},
...
void addCylindricalShapeCylinders(Json::Value &shape, const std::vector<int> &arrayShape = {3},
                                  const std::vector<int> &indices = {0, 1, 2});
void addCylindricalShapeVertices(Json::Value &shape, const std::vector<int> &arrayShape = {3, 3},
