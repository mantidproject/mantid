...
MatrixWorkspace_sptr createREFL_WS(size_t nBins, double startX, double endX, std::vector<double> const &values,
                                   std::string const &paramsType, std::string const &instrumentSuffix) {
...
void prepareInputGroup(std::string const &name, std::string const &paramsType, size_t size, double const startX,
