...
/// Return a string with all occurrences of indicated characater replaced by the new character
MANTID_KERNEL_DLL std::string replaceAll(const std::string &input, char const charStr, char const substitute);
