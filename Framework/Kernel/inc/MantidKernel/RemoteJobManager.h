...
private:
  ...
  // requests
  void initGetRequest(Poco::Net::HTTPRequest &req, const std::string &extraPath, const std::string &queryString);
  void initPostRequest(Poco::Net::HTTPRequest &req, const std::string &extraPath);
  ...
  std::unique_ptr<Poco::Net::HTTPClientSession> m_session; // Pointer to session object for all our HTTP requests
