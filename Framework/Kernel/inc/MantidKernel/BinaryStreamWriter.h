...
public:
  ...
  ///@name 2D methods
  /// @{
  BinaryStreamWriter &write(const std::vector<std::string> &value, const std::vector<int32_t> &shape,
                            MatrixOrdering order);
  BinaryStreamWriter &write(const Kernel::Matrix<float> &value, const std::vector<int32_t> &shape,
                            MatrixOrdering order);
  BinaryStreamWriter &write(const Kernel::Matrix<double> &value, const std::vector<int32_t> &shape,
                            MatrixOrdering order);
  /// @}
