...
public:
  ...
  /// Constructor
  TimeInterval(const Types::DateAndTime &from, const Types::DateAndTime &to);
  /// Beginning of the interval
  Types::DateAndTime begin() const { return m_begin; }
  /// End of the interval
  Types::DateAndTime end() const { return m_end; }
  /// True if the interval is not empty
  bool isValid() const { return m_end > m_begin; }

  /// Interval length (in seconds?)
  Types::time_duration length() const { return m_end - m_begin; }

  /// True if the interval contains \a t.
  bool contains(const Types::DateAndTime &t) const {
...
private:
  /// begin
  Types::DateAndTime m_begin;
  /// end
  Types::DateAndTime m_end;
};
} // namespace Kernel
} // namespace Mantid
