...
template <typename T>
MANTID_KERNEL_DLL int StrComp(const char * /*Text*/,
                              const boost::regex & /*Re*/, T & /*Aout*/,
                              const int /*compNum*/ = 0);

/// Find if a pattern matches
template <typename T>
MANTID_KERNEL_DLL int StrComp(const std::string & /*Text*/,
                              const boost::regex & /*Re*/, T & /*Aout*/,
                              const int /*compNum*/ = 0);
...
/// Find is a pattern matches
MANTID_KERNEL_DLL int StrLook(const std::string & /*Text*/,
...
MANTID_KERNEL_DLL int StrRemove(std::string & /*Sdx*/,
                                std::string & /*Extract*/,
                                const boost::regex & /*Re*/);

/// Find a compmonent in a Regex in a file
template <typename T>
MANTID_KERNEL_DLL int findComp(std::istream & /*fh*/,
                               const boost::regex & /*Re*/, T & /*Out*/);

/// Finds a pattern in a file
MANTID_KERNEL_DLL int findPattern(std::istream & /*fh*/,
                                  const boost::regex & /*Re*/,
                                  std::string & /*Out*/);
