...
template <class T> typename _Unique_if<T>::_Single_object make_unique() {
  return std::unique_ptr<T>(new T());
}

template <class T, class Arg1>
typename _Unique_if<T>::_Single_object make_unique(Arg1 param1) {
  return std::unique_ptr<T>(new T(std::forward<Arg1>(param1)));
}

template <class T, class Arg1, class Arg2>
typename _Unique_if<T>::_Single_object make_unique(Arg1 param1, Arg2 param2) {
...
template <class T> typename _Unique_if<T>::_Known_bound make_unique() = delete;
template <class T, class Arg1>
typename _Unique_if<T>::_Known_bound make_unique(Arg1 param1) = delete;
template <class T, class Arg1, class Arg2>
typename _Unique_if<T>::_Known_bound make_unique(Arg1 param1,
                                                 Arg2 param2) = delete;
template <class T, class Arg1, class Arg2, class Arg3>
typename _Unique_if<T>::_Known_bound make_unique(Arg1 param1, Arg2 param2,
                                                 Arg3 param3) = delete;
template <class T, class Arg1, class Arg2, class Arg3, class Arg4>
