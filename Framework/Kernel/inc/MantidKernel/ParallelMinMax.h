 ...
 */
template <typename T>
std::pair<T, T> parallel_minmax(std::shared_ptr<std::vector<T> const> const vec, size_t const grainsize = 1000);
 ...
 */
template <typename T>
std::pair<T, T> parallel_minmax(std::unique_ptr<std::vector<T> const> const vec, size_t const grainsize = 1000);
