...
int slsqpb_(int * /*m*/, int * /*meq*/, int * /*la*/, int * /*n*/, double * /*x*/, double * /*xl*/, double * /*xu*/, double * /*f*/,
            double * /*c__*/, double * /*g*/, double * /*a*/, double * /*acc*/, int * /*iter*/, int * /*mode*/, double * /*r__*/,
            double * /*l*/, double * /*x0*/, double * /*mu*/, double * /*s*/, double * /*u*/, double * /*v*/,
            double * /*w*/, int * /*iw*/);
