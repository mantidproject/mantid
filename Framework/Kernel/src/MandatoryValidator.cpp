 ...
 */
template <> DLLExport bool checkIsEmpty(const std::string &value) { return value.empty(); }
/**
 * Specialization of checkIsEmpty for double values
 * @param value :: A double
 * @return True if the value is considered empty, see EmptyValues.h
 */
template <> DLLExport bool checkIsEmpty(const double &value) { return std::fabs(value - Mantid::EMPTY_DBL()) < 1e-08; }
/**
 * Specialization of checkIsEmpty for int
 * @param value :: A int value
 * @return True if the value is considered empty, see EmptyValues.h
 */
template <> DLLExport bool checkIsEmpty(const int &value) { return (value == Mantid::EMPTY_INT()); }
/**
 ...
 * @return True if the value is considered empty, see EmptyValues.h
 */
template <> DLLExport bool checkIsEmpty(const int64_t &value) { return (value == Mantid::EMPTY_INT64()); }
#endif
/**
