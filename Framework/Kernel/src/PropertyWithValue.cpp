...
// PropertyWithValue.h; skip that extern block here to avoid a self-conflicting DLL export attribute.
#define PROPERTYWITHVALUE_PROVIDES_EXPLICIT_INSTANTIATIONS
