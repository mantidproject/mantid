 ...
 */
template <typename TYPE>
TimeSeriesPropertyStatistics TimeSeriesProperty<TYPE>::getStatistics(const Kernel::TimeROI *roi) const {
...
double filterByStatistic(TimeSeriesProperty<double> const *const propertyToFilter,
                         Kernel::Math::StatisticType statisticType, const Kernel::TimeROI *roi) {
