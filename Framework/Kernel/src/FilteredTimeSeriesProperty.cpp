...
// FilteredTimeSeriesProperty.h; skip that extern block here to avoid a self-conflicting DLL
// export attribute.
#define FILTEREDTIMESERIESPROPERTY_PROVIDES_EXPLICIT_INSTANTIATIONS
