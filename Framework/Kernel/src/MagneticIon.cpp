...
MagneticIon::MagneticIon()
    : symbol(""), charge(0), j0(8, 0.0), j2(8, 0.0), j4(8, 0.0), j6(8, 0.0), g(0.) {}
 ...
 */
MagneticIon::MagneticIon(const char *symbol, const uint16_t charge,
                         const double j0i[10], const double j2i[10],
                         const double j4i[10], const double gi)
    : symbol(symbol), charge(charge), j0(j0i, j0i + 10), j2(j2i, j2i + 10),
      j4(j4i, j4i + 10), g(gi) {}
...
constexpr double j_Au5[3][10] = {
    ...
    {-1.2007, 13.734, 1.2262, 3.424, 0.5164, 0.401, -0.5461, 0.379, 0.0216, 0.006}};   // <j4>
}
...
void createIonLookup(IonIndex &ion_map) {
  ...
  static const MagneticIon Ta4("Ta", static_cast<uint16_t>(4), j_Ta4[0],
                               j_Ta4[1], j_Ta4[2], 2.);
  ion_map["Ta4"] = Ta4;
  static const MagneticIon W0("W", static_cast<uint16_t>(0), j_W0[0],
                               j_W0[1], j_W0[2], 2.);
  ion_map["W0"] = W0;
  static const MagneticIon W1("W", static_cast<uint16_t>(1), j_W1[0],
                               j_W1[1], j_W1[2], 2.);
  ion_map["W1"] = W1;
  static const MagneticIon W2("W", static_cast<uint16_t>(2), j_W2[0],
                               j_W2[1], j_W2[2], 2.);
  ion_map["W2"] = W2;
  static const MagneticIon W3("W", static_cast<uint16_t>(3), j_W3[0],
                               j_W3[1], j_W3[2], 2.);
  ion_map["W3"] = W3;
  static const MagneticIon W4("W", static_cast<uint16_t>(4), j_W4[0],
                               j_W4[1], j_W4[2], 2.);
  ion_map["W4"] = W4;
  static const MagneticIon W5("W", static_cast<uint16_t>(5), j_W5[0],
                               j_W5[1], j_W5[2], 2.);
  ion_map["W5"] = W5;
