...
private:
  ...
  std::time_t createTime_t_FromString(const std::string &str) {
    ...
    time_since_1900.tm_year = std::stoi(str.substr(0, 4).c_str()) - 1900;
    time_since_1900.tm_mon = std::stoi(str.substr(5, 2).c_str()) - 1;
    time_since_1900.tm_mday = std::stoi(str.substr(8, 2).c_str());
    time_since_1900.tm_hour = std::stoi(str.substr(11, 2).c_str());
    time_since_1900.tm_min = std::stoi(str.substr(14, 2).c_str());
    time_since_1900.tm_sec = std::stoi(str.substr(17, 2).c_str());
