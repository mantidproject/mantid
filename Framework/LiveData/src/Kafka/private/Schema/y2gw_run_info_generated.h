...
inline const InfoTypes (&EnumValuesInfoTypes())[3] {
  static const InfoTypes values[] = {InfoTypes::NONE, InfoTypes::RunStart,
                                     InfoTypes::RunStop};
  return values;
}

inline const char *const *EnumNamesInfoTypes() {
  static const char *const names[] = {"NONE", "RunStart", "RunStop", nullptr};
  return names;
}
...
bool VerifyInfoTypes(flatbuffers::Verifier &verifier, const void *obj,
                     InfoTypes type);
bool VerifyInfoTypesVector(
...
struct RunStart FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_RUN_ID) && verifier.Verify(run_id()) &&
           ...
           verifier.Verify(nexus_structure()) && verifier.EndTable();
  }
};
...
CreateRunStart(flatbuffers::FlatBufferBuilder &_fbb, uint64_t start_time = 0,
...
inline flatbuffers::Offset<RunStart> CreateRunStartDirect(
    ...
    const char *run_id = nullptr, const char *instrument_name = nullptr,
    int32_t n_periods = 0, const char *nexus_structure = nullptr) {
  return CreateRunStart(
      _fbb, start_time, run_id ? _fbb.CreateString(run_id) : 0,
      instrument_name ? _fbb.CreateString(instrument_name) : 0, n_periods,
...
struct RunStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum { VT_STOP_TIME = 4, VT_RUN_ID = 6 };
...
CreateRunStopDirect(flatbuffers::FlatBufferBuilder &_fbb,
                    uint64_t stop_time = 0, const char *run_id = nullptr) {
  return CreateRunStop(_fbb, stop_time, run_id ? _fbb.CreateString(run_id) : 0);
}
...
struct RunInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum { VT_INFO_TYPE_TYPE = 4, VT_INFO_TYPE = 6 };
  ...
  bool mutate_info_type_type(InfoTypes _info_type_type) {
    return SetField<uint8_t>(VT_INFO_TYPE_TYPE,
                             static_cast<uint8_t>(_info_type_type), 0);
  }
  ...
  const RunStart *info_type_as_RunStart() const {
    return info_type_type() == InfoTypes::RunStart
               ? static_cast<const RunStart *>(info_type())
               : nullptr;
  }
  const RunStop *info_type_as_RunStop() const {
    return info_type_type() == InfoTypes::RunStop
               ? static_cast<const RunStop *>(info_type())
               : nullptr;
  }
  void *mutable_info_type() { return GetPointer<void *>(VT_INFO_TYPE); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct RunInfoBuilder {
  ...
  void add_info_type_type(InfoTypes info_type_type) {
    fbb_.AddElement<uint8_t>(RunInfo::VT_INFO_TYPE_TYPE,
                             static_cast<uint8_t>(info_type_type), 0);
  }
  void add_info_type(flatbuffers::Offset<void> info_type) {
    fbb_.AddOffset(RunInfo::VT_INFO_TYPE, info_type);
  }
  explicit RunInfoBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<RunInfo>
CreateRunInfo(flatbuffers::FlatBufferBuilder &_fbb,
...
inline bool VerifyInfoTypes(flatbuffers::Verifier &verifier, const void *obj,
                            InfoTypes type) {
  switch (type) {
  case InfoTypes::NONE: {
    return true;
...
inline bool VerifyInfoTypesVector(
    flatbuffers::Verifier &verifier,
    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
    const flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types)
  ...
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyInfoTypes(verifier, values->Get(i),
                         types->GetEnum<InfoTypes>(i))) {
      return false;
    }
  }
  return true;
...
inline const char *RunInfoIdentifier() { return "y2gw"; }

inline bool RunInfoBufferHasIdentifier(const void *buf) {
  return flatbuffers::BufferHasIdentifier(buf, RunInfoIdentifier());
}

inline bool VerifyRunInfoBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RunInfo>(RunInfoIdentifier());
}

inline bool VerifySizePrefixedRunInfoBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RunInfo>(RunInfoIdentifier());
}

inline void FinishRunInfoBuffer(flatbuffers::FlatBufferBuilder &fbb,
                                flatbuffers::Offset<RunInfo> root) {
  fbb.Finish(root, RunInfoIdentifier());
}

inline void FinishSizePrefixedRunInfoBuffer(flatbuffers::FlatBufferBuilder &fbb,
                                            flatbuffers::Offset<RunInfo> root) {
