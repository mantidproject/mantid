...
struct PulseImage FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<uint32_t> *mutable_detection_count() {
    return GetPointer<flatbuffers::Vector<uint32_t> *>(VT_DETECTION_COUNT);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_DETECTION_COUNT) &&
           verifier.VerifyVector(detection_count()) &&
           verifier.EndTable();
  }
};
...
struct PulseImageBuilder {
  ...
  explicit PulseImageBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline const PulseImage *GetSizePrefixedPulseImage(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<PulseImage>(buf);
}

inline PulseImage *GetMutablePulseImage(void *buf) {
  return flatbuffers::GetMutableRoot<PulseImage>(buf);
}
...
inline bool VerifySizePrefixedPulseImageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<PulseImage>(PulseImageIdentifier());
}
...
inline void FinishSizePrefixedPulseImageBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<PulseImage> root) {
