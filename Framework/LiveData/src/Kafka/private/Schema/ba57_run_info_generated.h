...
template<typename T> struct InfoTypesTraits {
  static const InfoTypes enum_value = InfoTypes_NONE;
};

template<> struct InfoTypesTraits<RunStart> {
  static const InfoTypes enum_value = InfoTypes_RunStart;
};

template<> struct InfoTypesTraits<RunStop> {
  static const InfoTypes enum_value = InfoTypes_RunStop;
};
...
struct RunStartBuilder {
  ...
  RunStartBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
struct RunStopBuilder {
  ...
  RunStopBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct RunInfoBuilder {
  ...
  RunInfoBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
