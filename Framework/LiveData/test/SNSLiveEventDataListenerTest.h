...
public:
  ...
  void test_rxPacketThrow_setsErrorState_and_extractRethrows() {
    ...
    protected:
      // Re-expose the hidden base overload set; the RunStatusPkt override below
      // would otherwise hide all of ADARA::Parser's rxPacket() overloads
      // (-Woverloaded-virtual).  Mirrors SNSLiveEventDataListener.h:57.
      using SNSLiveEventDataListener::rxPacket;
