...
class Test_Player_play(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Config = {
            ...
            "record": {"file_output": "multi_packet", "transfer_limit": 16000},
            "logging": {
    ...
    def test_waits_for_clienthello(self):
        ...
        self.Config["playback"]["handshake"] = "client_hello"
        with (
            patch("packet_player.Config", self.Config),
    ...
    def test_sets_starttime_from_packet(self):
        ...
        self.Config["playback"]["handshake"] = "none"
        with (
            patch("packet_player.Config", self.Config),
            patch.object(Player, "PLAYBACK_HANDSHAKE", "none"),  # patch class attribute
        ):
    ...
    def test_buffer_prefill_and_stream(self):
        ...
        # Override the base Config for this test
        self.Config["server"]["buffer_MB"] = 2
        with (
            patch("packet_player.Config", self.Config),
            patch.object(Player, "PLAYBACK_HANDSHAKE", "none"),  # patch class attribute
        ):
    ...
    def test_handles_no_packets(self):
        ...
        # Override the base Config for this test
        self.Config["playback"]["rate"] = "normal"
        with (
            patch("packet_player.Config", self.Config),
            patch.object(Player, "PLAYBACK_HANDSHAKE", "none"),  # patch class attribute
        ):
