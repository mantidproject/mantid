...
public:
  ...
  void test_size() {
    ...
    auto ranges = boost::make_shared<const std::vector<std::pair<size_t, size_t>>>();
  ...
  void test_throw_if_positions_rotation_inputs_different_sizes() {
    ...
    auto innerRanges = std::vector<std::pair<size_t, size_t>>{{0, 0}};// One component with no detectors
    auto ranges = boost::make_shared<const std::vector<std::pair<size_t, size_t>>>(std::move(innerRanges));
    auto positions = boost::make_shared<std::vector<Eigen::Vector3d>>(
  ...
  void test_throw_if_positions_and_rotations_not_same_size_as_ranges() {
    ...
    auto ranges = boost::make_shared<const std::vector<std::pair<size_t, size_t>>>(); // Empty ranges
    auto positions = boost::make_shared<std::vector<Eigen::Vector3d>>(
        1); // 1 position provided
    auto rotations = boost::make_shared<std::vector<Eigen::Quaterniond>>(
  ...
  void test_read_positions_rotations() {
    ...
    */
    ...
    ComponentInfo info(boost::make_shared<const std::vector<size_t>>(bankSortedDetectorIndices), boost::make_shared<const std::vector<std::pair<size_t, size_t>>>(ranges), compPositions,
  ...
  void test_detector_indexes() {
    ...
    */
    ...
    ComponentInfo info(boost::make_shared<const std::vector<size_t>>(bankSortedDetectorIndices), boost::make_shared<const std::vector<std::pair<size_t, size_t>>>(ranges), positions,
