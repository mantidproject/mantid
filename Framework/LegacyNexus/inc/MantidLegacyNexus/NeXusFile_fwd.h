...
MANTID_LEGACYNEXUS_DLL std::ostream &operator<<(std::ostream &stm, const Mantid::LegacyNexus::NXstatus status);
MANTID_LEGACYNEXUS_DLL std::ostream &operator<<(std::ostream &stm, const Mantid::LegacyNexus::NXnumtype type);
