...
public:
  void test_nexus_io_helper_readNexusVector() {
    const std::string filename = FileResource("V20_ESS_example.nxs").fullPath();
  ...
  void test_nexus_io_helper_readNexusVector_v20_ess_integration_2018() {
    const std::string filename = FileResource("V20_ESSIntegration_2018-12-13_0942.nxs").fullPath();
    ::NeXus::File file(filename);
    file.openGroup("entry", "NXentry");
  ...
  void test_nexus_io_helper_readNexusValue() {
    const std::string filename = FileResource("LARMOR00003368.nxs").fullPath();
    ::NeXus::File file(filename);
