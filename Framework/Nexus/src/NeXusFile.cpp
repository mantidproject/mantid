...
template MANTID_NEXUS_DLL void File::putData(const float *const data);
template MANTID_NEXUS_DLL void File::putData(const double *const data);
template MANTID_NEXUS_DLL void File::putData(const int8_t *const data);
template MANTID_NEXUS_DLL void File::putData(const uint8_t *const data);
template MANTID_NEXUS_DLL void File::putData(const int16_t *const data);
template MANTID_NEXUS_DLL void File::putData(const uint16_t *const data);
template MANTID_NEXUS_DLL void File::putData(const int32_t *const data);
template MANTID_NEXUS_DLL void File::putData(const uint32_t *const data);
template MANTID_NEXUS_DLL void File::putData(const int64_t *const data);
template MANTID_NEXUS_DLL void File::putData(const uint64_t *const data);
template MANTID_NEXUS_DLL void File::putData(const char *const data);
template MANTID_NEXUS_DLL void File::putData(const bool *const data);

template MANTID_NEXUS_DLL void File::getData(float *const data);
template MANTID_NEXUS_DLL void File::getData(double *const data);
template MANTID_NEXUS_DLL void File::getData(int8_t *const data);
template MANTID_NEXUS_DLL void File::getData(uint8_t *const data);
template MANTID_NEXUS_DLL void File::getData(int16_t *const data);
template MANTID_NEXUS_DLL void File::getData(uint16_t *const data);
template MANTID_NEXUS_DLL void File::getData(int32_t *const data);
template MANTID_NEXUS_DLL void File::getData(uint32_t *const data);
template MANTID_NEXUS_DLL void File::getData(int64_t *const data);
template MANTID_NEXUS_DLL void File::getData(uint64_t *const data);
template MANTID_NEXUS_DLL void File::getData(char *const data);
template MANTID_NEXUS_DLL void File::getData(bool *const data);
