...
public:
	...
	const std::string summary() const override { return "Group several muon detector IDs together and perform an analysis."; }
...
private:
	...
	WorkspaceGroup_sptr getUserInput(Workspace_sptr& inputWS, WorkspaceGroup_sptr& groupedWS);
	...
	void setProcessAlgorithmProperties(IAlgorithm_sptr alg, const Muon::AnalysisOptions &options) const;
