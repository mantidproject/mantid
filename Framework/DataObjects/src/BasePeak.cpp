...
void BasePeak::setRunNumber(int m_runNumber) {
...
void BasePeak::setBankName(std::string m_bankName) {
 ...
 */
void BasePeak::setIntHKL(const V3D &HKL) {
 ...
 */
void BasePeak::setIntMNP(const V3D &MNP) {
...
void BasePeak::setIntensity(double m_intensity) {
...
void BasePeak::setGoniometerMatrix(
...
void BasePeak::setPeakNumber(int m_peakNumber) {
 ...
 */
void BasePeak::setPeakShape(Mantid::Geometry::PeakShape *shape) {
 ...
 * @param shape : Desired shape
 */
void BasePeak::setPeakShape(Mantid::Geometry::PeakShape_const_sptr shape) {
 ...
 */
void BasePeak::setAbsorptionWeightedPathLength(double pathLength) {
