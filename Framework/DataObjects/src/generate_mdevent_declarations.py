    ...
    for mdevent_type in mdevent_types:
        for nd in xrange(1, max_dimensions + 1):
            if (nd >= min_dimension):
                ...
                s += macro % (padding, const, eventType, nd, varname, const, eventType, nd, varname, eventType, nd,
                              varname)
    s += "} \n  \n  \n"
...
def generate():
    ...
    padding, lines, lines_after = parse_file("../inc/MantidDataObjects/MDEventFactory.h",
                                             "//### BEGIN AUTO-GENERATED CODE", "//### END AUTO-GENERATED CODE")
    ...
    macro_lines = build_macro(padding, 1, nDim) + build_macro(padding, 3, nDim) + build_macro(
        padding, 1, nDim, "const ")
    ...
    # =========== Do the Source File ===========
    padding, lines, lines_after = parse_file("./MDEventFactory.cpp", "//### BEGIN AUTO-GENERATED CODE",
