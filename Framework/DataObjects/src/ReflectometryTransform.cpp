...
ReflectometryTransform::ReflectometryTransform(
    std::string d0Label, std::string d0ID, double d0Min, double d0Max,
    ...
    : m_d0NumBins(d0NumBins), m_d1NumBins(d1NumBins), m_d0Min(d0Min),
      ...
      m_d0Label(std::move(d0Label)), m_d1Label(std::move(d1Label)),
      m_d0ID(std::move(d0ID)), m_d1ID(std::move(d1ID)), m_calculator(calc) {
