...
public:
  ...
  ReflectometryTransform(std::string d0Label, std::string d0ID, double d0Min,
                         double d0Max, std::string d1Label, std::string d1ID,
                         double d1Min, double d1Max, size_t d0NumBins,
                         size_t d1NumBins, CalculateReflectometry *calc);
};
