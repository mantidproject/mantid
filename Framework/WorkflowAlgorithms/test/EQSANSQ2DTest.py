...
from mantid.simpleapi import CreateWorkspace, DeleteWorkspace, EQSANSQ2D, Integration, LoadInstrument, ReplaceSpecialValues, SumSpectra
...
class EQSANSQ2DTest(unittest.TestCase):
    ...
    def test_q2d(self):
        ...
        self.assertAlmostEqual(mtd["summed"].y(0)[0], 7.24077, 6)
