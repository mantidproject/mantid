...
class CorelliPowderCalibrationLoadTest : public CxxTest::TestSuite {
    public:
        ...
        void testValidateWSType() {
            ...
            lei->execute();
            EventWorkspace_sptr ws = AnalysisDataService::Instance().retrieveWS<EventWorkspace>("wrongTypeWs");
        ...
        void testValidateWSTime() {
            ...
            lei->setPropertyValue("MakeEventWorkspace", "1");
            lei->execute();
            EventWorkspace_sptr ws = AnalysisDataService::Instance().retrieveWS<EventWorkspace>("correctTypeWs");
