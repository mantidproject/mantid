...
public:
  ...
  void test_createCountsWorkspace_correct_XYE_values() {
    ...
    Mantid::HistogramData::HistogramX vecX1 = ws->getSpectrum(0).x();
    Mantid::HistogramData::HistogramX vecX2 = ws->getSpectrum(1).x();
    ...
    Mantid::HistogramData::HistogramY vecY1 = ws->getSpectrum(0).y();
    Mantid::HistogramData::HistogramY vecY2 = ws->getSpectrum(1).y();
    ...
    Mantid::HistogramData::HistogramE vecE1 = ws->getSpectrum(0).e();
    Mantid::HistogramData::HistogramE vecE2 = ws->getSpectrum(1).e();
  ...
  void test_createAsymmetryWorkspace_custom_generator() {
    ...
    Mantid::HistogramData::HistogramY vecY1 = ws->getSpectrum(0).y();
    Mantid::HistogramData::HistogramY vecY2 = ws->getSpectrum(4).y();
  ...
  void test_createMultiPeriodWorkspace_XYE_values() {
    ...
    Mantid::HistogramData::HistogramX vecX1 = ws1->getSpectrum(0).x();
    Mantid::HistogramData::HistogramX vecX2 = ws1->getSpectrum(1).x();
    TS_ASSERT_DELTA(vecX1.at(0), 0.000, 0.001);
    TS_ASSERT_DELTA(vecX1.at(9), 0.900, 0.001);
    TS_ASSERT_DELTA(vecX2.at(0), 0.000, 0.001);
    TS_ASSERT_DELTA(vecX2.at(9), 0.900, 0.001);

    Mantid::HistogramData::HistogramY vecY1 = ws1->getSpectrum(0).y();
    Mantid::HistogramData::HistogramY vecY2 = ws1->getSpectrum(1).y();
    ...
    Mantid::HistogramData::HistogramY vecY3 = ws5->getSpectrum(0).y();
    Mantid::HistogramData::HistogramY vecY4 = ws5->getSpectrum(1).y();
    ...
    Mantid::HistogramData::HistogramE vecE1 = ws1->getSpectrum(0).e();
    Mantid::HistogramData::HistogramE vecE2 = ws1->getSpectrum(1).e();
    TS_ASSERT_DELTA(vecE1.at(0), 0.005, 0.0001);
    TS_ASSERT_DELTA(vecE1.at(9), 0.005, 0.0001);
    TS_ASSERT_DELTA(vecE2.at(0), 0.005, 0.0001);
    TS_ASSERT_DELTA(vecE2.at(9), 0.005, 0.0001);
