...
public:
  ...
  //   TS_ASSERT_THROWS_NOTHING(alg.setPropertyValue("InputWorkspace2",
  // "bottom"));
  ...
  //       "InputWorkspace2", WorkspaceCreationHelper::Create2DWorkspace(10,
  // 10)));
  //   TS_ASSERT_THROWS_NOTHING(
  ...
  //   AppendSpectra alg;
  //   alg.initialize();
  //   TS_ASSERT_THROWS_NOTHING(alg.setPropertyValue("InputWorkspace1",
  // ws1Name));
  //   TS_ASSERT_THROWS_NOTHING(alg.setPropertyValue("InputWorkspace2",
  // ws2Name));
