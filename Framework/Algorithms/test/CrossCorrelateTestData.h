...
public:
  ...
  */
  ...
  inline static std::string const b2bexp_default_111 =
      "name=Bk2BkExpConvPV,Alpha=0.03842,Beta=0.06335,Sigma2=37.33017,Gamma = 6.23432,Intensity=100";
  inline static std::string const b2bexp_default_220 =
      "name=Bk2BkExpConvPV,Alpha=0.06274,Beta=0.09550,Sigma2=18.78430,Gamma=3.81773,Intensity=100";
  inline static std::string const b2bexp_default_311 =
      "name=Bk2BkExpConvPV,Alpha=0.07357,Beta=0.12883,Sigma2=15.37579,Gamma=3.25575,Intensity=100";
