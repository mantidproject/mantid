...
public:
  void testExecwithOneGroupandOne2DWorkspace() {
    ...
    MatrixWorkspace_sptr work_in3 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr work_in4 = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);
    ...
    work_in = AnalysisDataService::Instance().retrieveWS<WorkspaceGroup>("test_in");
    ...
    TS_ASSERT_THROWS_NOTHING(
        work_out = std::dynamic_pointer_cast<WorkspaceGroup>(AnalysisDataService::Instance().retrieve("test_out")));
    MatrixWorkspace_sptr work_out1;
    TS_ASSERT_THROWS_NOTHING(
        work_out1 = std::dynamic_pointer_cast<MatrixWorkspace>(AnalysisDataService::Instance().retrieve("test_out_1")));
    MatrixWorkspace_sptr work_out2;
    TS_ASSERT_THROWS_NOTHING(
        work_out2 = std::dynamic_pointer_cast<MatrixWorkspace>(AnalysisDataService::Instance().retrieve("test_out_2")));
    MatrixWorkspace_sptr work_out3;
    TS_ASSERT_THROWS_NOTHING(
        work_out3 = std::dynamic_pointer_cast<MatrixWorkspace>(AnalysisDataService::Instance().retrieve("test_out_3")));
    MatrixWorkspace_sptr work_out4;
    TS_ASSERT_THROWS_NOTHING(
        work_out4 = std::dynamic_pointer_cast<MatrixWorkspace>(AnalysisDataService::Instance().retrieve("test_out_4")));
  ...
  void testExecOnlyOneGroupInput() {
    ...
    WorkspaceGroup_sptr work_in;
    work_in = AnalysisDataService::Instance().retrieveWS<WorkspaceGroup>("testdead_in");
    TS_ASSERT_EQUALS(work_in, wsSptr);
    ...
    WorkspaceGroup_sptr work_out;
    TS_ASSERT_THROWS_NOTHING(
        work_out = std::dynamic_pointer_cast<WorkspaceGroup>(AnalysisDataService::Instance().retrieve("testdead_out")));

    MatrixWorkspace_sptr work_out1;
    TS_ASSERT_THROWS_NOTHING(work_out1 = std::dynamic_pointer_cast<MatrixWorkspace>(
  ...
  void testRenameWorkspaceNonConsecutiveDuplicates() {
    ...
    MatrixWorkspace_sptr work_in1 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr work_in2 = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);
    MatrixWorkspace_sptr work_in3 = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);
  ...
  void testRenameWorkspaceDuplicateNotInGroup() {
    ...
    constexpr int nHist = 20, nBins = 10;
    // Register the workspace in the data service
    MatrixWorkspace_sptr inGroupWs1 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr inGroupWs2 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr notInGroupWs = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);
    ...
    TS_ASSERT_EQUALS(wsSptr->getNumberOfEntries(), 2);
    TS_ASSERT_EQUALS(AnalysisDataService::Instance().doesExist(notInGroupWsName), true);
  ...
  void testTwoGroupWorkspaces() {
    ...
    // Register the workspace in the data service
    MatrixWorkspace_sptr worklhs_in1 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr worklhs_in2 = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);
    MatrixWorkspace_sptr worklhs_in3 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr worklhs_in4 = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);

    MatrixWorkspace_sptr workrhs_in1 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr workrhs_in2 = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);
    MatrixWorkspace_sptr workrhs_in3 = WorkspaceCreationHelper::create2DWorkspace123(nHist, nBins);
    MatrixWorkspace_sptr workrhs_in4 = WorkspaceCreationHelper::create2DWorkspace154(nHist, nBins);
