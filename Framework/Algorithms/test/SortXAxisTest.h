...
namespace {
MatrixWorkspace_sptr createWorkspaceE(const std::vector<double> &xData, const std::vector<double> &yData,
                                      const std::vector<double> &eData, const int nSpec = 1) {

  Workspace2D_sptr outputWorkspace = create<DataObjects::Workspace2D>(
      nSpec, Mantid::HistogramData::Histogram(Mantid::HistogramData::Points(xData.size())));
...
MatrixWorkspace_sptr createHistoWorkspaceE(const std::vector<double> &xData, const std::vector<double> &yData,
                                           const std::vector<double> &eData, const int nSpec = 1) {

  Workspace2D_sptr outputWorkspace = create<DataObjects::Workspace2D>(
      nSpec, Mantid::HistogramData::Histogram(Mantid::HistogramData::BinEdges(xData.size())));
  for (int i = 0; i < nSpec; ++i) {
    outputWorkspace->mutableY(i) = yData;
    outputWorkspace->mutableE(i) = eData;
    outputWorkspace->mutableX(i) = xData;
...
MatrixWorkspace_sptr createWorkspaceDx(const std::vector<double> &xData, const std::vector<double> &yData,
                                       const std::vector<double> &dxData, const int nSpec = 1) {
...
MatrixWorkspace_sptr createHistoWorkspaceDx(const std::vector<double> &xData, const std::vector<double> &yData,
                                            const std::vector<double> &dxData, const int nSpec = 1) {
...
MatrixWorkspace_sptr createHistoWorkspace(const std::vector<double> &xData, const std::vector<double> &yData,
                                          const int nSpec = 1) {
...
public:
  ...
  void testXAscending() {
    ...
    TS_ASSERT_THROWS_NOTHING(sortedws = AnalysisDataService::Instance().retrieveWS<MatrixWorkspace>("sortedws"));
    TS_ASSERT(sortedws);
    ...
    TS_ASSERT_THROWS_NOTHING(AnalysisDataService::Instance().remove("unsortedws"));
    TS_ASSERT_THROWS_NOTHING(AnalysisDataService::Instance().remove("sortedws"));
  }
  ...
  void testSortsXHistogramAscending() {
    ...
    MatrixWorkspace_sptr unsortedws = createHistoWorkspaceE(xData, yData, eData);
  ...
  void testDxMultipleSpectrum() {
    ...
    MatrixWorkspace_sptr unsortedws = createWorkspaceDx(xData, yData, dxData, 2);
  ...
  void testDxHistogramAscending() {
    ...
    MatrixWorkspace_sptr unsortedws = createHistoWorkspaceDx(xData, yData, dxData, 2);
