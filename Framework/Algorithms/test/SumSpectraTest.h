...
public:
  ...
  void testExecEvent_going_too_far() {
    TS_ASSERT_THROWS(dotestExecEvent("testEvent", "testEvent2", "5,10-15, 500-600"), std::runtime_error);
  }

  void testExecEvent_negative_indices() {
	TS_ASSERT_THROWS(dotestExecEvent("testEvent", "testEvent2", "5-10,-10"), std::runtime_error);
  }
