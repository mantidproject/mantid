...
public:
  ...
  void test_TwoInputWorkspaces() {
    ...
    Mantid::DataObjects::MaskWorkspace_const_sptr cws1 =
        std::dynamic_pointer_cast<const Mantid::DataObjects::MaskWorkspace>(ws1);
    ...
    try {
      ...
      DataObjects::MaskWorkspace_sptr ws3 =
          AnalysisDataService::Instance().retrieveWS<DataObjects::MaskWorkspace>(ws3name);
  ...
  void test_NOTOperation() {
    ...
    try {
      ...
      if (ws4 == nullptr) {
        ...
        std::cout << "Workspace4 is good at output of NOT.  Number Histogram = " << ws4->getNumberHistograms() << '\n';
      }
      if (ws1 == nullptr) {
        std::cout << "Workspace1 is NULL\n";
      } else {
        std::cout << "Workspace1 is good at output of NOT.  Number Histogram = " << ws1->getNumberHistograms() << '\n';
      }
    ...
    try {
      ...
      DataObjects::MaskWorkspace_sptr ws2 =
          AnalysisDataService::Instance().retrieveWS<DataObjects::MaskWorkspace>(ws2name);
