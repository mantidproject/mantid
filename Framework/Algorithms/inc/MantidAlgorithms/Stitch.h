...
private:
  void init() override;
  void exec() override;
  void scale(const API::MatrixWorkspace_sptr &wsToMatch, const API::MatrixWorkspace_sptr &wsToScale,
  ...
  void scaleManual(const std::vector<std::string> &inputs, const std::vector<double> &scaleFactors,
                   const API::MatrixWorkspace_sptr &scaleFactorsWorkspace);
  ...
  void recordScaleFactor(const API::MatrixWorkspace_sptr &scaleFactorWorkspace,
                         const API::MatrixWorkspace_sptr &medianWorkspace,
                         const API::MatrixWorkspace_sptr &scaledWorkspace, const std::vector<std::string> &inputs);
