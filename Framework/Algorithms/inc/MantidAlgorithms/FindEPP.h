...
/** FindEPP : Performs Gaussian fit of all spectra to find the elastic peak position.
 * This is the translation of the homonym algorithm previously written in python.
