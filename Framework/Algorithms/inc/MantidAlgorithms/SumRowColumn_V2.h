#ifndef MANTID_ALGORITHMS_SUMROWCOLUMNV2_H_
#define MANTID_ALGORITHMS_SUMROWCOLUMNV2_H_
...
*/
class DLLExport SumRowColumn_V2 : public API::Algorithm {
public:
  /// Algorithm's name
  const std::string name() const override { return "SumRowColumn_V2"; }
...
#endif /*MANTID_ALGORITHMS_SUMROWCOLUMNV2_H_*/