...
private:
  ...
  std::vector<Kernel::V3D>
      m_sampleElementPositions;       ///< Cached sample element positions
  ...
  std::vector<Kernel::V3D>
      m_containerElementPositions; ///< Cached container element positions
  size_t
      m_numContainerVolumeElements; ///< The number of container volume elements
