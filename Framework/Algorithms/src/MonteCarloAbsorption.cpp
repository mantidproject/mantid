...
void MonteCarloAbsorption::init() {
  ...
  declareProperty("MaxScatterPtAttempts", 5000, positiveInt,
                  ...
                  "holes in them, e.g. an thin annulus can cause problems "
                  "if this number is too low.\n"
                  "If a scattering point cannot be generated no matter how high"
                  "the number then it is most likely a problem with "
                  "the sample geometry.");
}
