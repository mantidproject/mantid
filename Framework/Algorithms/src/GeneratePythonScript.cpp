...
void GeneratePythonScript::init() {
  ...
  declareProperty("IncludeGenerationComment", true,
                  "Whether to include the \"Python script generated by Mantid...\" comment at the start of the script");
}
...
void GeneratePythonScript::exec() {
  ...
  const bool includeGenerationComment = getProperty("IncludeGenerationComment");
