...
void WorkspaceBoundingBox::initBoundingBox(const std::size_t numSpec, const double beamRadius, const bool directBeam) {
  double totalCount = 0;
  for (std::size_t i = 0; i < numSpec; i++) {
    ...
    if (!isOutOfBoundsOfNonDirectBeam(beamRadius, i, directBeam))
      continue;
    else
...
void WorkspaceBoundingBox::updateBoundingBox(WorkspaceBoundingBox &previousBoundingBox, const std::size_t numSpec,
