...
double WorkspaceBoundingBox::initBoundingBox(const std::size_t numSpec, const double beamRadius,
...
double WorkspaceBoundingBox::updateBoundingBox(WorkspaceBoundingBox &previousBoundingBox, const std::size_t numSpec,
