...
double initBoundingBox(WorkspaceBoundingBox &boundingBox, const std::size_t numSpec, const double beamRadius,
...
double updateBoundingBox(WorkspaceBoundingBox &boundingBox, WorkspaceBoundingBox &previousBoundingBox,
                         const std::size_t numSpec, const double beamRadius, const bool directBeam) {
  double totalCount = 0;
