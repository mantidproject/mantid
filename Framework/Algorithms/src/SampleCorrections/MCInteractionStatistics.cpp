 ...
 * & material
 */
MCInteractionStatistics::MCInteractionStatistics(const detid_t detectorID,
 ...
 */
void MCInteractionStatistics::UpdateScatterPointCounts(int componentIndex,
                                                       bool pointUsed) {
 ...
 */
void MCInteractionStatistics::UpdateScatterAngleStats(V3D toStart,
                                                      V3D scatteredDirec) {
...
std::string MCInteractionStatistics::generateScatterPointStats() {
  ...
  scatterPointSummary << "Total scatter points used: " << totalScatterPointsUsed
                      << std::endl;
