            ...
            try {
                ...
                if (ModDim > 0)
                {
                    ...
                    for (size_t basis = 0; basis < 3; basis++)
                    {
                        ...
                        << setprecision(8) << modub[back][basis] << setw(12) << setprecision(8)
                        << modub[up][basis] << " \n";
                    }
                }
...
//                out << "Lattice Parameters: \n";
                ...
                if (ModDim == 1)
                {
                    out << "Modulation Vector 1:   " << setw(12) << setprecision(4) << lattice.getdh(1)
                    << setw(12) << setprecision(4) << lattice.getdk(1)
                    << setw(12) << setprecision(4) << lattice.getdl(1)<< " \n";
                    
                    out << "Modulation Vector 1 error:   " << setw(6) << setprecision(4) << lattice.getdherr(1)
                    << setw(12) << setprecision(4) << lattice.getdkerr(1)
                    << setw(12) << setprecision(4) << lattice.getdlerr(1)<< " \n\n";
                ...
                if (ModDim == 2)
                {
                    ...
                    out << "Modulation Vector 2:   " << setw(12) << setprecision(4) << lattice.getdh(2)
                    << setw(12) << setprecision(4) << lattice.getdk(2)
                    << setw(12) << setprecision(4) << lattice.getdl(2)<< " \n";
                    
                    out << "Modulation Vector 2 error:   " << setw(6) << setprecision(4) << lattice.getdherr(2)
                    << setw(12) << setprecision(4) << lattice.getdkerr(2)
                    << setw(12) << setprecision(4) << lattice.getdlerr(2)<< " \n\n";
                ...
                if (ModDim == 3)
                {
                    ...
                    out << "Modulation Vector 2:   " << setw(12) << setprecision(4) << lattice.getdh(3)
                    << setw(12) << setprecision(4) << lattice.getdk(3)
                    << setw(12) << setprecision(4) << lattice.getdl(3)<< " \n";
                    
                    out << "Modulation Vector 2 error:   " << setw(6) << setprecision(4) << lattice.getdherr(3)
                    << setw(12) << setprecision(4) << lattice.getdkerr(3)
                    << setw(12) << setprecision(4) << lattice.getdlerr(3)<< " \n\n";
