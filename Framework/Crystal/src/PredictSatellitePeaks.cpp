...
namespace Mantid {
    ...
    namespace Crystal {
        ...
        void PredictSatellitePeaks::predictOffsets(DataObjects::PeaksWorkspace_sptr Peaks,
        ...
        void PredictSatellitePeaks::predictOffsetsWithCrossTerms(DataObjects::PeaksWorkspace_sptr Peaks,
