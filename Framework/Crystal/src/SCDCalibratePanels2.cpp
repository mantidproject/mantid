...
SCDCalibratePanels2::selectPeaksByBankName(IPeaksWorkspace_sptr pws,
 ...
 */
ITableWorkspace_sptr SCDCalibratePanels2::generateCalibrationTable(
  ...
  for (int i = 0; i < 8; ++i)
    itablews->addColumn(calibrationTableColumnTypes[i],
