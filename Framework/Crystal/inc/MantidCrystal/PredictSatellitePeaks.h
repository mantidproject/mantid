...
private:
  ...
  void predictOffsets(const int iVector, const Kernel::V3D &offsets, const int maxOrder, const int runNumber,
                      Kernel::Matrix<double> const &goniometer, const Kernel::V3D &hkl,
