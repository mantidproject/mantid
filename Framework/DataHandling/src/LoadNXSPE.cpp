...
void LoadNXSPE::exec() {
  ...
  // For NXSPE files generated by Mantid using the usual direct reduction
  // on ISIS instruments, the data is actually a distribution.
  if (instrument_name == "LET" || instrument_name == "MAPS" || 
      instrument_name == "MARI" || instrument_name == "MERLIN")
