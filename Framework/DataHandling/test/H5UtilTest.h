...
public:
    ...
    void test_strings()
    {
        ...
        do_assert_simple_string_data_set(FILENAME, GRP_NAME, DATA_NAME,
                                         DATA_VALUE);
    ...
    void test_array1d()
    {
        ...
        { // read tests
            ...
            // without conversion
            TS_ASSERT_EQUALS(
                H5Util::readArray1DCoerce<float>(group, "array1d_float"),
                array1d_float);
            TS_ASSERT_EQUALS(
...
private:
        ...
        = std::map<std::string, std::string>())
    {
        ...
        auto fullCheck
            = H5Util::readString(file, "/" + groupName + "/" + dataName);
