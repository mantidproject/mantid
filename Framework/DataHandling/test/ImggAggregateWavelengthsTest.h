...
public:
  ...
  static ImggAggregateWavelengthsTest *createSuite() { return new ImggAggregateWavelengthsTest(); }
  static void destroySuite( ImggAggregateWavelengthsTest *suite ) { delete suite; }
