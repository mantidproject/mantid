...
public:
  ...
  void test_that_sample_run_numbers_included_if_sample_transmission_property_is_set() {
    ...
    setXValuesOn1DWorkspaceWithPointData(transmission, transmissionParameters.xmin, transmissionParameters.xmax);
  ...
  void test_that_can_run_numbers_included_if_can_transmission_property_is_set() {
    ...
    setXValuesOn1DWorkspaceWithPointData(transmissionCan, transmissionCanParameters.xmin,
