...
public:
  ...
  void testExecAl2O3() {
    ...
    TS_ASSERT_DELTA(sampleMaterial.absorbXSection(NeutronAtom::ReferenceLambda), 0.0925, 0.0001);
    TS_ASSERT_DELTA(sampleMaterial.cohScatterLength(NeutronAtom::ReferenceLambda), 4.8614, 0.0001);
    TS_ASSERT_DELTA(sampleMaterial.totalScatterLengthSqrd(NeutronAtom::ReferenceLambda), 24.9905, 0.0001);
  ...
  void testExecBaTiO3() {
    ...
    TS_ASSERT_THROWS_NOTHING(setmat->setPropertyValue("InputWorkspace", wsName));
    TS_ASSERT_THROWS_NOTHING(setmat->setPropertyValue("ChemicalFormula", "Ba Ti O3"));
    TS_ASSERT_THROWS_NOTHING(setmat->setPropertyValue("SampleNumberDensity", "0.1183245")); // TODO
    TS_ASSERT_THROWS_NOTHING(setmat->execute());
    TS_ASSERT(setmat->isExecuted());
    ...
    TS_ASSERT_DELTA(sampleMaterial.absorbXSection(NeutronAtom::ReferenceLambda), 1.4381, 0.0001);
    TS_ASSERT_DELTA(sampleMaterial.cohScatterLength(NeutronAtom::ReferenceLambda), 3.8082, 0.0001);
    TS_ASSERT_DELTA(sampleMaterial.totalScatterLengthSqrd(NeutronAtom::ReferenceLambda), 32.5090, 0.0001);
  ...
  void testExecMat_OneAtom() {
    ...
    TS_ASSERT_DELTA(sampleMaterial.absorbXSection(NeutronAtom::ReferenceLambda), 4.49, 0.0001);
    TS_ASSERT_DELTA(sampleMaterial.cohScatterLength(NeutronAtom::ReferenceLambda), 10.3, 0.0001);
    const double totScattLength = sampleMaterial.totalScatterLength(NeutronAtom::ReferenceLambda);
    TS_ASSERT_DELTA(sampleMaterial.totalScatterLengthSqrd(NeutronAtom::ReferenceLambda),
