 ...
 */
void IntegrateEllipsoidsWithSatellites::qListFromEventWS(
 ...
 * @param hkl_integ ; boolean for integrating in HKL space
 */
void IntegrateEllipsoidsWithSatellites::qListFromHistoWS(
...
/**
 * @brief IntegrateEllipsoidsWithSatellites::initTargetWSDescr Initialize the
 * output information for the MD conversion framework.
 *
 * @param wksp The workspace to get information from.
 */
void IntegrateEllipsoidsWithSatellites::initTargetWSDescr(
...
void IntegrateEllipsoidsWithSatellites::calculateE1(
...
void IntegrateEllipsoidsWithSatellites::runMaskDetectors(
