...
public:
  ...
  void test_runIndex() {
    ...
    const std::vector<coord_t> ref = {1,    1,    0,    0, 6.25, 6.25, 6.25, 1,    1,    1,   0,
                                      6.25, 6.25, 6.25, 1, 1,    2,    0,    6.25, 6.25, 6.25};
    ...
    const std::vector<coord_t> ref2 = {1, 1, 0, 0, 6.25, 6.25, 6.25, 1, 1, 1, 0, 6.25, 6.25, 6.25,
