...
public:
  ...
  void test_histo_histo() {
    ...
    out = BinaryOperationMDTestHelper::doTest("GreaterThanMD", "histo_A",
                                              "histo_B", "out");
    TS_ASSERT_DELTA(out->getSignalAt(0), 0.0, 1e-5);
    out = BinaryOperationMDTestHelper::doTest("GreaterThanMD", "histo_B",
                                              "histo_A", "out");
  ...
  void test_event_fails() {
    BinaryOperationMDTestHelper::doTest("GreaterThanMD", "event_A", "scalar",
                                        "out", false /*fails*/);
    BinaryOperationMDTestHelper::doTest("GreaterThanMD", "event_A", "event_B",
                                        "out", false /*fails*/);
  }

  void test_scalar_histo_fails() {
    BinaryOperationMDTestHelper::doTest("GreaterThanMD", "scalar", "histo_A",
                                        "out", false /*fails*/);
  }
};
