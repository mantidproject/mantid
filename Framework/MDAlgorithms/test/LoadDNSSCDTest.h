...
public:
  ...
  void test_NormMonitor() {
    ...
    const std::vector<coord_t> ref = {
        ...
        0.223000198347f, 8332872, 8332872, 1, 4, -0.359968893923f,
        ...
        -0.78089653758f, -0.78089653758f, 0.217039697581f, 8332872, 8332872, 1,
        11, -0.847435189645f, -0.847435189645f, 0.182341737639f, 8332872,
        8332872, 1, 12, -0.911552400429f, -0.911552400429f, 0.13968742025f,
        8332872, 8332872, 1, 13, -0.972760199244f, -0.972760199244f,
        0.089401370527f, 8332872, 8332872, 1, 14, -1.03059275778f,
        -1.03059275778f, 0.0318662956709f, 8332872, 8332872, 1, 15,
        -1.08460993535f, -1.08460993535f, -0.0324799276578f, 8332872, 8332872,
        1, 16, -1.13440062862f, -1.13440062862f, -0.103147585846f, 8332872,
        8332872, 1, 17, -1.17958590034f, -1.17958590034f, -0.179598855345f,
        8332872, 8332872, 1, 18, -1.21982186332f, -1.21982186332f,
        -0.261251895832f, 8332872, 8332872, 1, 19, -1.25480229757f,
        -1.25480229757f, -0.347485278364f, 8332872, 8332872, 1, 20,
        -1.28426098088f, -1.28426098088f, -0.437642714831f, 8332872, 8332872, 1,
        21, -1.30797371487f, -1.30797371487f, -0.531038052704f, 8332872,
        8332872, 1, 22, -1.32576003133f, -1.32576003133f, -0.626960497068f,
        8332872, 8332872, 1, 23, -1.33748456564f, -1.33748456564f,
        -0.724680020201f};
    double d(1.0e-06);
    for (auto i = 0; i < 168; i++) {
      TS_ASSERT_DELTA(events[i], ref[i], d);
