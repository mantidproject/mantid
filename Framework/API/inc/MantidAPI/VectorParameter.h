...
*/
template <typename Derived, typename ElemType> bool VectorParameter<Derived, ElemType>::isValid() const {
  return m_isValid;
}
...
/// Default constructor
template <typename Derived, typename ElemType>
VectorParameter<Derived, ElemType>::VectorParameter() : m_arry(nullptr), m_size(0) {
  m_isValid = false;
}
...
/// Destructor
template <typename Derived, typename ElemType> VectorParameter<Derived, ElemType>::~VectorParameter() {
  delete[] m_arry;
}
...
*/
template <typename Derived, typename ElemType> std::string VectorParameter<Derived, ElemType>::toXMLString() const {
  if (!m_isValid) {
...
*/
template <typename Derived, typename ElemType> ElemType &VectorParameter<Derived, ElemType>::operator[](int index) {
  return m_arry[index];
}
...
*/
template <typename Derived, typename ElemType> size_t VectorParameter<Derived, ElemType>::getSize() const {
  return m_size;
}
...
*/
template <typename Derived, typename ElemType> const ElemType *VectorParameter<Derived, ElemType>::getPointerToStart() {
  return m_arry;
}
...
*/
template <typename Derived, typename ElemType> ElemType &VectorParameter<Derived, ElemType>::at(size_t index) {
  return m_arry[index];
}
