...
private:
  ...
  protected:
    ImplicitFunctionParameter *clone() const override { return new MockImplicitFunctionParameter; }
  };
  ...
  public:
    Mantid::API::ImplicitFunctionParameter *createParameter(Poco::XML::Element *) override {
...
public:
  void testSetup() {
    ...
    Mantid::API::ImplicitFunctionParameterParserFactory::Instance().subscribe<MockImplicitFunctionParameterParserA>(
        "MockImplicitFunctionParameterParserA");
    Mantid::API::ImplicitFunctionParameterParserFactory::Instance().subscribe<MockImplicitFunctionParameterParserB>(
        "MockImplicitFunctionParameterParserB");
  }

  void testGetFirstConcreteInstance() {
    Mantid::API::ImplicitFunctionParameterParser *parser =
        Mantid::API::ImplicitFunctionParameterParserFactory::Instance().createUnwrapped(
            "MockImplicitFunctionParameterParserA");
