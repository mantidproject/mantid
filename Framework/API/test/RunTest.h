...
public:
  ...
  void test_GetPropertyAsSingleValue_Throws_If_Type_Is_Not_Numeric_Or_TimeSeries_Numeric() {
    Run runInfo;
  ...
  void test_storeHistogramBinBoundaries_Throws_If_Fewer_Than_Two_Values_Are_Given() {
    ...
    TS_ASSERT_THROWS(runInfo.storeHistogramBinBoundaries(bins), const std::invalid_argument &);
  ...
  void test_storeHistogramBinBoundaries_Throws_If_First_Value_Is_Greater_Or_Equal_To_Last_Value() {
    ...
    TS_ASSERT_THROWS(runInfo.storeHistogramBinBoundaries(bins), const std::out_of_range &);
  ...
  void test_histogramBinBoundaries_Throws_RuntimeError_For_New_Run() {
    ...
    TS_ASSERT_THROWS(runInfo.histogramBinBoundaries(1.5), const std::runtime_error &);
  }
  ...
  void test_histogramBinBoundaries_Throws_RuntimeError_When_Value_Is_Outside_Boundaries_Range() {
    ...
    TS_ASSERT_THROWS(runInfo.histogramBinBoundaries(m_test_energy_bins.front() - 1.3), const std::out_of_range &);
    TS_ASSERT_THROWS(runInfo.histogramBinBoundaries(m_test_energy_bins.back() + 1.3), const std::out_of_range &);
  }
  ...
  void test_setGoniometerWhenLogsDoNotExistsThrows() {
    ...
    TS_ASSERT_THROWS(runInfo.setGoniometer(gm, true), const std::runtime_error &);
  }
...
public:
  ...
  RunTestPerformance() : m_testRun(), m_propName("test") { addTestTimeSeries(m_testRun, m_propName); }
