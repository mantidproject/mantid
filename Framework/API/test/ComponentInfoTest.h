...
public:
  ...
  void test_size() {
    std::vector<std::vector<size_t>> detectorIndexes{{}, {}}; // No detectors in this example
    ...
    ComponentInfo info(internalInfo, std::vector<Mantid::Geometry::ComponentID>{&comp1, &comp2});
 ...
 void test_indexOf() {
  ...
  void test_throws_if_componentids_and_internalinfo_size_mismatch(){
      std::vector<std::vector<size_t>> detectorIndexes{{}, {}}; // No detectors in this example
      Mantid::Beamline::ComponentInfo internalInfo(detectorIndexes);
      TSM_ASSERT_THROWS("Should throw too few ComponentIDs", ComponentInfo(internalInfo, std::vector<Mantid::Geometry::ComponentID>{}), std::invalid_argument&);
  ...
  void test_detector_indexes() {
    ...
    ComponentInfo info(internalInfo, std::vector<Mantid::Geometry::ComponentID>{&fakeComposite1, &fakeComposite2, &fakeDetector1, &fakeDetector2, &fakeDetector3});
