 ...
 */
Kernel::IValidator_sptr MDFrameValidator::clone() const { return std::make_shared<MDFrameValidator>(*this); }
 ...
 */
std::string MDFrameValidator::checkValidity(const IMDWorkspace_sptr &workspace) const {
