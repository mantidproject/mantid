...
DetectorSearcher::DetectorSearcher(Geometry::Instrument_const_sptr instrument, const API::DetectorInfo& detInfo)
  : m_usingFullRayTrace(instrument->containsRectDetectors() == Geometry::Instrument::ContainsState::Full),
    m_crystallography_convention(Kernel::ConfigService::Instance().getString("Q.convention") == "Crystallography"),
...
const std::tuple<bool, size_t> DetectorSearcher::findDetectorIndex(const V3D &q)
{
...
const std::tuple<bool, size_t> DetectorSearcher::searchUsingInstrumentRayTracing(const V3D &q)
{
...
const std::tuple<bool, size_t> DetectorSearcher::searchUsingNearestNeighbours(const V3D &q)
{
...
const std::tuple<bool, size_t> DetectorSearcher::checkInteceptWithNeighbours(const V3D& direction, const Kernel::NearestNeighbours<3>::NearestNeighbourResults& neighbours) const {
