...
RemoteJobManagerFactoryImpl::RemoteJobManagerFactoryImpl() : Mantid::Kernel::DynamicFactory<IRemoteJobManager>() {
 ...
 */
IRemoteJobManager_sptr RemoteJobManagerFactoryImpl::create(const std::string &computeResourceName) const {
  ...
  Mantid::Kernel::ComputeResourceInfo cr =
      Mantid::Kernel::ConfigService::Instance().getFacility().computeResource(computeResourceName);
 ...
 */
Mantid::API::IRemoteJobManager_sptr RemoteJobManagerFactoryImpl::create(const std::string &baseURL,
                                                                        const std::string &jobManagerType) const {
  Mantid::API::IRemoteJobManager_sptr jm;

  // use the inherited/generic create method
  try {
    jm = Mantid::Kernel::DynamicFactory<IRemoteJobManager>::create(jobManagerType);
  } catch (Kernel::Exception::NotFoundError &e) {
    throw Kernel::Exception::NotFoundError("RemoteJobManagerFactory: failed to create a remote job manager of "
                                           "type (class) '" +
