...
public:
  ...
  static SubmitRemoteJob2Test *createSuite() { return new SubmitRemoteJob2Test(); }
  static void destroySuite(SubmitRemoteJob2Test *suite) { delete suite; }

  void test_algorithm() {
    testAlg = Mantid::API::AlgorithmManager::Instance().create("SubmitRemoteJob" /*, 2*/);
    TS_ASSERT(testAlg);
  ...
  void test_castAlgorithm() {
    ...
    TS_ASSERT(dynamic_cast<Mantid::RemoteAlgorithms::SubmitRemoteJob2 *>(a.get()));
  ...
  void test_propertiesMissing() {
    ...
    TS_ASSERT_THROWS_NOTHING(alg1.setPropertyValue("ScriptParams", "print 'hello world'"));
    ...
    TS_ASSERT_THROWS_NOTHING(alg2.setPropertyValue("ScriptParams", "print 'hello world'"));
    ...
    TS_ASSERT_THROWS_NOTHING(alg3.setPropertyValue("ScriptParams", "print 'hello world'"));
    ...
    TS_ASSERT_THROWS_NOTHING(alg4.setPropertyValue("ScriptParams", "print 'hello world'"));
  ...
  void test_wrongProperty() {
    ...
    TS_ASSERT_THROWS(s.setPropertyValue("ScriptParams", ""), const std::invalid_argument &);
  }
  ...
  void test_propertiesOK() {
    ...
    for (auto &testFacility : testFacilities) {
      ...
      TS_ASSERT_THROWS_NOTHING(s.setPropertyValue("ScriptParams", "print 'hello world'"));
