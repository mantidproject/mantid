#ifndef CURVEFITTING_RAL_NLLS_NLLS_H_
#define CURVEFITTING_RAL_NLLS_NLLS_H_
...
struct nlls_options {
  ...
  real  more_sorensen_tiny = 10.0 * std::numeric_limits<double>::epsilon();
...
void MANTID_CURVEFITTING_DLL nlls_solve(int n, int m, DoubleFortranVector& X,
...
#endif // CURVEFITTING_RAL_NLLS_NLLS_H_
