...
namespace Functions {
/**
 * @brief Chudley-Elliots jump diffusion model
 */
class MANTID_CURVEFITTING_DLL ChudleyElliotSQE : public FunctionQDepends {

public:
  std::string name() const override { return "ChudleyElliotSQE"; }
