...
/**
 * @brief Fick's law for diffusion
 */
class MANTID_CURVEFITTING_DLL FickDiffusionSQE : public FunctionQDepends {

public:
  std::string name() const override { return "FickDiffusionSQE"; }
