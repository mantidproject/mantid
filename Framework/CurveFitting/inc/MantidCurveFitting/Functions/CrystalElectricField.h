...
void MANTID_CURVEFITTING_DLL calculateZeemanEigensystem(
    DoubleFortranVector &eigenvalues, ComplexFortranMatrix &eigenvectors,
...
void MANTID_CURVEFITTING_DLL calculateMagneticMoment(
    const ComplexFortranMatrix &ev, const DoubleFortranVector &Hmag,
    const int nre, DoubleFortranVector &moment);

void MANTID_CURVEFITTING_DLL calculateMagneticMomentMatrix(
    const ComplexFortranMatrix &ev, const std::vector<double> &Hdir,
