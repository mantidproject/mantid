...
*/
class MANTID_CURVEFITTING_DLL QENSFitSequential : public API::DataProcessorAlgorithm {
public:
...
private:
  ...
  void renameWorkspaces(API::WorkspaceGroup_sptr outputGroup, std::vector<std::string> const &spectra,
                        std::string const &outputBaseName, std::string const &endOfSuffix);
  void renameWorkspaces(API::WorkspaceGroup_sptr outputGroup, std::vector<std::string> const &spectra,
                        std::string const &outputBaseName, std::string const &endOfSuffix,
                        std::vector<std::string> const &names);
  void renameGroupWorkspace(std::string const &currentName, std::vector<std::string> const &spectra,
                            std::string const &outputBaseName, std::string const &endOfSuffix);
