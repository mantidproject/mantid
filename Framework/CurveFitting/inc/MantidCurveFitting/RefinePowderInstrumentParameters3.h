...
private:
  ...
  void bookKeepMCResult(std::map<std::string, Parameter> parammap, double chisq,
                        int istep, int igroup,
  ...
  void updateFunctionParameterValues(API::IFunction_sptr function,
                                     std::map<std::string, Parameter> &params);
  ...
  genOutputProfileTable(std::map<std::string, Parameter> parameters,
...
void convertToDict(std::vector<std::string> strvec,
...
void copyParametersValues(std::map<std::string, Parameter> source,
                          std::map<std::string, Parameter> &target);
