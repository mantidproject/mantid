...
public:
  ...
  std::string name() const override { return "FRConjugateGradientTestCostFunction"; }
...
public:
  ...
  static FRConjugateGradientTest *createSuite() { return new FRConjugateGradientTest(); }
