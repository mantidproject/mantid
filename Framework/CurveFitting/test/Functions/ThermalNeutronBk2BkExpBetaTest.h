...
public:
  ...
  static ThermalNeutronBk2BkExpBetaTest *createSuite() {
    return new ThermalNeutronBk2BkExpBetaTest();
  }
  static void destroySuite(ThermalNeutronBk2BkExpBetaTest *suite) {
    delete suite;
  }
