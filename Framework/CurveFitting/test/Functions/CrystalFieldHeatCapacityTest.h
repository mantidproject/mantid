...
public:
  void test_evaluate() {
    ...
    auto testFun2 = FunctionFactory::Instance().createInitialized("name=UserFunction,Formula=a*x*x*x+b*x*x+c*x+d,"
  ...
  void test_factory() {
    std::string funDef = "name=CrystalFieldHeatCapacity,Ion=Ce,Symmetry=C2v,"
