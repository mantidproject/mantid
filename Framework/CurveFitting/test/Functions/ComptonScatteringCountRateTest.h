...
public:
  ...
  void test_Empty_String_For_Intensity_Attribute_Throws_Error() {
    ...
    TS_ASSERT_THROWS(countRate->setAttributeValue("IntensityConstraints", ""), const std::invalid_argument &);
  }

  void test_Incorrect_String_For_Intensity_Attribute_Throws_Error() {
    auto countRate = createFunction();

    TS_ASSERT_THROWS(countRate->setAttributeValue("IntensityConstraints", "Matrix"), const std::invalid_argument &);
  }
  ...
  void test_IterStartingResetsIntensityAndBackgroundParsWithBackgroundIncluded() {
    using namespace Mantid::API;
    IFunction_sptr func = createFunctionWithBackground();
    func->setAttributeValue("IntensityConstraints",
                            "Matrix(1|2)1|-2"); // I_1 = 2I_2
...
private:
  ...
  public:
    ...
    std::vector<size_t> intensityParameterIndices() const override { return std::vector<size_t>(1, 1); }
  ...
  public:
    TwoIntensitiesComptonProfileStub() : ComptonProfileStub() { declareParameter("Intensity_2", 1.0); }
    std::string name() const override { return "TwoIntensitiesComptonProfileStub"; }
