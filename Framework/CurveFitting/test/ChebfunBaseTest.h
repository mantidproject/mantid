...
public:
  ...
  void testEval_Sin() { do_test_eval(Sin, -M_PI, M_PI, 10); }

  void testEval_Cos() { do_test_eval(Cos, -M_PI, M_PI, 10); }

  void testEval_SinCos() { do_test_eval(SinCos, -M_PI, M_PI, 10); }
  ...
  void test_bestFit_Sin() { do_test_bestFit(Sin, -M_PI, M_PI, 20); }

  void test_bestFit_Cos() { do_test_bestFit(Cos, -M_PI, M_PI, 21); }

  void test_bestFit_SinCos() { do_test_bestFit(SinCos, -M_PI, M_PI, 21); }

  void test_bestFit_Linear() { do_test_bestFit(Linear, -2, 10, 2); }

  void test_bestFit_Quadratic() { do_test_bestFit(Quadratic, -4, 4, 3); }
  ...
  void test_derivative_Sin() { do_test_derivative(Sin, -M_PI, M_PI, Cos); }
