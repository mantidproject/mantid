...
public:
  ...
  void test_on_Gaussian_ties() {
    auto fun =
        FunctionFactory::Instance().createInitialized("name=Gaussian,PeakCentre=0,Height=1,Sigma=2,ties=(Sigma=2)");
    auto ws = createWorkspace(*fun);
...
private:
  MatrixWorkspace_sptr createWorkspace(const IFunction &fun) const {
    ...
    const std::vector<double> noise(
        {0.429616,  0.390155,    -0.183624,  -0.369293,  -0.316081,  -0.460241,   -0.29544,   0.326436,  0.067725,
         0.0320779, 0.0955447,   0.45631,    0.464515,   -0.0380737, 0.153177,    0.423738,   0.248907,  -0.126079,
         0.15357,   -0.345027,   0.247715,   0.392344,   0.461307,   -0.47321,    -0.491612,  -0.208498, -0.393556,
         -0.101256, -0.201296,   0.307289,   0.156411,   0.127094,   0.309813,    0.407925,   0.372176,  0.0563973,
         0.464648,  0.339919,    0.223685,   -0.449512,  0.142475,   0.306235,    0.217454,   0.430816,  -0.032401,
         -0.13597,  -0.174415,   0.190948,   -0.0603554, -0.370685,  0.229689,    0.332686,   0.494015,  -0.181646,
         0.176874,  0.237202,    0.290823,   0.0967696,  -0.329086,  -0.136293,   -0.473151,  0.294971,  0.30037,
         0.198481,  0.403723,    0.321879,   -0.475324,  0.399466,   -0.00825268, 0.331899,   0.0262552, 0.409958,
         0.096366,  0.474914,    -0.448042,  0.15612,    0.39509,    0.31199,     0.228266,   -0.397256, 0.31835,
         -0.262472, 0.000222752, -0.120655,  0.310189,   0.199236,   -0.404031,   -0.0150548, -0.28105,  -0.0847778,
         -0.241281, 0.138662,    -0.0318942, 0.25929,    -0.0406268, 0.0575229,   0.20951,    0.193455,  -0.321947,
         0.413259});
    size_t n = 100;
