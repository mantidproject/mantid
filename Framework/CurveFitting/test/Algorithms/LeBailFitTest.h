...
createInputHKLWorkspace(std::vector<std::vector<int>> hkls,
...
API::MatrixWorkspace_sptr generateSeparateTwoPeaksData2() {
  ...
  CountStandardDeviations vecE = {
      1.000000,  1.000000,  1.000000,  1.000000,  1.187330,  1.416570,
      1.690260,  2.016600,  2.406230,  2.870800,  3.425470,  4.086820,
      4.876440,  5.817940,  6.942020,  8.282330,  9.882550,  11.791900,
      14.068000, 16.781200, 19.991300, 23.715500, 27.809000, 31.863500,
      35.190400, 37.080200, 37.155300, 35.586500, 32.957800, 29.912500,
      26.897200, 24.104900, 21.585500, 19.325000, 17.302000, 15.489600,
      13.867000, 12.415400, 11.114900, 9.951300,  8.908900,  7.976270,
      7.140760,  6.393230,  5.723530,  5.124370,  4.587590,  4.107340,
      3.677090,  3.292150,  2.947300,  2.638760,  2.362350,  2.115050,
      1.893500,  1.695150,  1.517700,  1.358720,  1.000000,  1.000000,
      1.000000,  1.000000,  1.000000,  1.000000,  1.168530,  1.366060,
      1.596820,  1.866750,  2.182090,  2.550950,  2.981870,  3.485930,
      4.074790,  4.763600,  5.568260,  6.509400,  7.608330,  8.891690,
      10.383700, 12.107300, 14.065200, 16.231500, 18.522700, 20.798500,
      22.861300, 24.495200, 25.519100, 25.829800, 25.434200, 24.441500,
      23.024500, 21.373800, 19.648200, 17.960600, 16.369600, 14.901300,
      13.557300, 12.333300, 11.218700, 10.205200, 9.282780,  8.444220,
      7.680940,  6.987080,  6.355510,  5.781020,  5.258800,  4.783440,
      4.351330,  3.958010,  3.600460,  3.275010,  2.979160,  2.709870,
      2.465080,  2.242250,  2.039700,  1.855330,  1.687730,  1.535170,
      1.396490,  1.270260,  1.155510,  1.051060,  1.000000,  1.000000,
      1.000000};
...
API::MatrixWorkspace_sptr generateTwinPeakData() {
  ...
  Points vecX = {12646.470000, 12658.333000, 12670.196000, 12682.061000,
                 12693.924000, 12705.787000, 12717.650000, 12729.514000,
                 12741.378000, 12753.241000, 12765.104000, 12776.968000,
                 12788.831000, 12800.695000, 12812.559000, 12824.422000,
                 12836.285000, 12848.148000, 12860.013000, 12871.876000,
                 12883.739000, 12895.603000, 12907.466000};
  Counts vecY = {0.569167,   0.355704,   0.851669,    4.611006,   24.960907,
                 135.082310, 613.158870, 587.661740,  213.997240, 85.320320,
                 86.317253,  334.309050, 1171.018700, 732.479430, 258.377170,
                 90.549515,  31.733501,  11.121155,   3.904864,   0.041584,
                 0.223411,   1.200295,   6.448674};
  CountStandardDeviations vecE = {
...
API::MatrixWorkspace_sptr generate1PeakDataPlusBackground() {
  ...
  Counts vecY = {
      ...
      -0.000605, -0.003475, 0.003512,  -0.000796, 0.006515, 0.010276,  0.004984,
      0.006924,  0.007722,  0.006036,  0.003330,  0.002929, 0.007368,  0.001504,
      0.002403,  0.004263,  0.001860,  0.002712,  0.001574, -0.001803, 0.000825,
      -0.003368, -0.003277, -0.001997};
  CountStandardDeviations vecE = {
...
API::MatrixWorkspace_sptr generateArgSiPeak220() {
  ...
  Points vecx = {31019.300000, 31050.400000, 31081.400000, 31112.500000,
                 31143.600000, 31174.800000, 31205.900000, 31237.100000,
                 31268.400000, 31299.600000, 31330.900000, 31362.300000,
                 31393.600000, 31425.000000, 31456.500000, 31487.900000,
                 31519.400000, 31550.900000, 31582.500000, 31614.100000,
                 31645.700000, 31677.300000, 31709.000000, 31740.700000,
                 31772.500000, 31804.200000};
  Counts vecy = {0.026242, 0.026461, 0.028096, 0.028964, 0.028611, 0.034328,
                 0.039418, 0.053557, 0.098894, 0.205568, 0.439015, 0.819417,
                 1.338839, 1.744511, 1.834295, 1.534555, 1.031174, 0.528931,
                 0.231984, 0.109614, 0.063961, 0.048803, 0.038360, 0.036393,
                 0.032483, 0.030962};
  vecy -= 0.02295189;
  CountStandardDeviations vece = {
...
createPeakParameterWorkspace(map<std::string, double> parammodifymap,
  ...
  for (paramiter = paramvaluemap.begin(); paramiter != paramvaluemap.end();
       ++paramiter) {
...
public:
  ...
  void Disabled_test_monteCarloLeBailFit_PG3Bank7() {
    ...
    lbfit.setProperty("BackgroundType", "Polynomial");
    lbfit.setPropertyValue("BackgroundParametersWorkspace",
                           "BackgroundParameters");
  ...
  void Xtest_refineBackground() {
    ...
    AnalysisDataService::Instance().addOrReplace("NomB4BackgroundParameters",
                                                 bkgdws);
    ...
    lbfit.setProperty("Damping", 0.4);
    lbfit.setProperty("NumberMinimizeSteps", 100);
    lbfit.setProperty("BackgroundParametersWorkspace",
                      "NomB4BackgroundParameters");
...
public:
  // This pair of boilerplate methods prevent the suite being created statically
  // This means the constructor isn't called when running other tests
  static LeBailFitTestPerformance *createSuite() {
    return new LeBailFitTestPerformance();
  }
  ...
  void test_CalculationSimpleModeProfile9() {
    ...
    AnalysisDataService::Instance().addOrReplace("PeakParameters",
                                                 parameterws9);
