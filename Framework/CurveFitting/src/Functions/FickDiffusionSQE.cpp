...
namespace {
Mantid::Kernel::Logger g_log("FickDiffusionSQE");
}

namespace Mantid::CurveFitting::Functions {

DECLARE_FUNCTION(FickDiffusionSQE)

/**
 * @brief function parameters and impose constraints
 */
void FickDiffusionSQE::declareParameters() {
 ...
 */
void FickDiffusionSQE::function1D(double *out, const double *xValues, const size_t nData) const {
 ...
 */
void FickDiffusionSQE::functionDeriv1D(Mantid::API::Jacobian *jacobian, const double *xValues, const size_t nData) {
