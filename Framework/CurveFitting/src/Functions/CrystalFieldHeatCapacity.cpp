...
void CrystalFieldHeatCapacityBase::function1D(double *out, const double *xValues,
...
// Sets the eigenvectors / values directly
void CrystalFieldHeatCapacityCalculation::setEnergy(const DoubleFortranVector &en) {
  m_en = en;
}
