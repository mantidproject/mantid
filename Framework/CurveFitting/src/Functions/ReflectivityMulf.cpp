...
void ReflectivityMulf::function1D(double *out, const double *xValues, const size_t nData) const {
  ...
  std::complex<double> rnf;
  std::complex<double> rnf1;
  std::complex<double> ac1;
  std::complex<double> ac2;
  std::complex<double> ac3;
  std::complex<double> ac4;
  std::complex<double> a12t;
  std::complex<double> a22t;
  std::complex<double> btm;
  std::complex<double> btm1;
  std::complex<double> cbtm;
  std::complex<double> cbtm1;

  std::complex<double> a111;
  std::complex<double> a112;
  std::complex<double> a121;
  std::complex<double> a122;
  std::complex<double> a211;
  std::complex<double> a212;
  std::complex<double> a221;
  std::complex<double> a222;
  std::complex<double> a311;
  std::complex<double> a312;
  std::complex<double> a321;
  std::complex<double> a322;
