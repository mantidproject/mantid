...
struct solve_LLS_work {
  DoubleFortranVector temp, work, Jlls;
};
...
//! -------------------------------------------------------
//
//     REAL, intent(in)  J(:), f(:), hf(:), g(:), Delta
//     integer, intent(in)   n, m
//     real, intent(out)  d(:)
//     real, intent(out)  normd
...
//! -----------------------------------------
//
//     REAL, intent(in)  J(:), hf(:), f(:), g(:), Delta
//     integer, intent(in)   n, m
//     real, intent(out)  d(:)
//     real, intent(out)  normd ! ||d||_D
//     TYPE( nlls_options ), INTENT( IN )  options
//     TYPE( nlls_inform ), INTENT( INOUT )  inform
//     TYPE( dogleg_work )  w
//     
...
//     integer, intent(in)   n, m
//     real, intent(out)  d(:)
//     real, intent(out)  nd ! ||d||_D
//     TYPE( nlls_options ), INTENT( IN )  options
//     TYPE( nlls_inform ), INTENT( INOUT )  inform
//     type( more_sorensen_work )  w
//
//     real  nq, epsilon
//     real  sigma, alpha, local_ms_shift, sigma_shift
...
//     integer, intent(in)   n, m
//     real, intent(out)  d(:)
//     real, intent(out)  normd ! ||d||_D, where D is the scaling
...
//! --------------------------------------------------       
//
//       real, intent(in)  f(:) ! f(x_k)
//       real, intent(in)  d(:) ! direction in which we move
//       real, intent(in)  J(:) ! J(x_k) (by columns)
//       real, intent(in)  hf(:)! (approx to) \sum_{i=1}^m f_i(x_k) \nabla^2 f_i(x_k)
//       integer, intent(in)  m,n
//       real, intent(out)  md  ! m_k(d)
//       TYPE( nlls_options ), INTENT( IN )  options
...
//       !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
//       real, intent(in)   normf    ! ||f(x_k)|| at 
//       real, intent(in)   normfnew ! ||f(x_k + d)||
//       real, intent(in)   md       !    m_k(d)
//       real, intent(out)  rho      ! act_red / pred_red (close to 1 == good)
//       TYPE( nlls_options ), INTENT( IN )  options
//
//       real  actual_reduction, predicted_reduction
//       
