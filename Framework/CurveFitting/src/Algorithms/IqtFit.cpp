...
namespace {
Mantid::Kernel::Logger g_log("IqtFit<Base>");
...
const std::string IqtFit<Base>::name() const { return "IqtFit<Base>"; }

/// Algorithm's version for identification. @see Algorithm::version
template <typename Base>
int IqtFit<Base>::version() const { return 1; }

/// Algorithm's category for identification. @see Algorithm::category
template <typename Base>
const std::string IqtFit<Base>::category() const {
  return "Workflow\\MIDAS";
}

/// Algorithm's summary for use in the GUI and help. @see Algorithm::summary
template <typename Base>
const std::string IqtFit<Base>::summary() const {
...
template <typename Base>
bool IqtFit<Base>::throwIfElasticQConversionFails() const { return true; }
