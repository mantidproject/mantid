...
/** ConvertToReflectometryQ : Creates a 2D MD Histogram workspace with two axis
  ...
  @date 2012-03-21
*/
class MANTID_REFLECTOMETRY_DLL ConvertToReflectometryQ : public API::BoxControllerSettingsAlgorithm {
public:
...
private:
  void init() override;
  void exec() override;
  Mantid::API::MatrixWorkspace_sptr correctDetectors(Mantid::API::MatrixWorkspace_sptr inputWs, double theta);
};
