 ...
 *
 */
class MANTID_REFLECTOMETRY_DLL SpecularReflectionAlgorithm : public Mantid::API::DataProcessorAlgorithm {
protected:
  /// Constructor
  ...
  Mantid::Geometry::IComponent_const_sptr getDetectorComponent(const Mantid::API::MatrixWorkspace_sptr &workspace,
