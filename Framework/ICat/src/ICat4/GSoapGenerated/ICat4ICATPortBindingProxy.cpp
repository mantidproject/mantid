...
int ICATPortBindingProxy::getUserName(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__getUserName(soap, &soap_tmp___ns1__getUserName, "-ns1:getUserName", nullptr) ||
...
int ICATPortBindingProxy::get(const char *endpoint, const char *soap_action, ns1__get *ns1__get_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__get(soap, &soap_tmp___ns1__get, "-ns1:get", nullptr) || soap_body_end_out(soap) ||
        soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
...
int ICATPortBindingProxy::getProperties(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__getProperties(soap, &soap_tmp___ns1__getProperties, "-ns1:getProperties", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  ns1__getPropertiesResponse_->soap_get(soap, "ns1:getPropertiesResponse", "ns1:getPropertiesResponse");
  if (soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
...
int ICATPortBindingProxy::delete_(const char *endpoint, const char *soap_action, ns1__delete *ns1__delete_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__delete(soap, &soap_tmp___ns1__delete, "-ns1:delete", nullptr) || soap_body_end_out(soap) ||
        soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__deleteResponse =
      soap_get___ns1__deleteResponse(soap, nullptr, "-ns1:deleteResponse", "ns1:deleteResponse");
...
int ICATPortBindingProxy::search(const char *endpoint, const char *soap_action, ns1__search *ns1__search_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__search(soap, &soap_tmp___ns1__search, "-ns1:search", nullptr) || soap_body_end_out(soap) ||
        soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
...
int ICATPortBindingProxy::create(const char *endpoint, const char *soap_action, ns1__create *ns1__create_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__create(soap, &soap_tmp___ns1__create, "-ns1:create", nullptr) || soap_body_end_out(soap) ||
        soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
...
int ICATPortBindingProxy::update(const char *endpoint, const char *soap_action, ns1__update *ns1__update_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__update(soap, &soap_tmp___ns1__update, "-ns1:update", nullptr) || soap_body_end_out(soap) ||
        soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__updateResponse =
      soap_get___ns1__updateResponse(soap, nullptr, "-ns1:updateResponse", "ns1:updateResponse");
...
int ICATPortBindingProxy::getApiVersion(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__getApiVersion(soap, &soap_tmp___ns1__getApiVersion, "-ns1:getApiVersion", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
...
int ICATPortBindingProxy::getEntityNames(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__getEntityNames(soap, &soap_tmp___ns1__getEntityNames, "-ns1:getEntityNames", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  ns1__getEntityNamesResponse_->soap_get(soap, "ns1:getEntityNamesResponse", "ns1:getEntityNamesResponse");
  if (soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
...
int ICATPortBindingProxy::refresh(const char *endpoint, const char *soap_action, ns1__refresh *ns1__refresh_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__refresh(soap, &soap_tmp___ns1__refresh, "-ns1:refresh", nullptr) || soap_body_end_out(soap) ||
        soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__refreshResponse =
      soap_get___ns1__refreshResponse(soap, nullptr, "-ns1:refreshResponse", "ns1:refreshResponse");
  if (!soap_tmp___ns1__refreshResponse || soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
  if (ns1__refreshResponse_ && soap_tmp___ns1__refreshResponse->ns1__refreshResponse_)
    *ns1__refreshResponse_ = *soap_tmp___ns1__refreshResponse->ns1__refreshResponse_;
  return soap_closesock(soap);
}

int ICATPortBindingProxy::dummy(const char *endpoint, const char *soap_action, ns1__dummy *ns1__dummy_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__dummy(soap, &soap_tmp___ns1__dummy, "-ns1:dummy", nullptr) || soap_body_end_out(soap) ||
        soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__dummyResponse =
      soap_get___ns1__dummyResponse(soap, nullptr, "-ns1:dummyResponse", "ns1:dummyResponse");
...
int ICATPortBindingProxy::logout(const char *endpoint, const char *soap_action, ns1__logout *ns1__logout_,
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__logoutResponse =
      soap_get___ns1__logoutResponse(soap, nullptr, "-ns1:logoutResponse", "ns1:logoutResponse");
...
int ICATPortBindingProxy::getRemainingMinutes(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__getRemainingMinutes(soap, &soap_tmp___ns1__getRemainingMinutes, "-ns1:getRemainingMinutes",
                                            nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  ns1__getRemainingMinutesResponse_->soap_get(soap, "ns1:getRemainingMinutesResponse",
...
int ICATPortBindingProxy::searchText(const char *endpoint, const char *soap_action, ns1__searchText *ns1__searchText_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__searchText(soap, &soap_tmp___ns1__searchText, "-ns1:searchText", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  ns1__searchTextResponse_->soap_get(soap, "ns1:searchTextResponse", "ns1:searchTextResponse");
  if (soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
...
int ICATPortBindingProxy::isAccessAllowed(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__isAccessAllowed(soap, &soap_tmp___ns1__isAccessAllowed, "-ns1:isAccessAllowed", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  ns1__isAccessAllowedResponse_->soap_get(soap, "ns1:isAccessAllowedResponse", "ns1:isAccessAllowedResponse");
  if (soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
...
int ICATPortBindingProxy::lucenePopulate(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__lucenePopulate(soap, &soap_tmp___ns1__lucenePopulate, "-ns1:lucenePopulate", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__lucenePopulateResponse = soap_get___ns1__lucenePopulateResponse(
      soap, nullptr, "-ns1:lucenePopulateResponse", "ns1:lucenePopulateResponse");
  if (!soap_tmp___ns1__lucenePopulateResponse || soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
  if (ns1__lucenePopulateResponse_ && soap_tmp___ns1__lucenePopulateResponse->ns1__lucenePopulateResponse_)
    *ns1__lucenePopulateResponse_ = *soap_tmp___ns1__lucenePopulateResponse->ns1__lucenePopulateResponse_;
  return soap_closesock(soap);
}

int ICATPortBindingProxy::luceneClear(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__luceneClear(soap, &soap_tmp___ns1__luceneClear, "-ns1:luceneClear", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  soap_tmp___ns1__luceneClearResponse =
      soap_get___ns1__luceneClearResponse(soap, nullptr, "-ns1:luceneClearResponse", "ns1:luceneClearResponse");
  if (!soap_tmp___ns1__luceneClearResponse || soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
  if (ns1__luceneClearResponse_ && soap_tmp___ns1__luceneClearResponse->ns1__luceneClearResponse_)
    *ns1__luceneClearResponse_ = *soap_tmp___ns1__luceneClearResponse->ns1__luceneClearResponse_;
  return soap_closesock(soap);
}

int ICATPortBindingProxy::luceneCommit(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__luceneCommit(soap, &soap_tmp___ns1__luceneCommit, "-ns1:luceneCommit", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__luceneCommitResponse =
      soap_get___ns1__luceneCommitResponse(soap, nullptr, "-ns1:luceneCommitResponse", "ns1:luceneCommitResponse");
  if (!soap_tmp___ns1__luceneCommitResponse || soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
  if (ns1__luceneCommitResponse_ && soap_tmp___ns1__luceneCommitResponse->ns1__luceneCommitResponse_)
    *ns1__luceneCommitResponse_ = *soap_tmp___ns1__luceneCommitResponse->ns1__luceneCommitResponse_;
  return soap_closesock(soap);
}

int ICATPortBindingProxy::luceneSearch(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__luceneSearch(soap, &soap_tmp___ns1__luceneSearch, "-ns1:luceneSearch", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  ns1__luceneSearchResponse_->soap_get(soap, "ns1:luceneSearchResponse", "ns1:luceneSearchResponse");
  if (soap->error)
    return soap_recv_fault(soap, 0);
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap) || soap_end_recv(soap))
    return soap_closesock(soap);
...
int ICATPortBindingProxy::luceneGetPopulating(const char *endpoint, const char *soap_action,
  ...
  soap->encodingStyle = nullptr;
  soap_tmp___ns1__luceneGetPopulating.ns1__luceneGetPopulating_ = ns1__luceneGetPopulating_;
  soap_begin(soap);
  soap_serializeheader(soap);
  soap_serialize___ns1__luceneGetPopulating(soap, &soap_tmp___ns1__luceneGetPopulating);
  if (soap_begin_count(soap))
    return soap->error;
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__luceneGetPopulating(soap, &soap_tmp___ns1__luceneGetPopulating, "-ns1:luceneGetPopulating",
                                            nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  ns1__luceneGetPopulatingResponse_->soap_get(soap, "ns1:luceneGetPopulatingResponse",
...
int ICATPortBindingProxy::createMany(const char *endpoint, const char *soap_action, ns1__createMany *ns1__createMany_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__createMany(soap, &soap_tmp___ns1__createMany, "-ns1:createMany", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
...
int ICATPortBindingProxy::deleteMany(const char *endpoint, const char *soap_action, ns1__deleteMany *ns1__deleteMany_,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__deleteMany(soap, &soap_tmp___ns1__deleteMany, "-ns1:deleteMany", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) || soap_body_begin_in(soap))
    return soap_closesock(soap);
  soap_tmp___ns1__deleteManyResponse =
      soap_get___ns1__deleteManyResponse(soap, nullptr, "-ns1:deleteManyResponse", "ns1:deleteManyResponse");
...
int ICATPortBindingProxy::getEntityInfo(const char *endpoint, const char *soap_action,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___ns1__getEntityInfo(soap, &soap_tmp___ns1__getEntityInfo, "-ns1:getEntityInfo", nullptr) ||
        soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  }
  if (soap_end_count(soap))
