...
#define SOAP_SOCKLEN_T SOCKLEN_T
    ...
    defined(__FreeBSD__) || defined(OPENBSD) || defined(__QNX__) || defined(QNX) || defined(OS390)
#define SOAP_SOCKLEN_T socklen_t
#elif defined(IRIX) || defined(WIN32) || defined(__APPLE__) || defined(SUN_OS) || defined(OPENSERVER) ||               \
    defined(TRU64) || defined(VXWORKS) || defined(HP_UX)
#define SOAP_SOCKLEN_T int
#else
...
#define soap_xml_error_check(e)                                                                                        \
  ((e) == SOAP_TAG_MISMATCH || (e) == SOAP_NO_TAG || (e) == SOAP_SYNTAX_ERROR || (e) == SOAP_NAMESPACE ||              \
   (e) == SOAP_DUPLICATE_ID || (e) == SOAP_MISSING_ID || (e) == SOAP_REQUIRED || (e) == SOAP_PROHIBITED ||             \
   (e) == SOAP_OCCURS || (e) == SOAP_LENGTH || (e) == SOAP_NULL || (e) == SOAP_HREF)
#define soap_soap_error_check(e)                                                                                       \
  ((e) == SOAP_CLI_FAULT || (e) == SOAP_SVR_FAULT || (e) == SOAP_VERSIONMISMATCH || (e) == SOAP_MUSTUNDERSTAND ||      \
...
#define soap_http_error_check(e)                                                                                       \
  ((e) == SOAP_HTTP_ERROR || (e) == SOAP_NO_DATA || ((e) >= SOAP_GET_METHOD && (e) <= SOAP_HTTP_METHOD) ||             \
   ((e) >= 100 && (e) < 600))
...
#define DBGFUN3(FNAME, FMT1, ARG1, FMT2, ARG2, FMT3, ARG3)                                                             \
  DBGLOG(TEST, SOAP_MESSAGE(fdebug, "%s(%d): %s(" FMT1 ", " FMT2 ", " FMT3 ")\n", __FILE__, __LINE__, FNAME, (ARG1),   \
                            (ARG2), (ARG3)))
#endif
#ifndef DBGHEX
...
#define soap_get0(soap)                                                                                                \
  (((soap)->bufidx >= (soap)->buflen && soap_recv(soap)) ? EOF : (unsigned char)(soap)->buf[(soap)->bufidx])
...
SOAP_FMAC1 int SOAP_FMAC2 soap_ssl_server_context(struct soap *soap, unsigned short flags, const char *keyfile,
...
#endif
#if defined(VXWORKS) && defined(WM_SECURE_KEY_STORAGE)
SOAP_FMAC1 int SOAP_FMAC2 soap_ssl_client_context(struct soap *soap, unsigned short flags, const char *keyfile,
                                                  const char *keyid, const char *password, const char *cafile,
...
SOAP_FMAC1 int SOAP_FMAC2 soap_pointer_lookup(struct soap *, const void *p, int type, struct soap_plist **);
SOAP_FMAC1 int SOAP_FMAC2 soap_pointer_enter(struct soap *, const void *p, const struct soap_array *a, int n, int type,
                                             struct soap_plist **);
SOAP_FMAC1 int SOAP_FMAC2 soap_array_pointer_lookup(struct soap *, const void *p, const struct soap_array *a, int n,
                                                    int type, struct soap_plist **);
SOAP_FMAC1 int SOAP_FMAC2 soap_embed(struct soap *soap, const void *p, const struct soap_array *a, int n,
...
SOAP_FMAC1 void *SOAP_FMAC2 soap_id_forward(struct soap *, const char *href, void *p, size_t len, int st, int tt,
                                            size_t n, unsigned int k,
                                            void (*fcopy)(struct soap *, int, int, void *, size_t, const void *,
                                                          size_t));
#endif
SOAP_FMAC1 void *SOAP_FMAC2 soap_id_enter(struct soap *, const char *id, void *p, int t, size_t n, unsigned int k,
                                          const char *type, const char *arrayType,
                                          void *(*finstantiate)(struct soap *, int, const char *, const char *,
                                                                size_t *));
...
SOAP_FMAC1 int SOAP_FMAC2 soap_array_begin_out(struct soap *, const char *tag, int id, const char *type,
                                               const char *offset);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_element_id(struct soap *, const char *tag, int id, const void *p,
...
SOAP_FMAC1 unsigned char *SOAP_FMAC2 soap_inunsignedByte(struct soap *, const char *tag, unsigned char *p, const char *,
                                                         int);
...
SOAP_FMAC1 unsigned int *SOAP_FMAC2 soap_inunsignedInt(struct soap *, const char *tag, unsigned int *p, const char *,
                                                       int);
SOAP_FMAC1 unsigned long *SOAP_FMAC2 soap_inunsignedLong(struct soap *, const char *tag, unsigned long *p, const char *,
                                                         int);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_set_dime_attachment(struct soap *, char *ptr, size_t size, const char *type,
                                                   const char *id, unsigned short optype, const char *option);
SOAP_FMAC1 int SOAP_FMAC2 soap_set_mime_attachment(struct soap *, char *ptr, size_t size,
                                                   enum soap_mime_encoding encoding, const char *type, const char *id,
...
SOAP_FMAC1 extern struct soap_cookie *SOAP_FMAC2 soap_set_cookie(struct soap *, const char *, const char *,
