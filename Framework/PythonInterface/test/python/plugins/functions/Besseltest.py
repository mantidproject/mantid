...
class BesselTest(unittest.TestCase):
    ...
    def test_function_output(self):
        ...
        expected = [0.09900249722395764, -0.010116392139648565,
	...
	def test_do_fit(self):
        do_a_fit(np.arange(0.1, 16, 0.2), 'Bessel',guess=dict(A0=0.15, fi=0.25, nu=0.25),target=dict(A0=0.1, fi=0.2, nu=0.2), atol=0.01)
