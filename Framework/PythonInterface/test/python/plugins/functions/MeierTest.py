...
class MeierTest(unittest.TestCase):
	...
	def test_do_fit(self):
		do_a_fit(np.arange(0.1, 16, 0.2), 'Meier', guess = dict(A0 = 0.55, FreqD = 0.02, FreqQ = 0.10, J = 3.55, Lambda = 0.15, Sigma = 0.25), target = dict(A0 = 0.5, FreqD = 0.01, FreqQ = 0.05, J = 3.5, Lambda = 0.1, Sigma = 0.2), atol = 0.01)
