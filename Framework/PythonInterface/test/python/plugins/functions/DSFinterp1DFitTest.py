...
class DSFinterp1DTestTest(unittest.TestCase):
    ...
    def test_input_exceptions(self):
        ...
        try:
            ...
            func_string = (
                'name=DSFinterp1DFit,InputWorkspaces="{0}",ParameterValues="{1}",'.format(InputWorkspaces, fvalueswrong)
        ...
        try:
            func_string = (
                'name=DSFinterp1DFit,InputWorkspaces="{0}",ParameterValues="{1}",'.format(InputWorkspaces, fvalues)
                + "LoadErrors=0,LocalRegression=1,RegressionType=quadratic,RegressionWindow=6,"
