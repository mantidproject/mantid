...
class SCgapPwaveTest(unittest.TestCase):
    ...
    def test_do_fit(self):
        do_a_fit(np.arange(0.1, 16, 0.2), 'SCgapPwave', guess=dict(Delta=1.55, Tcritical=9.1),
                 target=dict(Delta=1.5, Tcritical=9.0), atol=0.01)
