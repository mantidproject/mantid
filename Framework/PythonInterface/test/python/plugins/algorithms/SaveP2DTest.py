...
class SaveP2DTest(unittest.TestCase):
    ...
    def test_savep2d_raw(self):
         ...
         with open(os.path.join(self._test_dir, "ref_savep2d_raw.txt", 'w')) as of:
            of.write(text)
         self._assert_file_content_equal(os.path.join(self._test_dir, "ref_savep2d_raw.txt"), os.path.join(self._test_dir, "test_savep2d_raw.p2d"))
    ...
    def test_savep2d_remove_negatives(self):
         ...
         with open(os.path.join(self._test_dir, "ref_savep2d_remove_negatives.txt", 'w')) as of:
            of.write(text)
         self._assert_file_content_equal(os.path.join(self._test_dir, "ref_savep2d_remove_negatives.txt"), os.path.join(self._test_dir, "test_savep2d_remove_negatives.p2d"))
