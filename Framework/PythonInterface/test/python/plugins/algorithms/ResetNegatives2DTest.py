...
class ResetNegatives2DTest(unittest.TestCase):
    ...
    # Using this second testfunciton on workspace2 results in an error message. The data seems to be erased already...
    #def test_resetNegatives2D_resetValue(self):
    #    ResetNegatives2D(self._workspace1, AddMinimum=False, ResetValue=0)
    #    SaveP2D(Workspace=self._workspace1,
    #            OutputFile=os.path.join(self._test_dir,
    #                                    "test_ResetNegatives2D_resetValue"),
    #            RemoveNaN=0,
    #            RemoveNegatives=0,
    #            CutData=0)
    ...
    #        os.path.join(self._test_dir, "test_ResetNegatives2D_resetValue.p2d"))
