...
class SortByQVectorsTest(unittest.TestCase):
    def test_output(self):
        ...
        self.assertAlmostEqual(ws[0].y(0)[0], 0.0)
        self.assertAlmostEqual(ws[0].y(1)[0], 0.00600600591861)
        self.assertAlmostEqual(ws[0].y(2)[0], 0.0120120118372)
        self.assertAlmostEqual(ws[0].y(3)[0], 0.0180180184543)
        self.assertAlmostEqual(ws[0].y(4)[0], 0.0240240236744)
