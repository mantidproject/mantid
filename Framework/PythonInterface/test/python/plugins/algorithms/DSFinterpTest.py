...
class DSFinterpTest(unittest.TestCase):
    ...
    def test_input_exceptions(self):
        ...
        try:
            ...
            mantid.simpleapi.DSFinterp(
                Workspaces=workspaces, ParameterValues=fvalueswrong, LocalRegression=False, TargetParameters=5.5, OutputWorkspaces="outws"
            )
        ...
        try:
            ...
            mantid.simpleapi.DSFinterp(
                Workspaces=workspaces2, ParameterValues=fvalues2, LocalRegression=False, TargetParameters=5.5, OutputWorkspaces="outws"
            )
        except Exception as e:
        ...
        try:
            mantid.simpleapi.DSFinterp(
                Workspaces=workspaces, ParameterValues=fvalues, LocalRegression=False, TargetParameters=nf + 1, OutputWorkspaces="outws"
            )
        except Exception as e:
        ...
        try:
            mantid.simpleapi.DSFinterp(
                Workspaces=workspaces, ParameterValues=fvalues, LocalRegression=False, TargetParameters=[1, 2], OutputWorkspaces="outws"
            )
        except Exception as e:
