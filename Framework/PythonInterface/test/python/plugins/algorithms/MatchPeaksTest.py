...
import unittest
import numpy as np
from mantid.api import mtd, AnalysisDataService, MatrixWorkspace
from mantid.simpleapi import AppendSpectra, CreateSampleWorkspace, DeleteWorkspace, FindEPP
