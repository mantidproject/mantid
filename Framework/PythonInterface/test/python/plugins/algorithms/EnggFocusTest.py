...
class EnggFocusTest(unittest.TestCase):
    ...
    _expected_yvals_bank1 = [
        0.016676032919961604, 0.015995344072536975, 0.047449159145519233, 0.15629648148139513, 0.11018845452876322,
        0.017291707350351286
    ]

    _expected_yvals_bank2 = [
        0.0, 0.018310873111703541, 0.071387646720910913, 0.061783574337739511, 0.13102948781549345, 0.001766956921862095
    ]
    ...
    def _check_output_ok(self, wks, ws_name='', y_dim_max=1, yvalues=None):
        ...
        xvals = [
            10861.958645540433, 12192.372902418168, 13522.787159295902, 14853.201416173637, 24166.101214317776,
            34809.415269339654
        ]
    ...
    def test_runs_ok_bank2(self):
        ...
        out_name = 'out_bank2'
        out_bank2 = EnggFocus(InputWorkspace=self.__class__._data_ws,
                              Bank='2',
                              VanCurvesWorkspace=self.__class__._van_curves_ws,
                              VanIntegrationWorkspace=self.__class__._van_integ_tbl,
                              OutputWorkspace=out_name)
