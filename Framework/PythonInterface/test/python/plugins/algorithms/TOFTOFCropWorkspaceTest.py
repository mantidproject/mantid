...
class TOFTOFCropWorkspaceTest(unittest.TestCase):
    ...
    def test_basicrun(self):
        ...
        alg_test = run_algorithm("TOFTOFCropWorkspace", InputWorkspace=self._input_ws, OutputWorkspace=OutputWorkspaceName)
        ...
        self.assertGreater(full_channels, 0.0)
        self.assertGreater(channel_width, 0.0)
