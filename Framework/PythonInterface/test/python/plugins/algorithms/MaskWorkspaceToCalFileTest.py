...
class MaskWorkspaceToCalFileTest(unittest.TestCase):
    ...
    def do_test_cal_file(self, masked_workspace, should_invert, expected_masking_identifier,
        ...
        cal_file_alg = run_algorithm('MaskWorkspaceToCalFile',
                                     InputWorkspace=masked_workspace.name(),
                                     OutputFile=cal_filename,
    ...
    def test_calfile_from_extracted_masking_workspace(self):
        ...
        run_algorithm('MaskDetectors',
                      ...
                      MaskedWorkspace='wsMaskWSToCalFileTest',
                      rethrow=True)
        run_algorithm('ExtractMask',
                      InputWorkspace='wsMaskWSToCalFileTest',
                      OutputWorkspace='ExtractedWorkspace',
                      rethrow=True)
