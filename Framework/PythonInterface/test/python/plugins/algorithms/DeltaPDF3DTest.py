...
class DeltaPDF3DTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # 3D
        DeltaPDF3DTest_MDE = CreateMDWorkspace(Dimensions='3',
            ...
            for k in range(-3, 4):
                for l in range(-3, 4):
                    FakeMDEventData(DeltaPDF3DTest_MDE,
                                    PeakParams='100,' + str(h) + ',' + str(k) + ',' + str(l) + ',0.1',
                                    RandomSeed='1337')
        ...
        for h in np.arange(-2.5, 3):
            for k in np.arange(-2.5, 3):
                for l in np.arange(-2.5, 3):
                    FakeMDEventData(DeltaPDF3DTest_MDE,
                                    PeakParams='20,' + str(h) + ',' + str(k) + ',' + str(l) + ',0.1',
                                    RandomSeed='13337')
        ...
        # 2D
        DeltaPDF3DTest_MDE_2 = CreateMDWorkspace(Dimensions='3',
        ...
        for h in range(-3, 4):
            for k in range(-3, 4):
                FakeMDEventData(DeltaPDF3DTest_MDE_2,
                                PeakParams='100,' + str(h) + ',' + str(k) + ',0,0.01',
                                RandomSeed='1337')
        ...
        for h in np.arange(-2.5, 3):
            for k in np.arange(-2.5, 3):
                FakeMDEventData(DeltaPDF3DTest_MDE_2,
                                PeakParams='20,' + str(h) + ',' + str(k) + ',0,0.1',
                                RandomSeed='13337')
    ...
    def test_3D(self):
        DeltaPDF3D(InputWorkspace='DeltaPDF3DTest_MDH',
                   OutputWorkspace='fft',
                   Method='None',
                   CropSphere=False,
                   Convolution=False,
    ...
    def test_2D(self):
        DeltaPDF3D(InputWorkspace='DeltaPDF3DTest_MDH_2',
                   OutputWorkspace='fft',
                   Method='None',
                   CropSphere=False,
                   Convolution=False,
