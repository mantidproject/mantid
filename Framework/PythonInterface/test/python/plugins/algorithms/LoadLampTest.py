...
class LoadLampTest(unittest.TestCase):
    ...
    def test_1D(self):
        ...
        self.assertEqual(ws.y(0)[350], 1134)
        self.assertAlmostEqual(ws.x(0)[0], -11.8563, 4)
        self.assertAlmostEqual(ws.e(0)[1300], 54.2494, 4)
    ...
    def test_2D_ragged(self):
        ...
        self.assertEqual(ws.y(103)[373], 73)
        self.assertAlmostEqual(ws.e(105)[205], 80.7279, 4)
        self.assertAlmostEqual(ws.x(7)[8], -27.0516, 4)
    ...
    def test_2D_tile(self):
        ...
        self.assertAlmostEqual(ws.y(8)[1534], 0.2546, 4)
        self.assertEqual(ws.x(3)[4], 5)
        self.assertAlmostEqual(ws.e(10)[1535], 0.0012, 4)
