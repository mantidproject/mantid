...
class ReflectometryReductionOneLiveDataTest(unittest.TestCase):
    ...
    def test_slits_gaps_are_set_up_on_output_workspace(self):
        ...
        slit1vg = component_info.getNumberParameter(component_info.indexOfAny("slit1"), "vertical gap")
        slit2vg = component_info.getNumberParameter(component_info.indexOfAny("slit2"), "vertical gap")
