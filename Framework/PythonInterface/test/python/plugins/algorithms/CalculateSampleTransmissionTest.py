...
class CalculateSampleTransmissionTest(unittest.TestCase):
    def test_sample_transmission_calculation(self):
        ...
        ws = CalculateSampleTransmission(
            WavelengthRange="5.0,0.2,7.0", ChemicalFormula=formula, Density=density, Thickness=thickness, DensityType="Number Density"
        )
    ...
    def test_mass_density(self):
        ...
        ws = CalculateSampleTransmission(
            WavelengthRange="5.0,0.2,7.0", ChemicalFormula=formula, Density=density, Thickness=thickness, DensityType="Mass Density"
        )
