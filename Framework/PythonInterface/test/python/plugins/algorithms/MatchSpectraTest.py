...
class MatchSpectraTest(unittest.TestCase):
    ...
    def __testCommonBoundaries(self, histogram):
        ...
        self.assertTrue(np.all(mtd[outwsname].y(0) == mtd[outwsname].y(1)))
        ...
        self.assertTrue(np.all(mtd[outwsname].y(0) == mtd[outwsname].y(2)))
        ...
        self.assertTrue(np.all(mtd[outwsname].y(0) == mtd[outwsname].y(3)))
