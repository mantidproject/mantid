...
class CorrectTOFTest(unittest.TestCase):
    def setUp(self):
        ...
        self._input_ws = CreateSampleWorkspace(Function="User Defined",
    ...
    def testCorrection(self):
        ...
        alg_test = run_algorithm("CorrectTOF",
    ...
    def testConvertUnits(self):
        ...
        alg_cu = run_algorithm("ConvertUnits",
                               InputWorkspace=wscorr,
                               Target='DeltaE',
                               EMode='Direct',
                               EFixed=2.27,
                               OutputWorkspace=OutputWorkspaceName + '_dE')
