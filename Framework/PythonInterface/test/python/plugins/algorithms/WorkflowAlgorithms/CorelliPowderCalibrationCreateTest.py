...
from mantid.simpleapi import (CorelliPowderCalibrationCreate, CreateSampleWorkspace, MoveInstrumentComponent,
...
class CorelliPowderCalibrationCreateTest(unittest.TestCase):
    def test_exec(self):
        ...
        RotateInstrumentComponent(Workspace='test_workspace',
                                  ComponentName='bank1',
                                  X=0.1,
                                  Y=99,
                                  z=0.1,
        ...
        MoveInstrumentComponent(Workspace='test_workspace',
                                ComponentName='bank1',
                                X=4.98,
                                y=-0.12,
                                z=0.08,
        ...
        try:
            CorelliPowderCalibrationCreate(InputWorkspace='test_workspace',
                                           OutputWorkspacesPrefix='cal_',
                                           TofBinning=[300, 1.0, 16666.7],
                                           PeakPositions=spacings_reference,
                                           FixSource=True,
                                           AdjustSource=True,
                                           ComponentList='bank1',
