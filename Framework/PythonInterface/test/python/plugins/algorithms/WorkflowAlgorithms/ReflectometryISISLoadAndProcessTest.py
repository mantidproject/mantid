...
class ReflectometryISISLoadAndProcessTest(unittest.TestCase):
    ...
    def test_background_subtraction_not_done_if_not_enabled_even_if_background_properties_set(self):
        self._create_workspace_with_flat_background('test_ws')
        args = self._default_options
        args['InputRunList'] = 'test_ws'
        args['WavelengthMin'] = 0
        args['BackgroundProcessingInstructions'] = '1'
        args['BackgroundCalculationMethod'] = 'PerDetectorAverage'
        outputs = ['IvsQ', 'IvsQ_binned', 'TOF', 'test_ws']
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryReductionOneAuto', 'GroupWorkspaces']
        ws = AnalysisDataService.retrieve('IvsQ_binned')
        self._check_history(ws, history)

    def test_background_subtraction_with_default_properties(self):
        self._create_workspace_with_flat_background('test_ws')
        args = self._default_options
        args['InputRunList'] = 'test_ws'
        args['WavelengthMin'] = 0
        args['SubtractBackground'] = True
        outputs = ['IvsQ', 'IvsQ_binned', 'TOF', 'test_ws']
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryBackgroundSubtraction', 'ReflectometryReductionOneAuto',
                   'GroupWorkspaces']
        ws = AnalysisDataService.retrieve('IvsQ_binned')
        self._check_history(ws, history)
        self._check_history_algorithm_properties(
            ws, 0, 0,
            {'ProcessingInstructions': '', 'BackgroundCalculationMethod': 'PerDetectorAverage'})

    def test_subtract_flat_background(self):
        self._create_workspace_with_flat_background('test_ws')
        args = self._default_options
        args['InputRunList'] = 'test_ws'
        args['WavelengthMin'] = 0
        args['SubtractBackground'] = True
        args['BackgroundProcessingInstructions'] = '1, 2, 4, 5'
        args['BackgroundCalculationMethod'] = 'PerDetectorAverage'
        outputs = ['IvsQ', 'IvsQ_binned', 'TOF', 'test_ws']
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryBackgroundSubtraction', 'ReflectometryReductionOneAuto',
        ...
        self._check_history_algorithm_properties(
            ws, 0, 0,
            {'ProcessingInstructions': '1-2,4-5', 'BackgroundCalculationMethod': 'PerDetectorAverage'})

    def test_subtract_polynomial_background(self):
        self._create_workspace_with_polynomial_background('test_ws')
        args = self._default_options
        args['InputRunList'] = 'test_ws'
        args['WavelengthMin'] = 0
        args['SubtractBackground'] = True
        args['BackgroundProcessingInstructions'] = '1-4, 6-8'
        args['BackgroundCalculationMethod'] = 'Polynomial'
        args['DegreeOfPolynomial'] = '2'
        outputs = ['IvsQ', 'IvsQ_binned', 'TOF', 'test_ws']
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryBackgroundSubtraction', 'ReflectometryReductionOneAuto',
                   'GroupWorkspaces']
        ...
        self._check_history_algorithm_properties(
            ws, 0, 0,
            {'ProcessingInstructions': '1-4,6-8', 'BackgroundCalculationMethod': 'Polynomial',
             'DegreeOfPolynomial': '2'})

    def test_subtract_average_pixel_background(self):
        self._create_workspace_with_pixel_background('test_ws')
        args = self._default_options
        args['InputRunList'] = 'test_ws'
        args['WavelengthMin'] = 0
        args['SubtractBackground'] = True
        args['BackgroundProcessingInstructions'] = '1-3'
        args['BackgroundCalculationMethod'] = 'AveragePixelFit'
        args['PeakRange'] = '2'
        outputs = ['IvsQ', 'IvsQ_binned', 'TOF', 'test_ws']
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryBackgroundSubtraction', 'ReflectometryReductionOneAuto',
        ...
        self._check_history_algorithm_properties(
            ws, 0, 0,
            {'ProcessingInstructions': '1-3', 'BackgroundCalculationMethod': 'AveragePixelFit',
             'PeakRange': '2'})

    def test_background_subtraction_with_summed_inputs(self):
        args = self._default_options
        args['InputRunList'] = '13460, 13462'
        args['WavelengthMin'] = 0
        args['SubtractBackground'] = True
        outputs = ['IvsQ_13460+13462', 'IvsQ_binned_13460+13462',
                   'TOF', 'TOF_13460+13462', 'TOF_13460', 'TOF_13462']
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['LoadNexus', 'LoadNexus', 'MergeRuns', 'ReflectometryBackgroundSubtraction',
                   'ReflectometryReductionOneAuto', 'GroupWorkspaces']
        ws = AnalysisDataService.retrieve('IvsQ_binned_13460+13462')
        self._check_history(ws, history)
    ...
    def _create_workspace_with_flat_background(self, name):
        # Create a workspace with a background of 2 and a peak of 5 in the 2nd index
        background = [2, 2, 2, 2]
        peak = [5, 5, 5, 5]
        nspec = 5
        ...
        ws.setY(0, background)
        ws.setY(1, background)
        ws.setY(2, peak)
        ws.setY(3, background)
        ws.setY(4, background)

    def _create_workspace_with_polynomial_background(self, name):
        ...
        nspec = 9
        ws = CreateSampleWorkspace(NumBanks=nspec, BankPixelWidth=1, XMin=1, XMax=2,
                                   BinWidth=1, XUnit='TOF', WorkspaceType='Histogram',
                                   NumMonitors=0, OutputWorkspace=name)
        for spec in range(nspec):
            ws.setY(spec, [dataY[spec]])
