...
from mantid.simpleapi import (AddSampleLog, AddTimeSeriesLog, CreateSampleWorkspace, CropWorkspace, GroupWorkspaces,
                              Rebin)
...
class ReflectometryISISLoadAndProcessTest(unittest.TestCase):
    def setUp(self):
        ...
        self._expected_dummy_time_sliced_outputs = [
            'IvsQ_38415', 'IvsQ_38415_sliced_0_1200', 'IvsQ_38415_sliced_1200_2400', 'IvsQ_38415_sliced_2400_3600',
            'IvsQ_binned_38415', 'IvsQ_binned_38415_sliced_0_1200', 'IvsQ_binned_38415_sliced_1200_2400',
            'IvsLam_38415', 'IvsLam_38415_sliced_0_1200', 'IvsLam_38415_sliced_1200_2400',
            'IvsLam_38415_sliced_2400_3600', 'IvsQ_binned_38415_sliced_2400_3600', 'TOF_38415', 'TOF_38415_monitors',
            'TOF_38415_sliced', 'TOF_38415_sliced_0_1200', 'TOF_38415_sliced_1200_2400', 'TOF_38415_sliced_2400_3600',
            'TOF'
        ]

        self._expected_real_time_sliced_outputs = [
            'IvsQ_38415', 'IvsQ_38415_sliced_0_210', 'IvsQ_38415_sliced_210_420', 'IvsQ_38415_sliced_420_610',
            'IvsQ_binned_38415', 'IvsQ_binned_38415_sliced_0_210', 'IvsQ_binned_38415_sliced_210_420', 'IvsLam_38415',
            'IvsLam_38415_sliced_0_210', 'IvsLam_38415_sliced_210_420', 'IvsLam_38415_sliced_420_610',
            'IvsQ_binned_38415_sliced_420_610', 'TOF_38415', 'TOF_38415_monitors', 'TOF_38415_sliced',
            'TOF_38415_sliced_0_210', 'TOF_38415_sliced_210_420', 'TOF_38415_sliced_420_610', 'TOF'
        ]
    ...
    def test_trans_runs_are_loaded_if_not_in_ADS(self):
        ...
        outputs = [
            'IvsQ_13460', 'IvsQ_binned_13460', 'TOF_13460', 'TRANS_13463', 'TRANS_13464', 'TRANS_LAM_13463_13464', 'TOF'
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
    ...
    def test_trans_runs_are_reloaded_if_in_ADS_with_unknown_prefix(self):
        ...
        # creating the stitched transmission run
        outputs = [
            'IvsQ_13460', 'IvsQ_binned_13460', 'TOF_13460', 'TRANS_13463', 'TRANS_13464', 'TEST_13463', 'TEST_13464',
    ...
    def test_existing_workspace_is_used_for_trans_runs_when_name_passed_in_input_list(self):
        ...
        outputs = [
            'IvsQ_13460', 'IvsQ_binned_13460', 'TOF_13460', 'TEST_13463', 'TEST_13464', 'TRANS_LAM_13463_13464', 'TOF'
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryReductionOneAuto', 'GroupWorkspaces']
        self._check_history(AnalysisDataService.retrieve('IvsQ_binned_13460'), history)
    ...
    def test_first_and_second_trans_runs_are_combined_with_debug_output(self):
        ...
        outputs = [
            'IvsQ_13460', 'IvsQ_binned_13460', 'IvsLam_13460', 'TOF_13460', 'TRANS_13463', 'TRANS_13464',
            'TRANS_LAM_13463', 'TRANS_LAM_13464', 'TRANS_LAM_13463_13464', 'TOF'
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryReductionOneAuto', 'GroupWorkspaces']
        self._check_history(AnalysisDataService.retrieve('IvsQ_binned_13460'), history)
    ...
    def test_multiple_trans_runs_are_summed(self):
        ...
        outputs = [
            'IvsQ_13460', 'IvsQ_binned_13460', 'TOF_13460', 'TRANS_13463', 'TRANS_13464', 'TRANS_13463+13464',
            'TRANS_LAM_13463+13464', 'TOF'
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['MergeRuns', 'ReflectometryReductionOneAuto', 'GroupWorkspaces']
        self._check_history(AnalysisDataService.retrieve('IvsQ_binned_13460'), history)
    ...
    def test_slicing_uses_run_in_ADS_with_correct_prefix(self):
        ...
        history = [
            'ReflectometryReductionOneAuto', 'ReflectometryReductionOneAuto', 'ReflectometryReductionOneAuto',
            'GroupWorkspaces'
        ]
    ...
    def test_slicing_uses_run_in_ADS_with_no_prefix(self):
        ...
        args['InputRunList'] = '38415'
        outputs = [
            'IvsQ_38415', 'IvsQ_38415_1', 'IvsQ_38415_2', 'IvsQ_38415_3', 'IvsQ_binned_38415', 'IvsQ_binned_38415_1',
            'IvsQ_binned_38415_2', 'IvsLam_38415', 'IvsLam_38415_1', 'IvsLam_38415_2', 'IvsLam_38415_3',
            'IvsQ_binned_38415_3', '38415', '38415_monitors', '38415_sliced', '38415_sliced_0_1200',
            '38415_sliced_1200_2400', '38415_sliced_2400_3600', 'TOF'
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = [
            'ReflectometryReductionOneAuto', 'ReflectometryReductionOneAuto', 'ReflectometryReductionOneAuto',
    ...
    def test_slicing_with_no_interval_returns_single_slice(self):
        ...
        args['SliceWorkspace'] = True
        outputs = [
            'IvsQ_38415', 'IvsQ_38415_sliced_0_4200', 'IvsQ_binned_38415', 'IvsQ_binned_38415_sliced_0_4200',
            'IvsLam_38415', 'IvsLam_38415_sliced_0_4200', 'TOF_38415', 'TOF_38415_monitors', 'TOF_38415_sliced',
            'TOF_38415_sliced_0_4200', 'TOF'
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryReductionOneAuto', 'GroupWorkspaces']
    ...
    def test_slicing_by_log_value(self):
        ...
        outputs = [
            'IvsQ_38415', 'IvsQ_38415' + slice1, 'IvsQ_38415' + slice2, 'IvsQ_38415' + slice3, 'IvsQ_binned_38415',
            'IvsQ_binned_38415' + slice1, 'IvsQ_binned_38415' + slice2, 'IvsQ_binned_38415' + slice3, 'IvsLam_38415',
            'IvsLam_38415' + slice1, 'IvsLam_38415' + slice2, 'IvsLam_38415' + slice3, 'TOF', 'TOF_38415',
            'TOF_38415_monitors', 'TOF_38415_sliced', 'TOF_38415' + slice1, 'TOF_38415' + slice2, 'TOF_38415' + slice3
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = [
            'ReflectometryReductionOneAuto', 'ReflectometryReductionOneAuto', 'ReflectometryReductionOneAuto',
    ...
    def test_slicing_by_log_value_with_no_interval_returns_single_slice(self):
        ...
        outputs = [
            'IvsQ_38415', 'IvsQ_38415' + sliceName, 'IvsQ_binned_38415', 'IvsQ_binned_38415' + sliceName,
            'IvsLam_38415', 'IvsLam_38415' + sliceName, 'TOF', 'TOF_38415', 'TOF_38415_monitors', 'TOF_38415_sliced',
            'TOF_38415' + sliceName
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = ['ReflectometryReductionOneAuto', 'GroupWorkspaces']
    ...
    def test_with_input_workspace_group(self):
        ...
        outputs = [
            'IvsQ_12345', 'IvsQ_12345_1', 'IvsQ_12345_2', 'IvsQ_binned_12345', 'IvsQ_binned_12345_2',
            'IvsQ_binned_12345_1', 'IvsLam_12345', 'IvsLam_12345_1', 'IvsLam_12345_2', 'TOF', 'TOF_12345_1',
            'TOF_12345_2'
        ]
        self._assert_run_algorithm_succeeds(args, outputs)
        history = [
            'CreateSampleWorkspace', 'AddSampleLog', 'CreateSampleWorkspace', 'AddSampleLog', 'GroupWorkspaces',
            'ReflectometryReductionOneAuto', 'ReflectometryReductionOneAuto', 'GroupWorkspaces'
        ]
    ...
    def test_TOF_input_workspace_groups_collapsed(self):
        ...
        outputs = [
            'IvsQ_13460+13463', 'IvsQ_binned_13460+13463', 'TOF', 'TOF_13460+13463', 'TOF_13460_1', 'TOF_13460_2',
            'TOF_13463'
        ]
    ...
    def test_group_TOF_workspaces_fails_with_mixed_unit_workspace_group(self):
        ...
        args['GroupTOFWorkspaces'] = True
        outputs = [
            'IvsQ_13460+13463', 'IvsQ_binned_13460+13463', 'TOF', 'TOF_13460+13463', 'TOF_13460', 'TOF_13463', '12345'
        ]
    ...
    def _create_event_workspace(self, run_number, prefix='', includeMonitors=True):
        ...
        CropWorkspace(InputWorkspace=name, StartWorkspaceIndex=3, EndWorkspaceIndex=4, OutputWorkspace=name)
