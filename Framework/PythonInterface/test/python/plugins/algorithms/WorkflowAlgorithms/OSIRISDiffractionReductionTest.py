...
class OSIRISDiffractionReductionTest(unittest.TestCase):
    ...
    def test_basic_reduction_completes(self):
        ...
        """
        self._assert_valid_reduction_output(
            Sample=["OSI89813.raw"], CalFile="osiris_041_RES10.cal", Vanadium=["osi89757.raw"], SpectraMin=3, SpectraMax=361
        )
    ...
    def test_greater_sample_runs_no_container(self):
        ...
        """
        self._assert_valid_reduction_output(
            Sample=["OSI10203.raw", "OSI10204.RAW"], CalFile="osiris_041_RES10.cal", Vanadium=["OSI10156.raw"], SpectraMin=3, SpectraMax=361
        )
    ...
    def test_greater_vanadium_runs_no_container(self):
        ...
        """
        self._assert_valid_reduction_output(
            Sample=["OSI10203.raw"], CalFile="osiris_041_RES10.cal", Vanadium=["OSI10156.raw", "OSI10157.RAW"], SpectraMin=3, SpectraMax=361
        )
