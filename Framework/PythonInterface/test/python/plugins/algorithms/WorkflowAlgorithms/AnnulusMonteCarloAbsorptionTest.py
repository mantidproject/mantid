...
import unittest
from mantid.simpleapi import AnnulusMonteCarloAbsorption, LoadNexusProcessed, DeleteWorkspace, ConvertUnits
from mantid.api import *


class AnnulusMonteCarloAbsorptionTest(unittest.TestCase):
    def setUp(self):
        """
    ...
    def test_basic(self):
        corrections = AnnulusMonteCarloAbsorption(InputWorkspace=self._red_ws,
    ...
    def test_number_density(self):
        ...
        self.assertEqual(round(corrections.readY(0)[0], 6), 0.725233)
        self.assertEqual(round(corrections.readY(1)[0], 6), 0.727444)
    ...
    def test_mass_density(self):
        ...
        self.assertEqual(round(corrections.readY(0)[0], 6), 0.725233)
        self.assertEqual(round(corrections.readY(1)[0], 6), 0.727445)

    def test_not_in_wavelength(self):
        red_ws = LoadNexusProcessed(Filename='irs26176_graphite002_red.nxs')

        self.assertRaises(RuntimeError,
                          AnnulusMonteCarloAbsorption,
