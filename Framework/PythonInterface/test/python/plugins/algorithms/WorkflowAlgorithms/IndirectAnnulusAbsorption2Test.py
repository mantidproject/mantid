...
class IndirectAnnulusAbsorption2Test(unittest.TestCase):
    ...
    def test_sample_corrections_only(self):
        ...
        corrected, fact = IndirectAnnulusAbsorption(
            SampleWorkspace=self._red_ws, SampleChemicalFormula="H2-O", Events=200, UseCanCorrections=False
        )
    ...
    def test_sample_and_can_subtraction(self):
        ...
        corrected, fact = IndirectAnnulusAbsorption(
            SampleWorkspace=self._red_ws, SampleChemicalFormula="H2-O", CanWorkspace=self._can_ws, Events=200, UseCanCorrections=False
        )
