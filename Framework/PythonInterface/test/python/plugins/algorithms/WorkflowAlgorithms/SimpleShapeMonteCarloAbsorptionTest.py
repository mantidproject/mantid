...
from mantid.simpleapi import SimpleShapeMonteCarloAbsorption, Load, ConvertUnits, CompareWorkspaces, SetSampleMaterial, DeleteWorkspace
import unittest
...
class SimpleShapeMonteCarloAbsorptionTest(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        __corrected_flat_plate = SimpleShapeMonteCarloAbsorption(
            InputWorkspace=self._red_ws, Shape="FlatPlate", Width=2.0, Thickness=2.0, **self._arguments
        )
    ...
    def test_flat_plate(self):
        ...
        corrected = SimpleShapeMonteCarloAbsorption(InputWorkspace=self._red_ws, Shape="FlatPlate", Width=2.0, Thickness=2.0, **kwargs)
    ...
    def test_number_density(self):
        ...
        corrected_num = SimpleShapeMonteCarloAbsorption(InputWorkspace=self._red_ws, Shape="FlatPlate", Width=2.0, Thickness=2.0, **kwargs)
    ...
    def test_ILL_reduced(self):
        ...
        kwargs = self._arguments
        corrected = SimpleShapeMonteCarloAbsorption(InputWorkspace=ill_red_ws, Shape="FlatPlate", Width=2.0, Thickness=2.0, **kwargs)
    ...
    def test_max_scatter_point_attempts_similar(self):
        ...
        kwargs = self._arguments
        output_workspace = SimpleShapeMonteCarloAbsorption(
            InputWorkspace=self._red_ws, Shape="FlatPlate", Width=2.0, Thickness=2.0, MaxScatterPtAttempts=3000, **kwargs
        )
