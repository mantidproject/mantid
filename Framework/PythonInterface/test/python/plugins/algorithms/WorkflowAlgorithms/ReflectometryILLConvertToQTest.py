...
from mantid.simpleapi import CloneWorkspace, ReflectometryILLPreprocess, ReflectometryILLSumForeground, ReflectometryILLConvertToQ, mtd
import unittest
...
class ReflectometryILLConvertToQTest(unittest.TestCase):
    ...
    def testD17InLambda(self):
        ReflectometryILLConvertToQ(InputWorkspace="rb_frg", OutputWorkspace="in_lambda", DirectForegroundWorkspace="db_frg_rebinned")
        self.checkOutput(mtd["in_lambda"], 991)

    def testD17InQ(self):
        ReflectometryILLConvertToQ(InputWorkspace="rb_inq_frg", OutputWorkspace="in_q", DirectForegroundWorkspace="db_frg_for_q_rebinned")
