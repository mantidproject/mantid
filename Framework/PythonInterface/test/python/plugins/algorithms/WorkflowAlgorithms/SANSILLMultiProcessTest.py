...
class SANSILLMultiProcessTest(unittest.TestCase):
    ...
    def test_minimal(self):
        ...
        self.assertEquals(realspace.getNumberHistograms(), 128*128+2)
        self.assertEquals(realspace.blocksize(), 1)
        ...
        self.assertEquals(iq.getNumberHistograms(), 1)
        self.assertEquals(iq.blocksize(), 88)
