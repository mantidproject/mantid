...
class LagrangeILLReductionTest(unittest.TestCase):
    ...
    def test_only_one_run(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], 0.014433, 4)
        self.assertAlmostEqual(result.y(0)[80], 0.010947, 4)
    ...
    def test_water_correction(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], -0.017195, 4)
        self.assertAlmostEqual(result.y(0)[80], -0.015001, 4)
    ...
    def test_calibration_correction(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], 0.01478, 4)
        self.assertAlmostEqual(result.y(0)[80], 0.01176, 4)
    ...
    def test_all_corrections(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], -0.01761, 4)
        self.assertAlmostEqual(result.y(0)[80], -0.01612, 4)
    ...
    def test_no_normalisation(self):
        ...
        self.check_result(result, "Energy", 276, 21.4992, 446.5527)
        self.assertAlmostEqual(result.y(0)[10], 2165, 4)
        self.assertAlmostEqual(result.y(0)[80], 1642, 4)
    ...
    def test_merging_close_initial_energies(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], 1972, 4)
        self.assertAlmostEqual(result.y(0)[80], 1737, 4)
    ...
    def test_one_scan_point(self):
        ...
        self.assertAlmostEqual(result.y(0)[0], 2.096, 3)
    ...
    def test_nexus_sample_reduction(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], 3.0, 3)
        self.assertAlmostEqual(result.y(0)[30], 3.0, 3)
    ...
    def test_merging_close_scans_nexus(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], 120.0, 3)
        self.assertAlmostEqual(result.y(0)[29], 310.0, 3)
    ...
    def test_merging_close_scans_nexus_with_container(self):
        ...
        self.check_result(result, "Energy", 30, 35, 50)
        self.assertAlmostEqual(result.y(0)[10], (120 - 12), 3)
        self.assertAlmostEqual(result.y(0)[29], (310 - 31), 3)
    ...
    def test_nexus_with_offset(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], 3.0, 3)
        self.assertAlmostEqual(result.y(0)[29], 3.0, 3)
    ...
    def test_nexus_convert_to_wavenumber(self):
        ...
        self.assertAlmostEqual(result.y(0)[10], 3.0, 4)
        self.assertAlmostEqual(result.y(0)[30], 3.0, 4)
    ...
    def test_nexus_multiple_files(self):
        ...
        self.assertAlmostEqual(result.y(0)[0], 3.0, 4)
        self.assertAlmostEqual(result.y(0)[30], 3.0, 4)
        self.assertAlmostEqual(result.y(0)[32], 2.0, 4)
        self.assertAlmostEqual(result.y(0)[60], 30.0, 4)
