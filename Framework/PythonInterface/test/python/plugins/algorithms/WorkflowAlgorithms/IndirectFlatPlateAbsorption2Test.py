...
class IndirectFlatPlateAbsorption2Test(unittest.TestCase):
    ...
    def test_sample_corrections_only(self):
        ...
        corrected, fact = IndirectFlatPlateAbsorption(
            SampleWorkspace=self._red_ws, SampleChemicalFormula="H2-O", NumberWavelengths=10, Events=200
        )
    ...
    def test_sample_and_can_subtraction(self):
        ...
        corrected, fact = IndirectFlatPlateAbsorption(
            SampleWorkspace=self._red_ws, SampleChemicalFormula="H2-O", CanWorkspace=self._can_ws, UseCanCorrections=False, Events=200
        )
