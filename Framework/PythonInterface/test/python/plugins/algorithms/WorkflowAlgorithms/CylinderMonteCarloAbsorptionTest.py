...
import unittest
from mantid.simpleapi import CylinderMonteCarloAbsorption, LoadNexusProcessed, DeleteWorkspace, ConvertUnits
from mantid.api import *


class CylinderMonteCarloAbsorptionTest(unittest.TestCase):
    def setUp(self):
        """
    ...
    def test_basic(self):
        corrections = CylinderMonteCarloAbsorption(InputWorkspace=self._red_ws,
