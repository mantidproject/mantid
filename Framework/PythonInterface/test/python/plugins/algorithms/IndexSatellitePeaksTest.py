...
class IndexSatellitePeaksTest(unittest.TestCase):
    ...
    def test_exec_with_cluster_threshold(self):
        ...
        indexed_peaks = IndexSatellitePeaks(self._nuclear_peaks, self._peaks, Tolerance=0.1, ClusterThreshold=1.5, NumOfQs=-1)
    ...
    def test_exec_with_number_of_qs(self):
        expected_values = np.array([-1, -1, 1, 1])
        indexed_peaks = IndexSatellitePeaks(self._nuclear_peaks, self._peaks, Tolerance=0.1, NumOfQs=2)
