...
class HB2AReduceTest(unittest.TestCase):
    ...
    def test_IndividualDetectors(self):
        ...
        self.assertAlmostEquals(np.max(norm_time_wsk.extractY()), 707.946308236)
    ...
    def test_Binned(self):
        ...
        self.assertAlmostEquals(np.max(norm_time_wsk.extractY()), 707.480233538)
        HB2AReduce_ws.delete()
        norm_time_wsk.delete()
    ...
    def test_TwoFiles(self):
        ...
        self.assertEqual(norm_time_wsk.blocksize(), 2439)
        self.assertEqual(np.argmax(norm_time_wsk.extractY()), 2203)
        self.assertAlmostEquals(np.max(norm_time_wsk.extractY()), 712.465597607)
        HB2AReduce_ws.delete()
        norm_time_wsk.delete()
    ...
    def test_Vanadium(self):
        ...
        self.assertEqual(norm_time_wsk.blocksize(), 2439)
        self.assertEqual(np.argmax(norm_time_wsk.extractY()), 2203)
        self.assertAlmostEquals(np.max(norm_time_wsk.extractY()), 19915.92659908)
        HB2AReduce_ws.delete()
        norm_time_wsk.delete()
    ...
    def test_ExcludeDetectors(self):
        ...
        self.assertAlmostEquals(np.max(norm_time_wsk.extractY()), 209.011638786)
        HB2AReduce_ws.delete()
        norm_time_wsk.delete()
    ...
    def test_anode_vs_temp(self):
        ...
        self.assertAlmostEquals(np.max(norm_time_wsk.readY(7)), 1195.31351784)
        HB2AReduce_ws.delete()
        norm_time_wsk.delete()
    ...
    def test_saving_files(self):
        ...
        self.assertTrue(HB2AReduce_ws)
        self.assertTrue(os.path.exists(os.path.join(self._default_save_directory,
                                                    f"{HB2AReduce_ws}.dat")))
        norm_time_wsk = mtd[HB2AReduce_ws.name() + "_norm_time"]
        self.assertTrue(norm_time_wsk)
        self.assertTrue(os.path.exists(os.path.join(self._default_save_directory,
                                                    f"{HB2AReduce_ws}_norm_time.dat")))
        ...
        self.assertTrue(norm_time_wsk)
        self.assertTrue(os.path.exists(os.path.join(self._default_save_directory,
                                                    f"{HB2AReduce_ws}_norm_time.gss")))
        HB2AReduce_ws.delete()
        norm_time_wsk.delete()
