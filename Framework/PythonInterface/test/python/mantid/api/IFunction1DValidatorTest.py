...
from mantid.kernel import StringListValidator, IntBoundedValidator, StringContainsValidator, FloatArrayBoundedValidator, FloatBoundedValidator
...
class SimpleFuncWValidator(IFunction1D):
    ...
    def init(self, input_case):
        if input_case == "String List":
            ...
            #self.declareAttribute("IntAtt", 3, IntBoundedValidator(0, 5))
    ...
    def invalid_init(self, input_case):
        ...
        #elif input_case == "Int Bounded":
            #self.declareAttribute("IntAtt", 10, IntBoundedValidator(0, 5))
        elif input_case == "Float Bounded":
...
class IFunction1DValidatorTest(unittest.TestCase):
    ...
    #def test_int_bounded_validator(self):
        ##NOTE: int bounded validator does not work for some reason - fails in check function of TypedValidator.h
