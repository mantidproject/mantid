...
class StringToPng(mantid.api.PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(
            mantid.api.FileProperty("OutputFilename", "", action=mantid.api.FileAction.Save, extensions=["png"]),
    ...
    def PyExec(self):
        ...
        ax1.text(0.0, 1, bytearray(self.getProperty("String").valueAsStr, "utf-8").decode("unicode_escape"), va="center", fontsize=16)
