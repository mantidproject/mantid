...
class MergeCalFiles(PythonAlgorithm):
    ...
    def seeAlso(self):
        return [
            "ReadGroupsFromFile", "CreateDummyCalFile", "CreateCalFileByNames", "AlignDetectors",
    ...
    def PyInit(self):
        ...
        self.declareProperty("MergeOffsets",
                             False,
                             doc="If True, the offsets from file1 will be merged " +
                             "to the master file. Default: False")
        self.declareProperty("MergeSelections",
                             False,
                             doc="If True, the selections from file1 will be merged " +
                             "to the master file. Default: False")
        self.declareProperty("MergeGroups",
                             False,
                             doc="If True, the Groups from file1 will be merged to " +
    ...
    #add any lines at the end
        ...
        self.log().information("{0} lines Updated, {1} lines added, {2} lines untouched".format(
            linesUpdated, linesAdded, linesUntouched))
        #close the files
        masterFile.close()
        outputFile.close()
