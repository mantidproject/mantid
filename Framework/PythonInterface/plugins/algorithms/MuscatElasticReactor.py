...
# new neutrons start here
            ...
            # Want to divide by QS_mean^(nscatter-1) to normalize - one factor of QS_mean
            # for each path section that isn't the first or last section
            # Also want to divide by nrun2 because of MC integration
            # So divide by nrun2*(QS_mean^(nscatter-1))
            # Actually have QS_sum = (nscatter-1)*nrun2*QS_mean
