...
class LoadLogPropertyTable(PythonAlgorithm):
    ...
    # same concept as built in "CreateLogPropertyTable" but loads its own workspaces and needn't hold all in memory at
    # once select log values to put in table (list)
    # special cases for:
