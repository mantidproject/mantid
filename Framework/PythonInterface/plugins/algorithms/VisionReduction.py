...
class VisionReduction(PythonAlgorithm):
    ...
    def PyExec(self):
        ...
        LoadInstrument(Workspace='__IED_T',
                       Filename='/SNS/VIS/shared/autoreduce/VISION_Definition_no_efixed.xml',
        ...
        Rebin(InputWorkspace='__IED_E',
              OutputWorkspace='__IED_E',
              Params=self.binE,
              PreserveEvents='0',
        ...
        Scale(InputWorkspace='__IED_E_Forward',
              OutputWorkspace='__IED_E_Forward',
              Factor=str(1.0 / len(BanksForward)),
              Operation='Multiply')
        Scale(InputWorkspace='__IED_E_Backward',
              OutputWorkspace='__IED_E_Backward',
              Factor=str(1.0 / len(BanksBackward)),
              Operation='Multiply')
        Scale(InputWorkspace='__IED_E_Average',
              OutputWorkspace='__IED_E_Average',
              Factor=str(1.0 / len(Banks)),
              Operation='Multiply')

        AppendSpectra(InputWorkspace1='__IED_E_Backward',
                      InputWorkspace2='__IED_E_Forward',
                      OutputWorkspace='__IED_reduced')
        AppendSpectra(InputWorkspace1='__IED_reduced',
                      InputWorkspace2='__IED_E_Average',
                      OutputWorkspace='__IED_reduced')
