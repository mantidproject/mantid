...
class DNSComputeDetEffCorrCoefs(PythonAlgorithm):
    ...
    properties_to_compare = [
        'wavelength', 'slit_i_left_blade_position', 'slit_i_right_blade_position', 'slit_i_lower_blade_position',
    ...
    def PyInit(self):
        ...
        self.declareProperty(StringArrayProperty(name="VanadiumWorkspaces",
                                                 direction=Direction.Input,
                                                 validator=validator),
                             doc="Comma separated list of Vanadium workspaces or groups of workspaces.")
        self.declareProperty(StringArrayProperty(name="BackgroundWorkspaces",
                                                 direction=Direction.Input,
                                                 validator=validator),
        ...
        self.declareProperty("TwoThetaTolerance",
                             0.05,
