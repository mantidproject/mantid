            ...
            for cdp in range(ndp):
                ...
                for cd in range(Data.getDimension(0).getNBins()):
                    ...
                    if self.getPropertyValue('CutData') == '1':
                        if self.getPropertyValue('tthMin') < thkl < self.getPropertyValue('tthMax'):
                            if self.getPropertyValue('lambdaMin') < lhkl < self.getProeprtyValue('lambdaMax'):
                                if self.getPropertyValue('dMin') < d < self.getProeprtyValue('dMax'):
                                    if self.getPropertyValue('dpMin') < dp < self.getProeprtyValue('dpMax'):
