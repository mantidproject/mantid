...
class PDConvertReciprocalSpace(PythonAlgorithm):
    ...
    def summary(self):
        return "Transforms a Workspace2D between different " + "reciprocal space functions."
    ...
    def PyInit(self):
        ...
        self.declareProperty(
            MatrixWorkspaceProperty("InputWorkspace", "", direction=Direction.Input, validator=allowed_units),
