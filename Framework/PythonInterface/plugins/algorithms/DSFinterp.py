...
class DSFinterp(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty('LoadErrors',
                             True,
                             direction=Direction.Input,
                             doc='Do we load error data contained in the workspaces?')
        self.declareProperty(FloatArrayProperty('ParameterValues',
                                                values=[],
        ...
        self.declareProperty('RegressionWindow',
                             6,
                             direction=Direction.Input,
        ...
        self.declareProperty('RegressionType',
                             'quadratic',
