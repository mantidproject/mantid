...
class VelocityAutoCorrelations(PythonAlgorithm):
    ...
    def PyExec(self):
        ...
        # simulation and repackage particles into a dictionary 'particles_to_species' with structure id number ->
        # species
        atoms_to_species = {}
        species_to_atoms = {}
        elements = []
        ...
        for i in range(n_particles):
            # Retrieve particle indices from the 'particles' dictionary and determine the relevant position in the
