...
SAMP_POSITION = {6.0: "btm_", 85.5: "mid_", 165.0: "top_", "None": ""}
...
class GroupBySampleChangerPosition(Algorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(
            WorkspaceGroupProperty("InputWorkspace", "", direction=Direction.Input), doc="Workspace group for the workspaces to be sorted."
        )

        self.declareProperty("OutputGroupPrefix", "", doc="String to prefix the output groups.")
        self.declareProperty("OutputGroupSuffix", "", doc="String to suffix the output groups.")

        self.declareProperty(
            StringArrayProperty("OutputWorkspaceList", [], direction=Direction.Output),
