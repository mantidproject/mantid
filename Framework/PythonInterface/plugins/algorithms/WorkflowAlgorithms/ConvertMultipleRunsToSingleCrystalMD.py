...
from mantid.simpleapi import (LoadIsawUB, LoadInstrument, SetGoniometer, ConvertToMD, Load, LoadIsawDetCal, LoadMask,
                              DeleteWorkspace, MaskDetectors, ConvertToMDMinMaxGlobal, ApplyCalibration,
                              CopyInstrumentParameters, ConvertUnits, CropWorkspaceForMDNorm)
...
class ConvertMultipleRunsToSingleCrystalMD(DataProcessorAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty('MomentumMax',
                             ...
                             "the output is to be used with :ref:`MDNorm <algm-MDNorm>`")
        # UBMatrix
        self.declareProperty(FileProperty(name="UBMatrix",
                                          defaultValue="",
        ...
        self.copyProperties('ConvertToMD', [
            'Uproj', 'Vproj', 'Wproj', 'MinValues', 'MaxValues', 'SplitInto', 'SplitThreshold', 'MaxRecursionDepth',
            'OverwriteExisting'
        ])
