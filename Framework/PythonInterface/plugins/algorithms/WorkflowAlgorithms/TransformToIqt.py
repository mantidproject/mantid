...
class TransformToIqt(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(name='BinReductionFactor',
                             defaultValue=10.0,
        ...
        self.declareProperty('SeedValue',
                             DEFAULT_SEED,
                             IntBoundedValidator(lower=1),
    ...
    def _calculate_parameters(self):
        ...
        param_table.addRow([
            number_input_points, self._number_points_per_bin, num_bins, self._e_min, self._e_max, self._e_width,
    ...
    def _add_logs(self):
        sample_logs = [('iqt_sample_workspace', self._sample), ('iqt_resolution_workspace', self._resolution),
