...
class ABINS(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(name="Q vectors",
                             direction=Direction.Input,
                             defaultValue="[0,0,0]",
                             doc="Q vectors for which dynamical structure factor  S should be calculated.")
        ...
        self.declareProperty(name="Instrumental Broadening",
                             direction=Direction.Input,
                             defaultValue="Gaussian",
                             validator=StringListValidator(["None", "Gaussian"]),
                             doc="Broadening of a spectrum which is casued by an instrument; This function will be convoluted with the theoretical spectrum.")
