...
PROP_VERTICAL_AXIS_UNITS = 'VerticalAxisUnits'
...
REBIN_AUTO_ELASTIC_PEAK = 'Rebinning Elastic Bin Width'
REBIN_AUTO_MEDIAN_BIN_WIDTH = 'Rebinning Median Bin Width'
REBIN_AUTO_Q = 'Binning Median 2Theta'
REBIN_MANUAL_Q = 'Binning Manual'
REBIN_MANUAL_W = 'Rebinning Manual'
REBIN_W_OFF = 'Rebinning OFF'
...
UNITS_SCATTERING_ANGLE = 'Scattering Angle'
UNITS_SPECTRUM_NUMBER = 'Spectrum Number'
