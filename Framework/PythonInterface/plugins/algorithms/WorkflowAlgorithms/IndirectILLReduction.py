...
class IndirectILLReduction(DataProcessorAlgorithm):
    ...
    def PyExec(self):
		...
		# Instead of Load, LoadILLIndirect can be used
		# Load requires the field Filename to be set
		# LoadILLIndirect requires the field FileName to be set
	...
	def _perform_mirror(self, ws1, ws2, monitor1=None, monitor2=None, detgrouped1=None, detgrouped2=None, mnorm1=None, mnorm2=None):
		...
		if monitor1 is not None and monitor2 is not None and detgrouped1 is not None and detgrouped2 is not None and mnorm1 is not None and mnorm2 is not None:
			# Monitors
