...
class SANSSingleReductionBase(DistributedDataProcessorAlgorithm):
    def _pyinit(self):
        ...
        self.declareProperty("UseOptimizations",
                             True,
    ...
    def _create_reduction_bundles_for_data_type(self, state, data_type, reduction_modes, output_parts, scatter_name,
                                                scatter_monitor_name, transmission_name, direct_name):
        # Get workspaces
