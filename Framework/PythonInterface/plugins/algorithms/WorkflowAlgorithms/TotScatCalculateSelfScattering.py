...
from mantid.simpleapi import (CalculatePlaczekSelfScattering, ConvertUnits,
                              ExtractSpectra, FitIncidentSpectrum, SetSample)
                              # CreateWorkspace, DeleteWorkspace, Divide, LoadCalFile,
                              # GroupDetectors, Rebin, CloneWorkspace)
...
class TotScatCalculateSelfScattering(DataProcessorAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(name='CrystalDensity', defaultValue=0.0,
                             doc='The crystallographic density of the material.')
    ...
    def PyExec(self):
        ...
        # CloneWorkspace(InputWorkspace=self_scattering_correction, OutputWorkspace="daniel_ssc")
