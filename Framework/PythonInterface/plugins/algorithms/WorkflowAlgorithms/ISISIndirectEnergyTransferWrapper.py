...
class ISISIndirectEnergyTransferWrapper(DataProcessorAlgorithm):
    ...
    def summary(self):
        return (
            "Runs an energy transfer reduction for an inelastic indirect geometry instrument. It is a wrapper for "
    ...
    def _reduce_data(self):
        reduction_algorithm = self.createChildAlgorithm(
            name="ISISIndirectEnergyTransfer", startProgress=0.1, endProgress=1.0, enableLogging=False
        )
