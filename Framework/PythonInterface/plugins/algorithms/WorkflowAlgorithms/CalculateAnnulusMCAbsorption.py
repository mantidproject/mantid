...
from mantid.simpleapi import (mtd, CloneWorkspace, DeleteWorkspace, GroupWorkspaces, ConvertUnits,
                              Multiply, AddSampleLogMultiple, AnnulusMonteCarloAbsorption)
...
class CalculateAnnulusMCAbsorption(DataProcessorAlgorithm):
    # Sample variables
    ...
    def PyInit(self):
        ...
        self.declareProperty(name='SampleOuterRadius', defaultValue=0.3,
                             validator=FloatBoundedValidator(0.0),
                             doc='Sample inner radius')
    ...
    def PyExec(self):
        ...
        sample_logs = [('sample_shape', 'annulus'),
                       ...
                       ('sample_inner_radius', self._sample_inner_radius),
                       ('sample_outer_radius', self._sample_outer_radius)]
    ...
    def validateInputs(self):
        ...
        if self._can_ws_name is not None:
            ...
            if self._can_inner_radius >= self._sample_inner_radius:
...
AlgorithmFactory.subscribe(CalculateAnnulusMCAbsorption)
