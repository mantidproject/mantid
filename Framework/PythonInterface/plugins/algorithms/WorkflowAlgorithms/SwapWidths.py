...
class SwapWidths(DataProcessorAlgorithm):
    ...
    def PyExec(self):
        ...
        width1_x = mtd[self._input_ws].x(index_1)
        width1_y = mtd[self._input_ws].y(index_1)
        width1_e = mtd[self._input_ws].e(index_1)
        label_2 = "f2.f2.FWHM"
        index_2 = self._indexOf(mtd[self._input_ws].getAxis(1), label_2)
        width2_x = mtd[self._input_ws].x(index_2)
        width2_y = mtd[self._input_ws].y(index_2)
        width2_e = mtd[self._input_ws].e(index_2)
