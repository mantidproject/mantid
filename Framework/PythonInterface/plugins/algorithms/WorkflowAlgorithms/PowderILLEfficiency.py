...
class PowderILLEfficiency(PythonAlgorithm):
    ...
    def _process_global(self):
        ...
        if component_info.hasParameter("pixels_to_trim"):
            self._pixels_to_trim = component_info.getIntParameter("pixels_to_trim")[0]
        if component_info.hasParameter("chi2_ndof"):
            chi2_ndof_threshold = component_info.getNumberParameter("chi2_ndof")[0]
