...
from mantid.simpleapi import (mtd, SetGoniometer, AddSampleLog, MaskBTP, RenameWorkspace, GroupWorkspaces, CreateWorkspace, LoadNexusLogs,
                              LoadInstrument)
import numpy as np
import h5py
    ...
    def PyExec(self):
        ...
        for i, run in enumerate(runs):
            ...
            if grouping == 2:
                ...
                data = (data[::4, ::4] + data[1::4, ::4] + data[2::4, ::4] + data[3::4, ::4] + data[::4, 1::4] + data[1::4, 1::4]
                        + data[2::4, 1::4] + data[3::4, 1::4] + data[::4, 2::4] + data[1::4, 2::4] + data[2::4, 2::4] + data[3::4, 2::4]
