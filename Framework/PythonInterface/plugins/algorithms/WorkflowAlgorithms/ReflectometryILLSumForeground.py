...
from mantid.kernel import (CompositeValidator, Direction, FloatArrayBoundedValidator, FloatArrayProperty, IntArrayBoundedValidator,
                           IntArrayLengthValidator, IntArrayProperty, Property, StringListValidator)
...
class ReflectometryILLSumForeground(DataProcessorAlgorithm):
    ...
    def seeAlso(self):
        ...
        return [
            'ReflectometryILLConvertToQ', 'ReflectometryILLPolarizationCor', 'ReflectometryILLPreprocess', 'ReflectometryILLAutoProcess'
        ]
    ...
    def PyInit(self):
        ...
        non_negative_float_array = FloatArrayBoundedValidator(lower=0.)
        in_wavelength = WorkspaceUnitValidator('Wavelength')

        self.declareProperty(MatrixWorkspaceProperty(Prop.INPUT_WS, defaultValue='', direction=Direction.Input, validator=in_wavelength),
        ...
        self.declareProperty(FloatArrayProperty(Prop.WAVELENGTH_RANGE, values=[0.], validator=non_negative_float_array),
    ...
    def _correct_for_fractional_foreground_centre(self, ws: MatrixWorkspace, summed_foreground: MatrixWorkspace) -> MatrixWorkspace:
        ...
        if dist != 0.:
            ...
            RotateInstrumentComponent(Workspace=summed_foreground,
    ...
    def _rebin_direct_to_reflected(self, direct_ws: MatrixWorkspace, ws: MatrixWorkspace) -> MatrixWorkspace:
        ...
        rebinned_ws = RebinToWorkspace(WorkspaceToRebin=direct_ws,
                                       WorkspaceToMatch=ws,
    ...
    def _sum_foreground_in_lambda(self, ws: MatrixWorkspace) -> MatrixWorkspace:
        ...
        foreground_ws = ExtractSingleSpectrum(InputWorkspace=ws,
                                              OutputWorkspace=foreground_ws_name,
                                              WorkspaceIndex=beam_pos_index,
                                              EnableLogging=self._subalg_logging)
        ...
        for i in sum_indices:
            ...
            addee_ws = ExtractSingleSpectrum(InputWorkspace=ws,
                                             OutputWorkspace=addee_ws_name,
                                             WorkspaceIndex=i,
                                             EnableLogging=self._subalg_logging)
            addee_ws = RebinToWorkspace(WorkspaceToRebin=addee_ws,
                                        WorkspaceToMatch=foreground_ws,
                                        OutputWorkspace=addee_ws_name,
                                        EnableLogging=self._subalg_logging)
    ...
    def _sum_foreground_in_q(self, ws: MatrixWorkspace) -> MatrixWorkspace:
        ...
        sum_ws = ReflectometrySumInQ(InputWorkspace=ws,
