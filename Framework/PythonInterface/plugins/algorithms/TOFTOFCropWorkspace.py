...
class TOFTOFCropWorkspace(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(
            WorkspaceProperty("OutputWorkspace", "", direction=Direction.Output), doc="Name of the workspace that will contain the results"
        )
    ...
    def PyExec(self):
        ...
        outputws = api.CropWorkspace(inputws, XMin=0.0, XMax=full_channels * channel_width + tof1, StoreInADS=False)
