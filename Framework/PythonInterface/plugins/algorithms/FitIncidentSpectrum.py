...
class FitIncidentSpectrum(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(name='WorkspaceIndex',
                             defaultValue=0,
        ...
        self.declareProperty(name='FitSpectrumWith',
    ...
    def PyExec(self):
        ...
        if self._fit_spectrum_with == 'CubicSpline':
            ...
            fit, fit_prime = self.fit_cubic_spline_via_mantid_spline_smoothing(self._input_ws,
