...
class PDToGUDRUN(DataProcessorAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(MatrixWorkspaceProperty("OutputWorkspace", "", direction=Direction.Output),
                             doc="Handle to reduced workspace")
        self.declareProperty(
            FileProperty(name="GUDRUNFile", defaultValue="", action=FileAction.Save, extensions=[".getn"]),
            "Output filename")
        ...
        self.declareProperty("CropWavelengthMin", 0., "Crop the data at this minimum wavelength.")
        self.declareProperty("CropWavelengthMax", 0., "Crop the data at this maximum wavelength.")
