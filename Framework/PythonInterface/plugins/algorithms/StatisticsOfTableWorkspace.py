...
class StatisticsOfTableWorkspace(PythonAlgorithm):
    ...
    def PyInit(self):
        self.declareProperty(ITableWorkspaceProperty("InputWorkspace", "", Direction.Input), doc="Input table workspace.")
        ...
        self.declareProperty(
            ITableWorkspaceProperty("OutputWorkspace", "", Direction.Output), doc="Output workspace containing column statistics."
        )
