...
class IndexSatellitePeaks(PythonAlgorithm):
    ...
    def PyInit(self):
        self.declareProperty(
            IPeaksWorkspaceProperty(name="NuclearPeaks", defaultValue="", direction=Direction.Input),
            doc="Main integer HKL peaks. Q vectors will be calculated relative to these peaks.",
        )

        self.declareProperty(
            IPeaksWorkspaceProperty(name="SatellitePeaks", defaultValue="", direction=Direction.Input),
