...
class VesuvioThickness(PythonAlgorithm):
    ...
    def PyInit(self):
        self.declareProperty(FloatArrayProperty("Masses", direction=Direction.Input), doc="The masses that make up the sample")

        self.declareProperty(FloatArrayProperty("Amplitudes", direction=Direction.Input), doc="The amplitudes of the peaks")
        ...
        self.declareProperty(
            ITableWorkspaceProperty("DensityWorkspace", "", direction=Direction.Output),
        ...
        self.declareProperty(
            ITableWorkspaceProperty("TransmissionWorkspace", "", direction=Direction.Output),
