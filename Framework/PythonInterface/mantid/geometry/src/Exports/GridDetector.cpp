...
void export_GridDetector() {
  ...
  class_<GridDetector, bases<CompAssembly, IObjComponent>, boost::noncopyable>("GridDetector", no_init)
      ...
      .def("xsize", &GridDetector::xsize, arg("self"), "Returns the size in the X direction")
      .def("ysize", &GridDetector::ysize, arg("self"), "Returns the size in the Y direction")
      .def("zsize", &GridDetector::zsize, arg("self"), "Returns the size in the Z direction")
...
void export_GridDetectorPixel() {
  class_<GridDetectorPixel, bases<Detector>, boost::noncopyable>("GridDetectorPixel", no_init);
}
