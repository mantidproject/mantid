...
void export_PointGroupFactory() {
  ...
  class_<PointGroupFactoryImpl, boost::noncopyable>("PointGroupFactoryImpl", no_init)
      .def("isSubscribed", &PointGroupFactoryImpl::isSubscribed, (arg("self"), arg("hmSymbol")),
           "Returns true of the point group with the given symbol is "
           "subscribed.")
      .def("createPointGroup", &PointGroupFactoryImpl::createPointGroup, (arg("self"), arg("hmSymbol")),
           "Creates a point group if registered.")
      .def("createPointGroupFromSpaceGroup", &getPointGroupFromSpaceGroup, (arg("self"), arg("group")),
           "Creates the point group that corresponds to the given space group.")
      .def("createPointGroupFromSpaceGroupSymbol", &getPointGroupFromSpaceGroupSymbol, (arg("self"), arg("group")),
           "Creates a point group directly from the space group symbol.")
      .def("getAllPointGroupSymbols", &PointGroupFactoryImpl::getAllPointGroupSymbols, arg("self"),
           "Returns all registered point group symbols.")
      .def("getPointGroupSymbols", &PointGroupFactoryImpl::getPointGroupSymbols, (arg("self"), arg("crystalsystem")),
