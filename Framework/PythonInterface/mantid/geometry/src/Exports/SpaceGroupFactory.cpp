...
std::vector<std::string> spaceGroupSymbolsForPointGroup(SpaceGroupFactoryImpl &self,
...
void export_SpaceGroupFactory() {
  ...
  class_<SpaceGroupFactoryImpl, boost::noncopyable>("SpaceGroupFactoryImpl", no_init)
      .def("isSubscribedSymbol", &isSubscribedSymbol, (arg("self"), arg("symbol")),
           "Returns true if the space group the supplied symbol is subscribed.")
      .def("isSubscribedNumber", &isSubscribedNumber, (arg("self"), arg("number")),
           "Returns true if a space group with the given number is subscribed.")
      .def("createSpaceGroup", &createSpaceGroup, (arg("self"), arg("symbol")), "Creates a space group.")
      .def("getAllSpaceGroupSymbols", &allSpaceGroupSymbols, arg("self"), "Returns all subscribed space group symbols.")
      .def("getAllSpaceGroupNumbers", &SpaceGroupFactoryImpl::subscribedSpaceGroupNumbers, arg("self"),
           "Returns all subscribed space group numbers.")
      .def("subscribedSpaceGroupSymbols", &spaceGroupSymbolsForNumber, (arg("self"), arg("number")),
           "Returns all space group symbols that are registered under the "
           "given number.")
      .def("getSpaceGroupsForPointGroup", &spaceGroupSymbolsForPointGroup, (arg("self"), arg("pointGroup")))
