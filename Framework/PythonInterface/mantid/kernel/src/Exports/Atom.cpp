...
/**
 *
 * @param neutron neutron cross-sections for this atom
...
dict neutron(Atom &self) {
  ...
  retval["abs_scatt_xs"] = self.neutron.abs_scatt_xs;
  return retval;
}
/**
...
void export_Atom() {
  ...
  class_<Atom, boost::noncopyable>("Atom", no_init) // No default constructor
      ...
      .def_readonly("abundance", &Atom::abundance,
