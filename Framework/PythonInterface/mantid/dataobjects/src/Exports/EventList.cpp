...
namespace {
void addEventToEventList(EventList &self, double tof, Mantid::Types::Core::DateAndTime pulsetime) {
  self.addEventQuickly(Mantid::Types::Event::TofEvent(tof, pulsetime));
}

void addWeightedEventToEventList(EventList &self, double tof, double weight, double errorsquare,
                                 Mantid::Types::Core::DateAndTime pulsetime) {
  self.addEventQuickly(WeightedEvent(Mantid::Types::Event::TofEvent(tof, pulsetime), weight, errorsquare));
}
} // namespace
...
void export_EventList() {
  ...
  class_<EventList, bases<Mantid::API::IEventList>, boost::noncopyable>("EventList")
      .def("addEventQuickly", &addEventToEventList, args("self", "tof", "pulsetime"),
