...
void export_BoxController() {
  ...
  class_<BoxController, boost::noncopyable>("BoxController", no_init)
      .def("getNDims", &BoxController::getNDims, arg("self"), "Get # of dimensions")
      .def("getSplitThreshold", &BoxController::getSplitThreshold, arg("self"),
           "Return the splitting threshold, in # of events")
      .def("getSplitInto", &BoxController::getSplitInto, (arg("self"), arg("dim")),
      ...
      .def("getTotalNumMDBoxes", &BoxController::getTotalNumMDBoxes, arg("self"),
           "Return the total number of MD Boxes, irrespective of depth")
      .def("getTotalNumMDGridBoxes", &BoxController::getTotalNumMDGridBoxes, arg("self"),
      ...
      .def("useWriteBuffer", &BoxController::useWriteBuffer, arg("self"), "Return true if the MRU should be used");
}
