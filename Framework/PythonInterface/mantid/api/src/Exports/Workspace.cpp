...
void export_Workspace() {
  class_<Workspace, bases<DataItem>, boost::noncopyable>("Workspace", no_init)
      ...
      .def("isDirty", &Workspace::isDirty,
           Workspace_isDirtyOverloads((arg("self"), arg("n")), "True if the workspace has run "
      ...
      .def("getHistory", (const WorkspaceHistory &(Workspace::*)() const) & Workspace::getHistory, arg("self"),
