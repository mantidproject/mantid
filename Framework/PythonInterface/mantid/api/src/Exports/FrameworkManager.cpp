...
void export_FrameworkManager() {
  typedef class_<FrameworkManagerImpl, boost::noncopyable>
      FrameworkManagerPythonType;
  auto pythonClass =
      FrameworkManagerPythonType("FrameworkManagerImpl", no_init)
          .def("setNumOMPThreadsToConfigValue",
               &FrameworkManagerImpl::setNumOMPThreadsToConfigValue,
               arg("self"), "Sets the number of OpenMP threads to the value "
                            "specified in the "
                            "config file")
