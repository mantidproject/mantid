...
void export_IPeak() {
  ...
  class_<IPeak, boost::noncopyable>("IPeak", no_init)
      ...
      .def("findDetector", (bool (IPeak::*)()) & IPeak::findDetector, arg("self"),
      ...
      .def("getDetPos", &IPeak::getDetPos, arg("self"), "Return the :class:`~mantid.geometry.Detector` position vector")
