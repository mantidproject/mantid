...
void export_Run() {
  ...
  class_<Run, boost::noncopyable>("Run")
      ...
      .def("getGoniometer", (const Mantid::Geometry::Goniometer &(Run::*)() const) & Run::getGoniometer, arg("self"),
           return_value_policy<reference_existing_object>(), "Return the Goniometer object associated with this run.")
