...
namespace {
  ...
  typedef void (ProductFunction::*setParameterType2)(const std::string&, const double&, bool);
...
void export_ProductFunction() {
  ...
  class_<ProductFunction, bases<IFunction>, boost::noncopyable>(
    ...
    (arg("self"), arg("i")), "Get the i-th function.")
    .def("add", &ProductFunction::addFunction,
    (arg("self"), arg("function")), "Add a member function.")
    .def("getParameterValue", (getParameterType1) &ProductFunction::getParameter,
    (arg("self"), arg("i")), "Get value of parameter of given index.")
    .def("getParameterValue", (getParameterType2) &ProductFunction::getParameter,
