...
BOOST_PYTHON_FUNCTION_OVERLOADS(getParameterFilename_Overload, InstrumentFileFinder::getParameterFilename, 1, 3)
...
void exportInstrumentFileFinder() {
  ...
  class_<InstrumentFileFinder>("InstrumentFileFinder", no_init)
      ...
      //
      .def("getParameterFilename", &InstrumentFileFinder::getParameterFilename,
           getParameterFilename_Overload("Returns Instrument Parameter filename",
                                         (arg("instrument"), arg("date") = "", arg("dirHint") = "")))
