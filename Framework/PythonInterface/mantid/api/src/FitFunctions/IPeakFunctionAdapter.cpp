...
double IPeakFunctionAdapter::centre() const { return callMethodNoCheck<double>(getSelf(), "centre"); }

double IPeakFunctionAdapter::height() const { return callMethodNoCheck<double>(getSelf(), "height"); }

/**
 * Called when the centre of the peak has been updated outside of the function
 * @param c The centre of the peak
 */
void IPeakFunctionAdapter::setCentre(const double c) { callMethodNoCheck<void, double>(getSelf(), "setCentre", c); }

/**
 * Called when the height of the peak has been updated outside of the function
 * @param h The new height of the peak
 */
void IPeakFunctionAdapter::setHeight(const double h) { callMethodNoCheck<void, double>(getSelf(), "setHeight", h); }

/// Calls Python fwhm method
double IPeakFunctionAdapter::fwhm() const { return callMethodNoCheck<double>(getSelf(), "fwhm"); }
 ...
 * such that fwhm=w
 */
void IPeakFunctionAdapter::setFwhm(const double w) { return callMethodNoCheck<void, double>(getSelf(), "setFwhm", w); }
 ...
 * @param nData The size of the two arrays
 */
void IPeakFunctionAdapter::functionDerivLocal(API::Jacobian *jacobian, const double *xValues, const size_t nData) {
