...
public:
  ...
  void test_basic_attributes() {
    ...
    TS_ASSERT_EQUALS(dummy.id(), std::string("3fa1d522-f1b8-4134-a56b-b61f24d20510"));
  ...
  void test_basic_attributes_of_entity_vector() {
    ...
    TS_ASSERT_EQUALS(dummies[0].id(), std::string("3fa1d522-f1b8-4134-a56b-b61f24d20510"));
    TS_ASSERT_EQUALS(dummies[0].type(), std::string("dummy"));

    TS_ASSERT_EQUALS(dummies[1].id(), std::string("4b1dec2a-0f15-416d-8d23-e08901ac4634"));
  ...
  void test_throws_on_malformed_json() {
    ...
    TS_ASSERT_THROWS(ONCatEntity::fromJSONStream(ss), const MalformedRepresentationError &);
  }
  ...
  void test_nested_values_with_various_types() {
    ...
    TS_ASSERT_EQUALS(dummy.get<std::string>("val.a.string"), std::string("value"));
  ...
  void test_default_values_with_various_types() {
    ...
    TS_ASSERT_EQUALS(dummy.get<std::string>("a.string", "val"), std::string("val"));
