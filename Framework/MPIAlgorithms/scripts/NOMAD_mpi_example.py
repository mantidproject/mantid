...
def focus(filename):
    ...
    LoadEventPreNexus(EventFilename=filename,
                      OutputWorkspace=wksp,
                      ChunkNumber=comm.rank + 1,
                      TotalChunks=comm.size,
                      UseParallelProcessing="Serial")
    ...
    DiffractionFocussing(InputWorkspace=wksp, OutputWorkspace=wksp, GroupingWorkspace="grouping", PreserveEvents=False)
    return mtd[wksp]
