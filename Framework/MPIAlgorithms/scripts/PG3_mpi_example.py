...
def focus(eventfile, wksp, binning):
    ...
    AlignDetectors(InputWorkspace=wksp, OutputWorkspace=wksp, CalibrationFile=calfile)
    DiffractionFocussing(InputWorkspace=wksp, OutputWorkspace=wksp, GroupingFileName=calfile)
...
def loopmethod():
    ...
    for name in names[1:]:
        ConjoinWorkspaces(InputWorkspace1=names[0],
