...
class VariancesTester : public VectorOf<VariancesTester, HistogramX>, public Iterable<VariancesTester> {
public:
...
class StandardDeviationVectorOfTester
    : public StandardDeviationVectorOf<StandardDeviationVectorOfTester, HistogramX, VariancesTester> {
public:
  using StandardDeviationVectorOf<StandardDeviationVectorOfTester, HistogramX,
                                  VariancesTester>::StandardDeviationVectorOf;
  using StandardDeviationVectorOf<StandardDeviationVectorOfTester, HistogramX, VariancesTester>::operator=;
  StandardDeviationVectorOfTester(const StandardDeviationVectorOfTester &) = default;
  StandardDeviationVectorOfTester &operator=(const StandardDeviationVectorOfTester &) = default;
};
...
public:
  ...
  static StandardDeviationVectorOfTest *createSuite() { return new StandardDeviationVectorOfTest(); }
  static void destroySuite(StandardDeviationVectorOfTest *suite) { delete suite; }
