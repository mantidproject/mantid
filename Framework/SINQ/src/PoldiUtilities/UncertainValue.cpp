...
UncertainValue UncertainValue::operator*(double d) { return UncertainValue(m_value * d, m_error * d); }
...
UncertainValue UncertainValue::operator+(double d) { return UncertainValue(m_value + d, m_error); }

UncertainValue UncertainValue::operator-(double d) { return UncertainValue(m_value - d, m_error); }

UncertainValue operator*(double d, const UncertainValue &v) { return UncertainValue(d * v.value(), d * v.error()); }
