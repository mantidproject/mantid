...
public:
  ...
  void test_exec() {
    ...
    ITableWorkspace_sptr tableWs = std::dynamic_pointer_cast<ITableWorkspace>(ws);
  ...
  void testGetConstrainedUnitCell() {
    ...
    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Cubic), 2.0, 2.0, 2.0, 90.0,
                            90.0, 90.0, "Cubic");

    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Tetragonal), 2.0, 2.0, 4.0,
                            90.0, 90.0, 90.0, "Tetragonal");

    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Orthorhombic), 2.0, 3.0, 4.0,
                            90.0, 90.0, 90.0, "Orthorhombic");

    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Monoclinic), 2.0, 3.0, 4.0,
                            90.0, 92.0, 90.0, "Monoclinic");

    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Triclinic), 2.0, 3.0, 4.0,
                            91.0, 92.0, 93.0, "Triclinic");

    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Hexagonal), 2.0, 2.0, 4.0,
                            90.0, 90.0, 120.0, "Hexagonal");

    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Trigonal), 2.0, 2.0, 2.0,
                            91.0, 91.0, 91.0, "Trigonal");

    checkUnitCellParameters(alg.getConstrainedUnitCell(rawCell, PointGroup::CrystalSystem::Trigonal, Group::Hexagonal),
                            2.0, 2.0, 4.0, 90.0, 90.0, 120.0, "Trigonal");
  }

private:
  void checkUnitCellParameters(const UnitCell &cell, double a, double b, double c, double alpha, double beta,
  ...
  public:
    ...
    ~TestablePoldiCreatePeaksFromCell() override = default;
