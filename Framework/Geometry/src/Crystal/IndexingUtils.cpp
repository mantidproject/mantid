...
/**
 ...
 nearly maps
 the specified hkl_vectors and mnp_vectors to the specified q_vectors.  The
 calculated
 ...
 The sum of the squares of the residual errors is returned.  This method is
 used to optimize the UB matrix and ModUB matrix once an initial indexing has
 been found.
...
double IndexingUtils::Optimize_6dUB(DblMatrix &UB, DblMatrix &ModUB,
  ...
  if (hkl_vectors.size() < 4) {
    throw std::invalid_argument(
        "Optimize_6dUB(): Four or more indexed peaks needed to find UB");
  }
