 ...
 */
ConvexPolygon::Iterator::Iterator(const ConvexPolygon &polygon) : m_polygon(polygon), m_index(0) {
  if (!polygon.isValid()) {
 ...
 */
const Kernel::V2D &ConvexPolygon::Iterator::operator*() const { return m_polygon[m_index]; }
 ...
 */
PolygonEdge ConvexPolygon::Iterator::edge() const { return PolygonEdge(**this, m_polygon[nextIndex()]); }
