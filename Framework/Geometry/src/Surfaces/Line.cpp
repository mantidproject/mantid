...
int Line::intersect(boost::container::small_vector<Kernel::V3D, 5> &VecOut, const Quadratic &Sur) const
/**
...
int Line::intersect(boost::container::small_vector<Kernel::V3D, 5> &PntOut, const Plane &Pln) const
/**
...
int Line::intersect(boost::container::small_vector<Kernel::V3D, 5> &PntOut, const Cylinder &Cyl) const
/**
For the line that intersects the cylinder generate
add the point to the VecOut, return number of points
added. It does not check the points for validity.
...
int Line::intersect(boost::container::small_vector<Kernel::V3D, 5> &PntOut, const Sphere &Sph) const
/**
For the line that intersects the cylinder generate
add the point to the VecOut, return number of points
added. It does not check the points for validity.
