...
void OSD_Error::Reset() { myErrno = 0; }
...
Standard_Integer OSD_Error::Error() const { return (extCode); }
...
OSD_Error ::OSD_Error() : myCode((OSD_WhoAmI)0), extCode(0) { Reset(); } // end constructor ( 1 )
...
Standard_Integer OSD_Error ::Error() const { return extCode; } // end OSD_Error :: Error
...
void OSD_Error ::Reset() { myErrno = ERROR_SUCCESS; } // end OSD_Error :: Reset
