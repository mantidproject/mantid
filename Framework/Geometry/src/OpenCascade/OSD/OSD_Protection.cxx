...
void OSD_Protection::SetSystem(const OSD_SingleProtection priv) { s = priv; }

void OSD_Protection::SetUser(const OSD_SingleProtection priv) { u = priv; }

void OSD_Protection::SetGroup(const OSD_SingleProtection priv) { g = priv; }

void OSD_Protection::SetWorld(const OSD_SingleProtection priv) { w = priv; }

OSD_SingleProtection OSD_Protection::System() const { return (s); }

OSD_SingleProtection OSD_Protection::User() const { return (u); }

OSD_SingleProtection OSD_Protection::Group() const { return (g); }

OSD_SingleProtection OSD_Protection::World() const { return (w); }
...
void OSD_Protection ::SetSystem(const OSD_SingleProtection priv) { s = priv; } // end OSD_Protection :: SetSystem

void OSD_Protection ::SetUser(const OSD_SingleProtection priv) { u = priv; } // end OSD_Protection :: SetUser

void OSD_Protection ::SetGroup(const OSD_SingleProtection priv) { g = priv; } // end OSD_Protection :: SetGroup

void OSD_Protection ::SetWorld(const OSD_SingleProtection priv) { w = priv; } // end OSD_Protection :: SetWorld

OSD_SingleProtection OSD_Protection ::System() const { return s; } // end OSD_Protection :: System

OSD_SingleProtection OSD_Protection ::User() const { return u; } // end OSD_Protection :: User

OSD_SingleProtection OSD_Protection ::Group() const { return g; } // end OSD_Protection :: Group

OSD_SingleProtection OSD_Protection ::World() const { return w; } // end OSD_Protection :: World
...
Standard_Integer OSD_Protection ::Internal() const { return 0; } // end OSD_Protection :: Internal
