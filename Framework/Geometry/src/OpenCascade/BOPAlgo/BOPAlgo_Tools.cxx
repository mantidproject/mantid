...
public:
  ...
  void SetMapOfVerticesTolerances(const TopTools_IndexedDataMapOfShapeReal &theVertices) { myVertices = &theVertices; }
...
void BOPAlgo_Tools::FillInternals(const TopTools_ListOfShape &theSolids, const TopTools_ListOfShape &theParts,
  ...
  for (; itLS.More(); itLS.Next()) {
    ...
    for (; itLP.More();) {
      ...
      TopAbs_State aState = BOPTools_AlgoTools::ComputeStateByOnePoint(aPart, aSd, Precision::Confusion(), theContext);
      if (aState == TopAbs_IN) {
