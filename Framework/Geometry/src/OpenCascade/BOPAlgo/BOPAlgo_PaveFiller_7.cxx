...
public:
  ...
  BOPAlgo_SplitEdge() : BOPAlgo_ParallelAlgo() {
    myT1 = 0.;
    myT2 = 0.;
    myTol = 0.;
  }
  ...
  //
  void SetData(const TopoDS_Edge &aE, const TopoDS_Vertex &aV1, const Standard_Real aT1, const TopoDS_Vertex &aV2,
...
public:
  ...
  BOPAlgo_MPC() : BOPAlgo_ParallelAlgo(), myFlag(Standard_False){};
  //
  virtual ~BOPAlgo_MPC(){};
  //
  ...
  //
  void SetData(const TopoDS_Edge &aEz, const TopoDS_Vertex &aV1, const Standard_Real aT1, const TopoDS_Vertex &aV2,
               const Standard_Real aT2) {
    myEz = aEz;
    myV1 = aV1;
    myT1 = aT1;
    ...
    try {
      ...
      if (aC2d.IsNull()) {
        ...
        if (aBAS.IsUPeriodic() || aBAS.IsVPeriodic()) {
          ...
          BOPTools_AlgoTools2D::AdjustPCurveOnSurf(myContext->SurfaceAdaptor(myF), f, l, aC2d, myNewC2d);
          if (myNewC2d != aC2d)
            myNewTol = BRep_Tool::Tolerance(aCopyE);
          else
            myNewC2d.Nullify();
...
// purpose:
//=======================================================================
Standard_Integer BOPAlgo_PaveFiller::SplitEdge(const Standard_Integer nE, const Standard_Integer nV1,
                                               const Standard_Real aT1, const Standard_Integer nV2,
                                               const Standard_Real aT2) {
