...
BRepPrim_FaceBuilder::BRepPrim_FaceBuilder(const BRep_Builder &B, const Handle(Geom_Surface) & S) { Init(B, S); }
...
BRepPrim_FaceBuilder::BRepPrim_FaceBuilder(const BRep_Builder &B, const Handle(Geom_Surface) & S,
                                           const Standard_Real UMin, const Standard_Real UMax, const Standard_Real VMin,
...
void BRepPrim_FaceBuilder::Init(const BRep_Builder &B, const Handle(Geom_Surface) & S) {
...
void BRepPrim_FaceBuilder::Init(const BRep_Builder &B, const Handle(Geom_Surface) & S, const Standard_Real UMin,
                                const Standard_Real UMax, const Standard_Real VMin, const Standard_Real VMax) {
  // Check the values
...
const TopoDS_Face &BRepPrim_FaceBuilder::Face() const { return myFace; }
...
BRepPrim_FaceBuilder::operator TopoDS_Face() { return Face(); }
