...
TopLoc_Location::TopLoc_Location(const Handle(TopLoc_Datum3D) & D) { myItems.Construct(TopLoc_ItemLocation(D, 1)); }
...
TopLoc_Location::operator gp_Trsf() const { return Transformation(); }
...
TopLoc_Location TopLoc_Location::Divided(const TopLoc_Location &Other) const { return Multiplied(Other.Inverted()); }
...
Standard_Boolean TopLoc_Location::IsDifferent(const TopLoc_Location &Other) const { return !IsEqual(Other); }
