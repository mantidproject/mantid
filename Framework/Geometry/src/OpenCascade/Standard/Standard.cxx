...
Standard_MMgrFactory::Standard_MMgrFactory() : myFMMgr(NULL) {
  /*#if defined(_MSC_VER) && (_MSC_VER > 1400)
    ...
    // This is not well documented call because _ENABLE_PER_THREAD_LOCALE_GLOBAL flag is defined but not implemented for
  some reason.
...
void Standard::Free(Standard_Address theStorage) { Standard_MMgrFactory::GetMMgr()->Free(theStorage); }
...
Standard_Integer Standard::Purge() { return Standard_MMgrFactory::GetMMgr()->Purge(); }
