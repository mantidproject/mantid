...
void Standard_Transient::IncrementRefCounter() const { Standard_Atomic_Increment(&myRefCount_); }

// Decrement reference counter
Standard_Integer Standard_Transient::DecrementRefCounter() const { return Standard_Atomic_Decrement(&myRefCount_); }
