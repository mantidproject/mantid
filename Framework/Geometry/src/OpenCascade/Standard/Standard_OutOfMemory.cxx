...
Standard_CString Standard_OutOfMemory::GetMessageString() const { return myBuffer; }
...
void Standard_OutOfMemory::Raise(const Standard_CString theMessage) { NewInstance(theMessage)->Reraise(); }
...
void Standard_OutOfMemory::Raise(Standard_SStream &theMessage) { NewInstance(theMessage.str().c_str())->Reraise(); }
...
void Standard_OutOfMemory::Throw() const { throw *this; }
