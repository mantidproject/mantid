...
BRepLib_MakeFace::BRepLib_MakeFace(const TopoDS_Face &F) { Init(F); }
...
const TopoDS_Face &BRepLib_MakeFace::Face() const { return TopoDS::Face(myShape); }
...
BRepLib_MakeFace::operator TopoDS_Face() const { return Face(); }
...
BRepLib_FaceError BRepLib_MakeFace::Error() const { return myError; }
