...
Standard_Boolean BRepLib_MakePolygon::Added() const { return !myEdge.IsNull(); }
...
const TopoDS_Vertex &BRepLib_MakePolygon::FirstVertex() const { return myFirstVertex; }
...
const TopoDS_Vertex &BRepLib_MakePolygon::LastVertex() const { return myLastVertex; }
...
const TopoDS_Edge &BRepLib_MakePolygon::Edge() const { return myEdge; }
...
const TopoDS_Wire &BRepLib_MakePolygon::Wire() { return TopoDS::Wire(Shape()); }
...
BRepLib_MakePolygon::operator TopoDS_Edge() const { return Edge(); }
...
BRepLib_MakePolygon::operator TopoDS_Wire() { return Wire(); }
