...
//=======================================================================
static gp_Pnt Point(const gp_Pnt2d &P) { return BRepLib::Plane()->Value(P.X(), P.Y()); }
...
static Standard_Boolean Project(const Handle(Geom2d_Curve) & C, const TopoDS_Vertex &V, Standard_Real &p) {
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Lin2d &L, const Standard_Real p1, const Standard_Real p2) {
  Handle(Geom2d_Line) GL = new Geom2d_Line(L);
  Init(GL, p1, p2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Lin2d &L, const TopoDS_Vertex &V1, const TopoDS_Vertex &V2) {
  Handle(Geom2d_Line) GL = new Geom2d_Line(L);
  Init(GL, V1, V2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Circ2d &C, const Standard_Real p1, const Standard_Real p2) {
  Handle(Geom2d_Circle) GC = new Geom2d_Circle(C);
  Init(GC, p1, p2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Circ2d &C, const TopoDS_Vertex &V1, const TopoDS_Vertex &V2) {
  Handle(Geom2d_Circle) GC = new Geom2d_Circle(C);
  Init(GC, V1, V2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Elips2d &E, const Standard_Real p1, const Standard_Real p2) {
  Handle(Geom2d_Ellipse) GE = new Geom2d_Ellipse(E);
  Init(GE, p1, p2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Elips2d &E, const TopoDS_Vertex &V1, const TopoDS_Vertex &V2) {
  Handle(Geom2d_Ellipse) GE = new Geom2d_Ellipse(E);
  Init(GE, V1, V2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Hypr2d &H, const Standard_Real p1, const Standard_Real p2) {
  Handle(Geom2d_Hyperbola) GH = new Geom2d_Hyperbola(H);
  Init(GH, p1, p2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Hypr2d &H, const TopoDS_Vertex &V1, const TopoDS_Vertex &V2) {
  Handle(Geom2d_Hyperbola) GH = new Geom2d_Hyperbola(H);
  Init(GH, V1, V2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Parab2d &P, const Standard_Real p1, const Standard_Real p2) {
  Handle(Geom2d_Parabola) GP = new Geom2d_Parabola(P);
  Init(GP, p1, p2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const gp_Parab2d &P, const TopoDS_Vertex &V1, const TopoDS_Vertex &V2) {
  Handle(Geom2d_Parabola) GP = new Geom2d_Parabola(P);
  Init(GP, V1, V2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const Handle(Geom2d_Curve) & L) { Init(L); }
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const Handle(Geom2d_Curve) & L, const Standard_Real p1, const Standard_Real p2) {
  Init(L, p1, p2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const Handle(Geom2d_Curve) & L, const gp_Pnt2d &P1, const gp_Pnt2d &P2) {
  Init(L, P1, P2);
}
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const Handle(Geom2d_Curve) & L, const TopoDS_Vertex &V1,
...
BRepLib_MakeEdge2d::BRepLib_MakeEdge2d(const Handle(Geom2d_Curve) & L, const TopoDS_Vertex &V1, const TopoDS_Vertex &V2,
                                       const Standard_Real p1, const Standard_Real p2) {
  Init(L, V1, V2, p1, p2);
}
...
void BRepLib_MakeEdge2d::Init(const Handle(Geom2d_Curve) & C) { Init(C, C->FirstParameter(), C->LastParameter()); }
...
void BRepLib_MakeEdge2d::Init(const Handle(Geom2d_Curve) & C, const Standard_Real p1, const Standard_Real p2) {
  //  BRep_Builder B;
...
void BRepLib_MakeEdge2d::Init(const Handle(Geom2d_Curve) & C, const TopoDS_Vertex &V1, const TopoDS_Vertex &V2) {
...
void BRepLib_MakeEdge2d::Init(const Handle(Geom2d_Curve) & CC, const TopoDS_Vertex &VV1, const TopoDS_Vertex &VV2,
                              const Standard_Real pp1, const Standard_Real pp2) {
  // kill trimmed curves
...
BRepLib_EdgeError BRepLib_MakeEdge2d::Error() const { return myError; }
...
const TopoDS_Edge &BRepLib_MakeEdge2d::Edge() { return TopoDS::Edge(Shape()); }
...
BRepLib_MakeEdge2d::operator TopoDS_Edge() { return Edge(); }
