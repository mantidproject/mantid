...
Standard_Boolean BRepBuilderAPI_MakeShell::IsDone() const { return myMakeShell.IsDone(); }
...
const TopoDS_Shell &BRepBuilderAPI_MakeShell::Shell() const { return myMakeShell.Shell(); }
...
BRepBuilderAPI_MakeShell::operator TopoDS_Shell() const { return Shell(); }
