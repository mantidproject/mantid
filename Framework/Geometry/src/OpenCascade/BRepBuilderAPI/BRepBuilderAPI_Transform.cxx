...
BRepBuilderAPI_Transform::BRepBuilderAPI_Transform(const TopoDS_Shape &theShape, const gp_Trsf &theTrsf,
...
void BRepBuilderAPI_Transform::Perform(const TopoDS_Shape &theShape, const Standard_Boolean theCopyGeom,
                                       const Standard_Boolean theCopyMesh) {
  myUseModif =
      theCopyGeom || myTrsf.IsNegative() || (Abs(Abs(myTrsf.ScaleFactor()) - 1.) > TopLoc_Location::ScalePrec());
  if (myUseModif) {
