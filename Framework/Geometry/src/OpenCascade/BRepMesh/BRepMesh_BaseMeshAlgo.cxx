...
// Purpose :
//=======================================================================
void BRepMesh_BaseMeshAlgo::Perform(const IMeshData::IFaceHandle &theDFace, const IMeshTools_Parameters &theParameters,
    ...
    for (Standard_Integer aEdgeIt = 0; aEdgeIt < aDWire->EdgesNb(); ++aEdgeIt) {
      ...
      for (Standard_Integer aPointIt = 0; aPointIt <= aLastPoint; ++aPointIt) {
        const Standard_Integer aNodeIndex =
            registerNode(aCurve->GetPoint(aPointIt), aPCurve->GetPoint(aPointIt), BRepMesh_Frontier,
...
// Purpose :
//=======================================================================
Standard_Integer BRepMesh_BaseMeshAlgo::registerNode(const gp_Pnt &thePoint, const gp_Pnt2d &thePoint2d,
                                                     const BRepMesh_DegreeOfFreedom theMovability,
                                                     const Standard_Boolean isForceAdd) {
  const Standard_Integer aNodeIndex = addNodeToStructure(thePoint2d, myNodesMap->Size(), theMovability, isForceAdd);
...
// Purpose :
//=======================================================================
Standard_Integer BRepMesh_BaseMeshAlgo::addNodeToStructure(const gp_Pnt2d &thePoint,
...
// purpose  :
//=======================================================================
TopAbs_Orientation BRepMesh_BaseMeshAlgo::fixSeamEdgeOrientation(const IMeshData::IEdgeHandle &theDEdge,
...
// Purpose :
//=======================================================================
gp_Pnt2d BRepMesh_BaseMeshAlgo::getNodePoint2d(const BRepMesh_Vertex &theVertex) const { return theVertex.Coord(); }
