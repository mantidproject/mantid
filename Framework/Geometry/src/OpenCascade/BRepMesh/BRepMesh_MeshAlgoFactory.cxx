...
Handle(IMeshTools_MeshAlgo) BRepMesh_MeshAlgoFactory::GetAlgo(const GeomAbs_SurfaceType theSurfaceType,
  ...
  case GeomAbs_Plane:
    return theParameters.EnableControlSurfaceDeflectionAllSurfaces
               ...
               : (theParameters.InternalVerticesMode ? new NodeInsertionMeshAlgo<BRepMesh_DefaultRangeSplitter>::Type
  ...
  case GeomAbs_Cylinder:
    return theParameters.EnableControlSurfaceDeflectionAllSurfaces
               ...
               : (theParameters.InternalVerticesMode ? new NodeInsertionMeshAlgo<BRepMesh_CylinderRangeSplitter>::Type
                                                     : new BaseMeshAlgo::Type);
    break;
