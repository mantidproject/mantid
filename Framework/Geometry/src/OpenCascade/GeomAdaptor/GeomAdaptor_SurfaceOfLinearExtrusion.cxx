...
Standard_Real GeomAdaptor_SurfaceOfLinearExtrusion::FirstUParameter() const { return myBasisCurve->FirstParameter(); }
...
Standard_Real GeomAdaptor_SurfaceOfLinearExtrusion::LastUParameter() const { return myBasisCurve->LastParameter(); }
...
Standard_Real GeomAdaptor_SurfaceOfLinearExtrusion::FirstVParameter() const { return RealFirst(); }
...
Standard_Real GeomAdaptor_SurfaceOfLinearExtrusion::LastVParameter() const { return RealLast(); }
...
GeomAbs_Shape GeomAdaptor_SurfaceOfLinearExtrusion::UContinuity() const { return myBasisCurve->Continuity(); }
...
GeomAbs_Shape GeomAdaptor_SurfaceOfLinearExtrusion::VContinuity() const { return GeomAbs_CN; }
...
Standard_Integer GeomAdaptor_SurfaceOfLinearExtrusion::NbVIntervals(const GeomAbs_Shape) const { return 1; }
...
Standard_Boolean GeomAdaptor_SurfaceOfLinearExtrusion::IsUClosed() const { return myBasisCurve->IsClosed(); }
...
Standard_Boolean GeomAdaptor_SurfaceOfLinearExtrusion::IsVClosed() const { return Standard_False; }
...
Standard_Boolean GeomAdaptor_SurfaceOfLinearExtrusion::IsUPeriodic() const { return myBasisCurve->IsPeriodic(); }
...
Standard_Real GeomAdaptor_SurfaceOfLinearExtrusion::UPeriod() const { return myBasisCurve->Period(); }
...
Standard_Boolean GeomAdaptor_SurfaceOfLinearExtrusion::IsVPeriodic() const { return Standard_False; }
...
Standard_Real GeomAdaptor_SurfaceOfLinearExtrusion::VResolution(const Standard_Real R3d) const { return R3d; }
...
Standard_Integer GeomAdaptor_SurfaceOfLinearExtrusion::UDegree() const { return myBasisCurve->Degree(); }
//=======================================================================
// function : NbUPoles
// purpose  :
//=======================================================================

Standard_Integer GeomAdaptor_SurfaceOfLinearExtrusion::NbUPoles() const { return myBasisCurve->NbPoles(); }
...
gp_Dir GeomAdaptor_SurfaceOfLinearExtrusion::Direction() const { return myDirection; }
...
Handle(Adaptor3d_Curve) GeomAdaptor_SurfaceOfLinearExtrusion::BasisCurve() const { return myBasisCurve; }
