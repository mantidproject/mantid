...
Standard_Boolean rayInsideAngle(const BVH_Vec3d &theDirec, const BVH_Vec3d &theEdge0, const BVH_Vec3d &theEdge1,
  ...
  return ccw(ZERO_VEC, theEdge0, theDirec, theX, theY) == aCCW && ccw(ZERO_VEC, theDirec, theEdge1, theX, theY) == aCCW;
}
...
BRepExtrema_SelfIntersection::isRegularSharedEdge(const BVH_Vec3d &theTrng0Vtxs0, const BVH_Vec3d &theTrng0Vtxs1,
  ...
  return ccw(ZERO_VEC, aSharedEdge, aUniqueEdges[0], anX, anY) != ccw(ZERO_VEC, aSharedEdge, aUniqueEdges[1], anX, anY)
