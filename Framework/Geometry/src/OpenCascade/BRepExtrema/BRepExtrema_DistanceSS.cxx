...
//------------------------------------------------------------------------------
static void MIN_SOLUTION(const BRepExtrema_SeqOfSolution &SeqSol1, const BRepExtrema_SeqOfSolution &SeqSol2,
                         const Standard_Real DstRef, const Standard_Real Eps, BRepExtrema_SeqOfSolution &seqSol1,
                         BRepExtrema_SeqOfSolution &seqSol2) {
  for (BRepExtrema_SeqOfSolution::iterator anIt1 = SeqSol1.begin(), anIt2 = SeqSol2.begin(); anIt1 != SeqSol1.end();
       anIt1++, anIt2++) {
...
static void TRIM_INFINIT_EDGE(const TopoDS_Edge &S1, const TopoDS_Edge &S2, TopoDS_Edge &aResEdge,
  ...
  if (Precision::IsInfinite(aFirst1) && Precision::IsInfinite(aLast1) && Precision::IsInfinite(aFirst2) &&
...
//------------------------------------------------------------------------------
static void TRIM_INFINIT_FACE(const TopoDS_Shape &S1, const TopoDS_Shape &S2, TopoDS_Face &aResFace,
...
//------------------------------------------------------------------------------
static void PERFORM_C0(const TopoDS_Edge &S1, const TopoDS_Edge &S2, BRepExtrema_SeqOfSolution &SeqSol1,
                       BRepExtrema_SeqOfSolution &SeqSol2, const Standard_Real DstRef, Standard_Real &mDstRef,
...
//=======================================================================
static Standard_Boolean isOnBoundary(const TopoDS_Edge &theEdge, const gp_Pnt &theSol, const Standard_Real theParam,
  ...
  for (TopoDS_Iterator it(theEdge); it.More(); it.Next()) {
    ...
    if (Abs(aVParam - theParam) < thePTol && BRep_Tool::Pnt(aV).Distance(theSol) < BRep_Tool::Tolerance(aV)) {
      return Standard_True;
    }
  }
  return Standard_False;
...
// purpose  :
//=======================================================================
void BRepExtrema_DistanceSS::Perform(const TopoDS_Shape &theS1, const TopoDS_Shape &theS2, const Bnd_Box &theBox1,
...
//=======================================================================
void BRepExtrema_DistanceSS::Perform(const TopoDS_Vertex &theS1, const TopoDS_Vertex &theS2,
...
// purpose  : Vertex-Edge
//=======================================================================
void BRepExtrema_DistanceSS::Perform(const TopoDS_Vertex &theS1, const TopoDS_Edge &theS2,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape1,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape2) {
...
// purpose  : Vertex-Face
//=======================================================================
void BRepExtrema_DistanceSS::Perform(const TopoDS_Vertex &theS1, const TopoDS_Face &theS2,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape1,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape2) {
...
// purpose  : Edge-Edge
//=======================================================================
void BRepExtrema_DistanceSS::Perform(const TopoDS_Edge &theS1, const TopoDS_Edge &theS2,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape1,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape2) {
...
// purpose  : Face-Face
//=======================================================================
void BRepExtrema_DistanceSS::Perform(const TopoDS_Face &theS1, const TopoDS_Face &theS2,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape1,
                                     BRepExtrema_SeqOfSolution &theSeqSolShape2) {
