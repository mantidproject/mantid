...
Standard_Boolean Geom2d_BSplineCurve::IsG1(const Standard_Real theTf, const Standard_Real theTl,
  ...
  if (((aFirstParam - theTf) * (theTl - aFirstParam) < 0.0) && ((aLastParam - theTf) * (theTl - aLastParam) < 0.0)) {
...
Standard_Boolean Geom2d_BSplineCurve::IsPeriodic() const { return periodic; }
...
GeomAbs_Shape Geom2d_BSplineCurve::Continuity() const { return smooth; }
...
Standard_Integer Geom2d_BSplineCurve::Degree() const { return deg; }
...
void Geom2d_BSplineCurve::D1(const Standard_Real U, gp_Pnt2d &P, gp_Vec2d &V1) const {
  ...
  BSplCLib::D1(aNewU, aSpanIndex, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(),
               knots->Array1(), &mults->Array1(), P, V1);
}
...
void Geom2d_BSplineCurve::D2(const Standard_Real U, gp_Pnt2d &P, gp_Vec2d &V1, gp_Vec2d &V2) const {
  ...
  BSplCLib::D2(aNewU, aSpanIndex, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(),
               knots->Array1(), &mults->Array1(), P, V1, V2);
}
...
void Geom2d_BSplineCurve::D3(const Standard_Real U, gp_Pnt2d &P, gp_Vec2d &V1, gp_Vec2d &V2, gp_Vec2d &V3) const {
  Standard_Integer aSpanIndex = 0;
  Standard_Real aNewU(U);
  PeriodicNormalization(aNewU);
  BSplCLib::LocateParameter(deg, knots->Array1(), &mults->Array1(), U, periodic, aSpanIndex, aNewU);
  ...
  BSplCLib::D3(aNewU, aSpanIndex, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(),
               knots->Array1(), &mults->Array1(), P, V1, V2, V3);
}
...
gp_Vec2d Geom2d_BSplineCurve::DN(const Standard_Real U, const Standard_Integer N) const {
  gp_Vec2d V;
  BSplCLib::DN(U, N, 0, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(), FKNOTS, FMULTS, V);
  return V;
}
...
Standard_Real Geom2d_BSplineCurve::FirstParameter() const { return flatknots->Value(deg + 1); }
...
GeomAbs_BSplKnotDistribution Geom2d_BSplineCurve::KnotDistribution() const { return knotSet; }
...
void Geom2d_BSplineCurve::Knots(TColStd_Array1OfReal &K) const {
  Standard_DomainError_Raise_if(K.Lower() < knots->Lower() || K.Upper() > knots->Upper(), "Geom2d_BSplineCurve::Knots");
  for (Standard_Integer anIdx = K.Lower(); anIdx <= K.Upper(); anIdx++)
    K(anIdx) = knots->Value(anIdx);
}

const TColStd_Array1OfReal &Geom2d_BSplineCurve::Knots() const { return knots->Array1(); }
...
const TColStd_Array1OfReal &Geom2d_BSplineCurve::KnotSequence() const { return flatknots->Array1(); }
...
Standard_Real Geom2d_BSplineCurve::LastParameter() const { return flatknots->Value(flatknots->Upper() - deg); }
...
gp_Pnt2d Geom2d_BSplineCurve::LocalValue(const Standard_Real U, const Standard_Integer FromK1,
...
void Geom2d_BSplineCurve::LocalD0(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
                                  gp_Pnt2d &P) const {
  ...
  BSplCLib::D0(u, index, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(), FKNOTS, FMULTS,
               P);
}
...
void Geom2d_BSplineCurve::LocalD1(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
                                  gp_Pnt2d &P, gp_Vec2d &V1) const {
  ...
  BSplCLib::D1(u, index, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(), FKNOTS, FMULTS, P,
               V1);
}
...
void Geom2d_BSplineCurve::LocalD2(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
  ...
  BSplCLib::D2(u, index, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(), FKNOTS, FMULTS, P,
               V1, V2);
}
...
void Geom2d_BSplineCurve::LocalD3(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
  ...
  BSplCLib::D3(u, index, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(), FKNOTS, FMULTS, P,
               V1, V2, V3);
}
...
gp_Vec2d Geom2d_BSplineCurve::LocalDN(const Standard_Real U, const Standard_Integer FromK1, const Standard_Integer ToK2,
  ...
  gp_Vec2d V;
  BSplCLib::DN(u, N, index, deg, periodic, POLES, rational ? &weights->Array1() : BSplCLib::NoWeights(), FKNOTS, FMULTS,
               V);
  return V;
}
...
Standard_Integer Geom2d_BSplineCurve::Multiplicity(const Standard_Integer Index) const {
  Standard_OutOfRange_Raise_if(Index < 1 || Index > mults->Length(), "Geom2d_BSplineCurve::Multiplicity");
...
void Geom2d_BSplineCurve::Multiplicities(TColStd_Array1OfInteger &M) const {
  Standard_DimensionError_Raise_if(M.Length() != mults->Length(), "Geom2d_BSplineCurve::Multiplicities");
  M = mults->Array1();
}

const TColStd_Array1OfInteger &Geom2d_BSplineCurve::Multiplicities() const { return mults->Array1(); }
...
Standard_Integer Geom2d_BSplineCurve::NbKnots() const { return knots->Length(); }
...
Standard_Integer Geom2d_BSplineCurve::NbPoles() const { return poles->Length(); }
...
const TColgp_Array1OfPnt2d &Geom2d_BSplineCurve::Poles() const { return poles->Array1(); }
...
Standard_Boolean Geom2d_BSplineCurve::IsRational() const { return !weights.IsNull(); }
...
void Geom2d_BSplineCurve::LocateU(const Standard_Real U, const Standard_Real ParametricTolerance, Standard_Integer &I1,
                                  Standard_Integer &I2, const Standard_Boolean WithKnotRepetition) const {
...
void Geom2d_BSplineCurve::Resolution(const Standard_Real ToleranceUV, Standard_Real &UTolerance) {
  if (!maxderivinvok) {
    if (periodic) {
      ...
      BSplCLib::Resolution(new_poles, rational ? &new_weights : BSplCLib::NoWeights(), new_poles.Length(),
                           flatknots->Array1(), deg, 1., maxderivinv);
    } else {
      BSplCLib::Resolution(poles->Array1(), rational ? &weights->Array1() : BSplCLib::NoWeights(), poles->Length(),
                           flatknots->Array1(), deg, 1., maxderivinv);
    }
    maxderivinvok = 1;
  }
