...
Standard_Real Geom2d_Line::FirstParameter() const { return -Precision::Infinite(); }
...
Standard_Real Geom2d_Line::LastParameter() const { return Precision::Infinite(); }
...
void Geom2d_Line::D0(const Standard_Real U, Pnt2d &P) const { P = ElCLib::LineValue(U, pos); }
...
void Geom2d_Line::D1(const Standard_Real U, Pnt2d &P, Vec2d &V1) const { ElCLib::LineD1(U, pos, P, V1); }
...
Standard_Real Geom2d_Line::ParametricTransformation(const gp_Trsf2d &T) const { return Abs(T.ScaleFactor()); }
