...
Handle(Geom2d_Curve) Geom2d_TrimmedCurve::BasisCurve() const { return basisCurve; }
...
GeomAbs_Shape Geom2d_TrimmedCurve::Continuity() const { return basisCurve->Continuity(); }
...
Pnt2d Geom2d_TrimmedCurve::EndPoint() const { return basisCurve->Value(uTrim2); }
...
Standard_Real Geom2d_TrimmedCurve::Period() const { return basisCurve->Period(); }
...
void Geom2d_TrimmedCurve::D0(const Standard_Real U, Pnt2d &P) const { basisCurve->D0(U, P); }
...
void Geom2d_TrimmedCurve::D1(const Standard_Real U, Pnt2d &P, Vec2d &V1) const { basisCurve->D1(U, P, V1); }
...
Vec2d Geom2d_TrimmedCurve::DN(const Standard_Real U, const Standard_Integer N) const { return basisCurve->DN(U, N); }
