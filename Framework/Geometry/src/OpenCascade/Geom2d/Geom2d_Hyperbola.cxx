...
gp_Hypr2d Geom2d_Hyperbola::Hypr2d() const { return gp_Hypr2d(pos, majorRadius, minorRadius); }
...
Standard_Real Geom2d_Hyperbola::ReversedParameter(const Standard_Real U) const { return (-U); }
...
Standard_Real Geom2d_Hyperbola::FirstParameter() const { return -Precision::Infinite(); }
...
Standard_Real Geom2d_Hyperbola::LastParameter() const { return Precision::Infinite(); }
...
Standard_Boolean Geom2d_Hyperbola::IsClosed() const { return Standard_False; }
...
Standard_Boolean Geom2d_Hyperbola::IsPeriodic() const { return Standard_False; }
...
Standard_Real Geom2d_Hyperbola::MajorRadius() const { return majorRadius; }
...
Standard_Real Geom2d_Hyperbola::MinorRadius() const { return minorRadius; }
