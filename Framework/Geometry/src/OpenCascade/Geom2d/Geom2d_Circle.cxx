...
Geom2d_Circle::Geom2d_Circle(const gp_Circ2d &C) : radius(C.Radius()) { pos = C.Axis(); }
...
Standard_Real Geom2d_Circle::Radius() const { return radius; }
...
gp_Circ2d Geom2d_Circle::Circ2d() const { return gp_Circ2d(pos, radius); }
...
Standard_Real Geom2d_Circle::ReversedParameter(const Standard_Real U) const { return (2. * M_PI - U); }
...
Standard_Real Geom2d_Circle::Eccentricity() const { return 0.0; }
...
Standard_Real Geom2d_Circle::FirstParameter() const { return 0.0; }
...
Standard_Real Geom2d_Circle::LastParameter() const { return 2.0 * M_PI; }
...
Standard_Boolean Geom2d_Circle::IsClosed() const { return Standard_True; }
...
Standard_Boolean Geom2d_Circle::IsPeriodic() const { return Standard_True; }
...
void Geom2d_Circle::D0(const Standard_Real U, Pnt2d &P) const { P = ElCLib::CircleValue(U, pos, radius); }
...
void Geom2d_Circle::D1(const Standard_Real U, Pnt2d &P, Vec2d &V1) const { ElCLib::CircleD1(U, pos, radius, P, V1); }
