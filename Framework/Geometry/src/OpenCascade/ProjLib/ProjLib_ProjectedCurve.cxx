...
void ProjLib_ProjectedCurve::Load(const Handle(Adaptor3d_Surface) & S) { mySurface = S; }
...
void ProjLib_ProjectedCurve::Load(const Standard_Real theTol) { myTolerance = theTol; }
  ...
  if (myResult.IsDone() && (isPeriodic[0] || isPeriodic[1])) {
    ...
    for (Standard_Integer anIdx = 1; anIdx <= 2; anIdx++) {
      ...
      if (myResult.GetType() == GeomAbs_BSplineCurve) {
        ...
        for (Standard_Integer aKnotIdx = aRes->FirstUKnotIndex(); aKnotIdx < aRes->LastUKnotIndex(); aKnotIdx++) {
...
// purpose  :
//=======================================================================
void ProjLib_ProjectedCurve::SetMaxSegments(const Standard_Integer theMaxSegments) { myMaxSegments = theMaxSegments; }

//=======================================================================
// function : SetBndPnt
// purpose  :
//=======================================================================
void ProjLib_ProjectedCurve::SetBndPnt(const AppParCurves_Constraint theBndPnt) { myBndPnt = theBndPnt; }

//=======================================================================
// function : SetMaxDist
// purpose  :
//=======================================================================
void ProjLib_ProjectedCurve::SetMaxDist(const Standard_Real theMaxDist) { myMaxDist = theMaxDist; }
...
const Handle(Adaptor3d_Surface) & ProjLib_ProjectedCurve::GetSurface() const { return mySurface; }
...
const Handle(Adaptor3d_Curve) & ProjLib_ProjectedCurve::GetCurve() const { return myCurve; }
...
Standard_Real ProjLib_ProjectedCurve::GetTolerance() const { return myTolerance; }
...
Standard_Real ProjLib_ProjectedCurve::FirstParameter() const { return myCurve->FirstParameter(); }
...
Standard_Real ProjLib_ProjectedCurve::LastParameter() const { return myCurve->LastParameter(); }
...
Standard_Boolean ProjLib_ProjectedCurve::IsPeriodic() const { return myResult.IsPeriodic(); }
...
GeomAbs_CurveType ProjLib_ProjectedCurve::GetType() const { return myResult.GetType(); }
...
gp_Lin2d ProjLib_ProjectedCurve::Line() const { return myResult.Line(); }
...
gp_Circ2d ProjLib_ProjectedCurve::Circle() const { return myResult.Circle(); }
...
gp_Elips2d ProjLib_ProjectedCurve::Ellipse() const { return myResult.Ellipse(); }
...
gp_Hypr2d ProjLib_ProjectedCurve::Hyperbola() const { return myResult.Hyperbola(); }
...
gp_Parab2d ProjLib_ProjectedCurve::Parabola() const { return myResult.Parabola(); }
...
Handle(Geom2d_BezierCurve) ProjLib_ProjectedCurve::Bezier() const { return myResult.Bezier(); }
...
Handle(Geom2d_BSplineCurve) ProjLib_ProjectedCurve::BSpline() const { return myResult.BSpline(); }
//=======================================================================
// function : Trim
// purpose  :
//=======================================================================
