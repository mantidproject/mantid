...
ProjLib_Sphere::ProjLib_Sphere(const gp_Sphere &Sp) { Init(Sp); }
...
void ProjLib_Sphere::Project(const gp_Circ &C) {
  ...
  if (isIsoU) {
    ...
    if (isIsoU &&
        (Abs(P2d1.Y() - M_PI / 2.) < Precision::PConfusion() || Abs(P2d1.Y() + M_PI / 2.) < Precision::PConfusion())) {
...
void ProjLib_Sphere::Project(const gp_Lin &L) { ProjLib_Projector::Project(L); }

void ProjLib_Sphere::Project(const gp_Elips &E) { ProjLib_Projector::Project(E); }

void ProjLib_Sphere::Project(const gp_Parab &P) { ProjLib_Projector::Project(P); }

void ProjLib_Sphere::Project(const gp_Hypr &H) { ProjLib_Projector::Project(H); }
