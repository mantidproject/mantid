...
Geom_SphericalSurface::Geom_SphericalSurface(const gp_Sphere &S) : radius(S.Radius()) { pos = S.Position(); }
...
Standard_Real Geom_SphericalSurface::UReversedParameter(const Standard_Real U) const { return (2. * M_PI - U); }
...
Standard_Real Geom_SphericalSurface::VReversedParameter(const Standard_Real V) const { return (-V); }
...
Standard_Real Geom_SphericalSurface::Area() const { return 4.0 * M_PI * radius * radius; }
...
Standard_Real Geom_SphericalSurface::Radius() const { return radius; }
...
Standard_Boolean Geom_SphericalSurface::IsUClosed() const { return Standard_True; }
...
Standard_Boolean Geom_SphericalSurface::IsVClosed() const { return Standard_False; }
...
Standard_Boolean Geom_SphericalSurface::IsUPeriodic() const { return Standard_True; }
...
Standard_Boolean Geom_SphericalSurface::IsVPeriodic() const { return Standard_False; }
...
gp_Sphere Geom_SphericalSurface::Sphere() const { return gp_Sphere(pos, radius); }
...
Standard_Real Geom_SphericalSurface::Volume() const { return (4.0 * M_PI * radius * radius * radius) / 3.0; }
