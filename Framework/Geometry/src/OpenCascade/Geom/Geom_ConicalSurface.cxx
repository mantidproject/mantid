...
Geom_ConicalSurface::Geom_ConicalSurface(const gp_Cone &C) : radius(C.RefRadius()), semiAngle(C.SemiAngle()) {
  pos = C.Position();
}
...
Standard_Real Geom_ConicalSurface::UReversedParameter(const Standard_Real U) const { return (2. * M_PI - U); }
...
Standard_Real Geom_ConicalSurface::VReversedParameter(const Standard_Real V) const { return (-V); }
...
Standard_Real Geom_ConicalSurface::RefRadius() const { return radius; }
...
Standard_Real Geom_ConicalSurface::SemiAngle() const { return semiAngle; }
...
Standard_Boolean Geom_ConicalSurface::IsUClosed() const { return Standard_True; }
...
Standard_Boolean Geom_ConicalSurface::IsVClosed() const { return Standard_False; }
...
Standard_Boolean Geom_ConicalSurface::IsUPeriodic() const { return Standard_True; }
...
Standard_Boolean Geom_ConicalSurface::IsVPeriodic() const { return Standard_False; }
...
gp_Cone Geom_ConicalSurface::Cone() const { return gp_Cone(pos, semiAngle, radius); }
...
void Geom_ConicalSurface::Coefficients(Standard_Real &A1, Standard_Real &A2, Standard_Real &A3, Standard_Real &B1,
...
void Geom_ConicalSurface::D1(const Standard_Real U, const Standard_Real V, Pnt &P, Vec &D1U, Vec &D1V) const {
...
void Geom_ConicalSurface::D2(const Standard_Real U, const Standard_Real V, Pnt &P, Vec &D1U, Vec &D1V, Vec &D2U,
...
void Geom_ConicalSurface::D3(const Standard_Real U, const Standard_Real V, Pnt &P, Vec &D1U, Vec &D1V, Vec &D2U,
...
Vec Geom_ConicalSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
...
void Geom_ConicalSurface::TransformParameters(Standard_Real &, Standard_Real &V, const gp_Trsf &T) const {
