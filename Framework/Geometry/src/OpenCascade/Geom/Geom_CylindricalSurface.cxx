...
Geom_CylindricalSurface::Geom_CylindricalSurface(const gp_Cylinder &C) : radius(C.Radius()) { pos = C.Position(); }
...
Standard_Real Geom_CylindricalSurface::UReversedParameter(const Standard_Real U) const { return (2. * M_PI - U); }
...
Standard_Real Geom_CylindricalSurface::VReversedParameter(const Standard_Real V) const { return (-V); }
...
gp_Cylinder Geom_CylindricalSurface::Cylinder() const { return gp_Cylinder(pos, radius); }
