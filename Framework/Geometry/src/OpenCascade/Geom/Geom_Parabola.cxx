...
Geom_Parabola::Geom_Parabola(const gp_Parab &Prb) : focalLength(Prb.Focal()) { pos = Prb.Position(); }
...
Geom_Parabola::Geom_Parabola(const Ax2 &A2, const Standard_Real Focal) : focalLength(Focal) {
...
Standard_Real Geom_Parabola::ReversedParameter(const Standard_Real U) const { return (-U); }
...
Standard_Real Geom_Parabola::FirstParameter() const { return -Precision::Infinite(); }
...
Standard_Real Geom_Parabola::LastParameter() const { return Precision::Infinite(); }
...
void Geom_Parabola::D0(const Standard_Real U, Pnt &P) const { P = ElCLib::ParabolaValue(U, pos, focalLength); }
...
void Geom_Parabola::D1(const Standard_Real U, Pnt &P, Vec &V1) const { ElCLib::ParabolaD1(U, pos, focalLength, P, V1); }
...
gp_Parab Geom_Parabola::Parab() const { return gp_Parab(pos, focalLength); }
...
Standard_Real Geom_Parabola::ParametricTransformation(const gp_Trsf &T) const { return Abs(T.ScaleFactor()); }
