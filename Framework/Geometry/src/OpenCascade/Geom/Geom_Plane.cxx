...
Geom_Plane::Geom_Plane(const gp_Ax3 &A3) { pos = A3; }
...
Geom_Plane::Geom_Plane(const gp_Pln &Pl) { pos = Pl.Position(); }
...
void Geom_Plane::SetPln(const gp_Pln &Pl) { pos = Pl.Position(); }
...
gp_Pln Geom_Plane::Pln() const { return gp_Pln(Position()); }
...
void Geom_Plane::UReverse() { pos.XReverse(); }
...
Standard_Real Geom_Plane::UReversedParameter(const Standard_Real U) const { return (-U); }
...
void Geom_Plane::VReverse() { pos.YReverse(); }
...
Standard_Real Geom_Plane::VReversedParameter(const Standard_Real V) const { return (-V); }
...
void Geom_Plane::Transform(const Trsf &T) { pos.Transform(T); }
...
Standard_Boolean Geom_Plane::IsUClosed() const { return Standard_False; }
...
Standard_Boolean Geom_Plane::IsVClosed() const { return Standard_False; }
...
Standard_Boolean Geom_Plane::IsUPeriodic() const { return Standard_False; }
...
Standard_Boolean Geom_Plane::IsVPeriodic() const { return Standard_False; }
...
void Geom_Plane::D0(const Standard_Real U, const Standard_Real V, Pnt &P) const { P = ElSLib::PlaneValue(U, V, pos); }
