...
Geom_TrimmedCurve::Geom_TrimmedCurve(const Handle(Geom_Curve) & C, const Standard_Real U1, const Standard_Real U2,
                                     const Standard_Boolean Sense, const Standard_Boolean theAdjustPeriodic)
    : uTrim1(U1), uTrim2(U2) {
...
void Geom_TrimmedCurve::SetTrim(const Standard_Real U1, const Standard_Real U2, const Standard_Boolean Sense,
  ...
  if (basisCurve->IsPeriodic()) {
    ...
    if (theAdjustPeriodic)
      ElCLib::AdjustPeriodic(Udeb, Ufin, Min(Abs(uTrim2 - uTrim1) / 2, Precision::PConfusion()), uTrim1, uTrim2);
  }
...
Standard_Boolean Geom_TrimmedCurve::IsClosed() const { return (StartPoint().Distance(EndPoint()) <= gp::Resolution()); }
...
Standard_Real Geom_TrimmedCurve::Period() const { return basisCurve->Period(); }
...
GeomAbs_Shape Geom_TrimmedCurve::Continuity() const { return basisCurve->Continuity(); }
...
Handle(Geom_Curve) Geom_TrimmedCurve::BasisCurve() const { return basisCurve; }
...
void Geom_TrimmedCurve::D0(const Standard_Real U, Pnt &P) const { basisCurve->D0(U, P); }
...
void Geom_TrimmedCurve::D1(const Standard_Real U, Pnt &P, Vec &V1) const { basisCurve->D1(U, P, V1); }
...
void Geom_TrimmedCurve::D2(const Standard_Real U, Pnt &P, Vec &V1, Vec &V2) const { basisCurve->D2(U, P, V1, V2); }
...
Vec Geom_TrimmedCurve::DN(const Standard_Real U, const Standard_Integer N) const { return basisCurve->DN(U, N); }
...
Pnt Geom_TrimmedCurve::EndPoint() const { return basisCurve->Value(uTrim2); }
...
Standard_Real Geom_TrimmedCurve::FirstParameter() const { return uTrim1; }
...
Standard_Real Geom_TrimmedCurve::LastParameter() const { return uTrim2; }
...
Pnt Geom_TrimmedCurve::StartPoint() const { return basisCurve->Value(uTrim1); }
