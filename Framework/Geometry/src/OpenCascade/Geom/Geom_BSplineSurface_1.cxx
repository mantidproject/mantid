...
void Geom_BSplineSurface::D0(const Standard_Real U, const Standard_Real V, gp_Pnt &P) const {
  ...
  BSplSLib::D0(aNewU, aNewV, 0, 0, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational, vrational,
               uperiodic, vperiodic, P);
}
...
gp_Vec Geom_BSplineSurface::DN(const Standard_Real U, const Standard_Real V, const Standard_Integer Nu,
  ...
  gp_Vec Vn;
  BSplSLib::DN(U, V, Nu, Nv, 0, 0, POLES, &WEIGHTS, UFKNOTS, VFKNOTS, FMULTS, FMULTS, udeg, vdeg, urational, vrational,
               uperiodic, vperiodic, Vn);
  return Vn;
}
...
const TColgp_Array2OfPnt &Geom_BSplineSurface::Poles() const { return poles->Array2(); }
...
Handle(Geom_Curve) Geom_BSplineSurface::UIso(const Standard_Real U) const {
  ...
  if (urational || vrational) {
    ...
    BSplSLib::Iso(U, Standard_True, POLES, BSplSLib::NoWeights(), UFKNOTS, FMULTS, udeg, uperiodic, cpoles, &cweights);
...
const TColStd_Array1OfReal &Geom_BSplineSurface::UKnots() const { return uknots->Array1(); }
...
const TColStd_Array1OfReal &Geom_BSplineSurface::VKnots() const { return vknots->Array1(); }
...
const TColStd_Array1OfReal &Geom_BSplineSurface::UKnotSequence() const { return ufknots->Array1(); }
...
const TColStd_Array1OfReal &Geom_BSplineSurface::VKnotSequence() const { return vfknots->Array1(); }
...
const TColStd_Array1OfInteger &Geom_BSplineSurface::UMultiplicities() const { return umults->Array1(); }
...
Handle(Geom_Curve) Geom_BSplineSurface::VIso(const Standard_Real V) const {
  ...
  if (urational || vrational) {
    ...
    BSplSLib::Iso(V, Standard_False, POLES, BSplSLib::NoWeights(), VFKNOTS, FMULTS, vdeg, vperiodic, cpoles, &cweights);
...
const TColStd_Array1OfInteger &Geom_BSplineSurface::VMultiplicities() const { return vmults->Array1(); }
  ...
  if (uperiodic) {
    ...
    if (urational || vrational) {
      ...
      BSplSLib::Unperiodize(Standard_True, udeg, umults->Array1(), uknots->Array1(), poles->Array2(),
                            &weights->Array2(), nmults->ChangeArray1(), nknots->ChangeArray1(), npoles->ChangeArray2(),
...
Standard_Boolean Geom_BSplineSurface::IsUPeriodic() const { return uperiodic; }
...
Standard_Boolean Geom_BSplineSurface::IsVPeriodic() const { return vperiodic; }
...
Standard_Integer Geom_BSplineSurface::MaxDegree() { return BSplCLib::MaxDegree(); }
...
Standard_Boolean Geom_BSplineSurface::IsURational() const { return urational; }
...
Standard_Boolean Geom_BSplineSurface::IsVRational() const { return vrational; }
...
GeomAbs_Shape Geom_BSplineSurface::Continuity() const { return ((Usmooth < Vsmooth) ? Usmooth : Vsmooth); }
...
Standard_Integer Geom_BSplineSurface::NbUKnots() const { return uknots->Length(); }
...
Standard_Integer Geom_BSplineSurface::NbUPoles() const { return poles->ColLength(); }
...
Standard_Integer Geom_BSplineSurface::NbVKnots() const { return vknots->Length(); }
...
Standard_Integer Geom_BSplineSurface::NbVPoles() const { return poles->RowLength(); }
...
Standard_Integer Geom_BSplineSurface::UDegree() const { return udeg; }
...
Standard_Integer Geom_BSplineSurface::VDegree() const { return vdeg; }
...
GeomAbs_BSplKnotDistribution Geom_BSplineSurface::UKnotDistribution() const { return uknotSet; }
...
GeomAbs_BSplKnotDistribution Geom_BSplineSurface::VKnotDistribution() const { return vknotSet; }
...
Standard_Boolean Geom_BSplineSurface::RemoveUKnot(const Standard_Integer Index, const Standard_Integer M,
  ...
  Handle(TColgp_HArray2OfPnt) npoles = new TColgp_HArray2OfPnt(1, oldpoles.ColLength() - step, 1, oldpoles.RowLength());
  Handle(TColStd_HArray1OfReal) nknots = uknots;
  Handle(TColStd_HArray1OfInteger) nmults = umults;
...
Standard_Boolean Geom_BSplineSurface::RemoveVKnot(const Standard_Integer Index, const Standard_Integer M,
  ...
  Handle(TColgp_HArray2OfPnt) npoles = new TColgp_HArray2OfPnt(1, oldpoles.ColLength(), 1, oldpoles.RowLength() - step);
  Handle(TColStd_HArray1OfReal) nknots = vknots;
  Handle(TColStd_HArray1OfInteger) nmults = vmults;
