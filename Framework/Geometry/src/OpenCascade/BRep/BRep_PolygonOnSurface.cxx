...
Standard_Boolean BRep_PolygonOnSurface::IsPolygonOnSurface() const { return Standard_True; }
...
const Handle(Geom_Surface) & BRep_PolygonOnSurface::Surface() const { return mySurface; }
...
const Handle(Poly_Polygon2D) & BRep_PolygonOnSurface::Polygon() const { return myPolygon2D; }
...
void BRep_PolygonOnSurface::Polygon(const Handle(Poly_Polygon2D) & P) { myPolygon2D = P; }
