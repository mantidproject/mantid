...
Standard_Boolean BRep_Polygon3D::IsPolygon3D() const { return Standard_True; }
...
const Handle(Poly_Polygon3D) & BRep_Polygon3D::Polygon3D() const { return myPolygon3D; }
...
void BRep_Polygon3D::Polygon3D(const Handle(Poly_Polygon3D) & P) { myPolygon3D = P; }
