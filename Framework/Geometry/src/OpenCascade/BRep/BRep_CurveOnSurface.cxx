...
Standard_Boolean BRep_CurveOnSurface::IsCurveOnSurface() const { return Standard_True; }
...
const Handle(Geom_Surface) & BRep_CurveOnSurface::Surface() const { return mySurface; }
...
const Handle(Geom2d_Curve) & BRep_CurveOnSurface::PCurve() const { return myPCurve; }
...
void BRep_CurveOnSurface::PCurve(const Handle(Geom2d_Curve) & C) { myPCurve = C; }
