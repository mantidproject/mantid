...
public: //! @name Choosing the best branch
  ...
  virtual Standard_Boolean IsMetricBetter(const Bnd_Range &theLeft, const Bnd_Range &theRight) const Standard_OVERRIDE {
    if (myPrmMin > myPrmMax)
      // no parameters computed
      return Standard_True;
...
OBBTool::OBBTool(const TColgp_Array1OfPnt &theL, const TColStd_Array1OfReal *theLT, const Standard_Boolean theIsOptimal)
  ...
  if (myOptimal) {
    ...
    opencascade::handle<BVH_LinearBuilder<Standard_Real, 3>> aLBuilder = new BVH_LinearBuilder<Standard_Real, 3>(30);
