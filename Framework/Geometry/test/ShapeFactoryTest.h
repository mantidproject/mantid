...
public:
  ...
  void testRotateCylinder() {
    ...
    V3D centre = V3D(10.0, 9.0, 11.0); // Actually centre of the base
    V3D topRotate = V3D(8.0, 6.0, 12.0);
    V3D topRotateAll = V3D(10.0, -11.0, 11.0);
    V3D centreRotateAll = V3D(10.0, -10.0, 11.0);
  ...
  void testRotateHollowCylinder() {
    ...
    V3D pointRotate = V3D(103.0, 80.0, 103.0);
    V3D pointRotateAll = V3D(103.0, -103.0, 120.0);
  ...
  void testRotateInfinitePlane() {
    ...
    xmlInfinitePlaneStart += "<point-in-plane x=\"10.0\" y=\"10.0\" z=\"10.0\" /> ";
    ...
    TS_ASSERT(plane_sptr->isValid(centre));
    TS_ASSERT(!plane_sptr->isValid(centreRotateAll));
    ...
    TS_ASSERT(planeRotate_sptr->isValid(centre));
    TS_ASSERT(!planeRotate_sptr->isValid(centreRotateAll));
    ...
    TS_ASSERT(planeRotateAll_sptr->isValid(centreRotateAll));
    TS_ASSERT(!planeRotateAll_sptr->isValid(centre));
  }

  void testRotateInfiniteCylinder() {
    std::string xmlInfiniteCylinderStart = "<infinite-cylinder id=\"InfiniteCylinder\"> ";
    xmlInfiniteCylinderStart += "<centre x=\"10.0\" y=\"10.0\" z=\"10.0\" /> ";
