...
public:
  ...
  void testRecursiveToXML() {
    ...
    TSM_ASSERT_EQUALS("The xml generated by this function did not match the expected schema.",
  ...
  void testCannotAddNullDimension() {
    ...
    TSM_ASSERT("A null function cannot be added to a function of type "
               "CompositeFunction",
               !function.addFunction(Mantid::Geometry::MDImplicitFunction_sptr(nullFunction)));
  }
};
