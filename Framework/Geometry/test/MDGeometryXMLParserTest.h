...
public:
  static std::string constructXML(const std::string &xDimensionIdMapping,
    ...
    return std::string(R"(<?xml version="1.0" encoding="utf-8"?>)") +
           ...
           "<UpperBounds>6.6</UpperBounds>" +
           "<LowerBounds>-6.6</LowerBounds>" +
           "<NumberOfBins>1</NumberOfBins>" + "</Dimension>" + "<XDimension>" +
...
public:
  ...
  void testAllDimensions() {
    using namespace Mantid::Geometry;
    MDGeometryXMLParser xmlParser(
        constructXML("qy", "qx", "en", "qz")); // All mapped
    xmlParser.execute();
  ...
  void testGetAllDimensions() {
    ...
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    xmlParser.execute();
    TSM_ASSERT_EQUALS("Returned wrong number of dimensions", 5,
                      xmlParser.getAllDimensions().size());
  }
  ...
  void testGetAllIntegratedDimensions() {
    ...
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    xmlParser.execute();
    TSM_ASSERT_EQUALS("Returned wrong number of integrated dimensions", 2,
                      xmlParser.getIntegratedDimensions().size());
  }
