...
public:
  static std::string constructXML(const std::string &xDimensionIdMapping, const std::string &yDimensionIdMapping,
                                  const std::string &zDimensionIdMapping, const std::string &tDimensionIdMapping) {
    return std::string(R"(<?xml version="1.0" encoding="utf-8"?>)") + "<DimensionSet>" + "<Dimension ID=\"en\">" +
           "<Name>Energy</Name>" + "<UpperBounds>150</UpperBounds>" + "<LowerBounds>0</LowerBounds>" +
           "<NumberOfBins>1</NumberOfBins>" + "</Dimension>" + "<Dimension ID=\"qx\">" + "<Name>Qx</Name>" +
           "<UpperBounds>5</UpperBounds>" + "<LowerBounds>-1.5</LowerBounds>" + "<NumberOfBins>5</NumberOfBins>" +
           "</Dimension>" + "<Dimension ID=\"qy\">" + "<Name>Qy</Name>" + "<UpperBounds>6.6</UpperBounds>" +
           "<LowerBounds>-6.6</LowerBounds>" + "<NumberOfBins>5</NumberOfBins>" + "</Dimension>" +
           "<Dimension ID=\"qz\">" + "<Name>Qz</Name>" + "<UpperBounds>6.6</UpperBounds>" +
           "<LowerBounds>-6.6</LowerBounds>" + "<NumberOfBins>5</NumberOfBins>" + "</Dimension>" +
           "<Dimension ID=\"other\">" + "<Name>Other</Name>" + "<UpperBounds>6.6</UpperBounds>" +
           "<LowerBounds>-6.6</LowerBounds>" + "<NumberOfBins>1</NumberOfBins>" + "</Dimension>" + "<XDimension>" +
           "<RefDimensionId>" + xDimensionIdMapping + "</RefDimensionId>" + "</XDimension>" + "<YDimension>" +
           "<RefDimensionId>" + yDimensionIdMapping + "</RefDimensionId>" + "</YDimension>" + "<ZDimension>" +
           "<RefDimensionId>" + zDimensionIdMapping + "</RefDimensionId>" + "</ZDimension>" + "<TDimension>" +
           "<RefDimensionId>" + tDimensionIdMapping + "</RefDimensionId>" + "</TDimension>" + "</DimensionSet>";
  }
...
public:
  ...
  void testGetNonMappedDimensionsThrows() {
    ...
    TSM_ASSERT_THROWS("execute not called before using getter. Should have thrown", xmlParser.getNonMappedDimensions(),
  ...
  void testGetXDimensionThrows() {
    using namespace Mantid::Geometry;
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    TSM_ASSERT_THROWS("execute not called before using getter. Should have thrown", xmlParser.getXDimension(),
                      const std::runtime_error &);
  }
  ...
  void testGetYDimensionThrows() {
    using namespace Mantid::Geometry;
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    TSM_ASSERT_THROWS("execute not called before using getter. Should have thrown", xmlParser.getYDimension(),
                      const std::runtime_error &);
  }
  ...
  void testGetZDimensionThrows() {
    using namespace Mantid::Geometry;
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    TSM_ASSERT_THROWS("execute not called before using getter. Should have thrown", xmlParser.getZDimension(),
                      const std::runtime_error &);
  }
  ...
  void testGetTDimensionThrows() {
    using namespace Mantid::Geometry;
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    TSM_ASSERT_THROWS("execute not called before using getter. Should have thrown", xmlParser.getTDimension(),
                      const std::runtime_error &);
  }
  ...
  void testGetAllDimensionsThrows() {
    using namespace Mantid::Geometry;
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    TSM_ASSERT_THROWS("execute not called before using getter. Should have thrown", xmlParser.getAllDimensions(),
                      const std::runtime_error &);
  }
  ...
  void testGetNonIntegratedDimensionsThrows() {
    using namespace Mantid::Geometry;
    MDGeometryXMLParser xmlParser(constructXML("qy", "qx", "en", "qz"));
    TSM_ASSERT_THROWS("execute not called before using getter. Should have thrown",
  ...
  void testAssignment() {
    ...
    TSM_ASSERT_EQUALS("X dimension output not the same after assignment", A.getXDimension()->getDimensionId(),
    ...
    TSM_ASSERT_EQUALS("Y dimension output not the same after assignment", A.getYDimension()->getDimensionId(),
    ...
    TSM_ASSERT_EQUALS("Z dimension output not the same after assignment", A.getZDimension()->getDimensionId(),
    ...
    TSM_ASSERT_EQUALS("T dimension output not the same after assignment", A.getTDimension()->getDimensionId(),
                      B.getTDimension()->getDimensionId());
    TSM_ASSERT_EQUALS("Non mapped dimension output not the same after assignment", A.getNonMappedDimensions().size(),
                      B.getNonMappedDimensions().size());
  }
  ...
  void testThrowsIfRootInvalid() {
    ...
    MDGeometryXMLParser xmlParser("<ElementTypeA><ElementTypeB></"
                                  "ElementTypeB></ElementTypeA>"); // Valid xml,
                                                                   // but the
                                                                   // wrong
                                                                   // schema.
