...
public:
  ...
  */
  {
    ...
    TS_ASSERT_DELTA(geom_obj->triangulatedSolidAngle(V3D(-0.5, 0.0, 0.0)), 0.0,
                    satol);
    // Other end
    TS_ASSERT_DELTA(geom_obj->triangulatedSolidAngle(V3D(-1.497, 0.0, 0.0)), 0.0,
                    satol);

    // Side values
    TS_ASSERT_DELTA(geom_obj->triangulatedSolidAngle(V3D(0, 0, 0.1)), 0.00301186,
                    satol);
    TS_ASSERT_DELTA(geom_obj->triangulatedSolidAngle(V3D(0, 0, -0.1)), 0.00301186,
                    satol);
    ...
    // surface points
    TS_ASSERT_DELTA(geom_obj->triangulatedSolidAngle(V3D(-1.0, 0.0, 0.0)), 2 * M_PI,
                    satol);
  ...
  */
  ...
  void testSolidAngleCubeTriangles_WithScaleFactor() {
    ...
    TS_ASSERT_DELTA(geom_obj->triangulatedSolidAngle(V3D(2.0, 0, 0), scaleFactor),
                    expected, satol);
  }
