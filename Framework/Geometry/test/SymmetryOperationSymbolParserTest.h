...
public:
  ...
  void testParseIdentifier() {
    ...
    TS_ASSERT_THROWS(TestableSymmetryOperationSymbolParser::parseIdentifier("1/4, x, -z-x"),
                     const std::runtime_error &);
    TS_ASSERT_THROWS(TestableSymmetryOperationSymbolParser::parseIdentifier("x, -z-x"), const std::runtime_error &);
    TS_ASSERT_THROWS(TestableSymmetryOperationSymbolParser::parseIdentifier("y, x, -z-x, z"),
                     const std::runtime_error &);
  }

  void testGetNormalizedIdentifier() {
    MatrixVectorPair<int, V3R> param1 = SymmetryOperationSymbolParser::parseIdentifier("x+1/2, y, -z-1/2");
    TS_ASSERT_EQUALS(SymmetryOperationSymbolParser::getNormalizedIdentifier(param1), "x+1/2,y,-z-1/2");

    MatrixVectorPair<int, V3R> param2 = TestableSymmetryOperationSymbolParser::parseIdentifier("1/2+x, y, -1/2-z");
  ...
  void testGetNormalizedIdentifierDenominatorOne() {
    MatrixVectorPair<int, V3R> param1 = SymmetryOperationSymbolParser::parseIdentifier("2+x, y, -z-1");
    TS_ASSERT_EQUALS(SymmetryOperationSymbolParser::getNormalizedIdentifier(param1), "x+2,y,-z-1");
  }
