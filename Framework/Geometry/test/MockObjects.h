...
public:
  MOCK_METHOD1(setInstrument, void(const Geometry::Instrument_const_sptr &inst));
  ...
  MOCK_METHOD1(findDetector, bool(const Mantid::Geometry::InstrumentRayTracer &tracer));
