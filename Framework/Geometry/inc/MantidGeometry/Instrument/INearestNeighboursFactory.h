...
/** INearestNeighboursFactory : Abstract class for creating INearestNeighbour
products/objects. This implements a factory method.
...
public:
  ...
  create(boost::shared_ptr<const Instrument> instrument,
         const ISpectrumDetectorMapping &spectraMap,
         bool ignoreMasked = false) = 0;
  /// Factory method
  virtual INearestNeighbours *
  create(int numberOfNeighbours, boost::shared_ptr<const Instrument> instrument,
         const ISpectrumDetectorMapping &spectraMap,
         bool ignoreMasked = false) = 0;
  /// Destructor
