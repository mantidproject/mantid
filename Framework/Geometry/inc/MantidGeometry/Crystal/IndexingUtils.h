...
public:
  ...
  static double Optimize_6dUB(Kernel::DblMatrix &UB, Kernel::DblMatrix &ModUB, 
                            ...
                            std::vector<double> &sigabc, std::vector<double> &sigq);
  ...
  static bool GetModulationVector(const Kernel::DblMatrix &UB, const Kernel::DblMatrix &ModUB, Kernel::V3D &ModVec, int &j);
